...
let message = {
  ...
  Privacy: {
    ...
    "policyDescription": '본 방침은 NeverCap(이하 "NeverCap", "당사", "우리")이 서비스, 웹사이트(https://www.nevercap.ai/) 및 소프트웨어(통칭 "서비스") 이용 시 귀하의 개인정보를 수집, 사용, 공개하는 방법을 설명합니다.',
    ...
    "childrenDescription": "본 서비스는 아동을 대상으로 하지 않으며, 당사는 고의로 13세 미만 아동의 개인정보를 수집하지 않습니다. 13세 미만인 경우 서비스를 통해 어떠한 개인정보도 제출하지 마십시오. 아동이 본 방침을 위반하여 당사에 개인정보를 제공했다고 생각되는 경우, 아래와 같이 당사에 연락하시기 바랍니다.",
    ...
    "contactTitle": "9. 문의하기",
    "contactDescription": "개인정보 처리방침에 대한 질문, 의견 또는 불만이 있는 경우 당사에 연락하시면 가능한 한 빨리 처리하도록 노력하겠습니다.",
  ...
  TermsOfUse: {
    ...
    "trademarkProtection": "서비스의 이름, 외관 및 느낌은 회사의 저작권©입니다. 모든 권리 보유. 회사의 서면 허가 없이 HTML, CSS, JavaScript 또는 시각적 디자인 요소의 일부를 복제, 복사 또는 재사용할 수 없습니다. 회사 로고 또는 서비스 로고를 홍보 목적으로 사용하려면 허가를 요청해야 합니다. 로고 사용 요청은 이메일로 보내주십시오. 본 서비스 약관을 위반할 경우 이 허가를 취소할 권리가 있습니다.",
    ...
    "privacyPolicyDescription": "당사는 데이터 개인정보 보호와 보안을 중요하게 생각합니다. 개인정보 보호 정책을 검토하시기 바랍니다. 사이트를 사용함으로써 귀하는 본 이용 약관에 포함된 개인정보 보호 정책에 구속됨에 동의합니다. 사이트는 미국에 호스팅되어 있습니다. 미국과 다른 법률 또는 개인 데이터 수집, 사용 또는 공개에 관한 요구 사항이 있는 다른 지역에서 사이트에 접근하는 경우, 귀하는 계속적인 사이트 사용을 통해 데이터를 미국으로 전송하며, 미국에서 데이터가 전송 및 처리되는 것에 동의합니다.",
    "liabilityTitle": "15. 책임",
    ...
    "contactDescription": "이용 약관에 대한 질문이 있으시면 당사에 문의하십시오.",
    "neverCap": "NeverCap",
    "site": "사이트",
    "services": "서비스"
  }
