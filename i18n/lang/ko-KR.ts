...
let message = {
  ...
  Index: {
    ...
    Testimonials: {
      subtitle:
        "전문가들이 제한적인 대안 대신 NeverCap을 선택하는 이유 확인하기",
      Mike: {
    ...
    CTASection: {
      ...
      subtitle:
        "진정한 무제한 필사로 전환한 50,000명 이상의 전문가와 함께하세요",
      button: "NeverCap 무료로 사용해보기",
      disclaimer:
        "무료 플랜에는 신용 카드 불필요 • 언제든지 무제한 액세스를 위해 업그레이드 가능"
    }
  },
  Features: {
    UnlimitedTranscription: {
      ...
      heroSubtitle1:
        "Trint는 한 달에 최대 50시간으로 제한하고 Otter는 한 달에 최대 10개의 파일로 제한합니다.",
      heroSubtitle2:
        "실제로 약속한 바를 실현해 드립니다. 숨겨진 대문자 없이 무제한으로 필사해 드립니다."
    },
    BulkUpload: {
      heroBadgeIcon: "📁",
      ...
      useCase4Description:
        "전체 채널에 대한 자막 생성. 동영상 콘텐츠로 블로그 게시물 작성. 모든 동영상의 SEO 개선.",
  ...
  Pricing: {
    ...
    ComparisonTable: {
      header: {
        ...
        subtitle:
          "각 플랜에서 정확히 무엇을 얻는지 확인하세요. 숨겨진 제한 없음."
      },
    ...
    FAQ: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "모든 주요 신용카드, 체크카드 및 PayPal을 통해 안전하고 편리한 결제가 가능합니다."
        },
        {
          q: "free_trial",
          question: "Pro 무료 체험 기회가 있나요?",
          answer:
            "네! 신용카드 없이 7일 동안 Pro를 무료로 사용해 보세요. 구독 시 첫 달 45% 할인도 제공됩니다."
        },
        {
          q: "file_retention",
          question: "파일을 얼마나 보관하나요?",
          answer:
            "무료 플랜: 30일. Pro 플랜: 영구! 계정에서 항상 기록을 확인할 수 있습니다."
        },
        {
          q: "data_security",
  ...
  UseCases: {
    AllUseCases: {
      ...
      journalists: {
        ...
        description:
          "마감 전 모든 인터뷰를 일괄 업로드하세요. 대본을 즉시 검색해 중요한 인용구를 놓치지 마세요.",
        benefits: {
      ...
      contentCreators: {
        ...
        description:
          "YouTube 채널 전체에 자막을 추가하세요. 다국어 자막 생성과 즉각적인 비디오 SEO 개선이 가능합니다.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          ...
          carlos: {
            textBefore:
              '"저는 스페인어로 교육 콘텐츠를 만듭니다. NeverCap은 완벽하게 전사하고',
            highlight: "영어로 번역",
            textAfter:
              '하여 더 넓은 관객에게 도달할 수 있게 해줍니다. 제한 없이 성장만 있습니다."',
      ...
      cta: {
        ...
        subtitle:
          "분 단위 계산을 멈추고 창작을 시작한 50,000명 이상의 전문가에 합류하세요",
        button: "무제한 여정 시작하기 →"
      },
      heroSubtitleA:
    ...
    Podcasters: {
      ...
      problemSubtitle:
        '다른 서비스는 어떤 에피소드가 텍스트 변환 "가치"가 있는지 선택하도록 강요합니다',
      problems: {
        problem1: {
      ...
      workflow: {
        step1: {
          title: "에피소드 업로드",
          description:
            "한 번에 50개 에피소드 드롭. MP3, MP4, WAV - 모두 처리 가능합니다."
        },
        step2: {
          title: "AI 변환",
        ...
        step4: {
          title: "게시 및 순위",
          description:
            "웹사이트로 내보내기. SEO 트래픽이 증가하는 것을 확인하세요."
        }
      },
      ...
      features: {
        ...
        feature4: {
          title: "SEO 최적화",
          description:
            "검색 엔진에 최적화된 텍스트. 팟캐스트의 검색 가능성을 높이고 새로운 청중에게 도달하세요."
        },
        feature5: {
          title: "100개 이상의 언어",
          description:
            "어떤 언어로든 녹취 가능. 249개 이상의 언어로 번역. 전 세계 청중에게 쉽게 도달하세요."
        },
        feature6: {
          title: "일괄 처리",
          description:
      ...
      ctaDisclaimer:
        "신용카드 불필요 • 무제한 에피소드 처리 • 언제든지 취소 가능",
    ...
    Journalists: {
      ...
      problem: {
        ...
        subtitle:
          '다른 서비스는 어떤 인터뷰가 자막화할 "가치"가 있는지 선택하게 합니다',
        problems: {
          uploadLimits: {
            title: "업로드 제한이 조사를 방해합니다",
            description:
              "Otter Pro는 월 10개 파일만 허용합니다. 3주 분량의 수사 인터뷰를 어떻게 자막화하나요?"
          },
          missingQuotes: {
            title: "중요한 발언 놓침",
            description:
          ...
          costExplosion: {
            ...
            description:
              "조사가 깊어질수록 필사 비용이 급증합니다. 월 $100의 초과 요금으로 속보 작성이 불가능해집니다."
          }
        },
        solution: {
          title: "The",
        ...
        solutions: {
          ...
          instantSearch: {
            ...
            searchDemo: {
              ...
              results: {
                ...
                expertPanel:
                  '"...정책 성명서에는 분명히 다음과 같은 내용이 나와 있습니다..."'
              }
            }
          },
          professionalAccuracy: {
            ...
            visual: {
              ...
              transcript: {
                speaker1:
                  '"조사 결과, 재무 보고서에 상당한 불일치가 있는 것으로 드러났습니다."',
                speaker2:
                  '"구체적인 차이점에 대해 자세히 설명해 주실 수 있나요?"'
              }
            }
          },
          ironclad: {
      ...
      cta: {
        ...
        subtitle:
          "업로드 횟수를 세는 걸 멈추고 스토리에 집중하는 수천 명의 저널리스트에 합류하세요",
    ...
    ContentCreators: {
      ...
      workflow: {
        ...
        steps: {
          pasteLinks: {
            title: "링크 붙여넣기",
            description:
              "YouTube, TikTok 또는 어떤 동영상 링크든 입력. 또는 파일 직접 업로드."
          },
          autoTranscribe: {
            title: "자동 변환",
      ...
      testimonials: {
        ...
        carlos: {
          textBefore:
            "저는 스페인어 교육 콘텐츠를 만듭니다. NeverCap은 완벽하게 변환해주고",
          textAfter:
            "더 넓은 확장을 가능케 합니다. 제한 없이 성장만. 다국어 자막 추가 후 채널 조회수 3배 증가.",
          highlight: "영어로 번역",
          name: "카를로스 마르티네즈",
      ...
      cta: {
        ...
        subtitle:
          "분을 세는 것을 멈추고 창작을 시작한 50,000명 이상의 크리에이터에 합류하세요",
        button: "무제한 자막 생성 시작 →"
      },
      FAQSection: {
        title: "여러분의 변환 질문,",
        ...
        questions: [
          ...
          {
            question:
              "Q: Facebook 비디오를 텍스트로 변환하는 가장 좋은 방법은 무엇인가요?",
            answer:
    ...
    Researchers: {
      ...
      conversationText5:
        "시골 지역에서는 비용, 접근성, 교통 이 세 가지 모두에요.",
      feature3Label: "정밀도",
      ...
      useCase3Title: "임상 연구",
      useCase3Desc:
        "HIPAA 호환 환자 인터뷰 옵션. 정확한 의학 용어 전사. 민감한 건강 데이터의 안전한 처리.",
      useCase4Title: "민족지학 연구",
      useCase4Desc:
        "자연 환경에서의 현장 녹음. 배경 소음 및 다중 화자 처리. 100개 이상의 언어 및 방언 지원.",
    ...
    BusinessTeams: {
      ...
      featuresSubtitle:
        "실시간 녹음부터 즉시 업로드까지, 모든 마찰점을 제거했습니다",
      ...
      feature2Benefit1:
        "지원 형식: MP3, MP4, M4A, MOV, AAC, WAV, OGG, OPUS, MPEG, WMA, WMV, FLAC",
      ...
      workflowStep2Desc:
        "AI가 몇 분 만에 96% 정확도로 녹음을 텍스트로 자동 변환합니다.",
      ...
      ctaSubtitle:
        "무제한 변환으로 모든 회의를 기록하는 수천 개의 팀에 합류하세요",
      ctaButton: "무료로 녹음 시작 →",
      featuresTitle2: "회의",
    ...
    Educators: {
      ...
      featuresSubtitle:
        "YouTube 강의부터 녹화 수업까지, 모든 콘텐츠를 접근 가능하게",
      ...
      workflowTitle: "작동 방식:",
      workflowSubtitle:
        "동영상 링크부터 접근 가능한 자막 및 학습 자료까지 몇 분 안에",
      workflowStep1Title: "강의 업로드",
      workflowStep1Desc:
        "오디오 또는 동영상 파일(MP3, MP4, WAV) 업로드 또는 YouTube 링크 붙여넣기",
      workflowStep2Title: "AI 자막 생성",
      workflowStep2Desc:
        "AI가 오디오를 변환하고 화자를 분리하며 주요 주제를 식별합니다.",
      workflowStep3Title: "자막 생성",
      workflowStep3Desc: "완벽하게 싱크된 자막 자동 생성",
      workflowStep4Title: "학습 가이드 내보내기",
      workflowStep4Desc:
        "텍스트, 요약을 다운로드하거나 최종 학습 가이드를 생성해 내보내세요",
      useCasesTitle: "모든",
      useCasesSubtitle:
        "교육자들이 NeverCap으로 학습 효과를 높이는 방법 확인하기",
      useCase1Title: "녹화 강의",
      useCase1Text:
      ...
      ctaSubtitle:
        "진정한 무제한 텍스트 변환을 사용하는 수천 명의 교육자들과 함께하세요",
      ctaButton: "NeverCap 무료로 사용해보기",
  ...
  Resources: {
    YouTubeToMP4: {
      part1: {
        ...
        Download: "다운로드",
        loading_text:
          "다운로드할 링크를 처리 중입니다. 페이지를 유지해 주세요.",
        ...
        steps: [
          {
            title: "URL 복사",
            content:
              "원하는 YouTube 동영상을 열고 브라우저 주소 표시줄에서 링크를 복사하세요."
          },
          {
            title: "링크 붙여넣기",
            content:
              "동영상 다운로드 도구로 이동하여 URL을 입력란에 붙여넣으세요."
          },
          {
            title: "MP4 다운로드",
      ...
      part4: {
        ...
        list: [
          ...
          },
          {
            title: "어디서나, 언제든 시청:",
            content:
              "인터넷 연결이 불안정해도 동영상을 끊김 없이 즐기세요. 버퍼링 걱정은 이제 그만."
          },
          {
            title: "손쉬운 보관 및 저장:",
            content:
      ...
      part5: {
        ...
        cards: [
          ...
          },
          {
            title: "광고 없음, 방해 없음",
            content:
              "팝업, 배너, 방해 요소 없는 깔끔한 인터페이스로 원활한 동영상 변환을 경험하세요."
          },
          {
            icon: "5",
            color: "#DEE5FF",
            title: "원본 품질 보장",
            content:
              "다운로드한 파일은 원본 동영상의 해상도를 그대로 유지하여 언제나 선명한 재생이 가능합니다."
          },
          {
            icon: "6",
            color: "#DEF6EE",
        ...
        list: [
          {
            ...
            answer:
              "저작권 소유자의 허가 없이 저작권이 있는 YouTube 동영상을 다운로드하는 것은 불법입니다."
          },
          {
          ...
          },
          {
            ...
            answer:
              "우리 서비스는 모든 인기 언어로 YouTube 동영상을 다운로드할 수 있도록 지원합니다."
          },
          {
            question:
              "YouTube 동영상 다운로드 시간에 영향을 주는 요소는 무엇인가요?",
            answer:
              "우리는 최대한 빠른 다운로드 환경을 제공하지만, 다운로드 시간은 동영상 길이와 인터넷 연결 속도와 같은 요소에 따라 영향을 받습니다."
          },
          {
            question:
              "스마트폰으로 MP4 동영상을 다운로드하면 어디에 저장되나요?",
            answer:
      ...
      freeResources: {
        ...
        steps: [
          {
            title: "무료 오디오 및 비디오",
            content:
              "오디오 및 비디오 파일을 몇 초 만에 텍스트로 변환합니다. 매일 무료로 3개의 대본을 받아보세요."
          },
          {
          ...
          },
          {
            ...
            content:
              "YouTube 동영상을 정확한 텍스트나 자막으로 변환하세요. YouTube 링크를 붙여넣기만 하면 됩니다."
          }
        ],
        stepsNew: [
          {
            ...
            content:
              "몇 초 만에 오디오 및 비디오 파일을 텍스트로 변환하세요. 매일 3개의 무료 대본이 제공됩니다."
          },
          {
            title: "오디오 파일을 텍스트로 변환",
            content: "MP3, MP4, WAV, MOV를 업로드하세요.",
        ...
        MoreFreeTools: {
              ...
              "YouTubeToMP_des": "YouTube 동영상을 오프라인 감상을 위해 MP3 형식으로 변환하세요. 고화질 동영상을 즉시 다운로드하세요.",
              "AITranscription": "AI 전사",
              "AITranscription_des": "96% 정확도로 오디오 및 비디오 파일을 텍스트로 변환하세요. 모든 콘텐츠에 대해 무제한 텍스트 변환이 가능합니다."
            }
    },
      YouTubeToMP3: {
            ...
            "part4": {
              "content": [
                "변환의 5가지 주요 이점은 다음과 같습니다.",
                "YouTube 비디오를 MP3 파일로"
              ],
              "list": [
                {
                  "title": "저장 공간을 절약하세요:",
                  "content": "MP3 파일은 크기가 더 작아 YouTube 사용 시 저장 공간이 줄어듭니다. 오프라인 시청을 위해 다운로드하고 인터넷 서비스가 가능할 때 사용하면 모바일 데이터를 절약할 수 있습니다."
                },
                {
                  "title": "배터리 절약:",
                  "content": "YouTube 동영상을 시청하려면 쉽게 들을 수 있는 연결을 사용하는 버퍼링 서비스를 이용하세요. 더 이상 버퍼링 걱정은 없습니다."
                },
                {
                  "title": "간편한 보관 및 보존:",
                  "content": "일부 비디오나 MP3를 이용하면 교육 콘텐츠, 음악 보관소 또는 중요한 콘텐츠 등 개인 라이브러리를 쉽게 구축할 수 있습니다."
                },
                {
                  "title": "더욱 간편한 공유:",
                  "content": "MP3 파일을 공유하는 것은 YouTube 링크보다 훨씬 편리합니다. WhatsApp이나 Instagram 같은 앱을 통해 친구에게 파일을 보낼 수 있으므로 YouTube를 여는 데 드는 비용이 들지 않습니다."
                },
                {
                  "title": "즉각적인 시청, 폭넓은 유연성:",
                  "content": "YouTube 동영상을 필요한 곳 ​​어디에서나 변환하여 좋아하는 동영상을 더 폭넓게 감상할 수 있으며, MP3 형식을 지원하므로 어색한 대기 없이 바로 원활하게 감상할 수 있습니다."
                }
              ]
            },
            "part5": {
              ...
              "cards": [
                ...
                },
                {
                  ...
                  "content": "팝업, 배너 또는 방해 요소 없이 깔끔한 인터페이스를 즐겨보세요. 원활하고 중단 없는 전환이 가능합니다."
                },
                {
                  "title": "정품 품질 보장",
              ...
              "list": [
                {
                  ...
                  "answer": "기술적으로는 가능하지만, 저작권이 있는 콘텐츠를 허가 없이 변환하는 것은 YouTube 서비스 약관 및 저작권법을 위반할 수 있습니다. 콘텐츠를 변환하거나 개인적, 비상업적 목적으로만 사용할 권리가 있는지 항상 확인하세요."
                },
                {
                  "question": "이 변환 도구는 안전한가요?",
                  "answer": "네, 저희 변환기는 완벽하게 안전합니다. 고객님의 데이터나 파일을 저장하지 않으며, 악성코드나 바이러스 감염 위험도 없습니다. 변환은 직접 안전하게 진행됩니다."
                },
                {
                  "question": "YouTube에서 MP3로 변환하는 기능은 어떤 언어를 지원하나요?",
                  "answer": "저희 변환기는 YouTube에서 제공되는 모든 언어를 지원합니다. 오디오는 원본 영상에 표시된 그대로 추출되며, 원래 언어와 오디오 품질은 그대로 유지됩니다."
                },
                {
                  "question": "YouTube 동영상을 변환하는 데 걸리는 시간에 영향을 미치는 요소는 무엇입니까?",
                  "answer": "변환 시간은 동영상 길이, 인터넷 연결 속도, 현재 서버 부하 등 여러 요인에 따라 달라집니다. 10분 미만의 동영상은 대부분 30초 이내에 변환됩니다."
                },
                {
                  "question": "스마트폰을 이용해 MP3를 변환하고 다운로드하면 어디에 저장되나요?",
                  "answer": "대부분의 스마트폰에서 변환된 MP3 파일은 다운로드 폴더에 저장됩니다. iPhone에서는 파일 앱에 저장될 수 있습니다. Android에서는 파일 관리자나 음악 앱에서 다운로드 폴더를 확인하세요."
                },
                {
                  "question": "YouTube 동영상을 MP3로 변환하면 오디오 품질이 저하되나요?",
                  "answer": "MP3는 오디오 전용 형식이므로 비디오 구성 요소가 없습니다. 오디오 품질은 원본 비디오에서 사용 가능한 최대 비트레이트(일반적으로 원본 업로드 품질에 따라 128~320kbps)로 유지됩니다."
                }
              ]
            },
            "MoreFreeTools": {
              ...
              "YouTubeToMP_des": "YouTube 동영상을 오프라인에서 볼 수 있도록 MP4 형식으로 변환하세요. 고화질 동영상을 즉시 다운로드하세요.",
              "AITranscription": "AI 전사",
              "AITranscription_des": "96% 정확도로 오디오 및 비디오 파일을 텍스트로 변환하세요. 모든 콘텐츠에 대해 무제한 텍스트 변환이 가능합니다."
            },
            "videoDownload": {
              "title": "YouTube 링크를 MP3로 변환하세요. 무료이고 빠르며 광고가 없습니다.",
              "description": "저희 서비스를 선택해 주셔서 감사합니다! 진심으로 감사드리며, 더 나은 경험을 하셨기를 바랍니다. 저희 웹사이트를 친구들과 공유해 주시면 큰 도움이 될 것입니다.",
              "downloadButton": "다운로드",
              "TranscribeButton": "고쳐 쓰다",
              "downloadError": "변환 오류."
            }
  ...
  About: {
    ...
    Mission: {
      title: "왜",
      subtitle:
        "우리는 언어 장벽을 허물고 모든 사람이 콘텐츠에 접근할 수 있도록 하는 것을 믿습니다",
      features: [
        {
          icon: "🎯",
          title: "비교 불가능한 정확도",
    ...
    CTA: {
      ...
      subtitle:
        "필사 서비스로 NeverCap을 신뢰하는 수천 명의 전문가와 함께하세요",
  ...
  Privacy: {
    ...
    collectionPrinciple:
      "당사의 기본 원칙은 필요한 정보만 수집하는 것입니다. 실제 적용 사항은 다음과 같습니다:",
    ...
    securityDescription:
      "모든 데이터는 당사 서버에서 귀하의 브라우저로 전송될 때 SSL/TLS로 암호화됩니다.",
  ...
  TermsOfUse: {
    ...
    servicesDescription1:
      "저희 서비스는 음성 대화를 검색, 번역, 공유 가능한 텍스트로 변환합니다.",
    servicesOptions:
      '무료 버전("무료 서비스") 또는 유료 구독 버전("유료 서비스") 중 선택할 수 있습니다.',
    servicesAccess:
    ...
    lawfulUse:
      "서비스를 불법적, 비윤리적 또는 부도덕한 목적으로 사용해서는 안 됩니다.",
    ...
    defamation:
      "당사의 판단에 따라 당사 및/또는 사이트의 평판을 훼손하거나 손해를 입히는 행위",
    harassment:
      "사이트에서 얻은 정보를 사용하여 다른 사람을 괴롭히거나 학대하는 행위",
    supportAbuse:
      "지원 서비스를 부적절하게 사용하거나 오남용 또는 부적절한 행위에 대한 허위 보고를 제출하는 행위",
    legalCompliance:
      "적용 가능한 법률 또는 규정과 일치하지 않는 방식으로 사이트를 사용하는 행위",
    ...
    impersonation:
      "다른 사용자 또는 사람을 사칭하거나 다른 사용자의 사용자 이름을 사용하는 시도",
    spyware:
    ...
    disruption:
      "사이트 또는 사이트에 연결된 네트워크/서비스에 과도한 부담을 주거나 방해하는 행위",
    employeeHarassment:
      "사이트의 일부를 제공하는 당사 직원 또는 대리인을 괴롭히거나 협박하는 행위",
    accessCircumvention:
      "사이트 또는 사이트의 일부에 대한 접근을 방지/제한하기 위해 설계된 조치를 우회하려는 시도",
    codeCopying:
    ...
    advertising:
      "사이트를 사용하여 상품 또는 서비스를 광고하거나 판매 제안을 하는 행위",
    ...
    liabilityIntroduction:
      "당사는 본 약관 전반에 걸쳐 책임에 대해 언급하지만, 한 섹션에 모두 명시합니다:",
    liabilityWaiver:
    ...
    contactDescription:
      "서비스 약관에 관한 질문이 있으시면 {at} {email}로 문의해 주십시오.",
    companyDefinitionA:
      '이 문서에서 "회사", "우리", "저희" 또는 "당사"라는 표현은 {NeverCap}을 지칭합니다.'
  },
  Blog: {
    Hero: {
      title: "되다",
