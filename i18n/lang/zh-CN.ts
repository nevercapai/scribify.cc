let message = {
  ...
  Privacy: {
    ...
    "privacyPolicyTitle": "隐私政策",
    "policyDescription": '本政策描述NeverCap（以下简称"NeverCap"、"我们"）在您使用我们的服务、网站(https://www.nevercap.ai/)及软件（统称"服务"）时如何收集、使用和披露您的个人信息。',
    ...
    "childrenDescription": "本服务不面向儿童，我们不会故意收集13岁以下儿童的个人信息。13岁以下用户请勿通过服务提交任何个人信息。如发现儿童违反本政策提供信息，请按下方联系方式告知我们。",
    "updatesTitle": "8. 隐私政策更新",
    "updatesDescription": "我们可能根据法规要求或实践变化更新本政策。重大变更时会更新页首日期。",
    "contactTitle": "9. 联系我们",
    "contactDescription": "如对本隐私政策有任何疑问、意见或投诉，请联系我们，我们将尽快处理。",
  ...
  TermsOfUse: {
    ...
    "trademarkProtection": "服务的名称、外观和感觉均为公司版权©。保留所有权利。未经公司明确书面许可，您不得复制、拷贝或重复使用任何HTML、CSS、JavaScript或视觉设计元素的部分。您必须请求许可才能将公司徽标或任何服务徽标用于宣传目的。请通过电子邮件向我们发送使用徽标的请求。如果您违反这些服务条款，我们保留撤销此许可的权利。",
    ...
    "privacyPolicyTitle": "14. 隐私政策",
    "privacyPolicyDescription": "我们重视数据隐私和安全。请查阅我们的隐私政策。使用本网站即表示您同意受隐私政策约束，该政策已纳入本服务条款。请注意，本网站托管在美国。如果您从世界上任何其他地区访问本网站，且该地区关于个人数据收集、使用或披露的法律或其他要求与美国适用法律不同，则通过继续使用本网站，您将把数据传输至美国，并同意在美国处理和存储您的数据。",
    "liabilityTitle": "15. 责任",
    ...
    "contactDescription": "如果您对本服务条款有任何疑问，请联系我们。",
    "neverCap": "NeverCap",
    "site": "网站",
    "services": "服务"
  }
