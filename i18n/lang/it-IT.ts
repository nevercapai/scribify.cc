...
let message = {
  ...
  HomePage: {
    ...
    tour: {
      ...
      step1: {
        ...
        content: "Supporta tre metodi di trascrizione: file locali, link e registrazioni."
      },
      step2: {
        title: "Crea una cartella",
        content: 'Clicca su "+" per creare una cartella e organizzare i tuoi file.'
      },
      step3: {
        title: "Visualizza dettagli trascrizione e modifica",
        content: "Clicca sull'elemento per visualizzare i dettagli della trascrizione, modificarla e tradurla."
      },
      next: "Avanti",
      finish: "Fatto"
    },
    ...
    welcome: {
      ...
      precision: "Ottieni trascrizioni precise con parlanti e timestamp istantaneamente.",
      translate: "Abbatti le barriere linguistiche: traduci le trascrizioni in più di 200 lingue con facilità.",
  ...
  FolderPage: {
    ...
    endRecord: {
      title: "Avviso",
      content: "Stai registrando. Questa azione terminerà la registrazione. Vuoi terminare la registrazione?",
    ...
    record: {
      ...
      dialog: {
        ...
        complete: {
          ...
          label: "La registrazione ha raggiunto le 10 ore e si è automaticamente fermata. Per favore, trascrivi.",
          confirm: "Fatto"
        },
        speaker: {
          content: "Per l'identificazione del parlante, i file sono limitati a 3 ore. Deseleziona '{text}'."
        }
      }
    },
    upload: {
      ...
      del: {
        title: "Avviso",
        content: "Tutto il progresso verrà perso. Sei sicuro di voler annullare la trascrizione?",
      ...
      speakerLabel: "Rileva automaticamente chi sta parlando",
      guest: {
      ...
      howToSetup: "Come configurare?",
      shareFilePublicly: "Condividi un file pubblicamente",
      retry: "Riprova",
      edit: "Modifica",
      delete: "Elimina",
      updateAndRetry: "Aggiorna e Riprova"
    }
  },
  // 转录详情页
  TranscriptionPage: {
  ...
  IdentityInfoManage: {
    ...
    signupToSaveProgress: "Completa la registrazione per salvare i tuoi progressi.",
    tip: "Suggerimento",
    tipContentEmail: "Abbiamo appena inviato la password di accesso del tuo account alla tua email.",
    tipContentPassword: "Controlla la posta in arrivo e accedi con la tua email e password.",
    codeToEmail:
  ...
  AccountSettingsPage: {
    ...
    filesUploadedAtOnce: "Ogni file può durare fino a 10 ore / 5 GB. Carica 50 file contemporaneamente.",
    highestPriority: "massima priorità",
    weWillGiveTheHighest: "Trascriveremo sempre i tuoi file il prima possibile con la massima priorità.",
    ...
    automaticRenewal: "Rinnovo automatico fallito, si prega di verificare il metodo di pagamento.",
    eachYear: "Rinnovo automatico il {time} ogni anno.",
    returnAccountSetting: "Ritorna",
    needsToWaitLonger: "Attendi più a lungo prima che i tuoi file vengano trascritti.",
    freeThreeTimesDay: "Trascrivi 3 file gratuitamente ogni giorno.",
    oneFileUploaded: "Ogni file può durare fino a 30 minuti. Carica 1 file alla volta.",
  ...
  demo: {
    ...
    waitlist: {
      cardTitle: "Unisciti alla lista d'attesa, ottieni le ultime news di NuxtPro PRIMA e sconti!",
      placeholder: "Inserisci la tua email",
      button: "Unisciti alla lista d'attesa",
      joinCountMessage: "🔥 Utente iniziale #{count} si è appena unito alla lista d'attesa!"
    },
    seo: {
  ...
  videoLang: {
    ...
    HAVE_FUTURE_DATA: "Dati correnti e almeno un frame di dati sono disponibili",
    HAVE_ENOUGH_DATA: "I dati disponibili sono sufficienti per riprodurre",
    NETWORK_EMPTY: "Audio/video non inizializzato",
    NETWORK_IDLE: "Audio/video è attivo e selezionato per le risorse, ma non viene utilizzato alcun network",
  ...
  privacyPolicy: {
    ...
    sslTlsLink: "SSL/TLS",
    secureDataContent2: "quando vengono trasmessi dai nostri server al tuo browser.",
    deleteContentContent: "Se elimini un contenuto, questo diventerà immediatamente inaccessibile.",
    locationContent:
    ...
    contactUsContent1: "Se hai domande, commenti o reclami sulla nostra Informativa sulla privacy, ti preghiamo di",
    contactUs: "contattaci",
    contactUsContent2: "e faremo il possibile per gestire il tuo reclamo il prima possibile."
  },
  termsOfService: {
    ...
    accountTerms2: "- Non è consentito utilizzare i Servizi per scopi illegali, non etici o immorali.",
    accountTerms3:
    ...
    prohibitedActivitiesUserAgreement: "In qualità di utente del Sito, accetti di non:",
    prohibitedActivity1:
    ...
    prohibitedActivity4: "- Denigrare, rovinare o comunque danneggiare, a nostro avviso, noi e/o il Sito.",
    prohibitedActivity5:
    ...
    prohibitedActivity7: "- Utilizzare il Sito in modo non conforme alle leggi o ai regolamenti applicabili.",
    prohibitedActivity8: "- Eseguire operazioni di framing o linking non autorizzate sul Sito.",
    prohibitedActivity9:
    ...
    prohibitedActivity11: "- Eliminare l'avviso di copyright o di altri diritti proprietari da qualsiasi Contenuto.",
    ...
    prohibitedActivity23: "- Utilizzare il Sito per pubblicizzare o offrire in vendita beni e servizi.",
    prohibitedActivity24: "- Vendere o trasferire in altro modo il tuo profilo.",
    featuresContent1:
    ...
    privacyPolicyContent1: "Ci preoccupiamo della privacy e della sicurezza dei dati. Si prega di consultare la nostra",
    ...
    contactUsContent1: "Se hai una domanda su uno qualsiasi dei Termini di servizio, per favore",
    contactUsContent2: "."
  },
  HeadNavbar: {
    ...
    Other: "Altro",
    mp4Transcription: "Trascrizione MP4",
    youtubeTranscription: "Trascrizione YouTube"
  },
  Footer: {
    ...
    Resources: "Risorse",
    resourcesMenus: ["YouTube in MP4","YouTube in MP3","Trascrizione Video","Trascrizione MP4","Trascrizione YouTube"]
  },
  Index: {
    Hero: {
      ...
      subtitleA:
        "L'intelligenza artificiale di NeverCap trascrive i video e converte l'audio in testo, elaborando 50 file contemporaneamente senza limiti mensili. Una trascrizione che si adatta davvero alle tue esigenze."
    },
    Stats: {
    ...
    FeaturesGrid: {
      ...
      transparency:
        "Basta Limiti Nascosti, Basta Sorprese - Mentre altri riducono silenziosamente i tuoi minuti o nascondono limiti nel testo piccolo, noi crediamo nella trasparenza radicale",
      feat_unltd: "Davvero Illimitato",
      feat_unltd_desc:
        'Nessuna "politica di uso equo" sepolta nei termini. Nessun limite di archiviazione mascherato da "illimitato". Carica tutto il tuo archivio, trascrivi tutto per ogni tua esigenza. Lo diciamo sul serio.',
      feat_bulk: "Libertà di Caricamento Massivo",
      feat_bulk_desc:
        'Stanco di "3 importazioni a vita" o "10 file al mese"? Carica 50 file alla volta, tutte le volte che vuoi. Perfetto per elaborare arretrati.',
      feat_batch: "Elaborazione in Batch",
      feat_batch_desc:
        "Elabora un'intera stagione di podcast in una notte. Carica 50 interviste alla volta. Lascia che la nostra IA lavori mentre dormi. Svegliati con le trascrizioni pronte.",
      feat_accuracy: "96% di Precisione",
      feat_accuracy_desc:
        "La nostra IA all'avanguardia trascrive l'audio con punteggiatura intelligente, diarizzazione fino a 20 speaker e gestisce accenti e termini tecnici in modo impeccabile.",
      feat_langs: "100+ Lingue",
      feat_langs_desc:
        "Trascrivi video e audio in 100+ lingue, traducili in 249+. Nessun costo aggiuntivo per lingue diverse. Contenuti globali, un prezzo semplice.",
      feat_pro: "Funzionalità Professionali",
      feat_pro_desc:
        "Timestamp a livello di parola per un posizionamento preciso di audio/video, identificazione accurata degli speaker anche durante cambi rapidi di conversazione e testo perfettamente formattato con paragrafi, frasi e punteggiatura per una lettura facile.",
      features: "Funzionalità"
    },
    UseCases: {
      built_for: "Massivo",
      ...
      join_users:
        'Progettato per Utenti Esigenti Come Te - Unisciti a YouTuber, creator e podcaster che hanno abbandonato servizi con "shrinkflation"',
      podcasters: {
        title: "Podcaster",
    ...
    Testimonials: {
      ...
      titleA: "Amato da oltre 50.000 utenti di"
    },
    PricingPreview: {
      ...
      questions: [
        {
          ...
          answer:
            "La trascrizione AI è il processo di conversione automatica dell'audio in testo utilizzando l'intelligenza artificiale avanzata. Con NeverCap, carichi semplicemente i tuoi file e la nostra AI trascrive il contenuto con una precisione fino al 96%. Il nostro servizio è progettato per trascrivere file video (come MP4, MOV) e file audio (come MP3, WAV) in testo leggibile e modificabile, completo di etichette dei parlanti e timestamp."
        },
        {
          q: "unlimited_policy",
          question: "È davvero illimitato? Qual è il trucco?",
          answer:
            "Sì, è veramente illimitato! Nessun limite mensile di minuti, nessun costo aggiuntivo. Gli unici limiti sono tecnici: i singoli file possono essere lunghi fino a 10 ore o di dimensioni fino a 5GB, e puoi elaborare 50 file contemporaneamente. Ma puoi caricare quante batch vuoi, tutto il mese."
        },
        {
          q: "accuracy",
          question: "Quanto è accurata la trascrizione?",
          answer:
            "Garantiamo il 96% di precisione per audio chiaro. La nostra AI è addestrata su milioni di ore di contenuti diversi e gestisce perfettamente accenti, termini tecnici e più parlanti. Per audio difficili, le nostre funzioni di miglioramento intelligente aiutano a ottenere risultati migliori."
        },
        {
          q: "languages",
          question: "Quali lingue supportate?",
          answer:
            "Supportiamo la trascrizione in oltre 100 lingue tra cui inglese, spagnolo, mandarino, hindi, arabo, francese e altre. Inoltre, puoi tradurre le tue trascrizioni in 249 lingue diverse, perfetto per contenuti globali."
        },
        {
          q: "speed",
          question: "Quanto è veloce la trascrizione?",
          answer:
            "Rapidissima! Un file audio di 1 ora viene elaborato in meno di 5 minuti. Con l'elaborazione in batch, puoi caricare 50 file contemporaneamente e farli elaborare in parallelo. La maggior parte degli utenti si sveglia con l'intera libreria già trascritta."
        },
        {
          q: "cancellation",
          question: "Posso annullare in qualsiasi momento?",
          answer:
            "Assolutamente! Nessun contratto, nessuna penale di cancellazione. Puoi aggiornare, ridurre o cancellare l'abbonamento in qualsiasi momento dal tuo pannello. Se annulli, manterrai l'accesso fino alla fine del periodo di fatturazione."
        },
        {
          q: "security",
          question: "I miei dati sono sicuri?",
          answer:
            "La tua sicurezza è la nostra priorità. Siamo certificati SOC 2, utilizziamo crittografia a 256 bit per tutti i dati e non usiamo mai i tuoi contenuti per addestrare i nostri modelli. Puoi eliminare i tuoi file in qualsiasi momento e li eliminiamo automaticamente dopo 30 giorni. Conformità GDPR e CCPA."
        },
        {
          q: "export_formats",
          question: "Quali formati di esportazione sono disponibili?",
          answer:
            "Scarica le tue trascrizioni nel formato che preferisci: PDF, Word (DOCX), Excel, CSV, sottotitoli SRT, testo semplice (TXT) e didascalie VTT. Perfetto per qualsiasi flusso di lavoro."
        },
        {
          q: "file_formats",
          question: "Quali file audio e video posso caricare?",
          answer:
            "Supportiamo praticamente tutti i formati audio e video che potresti incontrare: MP3, MP4, M4A, MOV, AAC, WAV, OGG, OPUS, MPEG, WMA, WMV e altri. Se puoi riprodurlo, possiamo trascriverlo."
        }
      ]
    },
    CTASection: {
      ...
      disclaimer:
        "Nessuna carta di credito richiesta per il Piano Gratuito • Aggiorna in qualsiasi momento per accesso illimitato"
    }
  },
  Features: {
    UnlimitedTranscription: {
      ...
      feature1Description:
        "Smetti di contare i minuti. Smetti di controllare i limiti. Che tu trascriva 10 ore o 10.000 ore al mese, paghi la stessa tariffa fissa. Nessun costo aggiuntivo. Nessuna bolletta a sorpresa.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Otter ti offre 3 importazioni a vita nella versione gratuita, 10 al mese nella Pro. Noi ti diamo illimitate. Carica la tua backlog di podcast, tutte le interviste, anni di registrazioni. Nessuna restrizione.",
      feature2Point1Icon: "✓",
      ...
      heroSubtitle1: "Mentre Trint ti limita a 50 ore e Otter ti limita a 10 file al mese,",
      heroSubtitle2: "manteniamo ciò che promettiamo: trascrizione illimitata senza limiti nascosti."
    },
    BulkUpload: {
      heroBadgeIcon: "📁",
      ...
      heroSubtitle:
        "Otter ti offre 3 importazioni a vita. TRE. Per tutta la tua vita. Noi ti offriamo caricamenti illimitati, 50 file alla volta, quando vuoi.",
      primaryCta: "Inizia Caricamento Massivo →",
      secondaryCta: "Vedi i Limiti",
      redditQuote:
        '"Ho 3 anni di episodi podcast da trascrivere. Otter mi dice che ho 3 importazioni a vita. TRE. È offensivo."',
      redditAuthorIcon: "📍",
      ...
      feature2Description:
        "La nostra infrastruttura di elaborazione parallela significa che i tuoi 50 file non aspettano in coda. Vengono tutti trascritti simultaneamente. Ciò che richiedeva settimane ora richiede ore.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        'Mentre altri ti fanno aspettare in code virtuali o richiedono un upgrade per "elaborazione prioritaria", noi trattiamo ogni caricamento con urgenza. I tuoi contenuti sono importanti e non dovrebbero aspettare.',
      feature3Point1Icon: "✓",
      ...
      useCase1Description:
        "Carica 3 anni di episodi in una volta. Crea trascrizioni per il tuo intero catalogo. Genera contenuti SEO per ogni episodio.",
      useCase2Title: "Creazione corsi",
      useCase2Description:
        "Elabora tutti i tuoi video di lezione simultaneamente. Crea trascrizioni accessibili per gli studenti. Costruisci materiali didattici ricercabili.",
      useCase3Title: "Arretrato interviste",
      useCase3Description:
        "Svuota quella montagna di interviste non trascritte. Elabora settimane di ricerca in ore. Rispetta le scadenze senza panico.",
      useCase4Title: "Libreria YouTube",
      useCase4Description:
        "Genera sottotitoli per l'intero canale. Crea post per blog dal contenuto video. Migliora il SEO per tutti i video.",
      useCase5Title: "Archivi riunioni",
      useCase5Description:
        "Carica mesi di riunioni registrate. Crea note di riunioni ricercabili. Non perdere più decisioni importanti.",
      useCase6Title: "Dati di Ricerca",
      useCase6Description:
        "Elabora gruppi di discussione in blocco. Trascrivi tutte le interviste dei partecipanti. Analizza i dati qualitativi in modo efficiente.",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "Precisione leader del settore in 12 lingue principali. Timestamp a livello di parola per una perfetta sincronizzazione. Identificazione intelligente degli speaker che gestisce conversazioni veloci. Formattazione professionale davvero leggibile.",
      ...
      feature1Description:
        "Ogni parola è perfettamente sincronizzata con la posizione audio. Crea trascrizioni cliccabili, genera sottotitoli precisi o salta a momenti esatti nelle tue registrazioni. Precisione di 100ms di cui i professionisti si fidano.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "La nostra AI identifica con precisione i parlanti anche durante discorsi sovrapposti, interruzioni e conversazioni rapide. Perfetto per interviste, podcast e riunioni con frequenti interventi.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "Basta muri di testo. La nostra IA aggiunge automaticamente paragrafi, frasi e punteggiatura esattamente dove servono. Il risultato? Trascrizioni piacevoli da leggere e facili da scorrere.",
      feature3Point1Icon: "✓",
      ...
      formattingBeforeText:
        "quindi oggi parleremo delle nuove funzionalità a cui abbiamo lavorato penso vi piaceranno molto sono state richieste dagli utenti da tempo e finalmente le abbiamo completate",
      ...
      comparisonDes1: "Guarda come",
      comparisonDes2: "confrontarsi con la concorrenza"
    }
  },
  Pricing: {
    Hero: {
      ...
      highlighted_text: "Nessun limite nascosto",
      description:
        "Scegli il piano adatto alle tue esigenze. Aggiorna o riduci quando vuoi. Niente contratti, nessuna sorpresa."
    },
    Cards: {
      title: "Prezzi semplici e trasparenti.",
      highlighted_text: "Nessun limite nascosto.",
      ...
      plans: [
        {
          ...
          limits: {
            ...
            items: [
              ...
              "Anteprima gratuita di 30 minuti su tutte le trascrizioni",
          ...
          features: {
            title: "Funzionalità",
            items: ["100+ lingue", "Etichette parlanti", "Traduzione", "Tutti i formati di esportazione"]
          },
          cta: {
      ...
      disclaimer:
        '"Illimitato" significa nessun limite mensile e nessun rallentamento artificiale. Si applica il fair-use per automazione abusiva o ridistribuzione.'
    },
    ComparisonTable: {
      header: {
        title: "Confronta",
      ...
      plans: ["Funzionalità", "Free", "Pro Mensile", "Pro Annuale"],
      features: [
        {
          name: "Prezzo",
          values: [
        ...
        {
          name: "Limite giornaliero di file",
          values: ["3 file/giorno", "Illimitato", "Illimitato"]
        },
        {
          name: "Durata massima del file",
          values: ["10 ore", "10 ore", "10 ore"]
        },
        {
        ...
        {
          name: "Accesso alla trascrizione",
          values: ["Anteprima dei primi 30 minuti", "Trascrizione completa", "Trascrizione completa"]
        },
        {
      ...
      items: [
        {
          ...
          answer:
            "Sì! I piani Pro non hanno limiti mensili. Gli unici limiti sono tecnici: durata massima file 10 ore e dimensione 5GB. Puoi elaborare tutti i file che vuoi."
        },
        {
          q: "plan_change",
          question: "Posso cambiare piano quando voglio?",
          answer:
            "Assolutamente! Puoi cancellare l'abbonamento dal tuo dashboard. Aggiorna o riduci il piano quando vuoi."
        },
        {
          q: "payment_methods",
          question: "Quali metodi di pagamento accettate?",
          answer:
            "Accettiamo tutte le principali carte di credito, debito e PayPal per pagamenti sicuri e senza problemi."
        },
        {
          q: "free_trial",
          question: "C'è un periodo di prova per Pro?",
          answer:
            "Sì! Prova Pro gratis per 7 giorni, senza carta di credito. In più, ottieni il primo mese con il 45% di sconto."
        },
        {
          q: "file_retention",
          question: "Per quanto tempo conservate i miei file?",
          answer:
            "Piano gratuito: 30 giorni. Piani Pro: per sempre! Le trascrizioni sono sempre disponibili nel tuo account."
        },
        {
          q: "data_security",
          question: "E la sicurezza dei dati?",
          answer:
            "Siamo certificati SOC 2 e utilizziamo crittografia a 256 bit. Non usiamo mai i tuoi contenuti per addestrare i nostri modelli. I tuoi dati sono tuoi."
        }
      ]
    },
    CTA: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description:
          "Carica l'intero archivio del podcast in una volta. Genera note dello show, migliora il SEO e riutilizza i contenuti senza contare i minuti.",
        benefits: {
      ...
      journalists: {
        ...
        description:
          "Carica in batch tutte le interviste prima della scadenza. Cerca nei trascritti all'istante e non perdere mai una citazione cruciale.",
        benefits: {
      ...
      researchers: {
        ...
        description:
          "Elabora interi studi di ricerca in una volta. Gestisci focus group, interviste e panel discussion con perfetta identificazione del parlante.",
        benefits: {
      ...
      businessTeams: {
        ...
        description:
          "Registra riunioni direttamente o carica file audio per la trascrizione immediata. Crea archivi ricercabili da conversazioni illimitate e non perdere mai più discussioni importanti.",
        benefits: {
      ...
      educators: {
        ...
        description:
          "Basta incollare link YouTube per ottenere trascrizioni istantanee e sottotitoli generati automaticamente. Trasforma qualsiasi video educativo in contenuto accessibile e ricercabile.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter:
              'non trascritti. Otter voleva che ne scegliessi 3. TRE. NeverCap mi ha permesso di caricare tutti i 150 episodi in un weekend."',
            name: "Mike Rodriguez",
            role: "Host Podcast"
          },
          jessica: {
            ...
            highlight: "$100/mese",
            textAfter:
              'di Trint, ma non posso lavorare neanche con il limite di 10 file mensili di Otter. NeverCap ha salvato la mia carriera."',
            name: "Jessica Park",
            role: "Giornalista Freelance"
          },
          sarah: {
            ...
            highlight: "200 ore",
            textAfter:
              'di registrazioni di focus group. Abbiamo elaborato tutto in un weekend invece di razionare minuti mensili."',
            name: "Dr. Sarah Chen",
      ...
      heroSubtitleA:
        "Dai podcaster con anni di arretrati ai ricercatori con centinaia di interviste. Scopri come i professionisti usano {NeverCap} per liberarsi dai limiti di caricamento e dai limiti di minuti."
    },
    Podcasters: {
      ...
      heroSubtitle:
        "Carica il tuo intero catalogo. Crea show notes per ogni episodio. Basta scegliere quali episodi trascrivere.",
      ...
      problems: {
        ...
        problem2: {
          ...
          description:
            "Ogni episodio non trascritto è traffico SEO perso. Ma Descript ti limita a 30 ore/mese al massimo."
        },
        problem3: {
          title: "I Costi Esplodono con la Crescita",
          description:
            "Man mano che il tuo podcast cresce, i costi di trascrizione salgono alle stelle. $2/ora di eccedenza rendono impossibile scalare."
        }
      },
      solutionTitle: "La",
      ...
      features: {
        feature1: {
          ...
          description:
            "Identifica ed etichetta automaticamente fino a 20 speaker. Perfetto per panel discussion, interviste e show con co-host."
        },
        feature2: {
          title: "Capitoli con Timestamp",
          description:
            "Genera timestamp cliccabili per le descrizioni YouTube. Permetti agli ascoltatori di saltare ai loro segmenti preferiti."
        },
        feature3: {
          title: "Formattazione Intelligente",
          description:
            "Aggiunge automaticamente paragrafi, frasi e punteggiatura. Ottieni trascrizioni pulite e leggibili. Risparmia ore di post-produzione."
        },
        feature4: {
          title: "Ottimizzazione SEO",
          description:
            "Trascrizioni formattate per i motori di ricerca. Aumenta la visibilità del tuo podcast e raggiungi nuovo pubblico."
        },
        feature5: {
          title: "100+ Lingue",
          description:
            "Trascrivi in qualsiasi lingua. Traduci in 249+ lingue. Raggiungi un pubblico globale senza sforzo."
        },
        feature6: {
          title: "Elaborazione in Batch",
          description:
            "Carica 50 episodi prima di dormire. Svegliati con le trascrizioni complete. Elabora tutto il tuo archivio in una notte."
        }
      },
      ...
      solutionDescriptionA:
        "Con {NeverCap}, ottieni una trascrizione davvero illimitata. Carica l'intero archivio. Trascrivi ogni nuovo episodio. Genera note di presentazione su larga scala. Nessun limite, nessun limite, solo crescita."
    },
    Journalists: {
      hero: {
        ...
        subtitle:
          "Smetti di scegliere quali interviste meritano la trascrizione. Carica tutte le registrazioni insieme, cerca istantaneamente ovunque e rispetta le scadenze senza ansia da upload.",
      ...
      problem: {
        ...
        problems: {
          uploadLimits: {
            ...
            description:
              "Otter ti dà 10 importazioni file/mese su Pro. Come trascrivi 3 settimane di interviste investigative?"
          },
          missingQuotes: {
            title: "Citazioni Cruciali Mancanti",
            description:
              "Ogni intervista non trascritta potrebbe contenere la citazione chiave della storia. Ma Trint ti limita a 50 ore/mese al massimo."
          },
          costExplosion: {
            title: "I Costi Esplodono con le Scadenze",
            description:
              "Con l'approfondirsi delle indagini, i costi di trascrizione salgono alle stelle. Tariffe extra di $100/mese rendono impossibile seguire le ultime notizie."
          }
        },
        solution: {
          title: "The",
          ...
          descriptionA:
            "Con {NeverCap}, ottieni una trascrizione davvero illimitata. Carica l'intera inchiesta. Trascrivi ogni intervista. Cerca tutte le citazioni all'istante. Senza limiti, senza limiti, solo giornalismo."
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description:
              "A differenza di software con limiti di minuti, puoi trascrivere ogni intervista, da una chiacchierata veloce a una discussione di ore. Mai più crediti esauriti in scadenza.",
            points: {
          ...
          instantSearch: {
            ...
            description:
              "Ottieni la trascrizione in minuti, non giorni. Concludi le storie più velocemente che mai. La nostra IA elabora ore di audio mentre prendi un caffè.",
            points: {
          ...
          professionalAccuracy: {
            ...
            description:
              "La nostra IA fornisce trascrizioni estremamente accurate, garantendo citazioni precise e affidabili. Trascrizioni di livello professionale fidate dagli editori.",
            points: {
          ...
          ironclad: {
            ...
            description:
              "Offriamo solide funzioni di sicurezza per proteggere i tuoi dati sensibili e le fonti confidenziali. Crittografia di livello bancario per indagini sicure.",
            points: {
      ...
      testimonials: {
        jessica: {
          quote:
            "Avevo 3 anni di interviste non trascritte a causa dei limiti di upload. NeverCap mi ha permesso di elaborare tutto in un weekend. Un punto di svolta.",
          name: "Jessica Park",
      ...
      cta: {
        ...
        subtitle:
          "Unisciti a migliaia di giornalisti che hanno smesso di contare gli upload e hanno iniziato a concentrarsi sulle storie",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA:
          "Che tu debba trascrivere un video di YouTube, un video di TikTok per riutilizzarlo o capire come trascrivere un video di Facebook in testo, {NeverCap} gestisce tutto senza problemi. Genera sottotitoli in oltre 100 lingue senza limiti mensili: pura libertà creativa."
      },
      platforms: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "Il nostro strumento semplifica la trascrizione dei video. Per trascrivere un video di Instagram, basta incollare il link. Lo stesso vale per Vimeo. Elabora l'intero backlog del tuo canale in un weekend.",
          points: {
        ...
        globalReach: {
          ...
          description:
            "Raggiungi un pubblico globale con traduzione automatica in 100+ lingue. Genera sottotitoli in più lingue simultaneamente. Nessun costo aggiuntivo, nessun limite mensile.",
          points: {
        ...
        flexibleExport: {
          ...
          description:
            "Esporta nel formato adatto al tuo flusso di lavoro. Da file SRT per YouTube a VTT per web player, o documenti editabili per script. Tutte le esportazioni sono illimitate e incluse in ogni piano.",
          points: {
      ...
      testimonials: {
        ...
        carlos: {
          textBefore: "Creo contenuti educativi in spagnolo. NeverCap trascrive perfettamente e",
          textAfter:
            "per una portata più ampia. Nessun limite, solo crescita. Le visualizzazioni del mio canale sono triplicate dopo l'aggiunta di sottotitoli multilingue.",
        ...
        sarah: {
          ...
          textAfter:
            ". Avevo un backlog di 500+ video. NeverCap mi ha permesso di elaborare tutto in un weekend. Il boost SEO dai sottotitoli si è ripagato nel primo mese.",
          highlight: "30 ore",
          name: "Sarah Lee",
        ...
        jake: {
          textBefore: "La",
          textAfter:
            "funzionalità è rivoluzionaria. Non scarico più nulla. Basta incollare, trascrivere, fatto. Elaborare i miei clip podcast per TikTok non è mai stato così semplice.",
        ...
        yuki: {
          ...
          textAfter:
            ". NeverCap mi offre traduzioni illimitate. Il mio pubblico internazionale è cresciuto del 400% da quando uso sottotitoli nativi corretti.",
        ...
        questions: [
          {
            ...
            answer:
              "È semplice. Trova il video YouTube che vuoi trascrivere, copia il suo URL e incollalo nella nostra app. La nostra IA recupererà automaticamente il video e fornirà una trascrizione completa in pochi minuti."
          },
          {
            question: "D: Qual è il modo migliore per trascrivere un video Facebook in testo?",
            answer:
              "Il modo più semplice è usare un link diretto. Copia l'URL del video Facebook e la nostra piattaforma farà il resto, convertendo il parlato in testo con una precisione fino al 96%, risparmiandoti la trascrizione manuale."
          },
          {
            question: "D: Posso trascrivere video TikTok e Instagram?",
            answer:
              "Assolutamente. Supportiamo la trascrizione per video TikTok e Instagram. È perfetto per i creatori di contenuti che vogliono riutilizzare i loro video brevi in post per blog, articoli o aggiornamenti social basati su testo."
          },
          {
            question: "D: Come trascrivo un video Vimeo in testo?",
            answer:
              "Trascrivere video Vimeo è facile come su qualsiasi altra piattaforma. Basta copiare l'URL del video Vimeo e incollarlo in NeverCap. La nostra IA elaborerà il video e genererà una trascrizione accurata che puoi scaricare in più formati."
          }
        ]
      }
    },
    Researchers: {
      ...
      heroSubtitle:
        "Smetti di scegliere quali focus group trascrivere. Elabora tutti i tuoi dati qualitativi con una precisione del 96% e un'identificazione impeccabile dei parlanti, anche con 20 partecipanti che parlano contemporaneamente.",
      ...
      problemCard2Desc:
        "Ogni intervista non trascritta potrebbe contenere intuizioni rivoluzionarie. Ma Rev addebita almeno $2 al minuto.",
      problemCard3Title: "I Fondi per le Borse Scompaiono",
      problemCard3Desc:
        "Man mano che il tuo dataset cresce, i costi di trascrizione esplodono. $500 per gruppo di discussione rende impossibile scalare.",
      solutionTitle: "Soluzione NeverCap",
      feature1Label: "Senza Limiti",
      feature1Title: "Gestisci il tuo",
      feature1Desc:
        'Carica tutte le 200 ore di interviste stanotte. Svegliati con trascrizioni complete e ricercabili. Nessun limite mensile, nessun limite per file, niente "uso equo".',
      ...
      feature2Desc:
        "La nostra IA tiene traccia fino a 20 parlanti anche quando si sovrappongono, si interrompono o parlano tutti insieme. Ogni voce viene catturata ed etichettata correttamente.",
      ...
      feature3Desc:
        "Gestisce gergo tecnico, accenti marcati e terminologia specifica come un professionista. Abbastanza accurato per pubblicazioni, revisione tra pari e la tua commissione di tesi.",
      ...
      feature4Desc:
        "I tuoi dati di ricerca sensibili sono protetti con sicurezza di livello enterprise. Conforme GDPR, opzioni pronte per HIPAA e tracce di audit complete per i requisiti IRB.",
      ...
      useCase1Desc:
        "Gestisce 8-20 partecipanti con discorsi sovrapposti. Identificazione perfetta dei parlanti anche durante discussioni accese. Esporta direttamente nel software di analisi qualitativa.",
      useCase2Title: "Interviste Approfondite",
      useCase2Desc:
        "Elabora centinaia di interviste individuali simultaneamente. Mantieni coerenza in tutto il tuo dataset. Cerca in tutti i trascritti istantaneamente.",
      useCase3Title: "Ricerca Clinica",
      useCase3Desc:
        "Opzioni conformi all'HIPAA per interviste con pazienti. Trascrizione accurata della terminologia medica. Gestione sicura di dati sanitari sensibili.",
      useCase4Title: "Studi Etnografici",
      useCase4Desc:
        "Registrazioni sul campo in ambienti naturali. Gestione del rumore di fondo e di più parlanti. Supporto per 100+ lingue e dialetti.",
      useCase5Title: "Progetti di Storia Orale",
      useCase5Desc:
        "Conserva interi archivi senza limiti. Crea registri storici ricercabili. Perfetto per studi longitudinali e generazionali.",
      useCase6Title: "Ricerca per Tesi",
      useCase6Desc:
        "Prezzi accessibili per studenti con funzionalità complete. Elabora il tuo dataset in modo economico. Rispetta scadenze strette con l'elaborazione in batch.",
      testimonialTitle: "Fidato da",
      testimonialText:
        "Il nostro team di ricerca aveva 200 ore di registrazioni di focus group dal nostro studio sulla salute comunitaria. Altri servizi ci chiedevano di scegliere quali sessioni trascrivere a causa dei costi. NeverCap ci ha permesso di elaborare tutto in un weekend. L'identificazione di 20 parlanti ha funzionato davvero - anche durante le nostre discussioni più caotiche dove tutti parlavano insieme. Questo strumento ha completamente cambiato il modo in cui gestiamo i dati qualitativi.",
      ...
      testimonialText3:
        "di registrazioni di focus group dal nostro studio sulla salute comunitaria. Altri servizi ci chiedevano di selezionare quali sessioni trascrivere a causa dei costi. NeverCap ci ha permesso di elaborare",
      testimonialText4Hl: "tutto in un weekend",
      testimonialText5:
        ". L'identificazione dei 20 parlanti ha funzionato davvero—anche durante le nostre discussioni più caotiche con tutti che parlavano contemporaneamente. Questo strumento ha",
      testimonialText6Hl: "cambiato completamente",
      testimonialText7: "il modo in cui gestiamo i dati qualitativi.",
      solutionDescA:
        "Con {NeverCap}, ottieni una trascrizione davvero illimitata. Carica l'intero studio. Trascrivi ogni intervista. Analizza tutti i tuoi dati. Nessun limite, nessun limite, solo ricerca."
    },
    BusinessTeams: {
      ...
      feature1Desc:
        "Nessun download, nessun plugin. Inizia a registrare all'istante con un clic. Qualità audio perfetta, rilevamento automatico dei parlanti.",
      ...
      feature2Desc:
        "Hai registrazioni da Zoom, Teams o dal tuo telefono? Caricale all'istante. Supporto per tutti i principali formati audio e video. Elabora più file simultaneamente senza attese.",
      ...
      feature3Desc:
        "Condividi i trascritti con il tuo team all'istante. Ascolta le registrazioni insieme, esporta trascritti in più formati e assicurati che tutti siano allineati con archivi di riunioni ricercabili.",
      ...
      feature4Desc:
        "Cerca in tutte le riunioni contemporaneamente. Trova quella decisione cruciale dell'ultimo trimestre o quel requisito del cliente di mesi fa. La ricerca basata su AI comprende il contesto, non solo le parole chiave.",
      ...
      workflowStep1Desc:
        "Inizia a registrare live o scarica semplicemente la registrazione da Zoom, Google Meet o Microsoft Teams",
      workflowStep2Title: "Trascrizione automatica",
      workflowStep2Desc:
        "La nostra AI trascriverà automaticamente la registrazione in testo con il 96% di accuratezza in pochi minuti",
      ...
      heroSubtitleA:
        "Registra le riunioni direttamente nel tuo browser o carica file audio all'istante. Crea archivi ricercabili da un numero illimitato di conversazioni. Non perdere mai più discussioni importanti con la trascrizione davvero illimitata di {NeverCap}."
    },
    Educators: {
      ...
      heroSubtitle:
        "Basta incollare link YouTube per ottenere trascrizioni istantanee con sottotitoli generati automaticamente. Trasforma lezioni, tutorial e video educativi in contenuti ricercabili e accessibili da cui ogni studente può imparare.",
      heroCtaPrimary: "Provalo Gratis - Senza carta di credito",
      ...
      feature1Desc:
        "Basta incollare qualsiasi link video e ottenere trascrizioni istantanee. Funziona con YouTube, Vimeo, Facebook, X (Twitter), TikTok, Instagram, Dropbox, Google Drive e altro. Nessun download, nessuna attesa.",
      ...
      feature2Desc:
        "Crea istantaneamente sottotitoli accurati per tutti i tuoi video educativi. Rendi i contenuti accessibili per studenti con problemi uditivi, non madrelingua o chi preferisce leggere.",
      ...
      feature3Desc:
        "Crea cartelle per organizzare le trascrizioni per corso, materia o semestre. Mantieni tutti i tuoi contenuti educativi ordinati e facilmente ricercabili. Crea una libreria completa di materiali didattici accessibili.",
      ...
      feature4Desc:
        "Non limitarti a condividere registrazioni. Trascrivi automaticamente lezioni e altri file audio in guide di studio dettagliate, complete di riassunti e concetti chiave per una revisione efficace. Esporta in formati TXT, DOCX o PDF.",
      ...
      useCase1Text:
        "Trascrivi interi semestri di lezioni registrate. Gli studenti possono cercare argomenti specifici, rivedere concetti chiave e non perdere mai informazioni importanti.",
      useCase2Title: "Corsi Online",
      useCase2Text:
        "Rendi i tuoi corsi online accessibili agli studenti internazionali con traduzioni in 100+ lingue. Aumenta iscrizioni e soddisfazione.",
      useCase3Title: "Materiali di Studio",
      useCase3Text:
        "Usa l'IA per trascrivere file audio in guide di studio da video tutorial e lezioni. Perfetto per studenti che preferiscono leggere o devono rivedere rapidamente contenuti con testo ricercabile.",
      useCase4Title: "Conformità all'Accessibilità",
      useCase4Text:
        "Soddisfa i requisiti di accessibilità fornendo sottotitoli e trascrizioni per tutti i contenuti video. Garantisci pari accesso a tutti gli studenti.",
      useCase5Title: "Classe Capovolta",
      useCase5Text:
        "Condividi lezioni video con trascrizioni prima della lezione. Gli studenti possono rivedere al proprio ritmo e arrivare preparati alle discussioni.",
      useCase6Title: "Ricerca & Citazioni",
      useCase6Text:
        "Aiuta gli studenti a citare accuratamente le fonti video con timestamp. Perfetto per progetti di ricerca e articoli accademici.",
      testimonialTitle: "Fidato da",
  ...
  Resources: {
    YouTubeToMP4: {
        ...
        list: [
          {
            ...
            content:
              "Normalmente, guardare video su YouTube consuma molti dati mobili. Scaricandoli per la visualizzazione offline, puoi evitare questi costi inutili."
          },
          {
            title: "Guarda ovunque, in qualsiasi momento:",
            content:
              "Goditi i tuoi video senza interruzioni, anche con connessioni internet instabili. Niente più problemi di buffering."
          },
          {
            title: "Archiviazione e conservazione semplici:",
            content:
              "Salvare video come MP4 rende facile creare la tua collezione personale, soprattutto per contenuti che trovi davvero preziosi o importanti."
          },
          {
            title: "Condivisione più semplice:",
            content:
              "Condividere un file MP4 è molto più conveniente che inviare un link. Puoi inviare il file video direttamente tramite app come WhatsApp o Instagram, evitando il passaggio aggiuntivo di aprire YouTube."
          },
          {
            title: "Visualizzazione istantanea, momenti condivisi:",
            content:
              "Vuoi mostrare entusiasta un video preferito ad amici o familiari vicini? Con l'MP4 scaricato, potete guardarlo tutti insieme senza pause imbarazzanti in attesa del caricamento."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Goditi un'interfaccia pulita senza pop-up, banner o interruzioni—solo conversione video senza intoppi."
          },
          {
            icon: "5",
            color: "#DEE5FF",
            ...
            content:
              "I tuoi download mantengono la risoluzione completa del video sorgente per una riproduzione perfetta ogni volta."
          },
          {
            icon: "6",
            color: "#DEF6EE",
      ...
      part7: {
        ...
        list: [
          ...
          },
          {
            ...
            answer:
              "Sì, è sicuro e affidabile. Non richiediamo alcuna informazione personale dagli utenti e adottiamo misure forti contro i virus. Ti ricordiamo di prestare sempre attenzione quando scarichi file da internet: evita di cliccare su link sospetti o scaricare file dubbi."
          },
          {
          ...
          },
          {
            ...
            answer:
              "Sebbene garantiamo l'esperienza di download più veloce possibile, il tempo di download è influenzato anche da fattori come la lunghezza del video e la velocità della tua connessione internet."
          },
          {
          ...
          },
          {
            ...
            answer:
              "No. Scaricare video YouTube come MP4 con il nostro strumento mantiene la qualità originale del video. Il processo di conversione preserva la qualità sorgente, garantendoti la stessa esperienza di visualizzazione che hai su YouTube."
          }
        ]
      },
      ...
      videoDownload: {
        ...
        description:
          "Grazie per aver scelto il nostro servizio! Apprezziamo la tua fiducia e speriamo che abbia migliorato la tua esperienza. Condividere il nostro sito con gli amici sarebbe di grande aiuto.",
      ...
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Converti i video di YouTube in formato MP3 per la visualizzazione offline. Scarica video di alta qualità all'istante.",
        AITranscription: "Trascrizione AI",
        AITranscription_des:
          "Trascrivi file audio e video con una precisione del 96%. Trascrizione illimitata per tutti i tuoi contenuti."
      }
    },
    YouTubeToMP3: {
        ...
        steps: [
          {
            title: "Copia l'URL",
            content:
              "Apri il video YouTube di destinazione, quindi copia il collegamento dalla barra degli indirizzi del browser."
          },
          {
      ...
      part4: {
        content: ["Ecco i 5 principali vantaggi della conversione", "Video di YouTube in file MP3"],
        list: [
          {
            title: "Risparmia sullo spazio di archiviazione:",
            content:
              "I file MP3 sono più piccoli, riducendo lo spazio di archiviazione su YouTube. Risparmia sui dati mobili scaricando la versione offline e utilizzala quando hai una connessione internet."
          },
          {
            title: "Risparmia la batteria:",
            content:
              "Per guardare i video di YouTube, c'è un servizio di buffering che utilizza connessioni facilmente ascoltabili. Niente più preoccupazioni di buffering."
          },
          {
            title: "Archiviazione e conservazione facili:",
            content:
              "Alcuni video o MP3 semplificano la creazione della propria libreria personale, che si tratti di contenuti didattici, archivi musicali o contenuti importanti."
          },
          {
            title: "Condivisione più semplice:",
            content:
              "Condividere un file MP3 è molto più comodo rispetto ai link di YouTube. Puoi inviare file agli amici tramite app come WhatsApp o Instagram, eliminando il costo di iscrizione per l'apertura di YouTube."
          },
          {
            title: "Visualizzazione immediata, ampia flessibilità:",
            content:
              "Accedi a un video preferito più ampio convertendo i video di YouTube ovunque ti servano e i formati MP3 consentono di unirli subito e senza problemi, senza fastidiose pause in attesa di questo caricamento."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            title: "Zero pubblicità, zero distrazioni",
            content:
              "Goditi un'interfaccia pulita, senza pop-up, banner o interruzioni: solo una conversione fluida e senza interruzioni."
          },
          {
            title: "Qualità originale garantita",
            content:
              "I tuoi download mantengono la piena risoluzione del video sorgente, per una riproduzione perfetta ogni volta."
          },
          {
            title: "Funziona ovunque",
            content: "Completamente compatibile con qualsiasi browser, su qualsiasi dispositivo."
      ...
      part6: {
        title: ["Massimizza le tue conversioni da YouTube a MP3", "Con il nostro convertitore"],
        ...
        list: [
          {
            ...
            answer:
              "Sebbene tecnicamente possibile, convertire contenuti protetti da copyright senza autorizzazione potrebbe violare i termini di servizio di YouTube e le leggi sul copyright. Assicurati sempre di avere il diritto di convertire i contenuti o di utilizzarli esclusivamente per scopi personali e non commerciali."
          },
          {
            question: "Questo strumento di conversione è sicuro?",
            answer:
              "Sì, il nostro convertitore è completamente sicuro e protetto. Non memorizziamo alcun dato o file e non vi è alcun rischio di malware o virus. La conversione avviene in modo diretto e sicuro."
          },
          {
            question: "Quali lingue supporta la conversione da YouTube a MP3?",
            answer:
              "Il nostro convertitore supporta tutte le lingue disponibili su YouTube. L'audio verrà estratto esattamente come appare nel video originale, preservando la lingua e la qualità audio originali."
          },
          {
            question: "Quali fattori influiscono sul tempo necessario per convertire un video di YouTube?",
            answer:
              "Il tempo di conversione dipende da diversi fattori: la durata del video, la velocità della connessione Internet e il carico attuale del server. La maggior parte dei video di durata inferiore a 10 minuti viene convertita in meno di 30 secondi."
          },
          {
            question: "Quando converto e scarico un MP3 tramite il mio smartphone, dove viene salvato?",
            answer:
              "Sulla maggior parte degli smartphone, i file MP3 convertiti vengono salvati nella cartella Download. Su iPhone, potrebbero essere salvati nell'app File. Su Android, controlla la cartella Download nel file manager o nell'app musicale."
          },
          {
            question: "Convertire un video di YouTube in MP3 riduce la qualità audio?",
            answer:
              "L'MP3 è un formato solo audio, quindi non contiene componenti video. La qualità audio viene preservata al bitrate più alto disponibile dal video sorgente, in genere 128-320 kbps, a seconda della qualità di caricamento originale."
          }
        ]
      },
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Converti i video di YouTube in formato MP4 per la visualizzazione offline. Scarica video di alta qualità all'istante.",
        AITranscription: "Trascrizione AI",
        AITranscription_des:
          "Trascrivi file audio e video con una precisione del 96%. Trascrizione illimitata per tutti i tuoi contenuti."
      },
      videoDownload: {
        ...
        description:
          "Grazie per aver scelto il nostro servizio! Apprezziamo davvero la tua fiducia e speriamo che abbia migliorato la tua esperienza. Se potessi condividere il nostro sito web con i tuoi amici, ci faresti un immenso piacere.",
    ...
    Transcription: {
      ...
      mp4Transcription: {
        hero: {
          title: "Convertitore da MP4 a Testo Online",
          des_1: "Converti i tuoi file MP4 in testo in pochi secondi.",
          des_2: "Nessuna registrazione richiesta. Veloce come un lampo. Precisione di prima classe.",
          feature_1: "Supporta 12 Formati",
          feature_2: "Supporta 100+ Lingue",
          feature_3: "Esporta in 6 Formati"
        },
        threeStep: {
          title: "Trascrivi il tuo MP4 in",
          titleHighlight: "testo in 3 semplici passaggi",
          step_1_title: "Carica il tuo file MP4",
          step_1_des: "Semplicemente trascinalo e rilascialo nell'area designata, o clicca sul pulsante \"Carica File\".",
          step_2_title: "Inizia la Trascrizione",
          step_2_des: "Clicca sul pulsante \"Trascrivi\". Il sistema convertirà automaticamente il tuo MP4 in testo in pochi istanti.",
          step_3_title: "Scarica la Trascrizione",
          step_3_des: "Il tuo testo è pronto per la modifica online e può essere esportato nei formati TXT, PDF, DOCX, SRT, CSV, VTT, o condiviso tramite un link."
        },
        howToGet: {
          title: "Come Ottenere i Migliori Risultati dalla",
          titleHighlight: "Tua Trascrizione?",
          fun_1: "Usa il file video originale per la trascrizione, invece di una versione compressa.",
          fun_2: "Riduci il rumore di fondo, la musica di fondo, statica o eco il più possibile.",
          fun_3: "Se scarichi un video, seleziona sempre l'opzione \"Alta Qualità Audio (HQ)\".",
          fun_4: "Abilita la funzione \"Identificazione Parlante\" quando c'è più di un parlante.",
          fun_5: "Seleziona la lingua e l'accento specifici del tuo file MP4, es. Inglese → Inglese (US) / Inglese (UK) / Inglese (India).",
          fun_6: "Rivedi rapidamente la trascrizione una volta completato il processo."
        },
        exportFormats: {
          title: "Formati di Esportazione e",
          titleHighlight: "Loro Utilizzi",
          format_1: "In formato TXT",
          des_1: "Per Notepad, Notepad++ e editor di testo leggeri",
          format_2: "In formato PDF",
          des_2: "Per stampare, condividere, archiviare e visualizzazione multipiattaforma",
          format_3: "In formato DOCX",
          des_3: "Per Microsoft Word, Google Docs e modifica di testo formattato",
          format_4: "In formato SRT",
          des_4: "Per sottotitoli YouTube, caricamento sottotitoli video e lettori multimediali",
          format_5: "In formato CSV",
          des_5: "Per Excel, Google Sheets e strumenti di analisi dati",
          format_6: "In formato VTT",
          des_6: "Per sottotitoli video web, lettori HTML5 e strumenti di accessibilità"
        },
        howToUse: {
          title: "Qual è il valore di convertire MP4 in testo,",
          titleHighlight: "e come puoi trarne il massimo vantaggio?",
          effect_1: "Leggi i punti chiave all'istante.",
          des_1: "Sfoglia le trascrizioni più velocemente che riguardare i video e localizza rapidamente le informazioni essenziali.",
          effect_2: "Organizza studi e ricerche.",
          des_2: "Trasforma lezioni, interviste e clip di ricerca in note pulite che puoi evidenziare, citare e riutilizzare.",
          effect_3: "Aumenta la produttività lavorativa.",
          des_3: "Crea riassunti di riunioni, traccia elementi di azione e archivia contenuti in documentazione o basi di conoscenza.",
          effect_4: "Supporta la creazione di contenuti.",
          des_4: "Estrai script, schemi, bozze di articoli ed esporta sottotitoli per modifica o localizzazione.",
          effect_5: "Rendi i contenuti ricercabili e traducibili.",
          des_5: "Ricerca di testo completo e traduci trascrizioni per uso multilingue.",
          effect_6: "Semplifica l'archiviazione.",
          des_6: "Il testo è più facile da archiviare, strutturare e riutilizzare, ideale per registri, documentazione e basi di conoscenza IA."
        },
        whyChoose: {
          title: "Perché",
          titleHighlight: "La Nostra Trascrizione da MP4 a Testo si Distingue",
          reason_1_title: "Precisione Leader nel Settore",
          reason_1_des: "Verificata indipendentemente come uno degli strumenti di trascrizione più precisi disponibili.",
          reason_2_title: "Velocità di Elaborazione Veloce",
          reason_2_des: "Ottieni la tua trascrizione approssimativamente in un ventesimo della durata del video originale.",
          reason_3_title: "Identificazione Parlante",
          reason_3_des: "Distingue chiaramente tra i parlanti, rendendo le trascrizioni più facili da leggere e seguire.",
          reason_4_title: "Ampia Copertura Linguistica",
          reason_4_des: "Supporta la trascrizione in 100+ lingue e la traduzione in 249 lingue.",
          reason_5_title: "Semplice e Facile da Usare",
          reason_5_des: "Nessuna interfaccia o passaggio complesso. Completa il tuo compito con pochi clic.",
          reason_6_title: "Sicurezza Completa dei Dati",
          reason_6_des: "Diamo priorità alla sicurezza e privacy dei tuoi dati come uno dei nostri impegni fondamentali."
        },
        faq: {
          title: "Domande su",
          titleHighlight: "Convertire MP4 in Testo",
          question_1: "Quanto tempo richiede trascrivere un file MP4 in testo?",
          answer_1: "Basato su test, in condizioni normali, il processo di trascrizione richiede circa 1/20 a 1/10 della durata del video. Ad esempio, un video di 1 ora richiederà circa 3-6 minuti per essere trascritto.",
          question_2: "Ci sono limiti sulla dimensione del file MP4 che carico?",
          answer_2: "Sì. La dimensione massima del file è 5GB e la durata del video non deve superare le 10 ore. Nota che i file più grandi potrebbero richiedere più tempo per essere elaborati.",
          question_3: "Quanto è accurata la trascrizione?",
          answer_3: "È importante capire che la qualità della trascrizione dipende in gran parte dalla qualità audio del tuo video. Detto questo, utilizziamo tecnologia di riconoscimento vocale leader nel settore per assicurare i migliori risultati possibili per la tua trascrizione MP4.",
          question_4: "Posso trascrivere MP4 in un documento Word?",
          answer_4: "Assolutamente. Carica semplicemente il tuo file MP4, clicca \"Trascrivi\", e una volta completato il processo, seleziona \"Esporta\" e scegli il formato DOCX. Riceverai una trascrizione completa in un documento Word.",
          question_5: "Come posso ottenere i sottotitoli per il mio video?",
          answer_5: "Carica il tuo video e trascrivilo. Dopo la trascrizione, clicca \"Esporta\" e seleziona il formato SRT o VTT per scaricare i tuoi sottotitoli.",
          question_6: "È sicuro usare questo strumento di trascrizione MP4?",
          answer_6: "Sì. La nostra pagina è senza pubblicità, non richiede registrazione per l'elaborazione e non chiede informazioni personali. Utilizziamo anche forti misure tecniche per prevenire virus. Incoraggiamo tutti gli utenti a rispettare le linee guida sul copyright e la privacy quando scaricano, usano o condividono file MP4."
        },
        explore: {
          title: "Convertitore da Qualsiasi Cosa a Testo",
          des: "La trascrizione semplifica il tuo flusso di lavoro e ti permette di concentrarti sul lavoro che genera un impatto reale.",
          tool_1: "Video a testo",
          tool_2: "MOV a testo",
          tool_3: "TikTok a testo",
          tool_4: "YouTube a testo",
          tool_5: "MP4 a SRT",
          tool_11: "Audio a testo",
          tool_12: "Voce a testo",
          tool_13: "MP3 a testo",
          tool_14: "M4A a testo",
          tool_15: "MP3 a SRT"
        }
      ...
      youtubeTranscription: {
        hero: {
          title: "YouTube a Trascrizione Online",
          des_1: "I video di YouTube vengono convertiti istantaneamente in trascrizioni — veloci, accurate e senza registrazione richiesta.",
          des_2: "Supporta 6 formati di esportazione, oltre 100 lingue e 249 traduzioni."
        },
        threeStep: {
          title: "Come ottenere",
          titleHighlight: "Risultati precisi",
          step_1_des: "Copia il link del video di YouTube.",
          step_2_des: "Incolla il link nella casella di input e fai clic su \"Ottieni Trascrizione Video\".",
          step_3_des: "Attendi il completamento della trascrizione, poi accedi al testo per modificarlo, tradurlo o esportarlo."
        },
        whatYouCan: {
          title: "Cosa puoi fare con",
          titleHighlight: "il nostro strumento di trascrizione YouTube",
          list_title_1: "Contenuto testuale flessibile",
          list_des_1: "Converte qualsiasi video di YouTube ti piaccia in trascrizioni di testo leggibili, copiabili e ricercabili.",
          list_title_2: "Ricerca e modifica rapide",
          list_des_2: "Individua facilmente contenuti chiave, citazioni memorabili o segmenti importanti nel video e modifica il testo mentre ti riferisci ad esso.",
          list_title_3: "Formati di esportazione multipli",
          list_des_3: "Esporta trascrizioni in vari formati come TXT, PDF, DOCX, SRT, CSV e VTT, adatti per sottotitoli, modifica di documenti, analisi dei dati e altro."
        },
        whyConvertYouTube: {
          title: "Perché",
          titleHighlight: "convertire i video di YouTube in testo",
          list_title_1: "Documentazione, salvataggio e organizzazione facili",
          list_des_1: "Il testo è più pratico del video per prendere appunti, organizzare interviste, estrarre punti chiave e creare riassunti di ricerca.",
          list_title_2: "Localizzare e reperire informazioni importanti",
          list_des_2: "Trova rapidamente contenuti chiave senza dover scorrere la timeline del video.",
          list_title_3: "Migliorare l'efficienza di apprendimento",
          list_des_3: "Usa il testo per evidenziare, riferire e confrontare i contenuti in modo efficace.",
          list_title_4: "Cercare ed estrarre contenuti",
          list_des_4: "Il testo è ricercabile e copiabile, ideale per estrarre citazioni, fare riferimento a clip o creare sceneggiature.",
          list_title_5: "Accessibilità multilingua",
          list_des_5: "Trascrivi facilmente contenuti in lingue sconosciute e traduci in molte lingue.",
          list_title_6: "Riutilizzo dei contenuti",
          list_des_6: "Genera articoli, sottotitoli, card per i social media, sceneggiature video e altro dalla tua trascrizione."
        },
        whyPeopleTrust: {
          title: "Perché",
          titleHighlight: "le persone si fidano del nostro strumento",
          list_title_1: "Strumento online gratuito",
          list_des_1: "Non è richiesto login. Nessun software, plugin o estensioni da installare.",
          list_title_2: "Zero pubblicità, zero distrazioni",
          list_des_2: "Un'interfaccia pulita e semplice progettata per soddisfare le tue esigenze senza interrompere il tuo flusso di lavoro.",
          list_title_3: "Conversione fulminea",
          list_des_3: "Sperimenta la velocità leader nel settore senza limitazioni.",
          list_title_4: "Alta precisione",
          list_des_4: "Alimentato dalla più recente tecnologia di riconoscimento vocale per una precisione migliorata.",
          list_title_5: "Ampio supporto linguistico",
          list_des_5: "Trascrivi contenuti in oltre 100 lingue e traduci in 249 lingue.",
          list_title_6: "Funzioni di salvataggio e modifica",
          list_des_6: "Modifica le trascrizioni in tempo reale e salva il tuo lavoro per uso futuro."
        },
        howToUse: {
          title: "Modi reali in cui le persone usano",
          titleHighlight: "le trascrizioni YouTube",
          list_title_1: "Per chi prende appunti",
          list_des_1: "Prendere appunti durante la visione di un video di YouTube può sembrare affrettato e disorganizzato. Con una trascrizione, puoi copiare facilmente punti chiave e concetti importanti direttamente nelle tue note, garantendo di catturare tutto. Puoi anche inserire la trascrizione in strumenti come ChatGPT per generare sintesi chiare, note di studio o schemi.",
          list_title_2: "Per i creatori di contenuti",
          list_des_2: "Basta incollare un link di YouTube e ottenere una versione testuale accurata —un flusso di lavoro molto più efficiente per i creatori. Usa la trascrizione per elaborare post di blog, sceneggiature, sottotitoli, newsletter o note dettagliate dello show. Fa risparmiare tempo e fatica, permettendoti di concentrarti sul contenuto stesso.",
          list_title_3: "Per professionisti e analisti",
          list_des_3: "Se il tuo lavoro in ambiti come legge, medicina, consulenza o business richiede un'estrazione di informazioni precisa, le trascrizioni rendono il lavoro più facile. Cerca rapidamente fatti specifici, timestamp e citazioni senza dover riguardare l'intero video. Ideale per rivedere discorsi di esperti, presentazioni, video di formazione e interviste con clienti.",
          list_title_4: "Per utenti con esigenze di accessibilità",
          list_des_4: "Non tutti possono guardare o ascoltare facilmente contenuti video. Le trascrizioni rendono YouTube accessibile a utenti con problemi uditivi o che semplicemente preferiscono leggere. Con supporto per tradurre in 249 lingue, abbattono le barriere linguistiche, rendendo i contenuti globali più facili da capire e condividere.",
          list_title_5: "Per gli estrattori di conoscenza",
          list_des_5: "Per studenti, ricercatori, creatori e professionisti che devono cogliere rapidamente idee chiave, le trascrizioni sono preziose. Sfoglia, cerca e individua istantaneamente informazioni cruciali senza dover seduti attraverso video lunghi, aiutandoti a estrarre efficientemente punti chiave, sintesi o timestamp."
        },
        howToGet: {
          title: "Sblocca nuove idee con",
          titleHighlight: "le trascrizioni YouTube",
          subTitle: "Trasforma i video di YouTube in testo facile da copiare e agibile e combinalo con strumenti AI come Gemini o ChatGPT per:",
          list_des_1: "Generare rapidamente note di studio o sintesi",
          list_des_2: "Estrarre punti chiave e citazioni o concetti memorabili",
          list_des_3: "Creare quiz, domande e risposte o materiali di studio",
          list_des_4: "Redigere post di blog, sceneggiature o articoli",
          list_des_5: "Sviluppare infografiche, meme o contenuti per i social media",
          list_des_6: "Produrre domande e risposte dei fan, curiosità o giochi educativi",
          list_des_7: "Approfondire i temi menzionati nel video",
          summary: "Tutto senza hassle: copia, incolla e inizia."
        },
        faq: {
          title: "Domande",
          titleHighlight: "Frequenti",
          question_1: "C'è un limite di lunghezza per la trascrizione dei video di YouTube?",
          answer_1: "No. Tuttavia, i video più lunghi richiedono più tempo di elaborazione. Si prega di pianificare le attività di trascrizione di conseguenza.",
          question_2: "Funziona con video privati o non elencati?",
          answer_2: "Funziona solo con video di YouTube pubblicamente disponibili. I video privati o limitati non possono essere trascritti.",
          question_3: "Quanto tempo ci vuole per ottenere la trascrizione?",
          answer_3: "In genere, il tempo di elaborazione varia da 1/10 a 1/20 della durata del video. Ottimizziamo costantemente la velocità garantendo allo stesso tempo un'elevata precisione per una migliore esperienza utente.",
          question_4: "Lo strumento può distinguere tra diversi parlanti?",
          answer_4: "Sì. Supporta il rilevamento dei parlanti fino a 20, ideale per trascrivere interviste, podcast e discussioni.",
          question_5: "Quanto è preciso lo strumento di trascrizione?",
          answer_5: "La nostra precisione supera il 96%. Mantiene un'elevata precisione anche con vari accenti o parlanti veloci, sebbene una migliore qualità audio con meno rumore di fondo migliori i risultati.",
          question_6: "Quali caratteristiche sono incluse nella trascrizione?",
          answer_6: "La trascrizione include l'identificazione automatica dei parlanti e i timestamp. Puoi modificare il testo online o esportarlo per un uso futuro.",
          question_7: "Posso salvare i miei registri di trascrizione?",
          answer_7: "Sì. Basta registrare un account per salvare le trascrizioni dopo aver elaborato un link di YouTube.",
          question_8: "I miei dati sono mantenuti privati e sicuri?",
          answer_8: "Sì. I tuoi video, trascrizioni e file vengono gestiti in modo sicuro — non vengono mai usati per addestrare modelli di IA o condivisi con terzi.",
          question_9: "Posso usare il contenuto della trascrizione con altri strumenti di IA?",
          answer_9: "Assolutamente. Puoi incollare il testo in ChatGPT o altri strumenti di IA per generare sintesi, note, quiz, sceneggiature, articoli e altro."
        }
      }
    },
    Upload: {
      ...
      linkV1Placeholder: "Incolla l'URL di YouTube qui.",
      linkV1Btn: "Ottieni Trascrizione Video"
    }
  },
  About: {
    Hero: {
      ...
      title: "Informazioni",
      description:
        "La nostra missione è fornire servizi di trascrizione audio e video più accurati. Grazie alla nostra tecnologia AI all'avanguardia, raggiungiamo tassi di accuratezza superiori al 96%. Per alcune lingue principali, attraverso l'ottimizzazione tecnica, possiamo arrivare fino al 99% di accuratezza."
    },
    Stats: {
      title: "Il Nostro",
      ...
      features: [
        {
          ...
          description:
            "I nostri modelli AI sono continuamente perfezionati per offrire tassi di accuratezza superiori al 96%, con alcune lingue principali che raggiungono fino al 99% grazie all'ottimizzazione avanzata."
        },
        {
          icon: "🌍",
          title: "Supporto Globale per le Lingue",
          description:
            "Supporto per oltre 100 lingue nel riconoscimento vocale e capacità di traduzione per più di 249 lingue, rendendo i tuoi contenuti veramente globali."
        },
        {
          icon: "⚡",
          title: "Elaborazione Lampo",
          description:
            "Elabora ore di contenuti audio e video in minuti, non ore. La nostra pipeline AI ottimizzata garantisce trascrizioni veloci senza compromettere la qualità."
        },
        {
          icon: "🔒",
          title: "Sicurezza di Livello Enterprise",
          description:
            "La sicurezza dei tuoi dati è la nostra priorità. Utilizziamo crittografia standard del settore e rispettiamo le normative globali sulla privacy per mantenere i tuoi contenuti al sicuro e riservati."
        }
      ]
    },
    Company: {
  ...
  Privacy: {
    ...
    policyAgreement:
      "Leggi attentamente questa Informativa sulla Privacy e assicurati di comprenderla. Utilizzando i nostri Servizi, accetti questa Informativa. Se non accetti l'uso dei tuoi dati personali conforme a questa Normativa, interrompi immediatamente l'uso dei nostri Servizi.",
    policyOverview:
      "In questa normativa spieghiamo: quali dati raccogliamo e perché; come gestiamo i tuoi dati; e i tuoi diritti sui tuoi dati. Non vendiamo i tuoi dati.",
    ...
    collectionPrinciple:
      "Il nostro principio guida è raccogliere solo ciò che ci serve. Ecco cosa significa in pratica:",
    identityTitle: "2.1 Identità e accesso",
    identityDescription:
      "Quando ti registri a un nostro prodotto, chiediamo informazioni identificative come nome e indirizzo email per fornire funzionalità essenziali e inviarti aggiornamenti e informazioni importanti.",
    billingTitle: "2.2 Informazioni di pagamento",
    billingDescription:
      "Se ti registri a un prodotto a pagamento, ti chiederemo i dati di pagamento e l'indirizzo di fatturazione. I dati di pagamento vengono inviati direttamente al nostro processore e non transitano sui nostri server.",
    productInteractionsTitle: "2.3 Interazioni con il prodotto",
    productInteractionsDescription:
      "Conserviamo sui nostri server i contenuti che carichi, ricevi o mantieni nei tuoi account. A meno che non li elimini, li conserveremo finché il tuo account è attivo.",
    websiteInteractionsTitle: "2.4 Interazioni con il sito web",
    ...
    cookiesTitle: "2.5 Cookie",
    cookiesDescription1:
      "Utilizziamo cookie persistenti di prima parte e alcuni di terze parti per memorizzare preferenze, semplificare l'uso delle nostre app, effettuare test A/B e supportare analisi.",
    cookiesDescription2:
      "Un cookie è un testo memorizzato dal browser. Può ricordare credenziali e preferenze, oltre a raccogliere dati come tipo di browser, sistema operativo, pagine visitate, durata della visita e click-stream. Puoi gestire i cookie nelle impostazioni del browser, ma disattivarli potrebbe compromettere il funzionamento dei nostri servizi.",
    correspondenceTitle: "2.6 Corrispondenza volontaria",
    correspondenceDescription:
      "Se ci contatti via email, conserviamo la corrispondenza e il tuo indirizzo per riferimento futuro.",
    accessTitle: "3. Quando accediamo o condividiamo le tue informazioni",
    accessDescription1:
      "Per fornire i servizi richiesti. Utilizziamo subprocessor di terze parti (come fornitori cloud e di analisi) per gestire le nostre app.",
    accessDescription2:
      "Per indagare, prevenire o agire su abusi. L'accesso a un account è l'ultima risorsa. Cerchiamo di bilanciare privacy e sicurezza, e agiremo se rileviamo usi non consentiti, anche notificando le autorità se necessario.",
    accessDescription3: "Quando richiesto dalla legge.",
    dataRequests:
      "Richieste di dati utente. Non rispondiamo a richieste governative a meno di obbligo legale o emergenza. Negli USA, rispettiamo mandati, subpoena o ordini giudiziari. Per richieste esterne, seguiamo i trattati di assistenza legale. Notificheremo gli utenti interessati, salvo divieto legale o casi di emergenza.",
    preservationRequests:
      "Richieste di conservazione. Conserviamo dati solo se obbligati dallo U.S. Federal Stored Communications Act (18 U.S.C. §2703(f)) o da subpoena civile. Non li condividiamo a meno di obbligo legale, e li distruggiamo alla scadenza del periodo di conservazione se non riceviamo un mandato valido.",
    taxAudits:
      "In caso di audit fiscale, potremmo condividere il minimo necessario (es. indirizzi di fatturazione e informazioni su esenzioni).",
    securityTitle: "4. Come proteggiamo i tuoi dati",
    securityDescription:
      "Tutti i dati sono crittografati via SSL/TLS durante il trasferimento dai nostri server al tuo browser.",
    ...
    locationTitle: "6. Ubicazione del sito e dei dati",
    locationDescription:
      "I nostri prodotti e servizi sono gestiti negli USA. Se sei nell'UE, UK o altrove fuori dagli USA, sappi che le tue informazioni verranno trasferite e archiviate negli USA. Usando i nostri servizi, acconsenti a questo trasferimento.",
    childrenTitle: "7. Privacy dei minori",
    updatesTitle: "8. Aggiornamenti a questa Informativa",
    updatesDescription:
      "Aggiorneremo questa normativa per conformarci alle regolamentazioni e riflettere nuove pratiche. Per modifiche significative, aggiorneremo la data in alto.",
    contactTitle: "9. Contattaci",
    websiteUrl: "https://www.nevercap.ai/",
    at: "a",
    childrenDescription:
      "I Servizi non sono destinati ai bambini e non raccogliamo consapevolmente Informazioni Personali da minori di 13 anni. Se hai meno di 13 anni, non inviare alcuna informazione personale tramite i Servizi. Se ritieni che un bambino ci abbia fornito Informazioni Personali in violazione di questa Politica, contattaci {at} {email} come indicato di seguito.",
    contactDescription:
      "Se hai domande, commenti o reclami sulla nostra Politica sulla Privacy, contattaci {at} {email} e ci impegneremo a gestire il tuo reclamo il prima possibile.",
    policyDescriptionA:
      'La presente Informativa descrive come {NeverCap} (di seguito denominata "NeverCap", "nostro", "noi", "ci") raccoglie, utilizza e divulga le tue informazioni personali quando utilizzi i nostri servizi, siti web ({url}) e software (collettivamente, i "Servizi").'
  },
  TermsOfUse: {
    title: "Termini di",
    ...
    servicesDescription1:
      "I nostri Servizi consentono agli utenti di trasformare conversazioni vocali in testo trascritto che può essere cercato, tradotto e condiviso con altri.",
    servicesOptions:
      'Puoi scegliere se utilizzare la versione gratuita dei Servizi ("Servizi Gratuiti") o la versione a pagamento basata su abbonamento per la quale potresti dover pagare delle tariffe ("Servizi a Pagamento").',
    servicesAccess:
      "Renderemo i Servizi disponibili per te. Sei responsabile di predisporre tutto il necessario per accedere ai Servizi.",
    accountTermsTitle: "3. Termini dell'Account",
    accountSecurity:
      "Sei responsabile della sicurezza del tuo account. La Società non può e non sarà responsabile per eventuali perdite o danni derivanti dal tuo mancato rispetto di questo obbligo di sicurezza.",
    lawfulUse: "Non puoi utilizzare i Servizi per scopi illegali, non etici o immorali.",
    contentResponsibility:
      "Sei responsabile di tutti i contenuti pubblicati e delle attività che avvengono sotto il tuo account. Ciò include i contenuti pubblicati da altri che: (a) hanno accesso alle tue credenziali di accesso; o (b) hanno i propri accessi sotto il tuo account.",
    humanRequirement:
      'Devi essere un essere umano. Non sono consentiti account registrati da "bot" o altri metodi automatizzati.',
    paymentTitle: "4. Pagamento, Rimborsi e Cambiamenti di Piano",
    freeTrial:
      "Per i Servizi a pagamento che offrono una prova gratuita, spieghiamo la durata della prova al momento della registrazione. Dopo il periodo di prova, devi pagare in anticipo per continuare a utilizzare il Servizio. Se non paghi, questi servizi cesseranno.",
    upgradePolicy:
      "Se passi da un piano gratuito a uno a pagamento, addebiteremo immediatamente la tua carta e il tuo ciclo di fatturazione inizierà il giorno dell'aggiornamento.",
    taxes:
      "Tutte le tariffe sono escluse tasse, imposte o dazi imposti dalle autorità fiscali. Se richiesto, riscuoteremo queste tasse per conto dell'autorità fiscale e le verseremo alle autorità competenti. Altrimenti, sei responsabile del pagamento di tutte le tasse, imposte o dazi.",
    refunds:
      "Tutti gli acquisti non sono rimborsabili. Puoi annullare qualsiasi servizio a pagamento in qualsiasi momento accedendo al tuo account. Per gli abbonamenti a pagamento, l'annullamento avrà effetto alla fine del periodo pagato corrente, salvo diversa indicazione.",
    cancellationTitle: "5. Annullamento e Risoluzione",
    cancellationPolicy:
      "Se annulli il Servizio prima della fine del periodo pagato, l'annullamento avrà effetto immediato e non ti verrà addebitato nuovamente. Non rimborsiamo automaticamente il tempo non utilizzato nell'ultimo ciclo di fatturazione.",
    terminationRights:
      "Ci riserviamo il diritto di sospendere o terminare il tuo account e rifiutare qualsiasi uso attuale o futuro dei nostri Servizi per qualsiasi motivo in qualsiasi momento. La sospensione significa che non potrai accedere all'account o a qualsiasi contenuto in esso presente. La terminazione comporterà inoltre la cancellazione del tuo account o del tuo accesso all'account e la perdita di tutti i contenuti nel tuo account. Ci riserviamo anche il diritto di rifiutare l'uso dei Servizi a chiunque per qualsiasi motivo in qualsiasi momento. Abbiamo questa clausola perché, statisticamente parlando, tra le centinaia di migliaia di account sui nostri Servizi, ce n'è almeno uno che fa qualcosa di nefasto.",
    abusePolicy:
    ...
    dataSecurity:
      "Adottiamo molte misure per proteggere e garantire la sicurezza dei tuoi dati attraverso backup, ridondanze e crittografia. Impieghiamo la crittografia per la trasmissione dei dati su Internet pubblico.",
    thirdPartyVendors:
      "Utilizziamo fornitori e partner di hosting terzi per fornire l'hardware, il software, la rete, lo storage e la tecnologia correlata necessari per erogare i Servizi.",
    siteManagementTitle: "8. Gestione del Sito",
    ...
    copyrightCompliance:
      "Tutti i contenuti pubblicati sui Servizi devono conformarsi alla legge sul copyright degli Stati Uniti.",
    ipRights:
      "Non rivendichiamo diritti di proprietà intellettuale sul materiale che fornisci ai Servizi. Tutti i materiali caricati rimangono tuoi.",
    contentModeration:
      "Non esaminiamo preventivamente i contenuti, ma ci riserviamo il diritto (ma non l'obbligo) a nostra esclusiva discrezione di rifiutare o rimuovere qualsiasi contenuto disponibile tramite il Servizio.",
    prohibitedExploitation:
      "Accetti di non riprodurre, duplicare, copiare, vendere, rivendere o sfruttare alcuna parte dei Servizi, l'uso dei Servizi o l'accesso ai Servizi senza l'esplicita autorizzazione scritta della Società.",
    impersonationProhibition:
      "Non devi modificare un altro sito web per far credere falsamente che sia associato ai Servizi o alla Società.",
    dmcaPolicy:
      "Rispettiamo i diritti di proprietà intellettuale altrui. Se ritieni che qualsiasi materiale disponibile sul o tramite il Sito violi un copyright di tua proprietà o controllo, contattaci immediatamente. Una copia della tua Notifica sarà inviata alla persona che ha pubblicato o memorizzato il materiale in questione. Ti informiamo che, in base alla legge applicabile, potresti essere ritenuto responsabile di danni se presenti false dichiarazioni materiali in una Notifica. Pertanto, se non sei sicuro che il materiale sul Sito o collegato ad esso violi il tuo copyright, dovresti prima contattare un avvocato.",
    prohibitedActivitiesTitle: "10. Attività Proibite",
    generalProhibition:
      "Non puoi accedere o utilizzare il Sito per scopi diversi da quelli per cui lo rendiamo disponibile. Il Sito non può essere utilizzato per attività commerciali, a meno che non siano specificamente approvate da noi.",
    userObligations: "Come utente del Sito, accetti di non:",
    dataScraping:
      "Recuperare sistematicamente dati o altri contenuti dal Sito per creare o compilare, direttamente o indirettamente, una raccolta, compilazione, database o directory senza il nostro permesso scritto.",
    fraud:
      "Ingannare, frodare o fuorviare noi e altri utenti, specialmente nel tentativo di ottenere informazioni sensibili come le password degli account.",
    securityInterference:
      "Eludere, disabilitare o interferire con le funzionalità di sicurezza del Sito, comprese quelle che impediscono o limitano l'uso o la copia dei contenuti o impongono restrizioni sull'uso del Sito e/o dei contenuti presenti.",
    defamation: "Denigrare, danneggiare o recare danno, a nostro giudizio, a noi e/o al Sito.",
    harassment:
      "Utilizzare qualsiasi informazione ottenuta dal Sito per molestare, abusare o danneggiare un'altra persona.",
    supportAbuse:
      "Fare un uso improprio dei nostri servizi di supporto o inviare false segnalazioni di abuso o condotta scorretta.",
    ...
    malware:
      "Caricare o trasmettere (o tentare di caricare o trasmettere) virus, Trojan o altro materiale, incluso l'uso eccessivo di lettere maiuscole e spam (pubblicazione continua di testo ripetitivo), che interferisca con l'uso ininterrotto del Sito o ne modifichi, comprometta, interrompa o interferisca con le funzionalità, l'operatività o la manutenzione.",
    automation:
      "Utilizzare in modo automatizzato il sistema, come script per inviare commenti o messaggi, o strumenti di data mining, robot o simili per raccogliere ed estrarre dati.",
    ...
    spyware:
      'Caricare o trasmettere (o tentare di caricare o trasmettere) materiale che funga da meccanismo passivo o attivo di raccolta o trasmissione di informazioni, inclusi, senza limitazione, GIF trasparenti, pixel 1×1, web bug, cookie o dispositivi simili (a volte chiamati "spyware" o "meccanismi di raccolta passiva").',
    disruption: "Interferire, interrompere o creare un carico eccessivo sul Sito o sulle reti o servizi connessi.",
    employeeHarassment:
      "Molestare, infastidire, intimidire o minacciare i nostri dipendenti o agenti che forniscono il Sito.",
    accessCircumvention:
      "Tentare di bypassare le misure del Sito progettate per impedire o limitare l'accesso al Sito o a sue parti.",
    codeCopying:
      "Copiare o adattare il software del Sito, incluso, ma non limitato a, Flash, PHP, HTML, JavaScript o altro codice.",
    reverseEngineering:
      "Salvo quanto consentito dalla legge, decifrare, decompilare, disassemblare o fare reverse engineering del software che compone il Sito.",
    ...
    unauthorizedUse:
      "Fare un uso non autorizzato del Sito, inclusa la raccolta di nomi utente e/o email per inviare email non richieste o creare account con mezzi automatizzati o sotto falsi pretesti.",
    competition:
      "Utilizzare il Sito per competere con noi o per attività generatrici di reddito o imprese commerciali.",
    ...
    featuresDescription:
      "Progettiamo i nostri Servizi con cura, basandoci sulla nostra esperienza e su quella dei clienti che condividono feedback. Tuttavia, non esiste un servizio che soddisfi tutti. Non garantiamo che i nostri Servizi soddisferanno le tue esigenze o aspettative specifiche.",
    bugsDescription:
      "Testiamo tutte le funzionalità prima del rilascio. Come qualsiasi software, i nostri Servizi hanno inevitabilmente bug. Monitoriamo i bug segnalati e li risolviamo, specialmente quelli relativi a sicurezza e privacy. Non tutti i bug verranno corretti e non garantiamo Servizi completamente privi di errori.",
    correctionsTitle: "12. Correzioni",
    informationAccuracy:
      "Potrebbero esserci errori tipografici, inesattezze o omissioni sul Sito, inclusi descrizioni, prezzi, disponibilità e altre informazioni. Ci riserviamo il diritto di correggere errori e aggiornare le informazioni in qualsiasi momento, senza preavviso.",
    siteAvailability:
  ...
  Blog: {
    ...
    ListSection: {
      ...
      categories: [
        ...
        "Suggerimenti sull'intelligenza artificiale"
      ]
    },
    Detail: {
      Home: "Casa",
  ...
  cello: {
    exclusiveAccess: "{name} ti ha dato accesso esclusivo a NeverCap Pro",
    proMember: "Membro NeverCap Pro",
    save: "Risparmia",
    unlimitedTranscription: "su trascrizione AI illimitata",
    specialPrice: "Il tuo prezzo speciale: {moneyOne}/mese (Reg. {moneyTwo})",
    whyChose: "Perché {name} ha scelto NeverCap:",
    noLimits: "Nessun limite mensile (altri limitano a 120 min/mese)",
    uploadFiles: "Carica 50 file alla volta",
    longFiles: "File di 10 ore supportati",
    accuracy: "96% di accuratezza garantita",
    regularPrice: "Prezzo Regolare",
    perMonth: "/mese",
    getsCredit: "{name} ottiene: $50 di credito",
    whenSubscribe: "quando ti abboni",
    activateGift: "Attiva Regalo di Bob",
    existingAccount: "↓ Hai già un account? Applica sconto all'account esistente",
    offerExpires: "L'offerta scade tra:",
    activeUsers: "utenti attivi",
    rating: "valutazione",
    noCreditCard: "Nessuna carta di credito",
    requiredFreeTrial: "richiesta per la prova gratuita",
    yourSpecialPrice: "Il Tuo Prezzo Speciale",
    activateNameGift: "Attiva Regalo di {name}",
    year: "anno"
  },
  RegisterDialog: {
