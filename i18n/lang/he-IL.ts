...
let message = {
  ...
  Index: {
    Hero: {
      ...
      subtitleA: "הבינה המלאכותית של NeverCap מתמללת וידאו וממירה אודיו לטקסט, ומעבדת 50 קבצים בו זמנית ללא הגבלת נפח חודשי. תמלול שמתפתח יחד איתך."
    },
    Stats: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      heroSubtitleA: "מפודקאסטרים עם שנים של צבר הזמנות ועד חוקרים עם מאות ראיונות. ראו כיצד אנשי מקצוע משתמשים ב-{NeverCap} כדי להשתחרר ממגבלות העלאה ומגבלות דקות."
    },
    Podcasters: {
      ...
      solutionDescriptionA: "עם {NeverCap}, אתם מקבלים תמלול אמיתי ללא הגבלה. העלו את כל הארכיון שלכם. תמללו כל פרק חדש. צרו הערות תוכנית בקנה מידה גדול. בלי מגבלות, בלי הגבלות, רק צמיחה."
    },
    Journalists: {
      hero: {
      ...
      problem: {
        ...
        solution: {
          ...
          descriptionA: "עם {NeverCap}, תקבלו תמלול אמיתי ללא הגבלה. העלו את כל החקירה שלכם. תמללו כל ראיון. חפשו את כל הציטוטים באופן מיידי. בלי אותיות גדולות, בלי מגבלות, רק עיתונות."
        }
      },
      solution: {
        title: "1",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA: "בין אם אתם צריכים לתמלל סרטון יוטיוב, לתמלל סרטון טיקטוק לשימוש חוזר, או להבין איך לתמלל סרטון פייסבוק לטקסט, {NeverCap} מטפלת בכל זה בצורה חלקה. צרו כתוביות ביותר מ-100 שפות ללא הגבלה חודשית - פשוט חופש יצירתי טהור."
      },
      platforms: {
    ...
    Researchers: {
      ...
      solutionDescA: "עם {NeverCap}, אתם מקבלים תמלול אמיתי ללא הגבלה. העלו את כל המחקר שלכם. תמללו כל ראיון. נתחו את כל הנתונים שלכם. בלי תקלות, בלי מגבלות, רק מחקר."
    },
    BusinessTeams: {
      ...
      heroSubtitleA: "הקלט פגישות ישירות בדפדפן שלך או העלה קבצי שמע באופן מיידי. בנה ארכיונים הניתנים לחיפוש משיחות ללא הגבלה. לעולם אל תאבד דיונים חשובים שוב עם תמלול בלתי מוגבל באמת מ-{NeverCap}."
    },
    Educators: {
      ...
      testimonialTextA: '"אני משתמש ב-{NeverCap} כדי לתמלל את כל ערוץ היוטיוב שלי של מדריכי מתמטיקה. מה שהיה לוקח שבועות עם שירותים אחרים לוקח עכשיו שעות. היכולת להדביק קישורים ישירות ולקבל תמלולים מיידיים שינתה את האופן שבו אני יוצר תוכן נגיש. התלמידים הבינלאומיים שלי אוהבים במיוחד את הכתוביות הרב-לשוניות!"'
    }
  },
  Resources: {
    YouTubeToMP4: {
  ...
  Privacy: {
    ...
    policyDescriptionA: 'מדיניות זו מתארת ​​כיצד {NeverCap} (להלן "NeverCap", "שלנו", "אנחנו", "אותנו") אוספת, משתמשת וחושפת את המידע האישי שלך כאשר אתה משתמש בשירותים, באתרי האינטרנט ({url}) ובתוכנה שלנו (ביחד, "השירותים").'
  },
  TermsOfUse: {
    title: "תנאי",
  ...
  Blog: {
    Hero: {
      ...
      "description": "מדריכים, אסטרטגיות וכלי בינה מלאכותית מבית {NeverCap} שיעזרו לכם ליצור תוכן ללא הגבלה עם זרימות עבודה מקצועיות לתמלול."
    },
    Featured: {
