...
let message = {
  ...
  Resources: {
    Transcription: {
      videoTranscription: {
        ...
        threeStep: {
          ...
          step_1_des: 'We support video formats like MP4, MOV, WMV, and MPEG, as well as links from YouTube, TikTok, X, Facebook, and other platforms.',
          step_2_title: 'Transcribe video to text.',
          step_2_des: 'Click the "Transcribe" button and wait for the process to complete. A 1-hour video typically takes just 1–2 minutes to transcribe.',
          step_3_title: 'Export or share.',
          step_3_des: 'Edit your text directly online, then export it in multiple formats such as TXT, PDF, DOCX, SRT, CSV, or VTT. You can also generate a shareable link to your transcript.',
        },
        whyTran: {
          title: 'Why',
          ...
          reason_1_des: 'Students, researchers, and creators often need to extract information from videos. Transcription makes it simple to take study notes, organize research interviews, draft scripts or articles, and translate content more accurately and cost-effectively.',
          reason_2_title: 'Enhances searchability.',
          reason_2_des: 'With text, you can quickly search for keywords and locate important sections—no more rewinding or fast-forwarding through the video.',
          reason_3_title: 'Saves time and boosts efficiency.',
          reason_3_des: 'Reading text is much faster than watching a video, especially for content like lectures, interviews, or meetings. Text allows you to skim or jump directly to key points.',
          reason_4_title: 'Improves accessibility.',
          reason_4_des: 'It provides equal access to information for people who are deaf or hard of hearing, non-native speakers, or those with hearing difficulties. It also helps platforms meet compliance standards like WCAG.',
          reason_5_title: 'Enables content repurposing.',
          reason_5_des: 'Creators often use transcriptions to quickly generate blog posts, social media content, summaries, or video captions—dramatically speeding up the creative process without manual typing.',
          reason_6_title: 'Supports better understanding, retention, and archiving.',
          reason_6_des: 'Combining visual and text-based information enhances comprehension and memory, while text files are easy to store, ideal for building knowledge bases, document libraries, or archival systems.',
        },
        whyChoose: {
          title: 'Why Choose',
          titleHighlight: 'Our Video Transcription Tool',
          reason_1_title: 'Transcribe & Translate Globally',
          reason_1_des: 'Supports transcription in 100+ languages and translation into 249 others, breaking down any language barrier.',
          reason_2_title: 'Universal Format Compatibility',
          reason_2_des: 'Works seamlessly with all common video formats (MP4, MOV, MKV, etc.) and platforms like YouTube & TikTok.',
          reason_3_title: 'Truly Unlimited Transcriptions',
          reason_3_des: 'Transcribe 100 or 1,000 videos—your flat rate stays the same. No hidden limits, no surprise costs.',
          reason_4_title: 'Accuracy You Can Trust',
          reason_4_des: 'Benefit from over 95% overall accuracy, with key languages like English and Spanish reaching over 96%.',
          reason_5_title: 'Enterprise-Grade Security',
          reason_5_des: 'Your data is protected by industry-leading encryption and privacy protocols. We treat your confidentiality with the utmost seriousness.',
          reason_6_title: 'Word-Level Timestamps',
          reason_6_des: 'Pinpoint any moment in your video instantly. Click on a word in the transcript to jump directly to the exact time in the original media.'
        },
        reviews: {
          title: 'Reviews from',
          titleHighlight: 'Our Users',
          des: 'See why thousands rely on us for effortless transcription.',
          people_1_content: `NeverCap's video transcription is absolutely fantastic! After trying over a dozen transcription tools, this is the first service I've found that's truly unlimited. I can transcribe as much as I want without ever worrying about usage limits.`,
          people_1_job: 'Content Creator',
          people_2_content: `Affordable pricing, handles large files with ease, and processes dozens of files simultaneously. NeverCap's video transcription hits almost every pain point I've had.`,
          people_2_job: 'Researcher',
          people_3_content: `Accurate, fast, and supports tons of languages. What really stands out is how well it handles long videos. NeverCap has become an essential part of my toolkit, and I've recommended it to all my classmates.`,
          people_3_job: 'PhD Candidate',
        },
        faq: {
          title: 'Key Questions about',
          titleHighlight: 'Video Transcription',
          q_1: 'What video formats does NeverCap support?',
          a_1: 'We support common video formats including MP4, MOV, WMV, MPEG, WebM, and MKV.',
          q_2: 'How do I transcribe a video link, and which platforms are supported?',
          a_2: 'Simply copy and paste the video URL, then click "Transcribe." We support links from YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram, and more.',
          q_3: 'Which languages are supported for video transcription?',
          a_3: 'NeverCap supports 100+ languages, including English, Spanish, Mandarin, French, German, Japanese, Korean, Portuguese, Russian, Italian, Dutch, and Arabic.',
          q_4: 'What is the maximum duration and file size for transcription?',
          a_4: 'The maximum file size is 5GB, and the maximum duration is 10 hours per video.',
          q_5: 'How many video files can I upload at once?',
          a_5: 'NeverCap allows up to 50 files to be processed simultaneously.',
          q_6: 'How fast is the transcription process? Do I need to wait a long time?',
          a_6: 'No long waits required. In our tests, a 1-hour video typically takes around 3 minutes to transcribe.',
          q_7: `What is the accuracy of NeverCap's transcription?`,
          a_7: 'We deliver over 95% accuracy across all languages, and over 96% for key languages like English, Spanish, Mandarin, and French.',
          q_8: 'Can the transcribed text be translated into other languages?',
          a_8: 'Yes. Once transcription is complete, you can translate the text into 249 supported languages.',
          q_9: 'Can I edit, export, or share the transcribed text?',
          a_9: 'Absolutely. Transcribed text can be edited in real-time. Export options include PDF, DOCX, TXT, TTV, CSV, and SRT formats. You can also generate a shareable link to the transcript.',
        },
        explore: {
          title: 'Explore further',
          transcribeTitle: 'Tools to transcribe to text',
          transcribe_1: 'Audio to text',
          transcribe_2: 'Voice to text',
          transcribe_3: 'MP3 to text',
          transcribe_4: 'MP4 to text',
          transcribe_5: 'AAC to text',
          transcribe_6: 'AMR to text',
          transcribe_7: 'M4A to text',
          transcribe_8: 'MOV to text',
          transcribe_9: 'MPEG to text',
          transcribe_10: 'OGG to text',
          transcribe_11: 'TS to text',
          transcribe_12: 'WAV to text',
          transcribe_13: 'WEBM to text',
          otherToolsTitle: 'Other related tools',
          otherTools_1: 'Al Notetaker',
          otherTools_2: 'Add subtitles to video',
          otherTools_3: 'Translate audio',
          otherTools_4: 'Translate video',
    ...
    YouTubeToMP3: {
      ...
      freeResources: {
        linkTitle: "Powered by {NeverCap}",
        linkTitle2: "- Fully Unlimited AI Transcription",
        title: "Free Resources",
        stepsNew: [
          {
            title: "Free Audio and Video Transcription",
          ...
          },
          {
            ...
            content: "Upload MP3, MP4, WAV, MOV.",
            content2: "Download DOCX, TXT, SRT, and more."
          },
          {
            title: "Transcribe YouTube Videos",
      ...
      part3: {
        content: [
          "Want to convert YouTube videos to MP3 to listen anytime?",
          "Whether you're on the subway, on a plane, or organizing podcasts, course content, or important archives, we often struggle with not being able to access them anytime. Here, our converter tool solves this problem for you.",
          "Simply copy the YouTube link, paste it into the converter, and with one click you can convert videos to high-quality MP3 audio. Save, listen, and archive anytime without needing an internet connection."
        ]
      },
      part4: {
        ...
        list: [
          {
            ...
            content:
              "MP3 files are smaller, reducing storage on YouTube consumption. Save on mobile data by downloading the offline viewing, and use when there's an internet service."
          },
          {
            title: "Saves Battery: ",
            content:
              "To watch YouTube videos, they're buffering service, which uses easily listened connections. No more buffering worries."
          },
          {
            title: "Easy Archiving & Preservation: ",
            content:
              "Some videos or MP3 makes it simple to build your personal library — whether for educational content, music archives, or important."
          },
          {
            title: "Simpler Sharing: ",
            content:
              "Sharing an MP3 file is much more convenient than YouTube links. You can send files to friends through apps like WhatsApp or Instagram, eliminating the entry cost of opening YouTube."
          },
          {
            title: "Instant Viewing, Broad Flexibility: ",
            content:
              "Access a wider favorite video to your favorite video by converting YouTube videos wherever you need them and MP3 formats allow for smoothly together right away, without awkward pauses waiting for this load."
          }
        ]
      },
      part5: {
        title: "Why Our Converter Stands Out",
        cards: [
          {
            title: "One-click simplicity",
            content: "Effortless setup and intuitive operation."
          ...
          },
          {
            title: "Zero Ads, Zero Distractions",
            content:
              "Enjoy a clean interface with no pop-ups, banners, or interruptions - just smooth, uninterrupted conversion."
          },
          {
            title: "Original Quality Guaranteed",
            content: "Your downloads retain the source video's full resolution for pixel-perfect playback every time."
      ...
      part6: {
        title: ["Maximize Your YouTube to MP3 Conversions", "With Our Converter"],
        title_des: "Effortless YouTube to MP3 Conversion — Fast, Simple & Free",
        content: [
          "There's where we excel. Our user-friendly interface is designed for everyone — no tech skills needed. Regardless of your experience level, you can convert videos instantly. No sign up required, and simply what you can get started — your downloaded MP3s maintain the original video quality and clarity, exactly as you watched them on YouTube.",
          "Speed matters too. You can download multiple files fast, no ads and devices. Whether you're on Windows, macOS, Linux, Android, or iOS — using a smartphone, tablet, or desktop — you can download videos effortlessly."
        ]
      },
      part7: {
        title: "Key Questions on Converting YouTube to MP3",
        list: [
          {
            question: "Can I convert a copyrighted YouTube video to MP3?",
            answer:
              "While technically possible, converting copyrighted content without permission may violate YouTube's terms of service and copyright laws. Always ensure you have the right to convert content or use it for personal, non-commercial purposes only."
          },
          {
            question: "Is this converter tool safe?",
            answer:
              "Yes, our converter is completely safe and secure. We don't store any of your data or files, and there's no risk of malware or viruses. The conversion happens directly and securely."
          },
          {
            question: "What languages does YouTube to MP3 conversion support?",
            answer:
