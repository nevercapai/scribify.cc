...
let message = {
  ...
  Index: {
    Hero: {
      ...
      subtitle: "Nossa IA transcreve vídeo e converte áudio em texto, processando 50 arquivos de uma vez sem limites mensais. Transcrição que realmente escala com você.",
    ...
    FeaturesGrid: {
      ...
      feat_unltd_desc: 'Sem "política de uso justo" escondida nos termos. Sem limites de armazenamento disfarçados de "ilimitado". Faça upload de todo seu arquivo, transcreva tudo para todas as suas necessidades de transcrição de áudio. Nós cumprimos.',
      feat_bulk: "Liberdade de Upload em Massa",
      feat_bulk_desc: 'Cansado de "3 importações vitalícias" ou "10 arquivos por mês"? Faça upload de 50 arquivos de uma vez, quantas vezes precisar. Perfeito para processar acúmulos.',
      feat_batch: "Processamento em Lote",
      feat_batch_desc: "Processe toda sua temporada de podcast durante a noite. Faça upload de 50 entrevistas de uma vez. Deixe nossa IA trabalhar enquanto você dorme. Acorde com as transcrições prontas.",
      feat_accuracy: "96% de Precisão",
      feat_accuracy_desc: "Nossa IA líder do setor transcreve áudio com pontuação inteligente, diarização para até 20 falantes, e lida com sotaques e termos técnicos perfeitamente.",
      feat_langs: "100+ Idiomas",
      feat_langs_desc: "Transcreva vídeo e áudio em 100+ idiomas, traduza para 249+. Sem custos extras para idiomas diferentes. Conteúdo global, um preço simples.",
      feat_pro: "Recursos Profissionais",
      feat_pro_desc: "Timestamps por palavra para posicionamento preciso de áudio/vídeo, identificação exata de falantes mesmo durante trocas rápidas de conversa, e texto perfeitamente formatado com parágrafos, frases e pontuação para fácil leitura.",
        features: "Recursos"
    },
    UseCases: {
      built_for: "Em Massa",
      "heavy_users": "Transcrição de Áudio & Vídeo",
      "join_users": 'Feito para Usuários Pesados Como Você - Junte-se a YouTubers, criadores de conteúdo e podcasters que migraram de serviços com "shrinkflation"',
      "podcasters": {
        "title": "Podcasters",
    ...
    Testimonials: {
      ...
      Mike: {
        "text": "Caramba, isso realmente funciona! Fazia um podcast há 3 anos e transcrevia tudo manualmente como um idiota. Enviei 6 episódios de uma vez e ele separou perfeitamente eu e meu co-apresentador. O episódio na cafeteria que achei que estava arruinado? Transcrição cristalina. Nunca mais vou digitar essas coisas eu mesmo.",
        "author": "Mike Rodriguez",
        "role": "Apresentador de Podcast"
      },
      Sarah: {
        "text": "Eu ensino online e precisava de legendas para meus vídeos. Tentei 3 outras ferramentas que tinham limites estranhos ou demoravam muito. Esta simplesmente... funciona? Enviei minha aula em espanhol e obtive legendas perfeitas em 2 minutos. Meus alunos com deficiência auditiva estão tão felizes. Queria ter encontrado isso antes!",
        "author": "Sarah Chen",
        "role": "Professora Online"
      },
      Jessica: {
        "text": "Tenho usado isso para minhas entrevistas e é incrível como é preciso. Tive uma entrevista de 2 horas em inglês ruim + espanhol e ele acertou tudo, até os timestamps. Pagava $200/mês ao meu estagiário só para transcrever. Isso literalmente está me economizando dinheiro todo mês.",
        "author": "Jessica Park",
    ...
    CTASection: {
      ...
      "subtitle": "Junte-se a 50.000+ profissionais que migraram para transcrição verdadeiramente ilimitada",
      "button": "Experimente o NeverCap Grátis",
      "disclaimer": "Nenhum cartão de crédito necessário para o Plano Grátis • Atualize a qualquer momento para acesso ilimitado"
    }
  },
  Features: {
    UnlimitedTranscription: {
      ...
      heroSubtitle: "Enquanto o Trint limita você a 50 horas e o Otter a 10 arquivos por mês, nós entregamos o que realmente prometemos: transcrição ilimitada sem limites ocultos.",
      ...
      feature1Description: "Pare de contar minutos. Pare de observar limites. Seja 10 horas ou 10.000 horas por mês, você paga a mesma taxa fixa. Sem custos extras. Sem surpresas na fatura.",
      feature1Point1Icon: "✓",
      ...
      feature2Description: "Otter oferece 3 importações vitalícias no gratuito, 10 por mês no Pro. Nós oferecemos ilimitado. Envie seu backlog de podcasts, todas as entrevistas, anos de gravações. Sem restrições.",
      feature2Point1Icon: "✓",
      ...
      feature3Description: '"Eu pago $100/ano pelo Otter e eles me limitam a 10 importações por mês. No momento em que houver uma alternativa com importações ilimitadas, eu mudo!" - Usuário real do Reddit',
      feature3Point1Icon: "✓",
    ...
    BulkUpload: {
      ...
      heroSubtitle: "Otter oferece 3 importações vitalícias. TRÊS. Para toda a sua vida. Nós oferecemos uploads ilimitados, 50 arquivos por vez, quando você precisar.",
      primaryCta: "Iniciar Upload em Massa →",
      secondaryCta: "Ver os Limites",
      redditQuote: '"Tenho 3 anos de episódios de podcast para transcrever. Otter me diz que tenho 3 importações vitalícias. TRÊS. Isso é insultante."',
      redditAuthorIcon: "📍",
      ...
      feature1Description: 'Carregue 50 arquivos antes de dormir. Acorde com transcrições completas. Sem filas, sem espera, sem mensagens de "atualize seu plano". Puro poder de processamento na ponta dos seus dedos.',
      feature1Point1Icon: "✓",
      ...
      feature2Description: "Nossa infraestrutura de processamento paralelo significa que seus 50 arquivos não ficam na fila. Todos são transcritos simultaneamente. O que levava semanas agora leva horas.",
      feature2Point1Icon: "✓",
      ...
      feature3Description: 'Enquanto outros fazem você esperar em filas virtuais ou pedem upgrades para "processamento prioritário", tratamos cada envio com urgência. Seu conteúdo importa e não deve esperar.',
      feature3Point1Icon: "✓",
      ...
      useCase1Description: "Envie 3 anos de episódios de uma vez. Crie transcrições para todo o seu catálogo. Gere conteúdo SEO para cada episódio.",
      useCase2Title: "Criação de Cursos",
      useCase2Description: "Processe todos os seus vídeos de aula simultaneamente. Crie transcrições acessíveis para alunos. Construa materiais de curso pesquisáveis.",
      useCase3Title: "Acúmulo de Entrevistas",
      useCase3Description: "Limpe aquela pilha de entrevistas não transcritas. Processe semanas de pesquisa em horas. Cumpra prazos sem desespero.",
      useCase4Title: "Biblioteca do YouTube",
      useCase4Description: "Gere legendas para todo o seu canal. Crie posts de blog a partir de vídeos. Melhore o SEO em todos os vídeos.",
      useCase5Title: "Arquivos de Reuniões",
      useCase5Description: "Carregue meses de reuniões gravadas. Crie anotações de reunião pesquisáveis. Nunca mais perca decisões importantes.",
      useCase6Title: "Dados de Pesquisa",
      useCase6Description: "Processe grupos de foco em massa. Transcreva todas as entrevistas com participantes. Analise dados qualitativos com eficiência.",
    ...
    Accuracy: {
      ...
      heroSubtitle: "Precisão líder do setor em 12 idiomas principais. Timestamps em nível de palavra para sincronização perfeita. Identificação inteligente de falantes que lida com conversas rápidas. Formatação profissional realmente legível.",
      ...
      feature1Description: "Cada palavra está perfeitamente sincronizada com sua posição no áudio. Crie transcrições clicáveis, gere legendas precisas ou vá para momentos exatos em suas gravações. Precisão de 100ms confiável para profissionais.",
      feature1Point1Icon: "✓",
      ...
      feature2Description: "Nossa IA identifica com precisão os locutores, mesmo durante fala sobreposta, interrupções e conversas rápidas. Perfeito para entrevistas, podcasts e reuniões onde os participantes frequentemente interrompem.",
      feature2Point1Icon: "✓",
      ...
      feature3Description: "Chega de blocos de texto. Nossa IA adiciona parágrafos, frases e pontuação exatamente onde devem estar. O resultado? Transcrições realmente agradáveis de ler e fáceis de visualizar.",
      feature3Point1Icon: "✓",
      ...
      formattingBeforeText: "então hoje vamos falar sobre os novos recursos em que estamos trabalhando acho que você vai gostar muito eles foram solicitados pelos usuários há muito tempo e finalmente os concluímos",
      formattingAfterLabel: "✓ NeverCap:",
      formattingAfterText: "Então hoje, vamos falar sobre os novos recursos em que estamos trabalhando. Acho que você vai gostar muito. Eles foram solicitados pelos usuários há muito tempo, e finalmente os concluímos.",
  ...
  Pricing: {
    ...
    CTA: {
      ...
      "disclaimer": "Nenhum cartão necessário • Comece a transcrever em segundos"
    }
  },
  UseCases: {
    AllUseCases: {
      ...
      heroSubtitle: "De podcasters com anos de backlog a pesquisadores com centenas de entrevistas. Veja como os profissionais usam o NeverCap para se libertar dos limites de upload e de minutos.",
      podcasters: {
        title: "Podcasters",
        pain: '"Pare de escolher quais episódios merecem transcrições"',
        description: "Carregue todo o seu arquivo de podcast de uma vez. Gere notas do programa, melhore o SEO e reutilize conteúdo sem contar minutos.",
        benefits: {
      ...
      journalists: {
        ...
        description: "Faça upload em lote de todas as entrevistas antes do prazo. Pesquise transcrições instantaneamente e nunca perca uma citação crucial.",
        benefits: {
      ...
      contentCreators: {
        ...
        description: "Legende todo o seu canal do YouTube. Gere legendas em vários idiomas e melhore o SEO dos seus vídeos instantaneamente.",
        benefits: {
      ...
      researchers: {
        ...
        description: "Processe estudos de pesquisa inteiros de uma vez. Lide com grupos de foco, entrevistas e discussões em painel com identificação perfeita de falantes.",
        benefits: {
      ...
      businessTeams: {
        ...
        description: "Grave reuniões diretamente ou envie arquivos de áudio para transcrição instantânea. Crie arquivos pesquisáveis de conversas ilimitadas e nunca mais perca discussões importantes.",
        benefits: {
      ...
      educators: {
        ...
        description: "Simplesmente cole links do YouTube para obter transcrições instantâneas e legendas automáticas. Transforme qualquer vídeo educacional em conteúdo acessível e pesquisável.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter: 'sem transcrição. Otter queria que eu escolhesse 3. TRÊS. NeverCap me deixou enviar todos os 150 episódios em um fim de semana."',
            name: "Mike Rodriguez",
            role: "Apresentador de Podcast"
          },
          jessica: {
            ...
            highlight: "$100/mês",
            textAfter: 'do Trint, mas também não consigo trabalhar com o limite de 10 arquivos por mês do Otter. NeverCap salvou minha carreira."',
            name: "Jessica Park",
            role: "Jornalista Freelancer"
          },
          sarah: {
    ...
    Podcasters: {
      ...
      heroSubtitle: "Envie todo seu catálogo. Crie notas de show para cada episódio. Chega de escolher quais episódios transcrever.",
      ...
      problems: {
        problem1: {
          ...
          description: "Otter oferece 3 importações vitalícias no gratuito, 10 por mês no Pro. Como transcrever 3 anos de episódios?"
        },
        problem2: {
          title: "Perdendo Oportunidades de SEO",
          description: "Cada episódio não transcrito é tráfego SEO perdido. Mas o Descript limita você a 30 horas/mês no máximo."
        },
        problem3: {
          title: "Custos Disparam com o Crescimento",
          description: "Conforme seu podcast cresce, os custos de transcrição disparam. Taxas extras de $2/hora tornam a expansão impossível."
        }
      },
      solutionTitle: "A",
      solutionTitleHighlight: "Solução NeverCap",
      solutionDescription: "Transcrição verdadeiramente ilimitada. Envie todo seu arquivo. Transcreva cada novo episódio. Gere notas de show em escala. Sem limites, apenas crescimento.",
      ...
      features: {
        feature1: {
          ...
          description: "Identifica e rotula automaticamente até 20 locutores. Perfeito para debates, entrevistas e programas com co-apresentadores."
        },
        feature2: {
          title: "Capítulos com Timestamp",
          description: "Gere timestamps clicáveis para descrições do YouTube. Permita que ouvintes saltem para seus segmentos favoritos instantaneamente."
        },
        feature3: {
          title: "Formatação Inteligente",
          description: "Adiciona parágrafos, frases e pontuação automaticamente. Obtenha transcrições limpas e legíveis. Economize horas na pós-produção."
        },
        feature4: {
          title: "Otimização SEO",
          description: "Transcrições formatadas para motores de busca. Aumente a visibilidade do seu podcast e alcance novos públicos."
        },
        feature5: {
          title: "100+ Idiomas",
          description: "Transcreva em qualquer idioma. Traduza para 249+ idiomas. Alcance audiências globais sem esforço."
        },
        feature6: {
          title: "Processamento em Lote",
          description: "Envie 50 episódios antes de dormir. Acorde com transcrições completas. Processe todo seu arquivo durante a noite."
        }
      },
    ...
    Journalists: {
      hero: {
        ...
        subtitle: "Pare de escolher quais entrevistas merecem transcrição. Carregue todas as gravações de uma vez, pesquise instantaneamente e cumpra prazos sem ansiedade.",
      ...
      problem: {
        ...
        problems: {
          uploadLimits: {
            ...
            description: "Otter oferece 10 importações/mês no Pro. Como transcrever 3 semanas de entrevistas investigativas?"
          },
          missingQuotes: {
            title: "Perdendo Citações Cruciais",
            description: "Cada entrevista não transcrita pode conter a citação-chave. Mas o Trint limita você a 50 horas/mês no máximo."
          },
          costExplosion: {
            title: "Custos Disparam com Prazos",
            description: "À medida que sua investigação avança, os custos de transcrição disparam. Taxas extras de $100/mês tornam as notícias urgentes impossíveis."
          }
        },
        solution: {
          title: "A",
          titleHighlight: "Solução NeverCap",
          description: "Transcrição verdadeiramente ilimitada. Envie toda a sua investigação. Transcreva cada entrevista. Pesquise todas as citações instantaneamente. Sem limites, apenas jornalismo."
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description: "Diferente de softwares com limites de minutos, você pode transcrever cada entrevista, desde uma conversa rápida até discussões de várias horas. Nunca se preocupe em ficar sem créditos no prazo.",
            points: {
          ...
          instantSearch: {
            ...
            description: "Receba sua transcrição de entrevista em minutos, não dias. Finalize matérias mais rápido que nunca. Nossa IA processa horas de áudio enquanto você toma um café.",
            points: {
          ...
          professionalAccuracy: {
            ...
            description: "Nossa IA fornece transcrições altamente precisas, garantindo que as citações que você publica sejam precisas e confiáveis. Transcrição de nível profissional que os editores confiam.",
            points: {
            ...
            ironclad: {
                  ...
                  description: "Oferecemos recursos de segurança robustos para proteger seus dados sensíveis de entrevista e fontes confidenciais. Criptografia de nível bancário mantém suas investigações seguras.",
                  points: {
      ...
      testimonials: {
        jessica: {
          quote: '"Fiquei com 3 anos de entrevistas não transcritas por limites de upload. O NeverCap me permitiu processar tudo em um fim de semana. Mudou tudo."',
          name: "Jessica Park",
    ...
    ContentCreators: {
      hero: {
        ...
        titleHighlight: "Sem Limites",
        titleSuffix: "1",
        subtitle: "Seja para transcrever um vídeo do YouTube, um vídeo do TikTok para reutilização ou descobrir como transcrever um vídeo do Facebook para texto, nossa plataforma faz tudo perfeitamente. Gere legendas em 100+ idiomas sem limites mensais - pura liberdade criativa.",
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description: "Nossa ferramenta simplifica como você transcreve conteúdo de vídeo. Para transcrever um vídeo do Instagram, basta colar o link. Para transcrever um vídeo do Vimeo em texto, faça o mesmo. Processe todo o histórico do seu canal em um fim de semana.",
          points: {
        ...
        globalReach: {
          ...
          title: "100+ Idiomas.",
          titleHighlight: "Sem Limites.",
          description: "Alcance audiências globais com tradução automática para 100+ idiomas. Gere legendas em vários idiomas simultaneamente. Sem custos extras, sem limites mensais de traduções.",
          points: {
        ...
        flexibleExport: {
          ...
          description: "Exporte no formato que funciona para seu fluxo de trabalho. De arquivos SRT para YouTube a VTT para players web, ou documentos editáveis para roteiros. Todas as exportações ilimitadas, todas incluídas em cada plano.",
          points: {
      ...
      testimonials: {
        ...
        carlos: {
          textBefore: "Eu crio conteúdo educacional em espanhol. NeverCap transcreve perfeitamente e",
          textAfter: "para maior alcance. Sem limites, apenas crescimento. Minhas visualizações triplicaram após adicionar legendas multilíngues.",
          highlight: "traduz para inglês",
          name: "Carlos Martinez",
        ...
        sarah: {
          ...
          textAfter: ". Eu tinha 500+ vídeos acumulados. O NeverCap me permitiu processar tudo em um final de semana. O impulso no SEO das legendas se pagou no primeiro mês.",
          highlight: "30 horas",
          name: "Sarah Lee",
        ...
        jake: {
          ...
          textAfter: "mudou o jogo. Não baixo mais nada. Basta colar, transcrever, pronto. Processar meus clipes de podcast para o TikTok nunca foi tão fácil.",
        ...
        yuki: {
          ...
          textAfter: ". O NeverCap me dá traduções ilimitadas. Meu público internacional cresceu 400% desde que comecei a usar legendas nativas adequadas.",
    ...
    Researchers: {
      ...
      heroSubtitle: "Pare de escolher quais grupos focais transcrever. Processe todos seus dados qualitativos com 96% de precisão e identificação perfeita de falantes - mesmo com 20 participantes falando ao mesmo tempo.",
      ...
      problemCard2Desc: "Cada entrevista não transcrita pode conter insights revolucionários. Mas o Rev cobra $2/minuto no mínimo.",
      problemCard3Title: "Verba de Bolsas Desaparece",
      problemCard3Desc: "À medida que seu conjunto de dados cresce, os custos de transcrição disparam. US$ 500 por grupo focal torna o dimensionamento impossível.",
      ...
      useCase1Desc: "Lida com 8-20 participantes com fala sobreposta. Identificação perfeita de falantes mesmo durante discussões acaloradas. Exporte diretamente para software de análise qualitativa.",
      useCase2Title: "Entrevistas em Profundidade",
      useCase2Desc: "Processe centenas de entrevistas individuais simultaneamente. Mantenha consistência em todo o seu conjunto de dados. Pesquise em todas as transcrições instantaneamente.",
      useCase3Title: "Pesquisa Clínica",
      useCase3Desc: "Opções compatíveis com HIPAA para entrevistas com pacientes. Transcrição precisa de terminologia médica. Manipulação segura de dados de saúde sensíveis.",
      useCase4Title: "Estudos Etnográficos",
      useCase4Desc: "Gravações em campo em ambientes naturais. Lida com ruídos de fundo e múltiplos falantes. Suporte para 100+ idiomas e dialetos.",
      ...
      useCase6Desc: "Preços acessíveis para estudantes com todos os recursos. Processe todo o seu conjunto de dados de forma econômica. Cumpra prazos apertados com processamento em lote.",
    ...
    BusinessTeams: {
      ...
      heroSubtitle: "Grave reuniões diretamente no seu navegador ou envie arquivos de áudio instantaneamente. Crie arquivos pesquisáveis de conversas ilimitadas. Nunca mais perca discussões importantes com transcrição verdadeiramente ilimitada.",
      ...
      feature1Desc: "Sem downloads, sem plugins. Comece a gravar instantaneamente com um clique. Qualidade de áudio perfeita, detecção automática de falantes.",
      ...
      feature2Desc: "Tem gravações do Zoom, Teams ou do seu telefone? Envie-as instantaneamente. Suporte para todos os principais formatos de áudio e vídeo. Processe vários arquivos simultaneamente sem espera.",
      ...
      feature3Desc: "Compartilhe transcrições com sua equipe instantaneamente. Ouça gravações juntos, exporte transcrições em vários formatos e garanta que todos permaneçam alinhados com arquivos de reunião pesquisáveis.",
      ...
      feature4Desc: "Pesquise em todas as suas reuniões de uma vez. Encontre aquela decisão crucial do último trimestre ou aquele requisito do cliente de meses atrás. A pesquisa com IA entende o contexto, não apenas palavras-chave.",
      ...
      workflowStep1Desc: "Comece a gravar ao vivo ou simplesmente baixe a gravação da reunião do Zoom, Google Meet ou Microsoft Teams",
      ...
      testimonial1Text: '"Passamos de perder detalhes cruciais para ter um arquivo pesquisável de todas as conversas. O recurso de gravação direta significa que nunca esquecemos de capturar discussões importantes."',
      testimonial1AuthorName: "James Kim",
      testimonial1AuthorRole: "Gerente de Produto, TechCorp",
      testimonial2Text: '"Otter nos limitava a 10 uploads de arquivos por mês. Agora carregamos todas as chamadas de clientes instantaneamente. Mudou o jogo para os acompanhamentos da nossa equipe de vendas."',
    ...
    Educators: {
      ...
      heroSubtitle: "Basta colar links do YouTube para obter transcrições instantâneas com legendas geradas automaticamente. Transforme palestras, tutoriais e vídeos educacionais em conteúdo pesquisável e acessível que todos os alunos podem aproveitar.",
      ...
      feature1Desc: "Basta colar qualquer link de vídeo e obter transcrições instantâneas. Funciona com YouTube, Vimeo, Facebook, X (Twitter), TikTok, Instagram, Dropbox, Google Drive e mais. Sem downloads, sem espera.",
      ...
      feature2Desc: "Crie legendas precisas instantaneamente para todos os seus vídeos educacionais. Torne o conteúdo acessível para alunos com deficiência auditiva, não nativos ou que preferem ler junto.",
      ...
      feature3Desc: "Crie pastas para organizar suas transcrições por curso, disciplina ou semestre. Mantenha todo seu conteúdo educacional organizado e facilmente pesquisável. Construa uma biblioteca abrangente de materiais de curso acessíveis.",
      ...
      feature4Desc: "Não apenas compartilhe gravações. Transcreva automaticamente aulas para texto e outros arquivos de áudio em guias de estudo detalhados, completos com resumos e conceitos-chave para revisão eficaz dos alunos. Exporte em formatos TXT, DOCX ou PDF.",
      ...
      useCase1Text: "Transcreva semestres inteiros de aulas gravadas. Os alunos podem buscar tópicos específicos, revisar conceitos-chave e nunca perder informações importantes.",
      useCase2Title: "Cursos Online",
      useCase2Text: "Torne seus cursos online acessíveis para estudantes internacionais com traduções em 100+ idiomas. Aumente matrículas e satisfação.",
      useCase3Title: "Materiais de Estudo",
      useCase3Text: "Use IA para transcrever arquivos de áudio em guias de estudo a partir de videoaulas. Perfeito para alunos que preferem ler ou precisam revisar conteúdo rapidamente com texto pesquisável.",
      useCase4Title: "Conformidade de Acessibilidade",
      useCase4Text: "Atenda requisitos de acessibilidade fornecendo legendas e transcrições para todo conteúdo em vídeo. Garanta acesso igualitário para todos os alunos.",
      useCase5Title: "Sala de Aula Invertida",
      useCase5Text: "Compartilhe videoaulas com transcrições antes da aula. Os alunos podem revisar no próprio ritmo e vir preparados para discussões.",
      useCase6Title: "Pesquisa & Citações",
      useCase6Text: "Ajude alunos a citar fontes em vídeo com precisão usando marcas de tempo. Perfeito para projetos de pesquisa e trabalhos acadêmicos.",
      testimonialTitle: "Confiado por",
      testimonialSubtitle: "Descubra por que professores do mundo todo escolhem o NeverCap",
      testimonialText: '"Uso o NeverCap para transcrever todo meu canal de tutoriais de matemática no YouTube. O que levava semanas com outros serviços agora leva horas. Poder colar links diretamente e obter transcrições instantâneas transformou como crio conteúdo acessível. Meus alunos internacionais adoram especialmente as legendas multilíngue!"',
  ...
  About: {
    Hero: {
      ...
      "description": "Nossa missão é fornecer os serviços de transcrição de áudio e vídeo mais precisos. Com tecnologia de IA líder do setor, alcançamos taxas de precisão acima de 96%. Para alguns idiomas principais, através de otimização técnica, podemos até atingir 99% de precisão."
    },
    Stats: {
      "title": "Nosso",
      "highlighted_text": "Impacto",
      "subtitle": "Capacitando a comunicação global com tecnologia de IA de ponta",
      "metrics": [
            {
              "value": "96%+",
    ...
    Mission: {
      ...
      "highlighted_text": "NeverCap",
      "subtitle": "Acreditamos em derrubar barreiras linguísticas e tornar o conteúdo acessível a todos",
      "features": [
            {
              "icon": "🎯",
    ...
    Company: {
      ...
      "subtitle": "Entre em contato conosco para dúvidas ou suporte",
      "details": [
            {
  ...
  Privacy: {
    ...
    "privacyPolicyTitle": "Política de Privacidade",
    "policyDescription": 'Esta Política descreve como o NeverCap (doravante denominado \"NeverCap\", \"nossa\", \"nós\", \"nos\") coleta, usa e divulga suas informações pessoais quando você usa nossos serviços, sites (https://www.nevercap.ai/) e softwares (coletivamente, os \"Serviços\").',
    "policyAgreement": "Por favor, leia esta Política de Privacidade com atenção e certifique-se de que a compreende. Ao usar qualquer um de nossos Serviços, você concorda com esta Política de Privacidade. Se você não concordar com o uso de seus dados pessoais de acordo com esta Política, deve interromper imediatamente o uso de nossos Serviços.",
    ...
    "scopeDescription": "Esta Política de Privacidade aplica-se apenas à nossa coleta e processamento de informações sobre usuários dos Serviços. Esta Política de Privacidade não se aplica a quaisquer serviços, sites ou softwares operados por terceiros que estejam vinculados a nós (sejam os links fornecidos por nós ou compartilhados por outros usuários), nem se aplica a conteúdo, dados, aplicativos ou materiais de terceiros. Aconselhamos que você verifique as políticas de privacidade de qualquer site ou software de terceiros antes de fornecer qualquer informação a eles.",
    ...
    "identityDescription": "Ao se inscrever em um de nossos produtos, solicitamos informações de identificação, como seu nome e endereço de e-mail. Isso é para fornecer funcionalidades essenciais do produto e para que possamos enviar atualizações e outras informações importantes.",
    "billingTitle": "2.2 Informações de cobrança",
    "billingDescription": "Se você se inscrever em um produto pago, será solicitado que forneça suas informações de pagamento e endereço de cobrança. As informações de pagamento são enviadas diretamente ao nosso processador de pagamentos e não chegam aos nossos servidores.",
    ...
    "websiteInteractionsDescription": "Coletamos informações sobre sua atividade de navegação para fins analíticos e estatísticos, como testes de taxa de conversão e experimentação com novos designs de produto. Isso inclui, por exemplo, versões do seu navegador e sistema operacional, seu endereço IP, quais páginas da web você visitou e quanto tempo levaram para carregar, e qual site o direcionou a nós. Se você tiver uma conta e estiver conectado, esses dados de análise da web estarão vinculados ao seu endereço IP e conta de usuário até que sua conta não esteja mais ativa.",
    "cookiesTitle": "2.5 Cookies",
    "cookiesDescription1": "Também usamos cookies persistentes de primeira parte e alguns cookies de terceiros para armazenar certas preferências, facilitar o uso de nossos aplicativos e realizar testes A/B, além de suportar algumas análises.",
    ...
    "correspondenceDescription": "Quando você nos envia um e-mail com uma pergunta ou pedido de ajuda, mantemos essa correspondência, incluindo seu endereço de e-mail, para que tenhamos um histórico de correspondências passadas para referência, caso você entre em contato no futuro.",
    "accessTitle": "3. Quando acessamos ou compartilhamos suas informações",
    "accessDescription1": "Para fornecer produtos ou serviços solicitados. Usamos alguns subprocessadores de terceiros para ajudar a executar nossos aplicativos e fornecer os Serviços a você. Isso inclui provedores de nuvem e análise.",
    "accessDescription2": "Para investigar, prevenir ou tomar medidas em relação a abusos. Acessar a conta de um cliente ao investigar possíveis abusos é um último recurso. Queremos proteger a privacidade e a segurança de nossos clientes e das pessoas que nos relatam problemas, e fazemos o possível para equilibrar essas responsabilidades durante todo o processo. Se descobrirmos que você está usando nossos produtos para fins restritos, tomaremos as medidas necessárias, incluindo notificar as autoridades apropriadas, quando justificado.",
    "accessDescription3": "Quando exigido por lei aplicável.",
    "dataRequests": "Solicitações de dados do usuário. Nossa política é não responder a solicitações governamentais de dados do usuário, a menos que sejamos obrigados por processo legal ou em circunstâncias limitadas em caso de solicitação de emergência. No entanto, se as autoridades policiais dos EUA tiverem o mandado necessário, intimação criminal ou ordem judicial exigindo que compartilhemos dados, devemos cumprir. Da mesma forma, só responderemos a solicitações de autoridades governamentais fora dos EUA se formos obrigados pelo governo dos EUA por meio de procedimentos descritos em um tratado ou acordo de assistência jurídica mútua. Nossa política é notificar os usuários afetados antes de compartilhar dados, a menos que sejamos legalmente proibidos de fazê-lo, exceto em alguns casos de emergência.",
    "preservationRequests": "Solicitações de preservação. Da mesma forma, nossa política é cumprir solicitações de preservação de dados apenas se obrigados pelo U.S. Federal Stored Communications Act, 18 U.S.C. Seção 2703(f), ou por uma intimação dos EUA devidamente servida para questões civis. Não compartilhamos dados preservados, a menos que exigido por lei ou por uma ordem judicial que optamos por não recorrer. Além disso, a menos que recebamos um mandado, ordem judicial ou intimação adequados antes do período de preservação expirar, destruiremos quaisquer cópias preservadas de dados do cliente no final do período de preservação.",
    "taxAudits": "Se formos auditados por uma autoridade fiscal, podemos ser obrigados a compartilhar informações relacionadas a cobrança. Se isso acontecer, compartilharemos apenas o mínimo necessário, como endereços de cobrança e informações de isenção fiscal.",
    ...
    "locationDescription": "Nossos produtos e outras propriedades web são operados nos Estados Unidos. Se você estiver localizado na União Europeia, Reino Unido ou em qualquer outro lugar fora dos Estados Unidos, esteja ciente de que qualquer informação que você nos fornecer será transferida e armazenada nos Estados Unidos. Ao usar nossos sites ou Serviços e/ou nos fornecer suas informações pessoais, você consente com essa transferência.",
    "childrenTitle": "7. Privacidade de crianças",
    "childrenDescription": "Os Serviços não são destinados a crianças, e não coletamos intencionalmente Informações Pessoais de crianças menores de 13 anos. Se você tem menos de 13 anos, por favor, não envie nenhuma informação pessoal através dos Serviços. Se você acredita que uma criança nos forneceu Informações Pessoais em violação a esta Política, entre em contato conosco conforme indicado abaixo.",
    "updatesTitle": "8. Atualizações desta Política de Privacidade",
    "updatesDescription": "Podemos atualizar esta política conforme necessário para cumprir regulamentações relevantes e refletir novas práticas. Sempre que fizermos uma alteração significativa em nossas políticas, atualizaremos a data no topo desta página.",
    "contactTitle": "9. Contate-nos",
    "contactDescription": "Se você tiver dúvidas, comentários ou reclamações sobre nossa Política de Privacidade, entre em contato conosco e nos esforçaremos para lidar com sua reclamação o mais rápido possível.",
  ...
  TermsOfUse: {
    ...
    "companyDefinition": 'Quando dizemos \"Empresa\", \"nós\", \"nosso\" ou \"nos\" neste documento, estamos nos referindo à NeverCap.',
    "servicesDefinition": 'Quando dizemos \"Serviços\", queremos dizer qualquer produto criado e mantido pela NeverCap, seja entregue em um navegador da web, aplicativo desktop, aplicativo móvel ou outro formato.',
    "termsUpdate": "Podemos atualizar estes Termos de Serviço no futuro. Normalmente, essas alterações são para esclarecer alguns termos vinculando a uma política relacionada expandida. Sempre que fizermos uma alteração significativa em nossas políticas, atualizaremos a data no topo desta página e tomaremos as medidas apropriadas para notificar os titulares de contas.",
    "acceptanceTitle": "1. Aceitação do Acordo",
    "acceptanceDescription1": "Ao usar nossos Serviços, você indica sua aceitação deste Acordo, que se torna um contrato vinculante entre você e a NeverCap. Você declara que está legalmente apto a aceitar estes Termos e afirma que tem idade legal para formar um contrato vinculante. A aceitação da NeverCap está expressamente condicionada à sua concordância com todos os termos e condições deste Acordo.",
    "eligibilityRequirement": "Os Serviços não são destinados e não devem ser usados por menores de 18 anos. Ao usar os Serviços, você declara e garante que atende ao requisito de elegibilidade acima.",
    "userResponsibility": 'Os termos \"você\", \"seu\", \"si mesmo\" também incluem seus funcionários, agentes, representantes comerciais e quaisquer outras pessoas que você conceda acesso aos Serviços através de sua Conta (conforme definido abaixo). Você é responsável por garantir que todas as pessoas que acessam os Serviços através de sua conta estejam cientes destes Termos e os cumpram.',
    "termsRevision": "A NeverCap reserva-se o direito de revisar e atualizar estes Termos periodicamente a seu critério. Todas as alterações são efetivas imediatamente após a publicação. Seu uso contínuo dos Serviços após a publicação dos Termos revisados significa que você aceita e concorda com as alterações. Espera-se que você verifique esta página periodicamente para estar ciente de quaisquer alterações, pois elas são vinculantes para você.",
    ...
    "contentResponsibility": "Você é responsável por todo o conteúdo postado e atividade que ocorre em sua conta. Isso inclui conteúdo postado por outras pessoas que: (a) têm acesso às suas credenciais de login; ou (b) têm seus próprios logins em sua conta.",
    ...
    "taxes": "Todas as taxas são exclusivas de impostos, taxas ou deveres impostos por autoridades fiscais. Quando exigido, cobraremos esses impostos em nome da autoridade fiscal e os remeteremos às autoridades fiscais. Caso contrário, você é responsável pelo pagamento de todos os impostos, taxas ou deveres.",
    "refunds": "Todas as compras não são reembolsáveis. Você pode cancelar quaisquer serviços pagos a qualquer momento fazendo login em sua conta. Para assinaturas pagas, seu cancelamento terá efeito no final do período pago atual, salvo indicação em contrário.",
    "cancellationTitle": "5. Cancelamento e Rescisão",
    "cancellationPolicy": "Se você cancelar o Serviço antes do final de qualquer período pago, seu cancelamento terá efeito imediato e você não será cobrado novamente. Não fazemos rateio automático do tempo não utilizado no último ciclo de faturamento.",
    "terminationRights": "Temos o direito de suspender ou encerrar sua conta e recusar qualquer uso atual ou futuro de nossos Serviços por qualquer motivo a qualquer momento. Suspensão significa que você não poderá acessar a conta ou qualquer conteúdo nela. A rescisão resultará ainda na exclusão de sua conta ou de seu acesso à conta e no perdão e renúncia de todo o conteúdo em sua conta. Também reservamos o direito de recusar o uso dos Serviços a qualquer pessoa por qualquer motivo a qualquer momento. Temos esta cláusula porque, estatisticamente falando, entre centenas de milhares de contas em nossos Serviços, há pelo menos uma fazendo algo nefasto.",
    "abusePolicy": "Abuso verbal, físico, escrito ou outro (incluindo ameaças de abuso ou retribuição) a um funcionário ou diretor da Empresa pode resultar no encerramento imediato da conta.",
    "submissionsTitle": "6. Submissões",
    "submissionsDescription": 'Você reconhece e concorda que quaisquer perguntas, comentários, sugestões, ideias, feedback ou outras informações sobre o Site (\"Submissões\") fornecidas por você a nós são não confidenciais e se tornarão nossa propriedade exclusiva. Teremos direitos exclusivos, incluindo todos os direitos de propriedade intelectual, e teremos direito ao uso e disseminação irrestritos dessas Submissões para qualquer finalidade lícita, comercial ou não, sem reconhecimento ou compensação a você. Você renuncia a todos os direitos morais sobre quaisquer Submissões e garante que tais Submissões são originais ou que você tem o direito de enviá-las. Você concorda que não haverá recurso contra nós por qualquer alegada ou real violação ou apropriação indevida de qualquer direito proprietário em suas Submissões.',
    "uptimeTitle": "7. Disponibilidade e Segurança",
    "serviceAvailability": 'Seu uso dos Serviços é por sua conta e risco. Fornecemos estes Serviços \"no estado em que se encontram\" e \"conforme disponíveis\". Não oferecemos acordos de nível de serviço para a maioria de nossos Serviços, mas levamos a sério a disponibilidade de nossas aplicações.',
    "throttlingPolicy": "Reservamo-nos o direito de limitar temporariamente o acesso à conta em casos raros em que a atividade de um usuário seja verificada como impactando negativamente a estabilidade e o desempenho do Serviço para outros usuários. Na maioria dos casos, entraremos em contato com você para encontrar uma solução antes de agir.",
    "dataSecurity": "Tomamos várias medidas para proteger e garantir seus dados por meio de backups, redundâncias e criptografia. Aplicamos criptografia para transmissão de dados pela Internet pública.",
    "thirdPartyVendors": "Usamos fornecedores terceirizados e parceiros de hospedagem para fornecer o hardware, software, rede, armazenamento e tecnologia relacionados necessários para executar os Serviços.",
    "siteManagementTitle": "8. Gerenciamento do Site",
    "siteManagementDescription": "Reservamo-nos o direito, mas não a obrigação, de: (1) monitorar o Site quanto a violações destes Termos de Serviço; (2) tomar as medidas legais apropriadas contra qualquer pessoa que, a nosso critério, viole a lei ou estes Termos de Serviço, incluindo, sem limitação, relatar tal usuário às autoridades policiais; (3) a nosso critério e sem limitação, recusar, restringir o acesso, limitar a disponibilidade ou desativar (na medida tecnicamente viável) qualquer de suas Contribuições ou parte delas; (4) a nosso critério e sem aviso prévio ou responsabilidade, remover do Site ou desativar todos os arquivos e conteúdos que sejam excessivamente grandes ou de qualquer forma onerosos para nossos sistemas; e (5) gerenciar o Site de forma a proteger nossos direitos e propriedade e facilitar o funcionamento adequado do Site.",
    "copyrightTitle": "9. Direitos Autorais e Propriedade de Conteúdo",
    "copyrightCompliance": "Todo o conteúdo postado nos Serviços deve estar em conformidade com a lei de direitos autorais dos EUA.",
    ...
    "contentModeration": "Não pré-selecionamos conteúdo, mas reservamo-nos o direito (mas não a obrigação) de recusar ou remover qualquer conteúdo disponível via Serviço a nosso critério.",
    "trademarkProtection": "Os nomes, aparência e identidade dos Serviços são protegidos por direitos autorais© da Empresa. Todos os direitos reservados. Você não pode duplicar, copiar ou reutilizar qualquer parte do HTML, CSS, JavaScript ou elementos de design visual sem permissão por escrito da Empresa. Você deve solicitar permissão para usar o logotipo da Empresa ou qualquer logotipo dos Serviços para fins promocionais. Envie-nos um e-mail para solicitar o uso de logotipos. Reservamo-nos o direito de revogar esta permissão se você violar estes Termos de Serviço.",
    "prohibitedExploitation": "Você concorda em não reproduzir, duplicar, copiar, vender, revender ou explorar qualquer parte dos Serviços, uso dos Serviços ou acesso aos Serviços sem permissão por escrito da Empresa.",
    "impersonationProhibition": "Você não deve modificar outro site para falsamente implicar que está associado aos Serviços ou à Empresa.",
    "dmcaPolicy": "Respeitamos os direitos de propriedade intelectual de terceiros. Se você acredita que qualquer material disponível no Site ou através dele infringe qualquer direito autoral que você possui ou controla, entre em contato conosco imediatamente. Uma cópia de sua Notificação será enviada à pessoa que postou ou armazenou o material em questão. Esteja ciente de que, de acordo com a lei aplicável, você poderá ser responsabilizado por danos se fizer declarações falsas em uma Notificação. Portanto, se não tiver certeza de que o material localizado ou vinculado pelo Site infringe seus direitos autorais, considere primeiro entrar em contato com um advogado.",
    "prohibitedActivitiesTitle": "10. Atividades Proibidas",
    "generalProhibition": "Você não pode acessar ou usar o Site para qualquer finalidade que não seja aquela para a qual disponibilizamos o Site. O Site não pode ser usado em conexão com qualquer empreendimento comercial, exceto aqueles que são especificamente endossados ou aprovados por nós.",
    "userObligations": "Como usuário do Site, você concorda em não:",
    "dataScraping": "Recuperar sistematicamente dados ou outros conteúdos do Site para criar ou compilar, direta ou indiretamente, uma coleção, compilação, banco de dados ou diretório sem permissão por escrito nossa.",
    "fraud": "Enganar, fraudar ou induzir em erro a nós e a outros usuários, especialmente em qualquer tentativa de obter informações confidenciais da conta, como senhas de usuário.",
    "securityInterference": "Contornar, desativar ou interferir de qualquer forma nos recursos de segurança do Site, incluindo recursos que previnam ou restrinjam o uso ou cópia de qualquer Conteúdo ou imponham limitações ao uso do Site e/ou do Conteúdo nele contido.",
    "defamation": "Difamar, manchar ou, em nossa opinião, prejudicar a nós e/ou ao Site.",
    "harassment": "Usar qualquer informação obtida do Site para assediar, abusar ou prejudicar outra pessoa.",
    "supportAbuse": "Fazer uso indevido de nossos serviços de suporte ou enviar relatórios falsos de abuso ou má conduta.",
    "legalCompliance": "Usar o Site de maneira inconsistente com quaisquer leis ou regulamentos aplicáveis.",
    "framingProhibition": "Participar de enquadramento não autorizado ou vinculação ao Site.",
    "malware": "Fazer upload ou transmitir (ou tentar fazer upload ou transmitir) vírus, cavalos de Troia ou outro material, incluindo o uso excessivo de letras maiúsculas e spam (postagem contínua de texto repetitivo), que interfira no uso e aproveitamento ininterrupto do Site por qualquer parte ou modifique, prejudique, interrompa, altere ou interfira no uso, recursos, funções, operação ou manutenção do Site.",
    "automation": "Participar de qualquer uso automatizado do sistema, como usar scripts para enviar comentários ou mensagens, ou usar qualquer mineração de dados, robôs ou ferramentas semelhantes de coleta e extração de dados.",
    "copyrightRemoval": "Excluir o aviso de direitos autorais ou outros direitos de propriedade de qualquer Conteúdo.",
    "impersonation": "Tentar se passar por outro usuário ou pessoa ou usar o nome de usuário de outro usuário.",
    "spyware": 'Fazer upload ou transmitir (ou tentar fazer upload ou transmitir) qualquer material que funcione como um mecanismo de coleta ou transmissão de informações passivo ou ativo, incluindo, sem limitação, formatos de intercâmbio de gráficos claros (\"gifs\"), pixels 1×1, web bugs, cookies ou outros dispositivos semelhantes (às vezes referidos como \"spyware\" ou \"mecanismos de coleta passiva\" ou \"pcms\").',
    "disruption": "Interferir, interromper ou criar um fardo indevido no Site ou nas redes ou serviços conectados ao Site.",
    "employeeHarassment": "Assediar, incomodar, intimidar ou ameaçar qualquer de nossos funcionários ou agentes envolvidos na prestação de qualquer parte do Site a você.",
    "accessCircumvention": "Tentar contornar quaisquer medidas do Site projetadas para prevenir ou restringir o acesso ao Site ou a qualquer parte do Site.",
    "codeCopying": "Copiar ou adaptar o software do Site, incluindo, mas não se limitando a Flash, PHP, HTML, JavaScript ou outro código.",
    "reverseEngineering": "Exceto conforme permitido pela lei aplicável, decifrar, descompilar, desmontar ou fazer engenharia reversa de qualquer software que compõe ou de qualquer forma faz parte do Site.",
    "bots": "Exceto como pode ser o resultado do uso padrão de mecanismo de busca ou navegador de Internet, usar, lançar, desenvolver ou distribuir qualquer sistema automatizado, incluindo, sem limitação, qualquer spider, robô, utilitário de trapaça, scraper ou leitor offline que acesse o Site, ou usar ou lançar qualquer script não autorizado ou outro software.",
    "buyingAgents": "Usar um agente de compras ou agente de compra para fazer compras no Site.",
    "unauthorizedUse": "Fazer qualquer uso não autorizado do Site, incluindo coletar nomes de usuário e/ou endereços de e-mail de usuários por meios eletrônicos ou outros para o envio de e-mails não solicitados, ou criar contas de usuário por meios automatizados ou sob falsos pretextos.",
    "competition": "Usar o Site como parte de qualquer esforço para competir conosco ou usar o Site e/ou o Conteúdo para qualquer empreendimento gerador de receita ou empresa comercial.",
    "advertising": "Usar o Site para anunciar ou oferecer a venda de bens e serviços.",
    "profileTransfer": "Vender ou transferir seu perfil.",
    "featuresTitle": "11. Recursos e Bugs",
    "featuresDescription": "Projetamos nossos Serviços com cuidado, com base em nossa própria experiência e nas experiências de clientes que compartilham seu tempo e feedback. No entanto, não existe um serviço que agrade a todos. Não garantimos que nossos Serviços atendam aos seus requisitos ou expectativas específicos.",
    "bugsDescription": "Também testamos todos os nossos recursos antes de lançá-los. Como qualquer software, nossos Serviços inevitavelmente têm alguns bugs. Acompanhamos os bugs relatados e trabalhamos neles, especialmente os relacionados a segurança ou privacidade. Nem todos os bugs relatados serão corrigidos e não garantimos Serviços completamente livres de erros.",
    "correctionsTitle": "12. Correções",
    "informationAccuracy": "Pode haver informações no Site que contenham erros tipográficos, imprecisões ou omissões, incluindo descrições, preços, disponibilidade e várias outras informações. Reservamo-nos o direito de corrigir quaisquer erros, imprecisões ou omissões e de alterar ou atualizar as informações no Site a qualquer momento, sem aviso prévio.",
    "siteAvailability": "Não podemos garantir que o Site estará disponível o tempo todo. Podemos enfrentar problemas de hardware, software ou outros ou precisar realizar manutenção relacionada ao Site, resultando em interrupções, atrasos ou erros. Reservamo-nos o direito de alterar, revisar, atualizar, suspender, descontinuar ou modificar o Site a qualquer momento ou por qualquer motivo, sem aviso prévio. Você concorda que não temos qualquer responsabilidade por qualquer perda, dano ou inconveniente causado pela sua incapacidade de acessar ou usar o Site durante qualquer tempo de inatividade ou descontinuação do Site. Nada nestes Termos de Serviço será interpretado como nos obrigando a manter e apoiar o Site ou a fornecer quaisquer correções, atualizações ou lançamentos em conexão com ele.",
    "userDataTitle": "13. Dados do Usuário",
    "userDataDescription": "Manteremos certos dados que você transmitir ao Site para gerenciar o desempenho do Site, bem como dados relacionados ao seu uso do Site. Embora façamos backups rotineiros de dados, você é o único responsável por todos os dados que transmite ou que estão relacionados a qualquer atividade que você realizou usando o Site. Você concorda que não teremos qualquer responsabilidade para com você por qualquer perda ou corrupção de tais dados, e você renuncia a qualquer direito de ação contra nós decorrente de qualquer perda ou corrupção de tais dados.",
    "privacyPolicyTitle": "14. Política de Privacidade",
    "privacyPolicyDescription": "Nós nos preocupamos com a privacidade e segurança dos dados. Por favor, revise nossa Política de Privacidade. Ao usar o Site, você concorda em estar vinculado à nossa Política de Privacidade, que está incorporada a estes Termos de Serviço. Observe que o Site está hospedado nos Estados Unidos. Se você acessar o Site de qualquer outra região do mundo com leis ou outros requisitos que regem a coleta, uso ou divulgação de dados pessoais diferentes das leis aplicáveis nos Estados Unidos, então, ao continuar a usar o Site, você está transferindo seus dados para os Estados Unidos e concorda que seus dados sejam transferidos e processados nos Estados Unidos.",
    "liabilityTitle": "15. Responsabilidade",
    "liabilityIntroduction": "Mencionamos responsabilidade ao longo destes Termos, mas para resumir em uma seção:",
    "liabilityWaiver": "Você entende e concorda expressamente que a Empresa não será responsável, em lei ou em equidade, para você ou para qualquer terceiro por quaisquer danos diretos, indiretos, incidentais, lucros cessantes, especiais, consequenciais, punitivos ou exemplares, incluindo, mas não se limitando a, danos por perda de lucros, boa vontade, uso, dados ou outras perdas intangíveis (mesmo que a Empresa tenha sido avisada da possibilidade de tais danos), resultantes de: (1) o uso ou a incapacidade de usar os Serviços; (2) erros, enganos ou imprecisões de conteúdo e materiais; (3) lesão pessoal ou dano à propriedade, de qualquer natureza, resultante do seu acesso e uso do site; (4) o custo de obtenção de bens e serviços substitutos resultantes de quaisquer bens, dados, informações ou serviços comprados ou obtidos ou mensagens recebidas ou transações realizadas através ou a partir dos Serviços; (5) qualquer acesso não autorizado ou uso de nossos servidores seguros e/ou quaisquer e todas as informações pessoais e/ou financeiras armazenadas neles; (6) qualquer interrupção ou cessação de transmissão para ou a partir do site; (7) quaisquer bugs, vírus, cavalos de Troia ou similares que possam ser transmitidos ao ou através do site por qualquer terceiro, e/ou; (8) quaisquer erros ou omissões em qualquer conteúdo e materiais ou por qualquer perda ou dano de qualquer tipo incorrido como resultado do uso de qualquer conteúdo postado, transmitido ou disponibilizado através do site; (9) declarações ou conduta de qualquer terceiro no serviço; (10) ou qualquer outro assunto relacionado a estes Termos de Serviço ou aos Serviços, seja como violação de contrato, delito (incluindo negligência, seja ativa ou passiva), ou qualquer outra teoria de responsabilidade.",
    "miscellaneousTitle": "16. Disposições Diversas",
    "miscellaneousDescription": "Estes Termos de Serviço e quaisquer políticas ou regras operacionais publicadas por nós no Site ou em relação ao Site constituem o acordo e entendimento integral entre você e nós. Nossa falha em exercer ou fazer valer qualquer direito ou disposição destes Termos de Serviço não operará como uma renúncia a tal direito ou disposição. Estes Termos de Serviço operam na máxima extensão permitida por lei. Podemos atribuir quaisquer ou todos os nossos direitos e obrigações a outros a qualquer momento. Não seremos responsáveis ou responsabilizados por qualquer perda, dano, atraso ou falha em agir causada por qualquer causa além do nosso controle razoável. Se qualquer disposição ou parte de uma disposição destes Termos de Serviço for considerada ilegal, nula ou inexequível, essa disposição ou parte da disposição será considerada separável destes Termos de Serviço e não afetará a validade e exequibilidade das demais disposições. Nenhuma joint venture, parceria, emprego ou relação de agência é criada entre você e nós como resultado destes Termos de Serviço ou uso do Site. Você concorda que estes Termos de Serviço não serão interpretados contra nós em virtude de tê-los redigido. Você renuncia a quaisquer e todas as defesas que possa ter com base na forma eletrônica destes Termos de Serviço e na falta de assinatura pelas partes para executar estes Termos de Serviço.",
    "contactTitle": "17. Contate-nos",
    "contactDescription": "Se você tiver alguma dúvida sobre qualquer um dos Termos de Serviço, por favor, entre em contato conosco.",
    "neverCap": "NeverCap",
    "site": "Site",
    "services": "Serviços"
  }
