...
let message = {
  ...
  HomePage: {
    ...
    tour: {
      step0: {
        ...
        tip: "Aquí puedes:",
        content: "Transcribir conversaciones puntuales, reuniones, conferencias y más",
        next: "Comenzar"
      },
      step1: {
        title: "Transcribir archivos",
        content: "Soporta tres métodos de transcripción: archivos locales, enlaces y grabaciones."
      },
      step2: {
        title: "Crear una carpeta",
        content: 'Haz clic en el "+" para crear una carpeta y organizar tus archivos.'
      },
      step3: {
        title: "Ver detalles de la transcripción y editar",
        content: "Haga clic en el elemento para ver los detalles de la transcripción y editarlo y traducirlo también."
      },
      next: "Siguiente",
      finish: "Entendido"
    },
    ...
    welcome: {
      ...
      precision: "Obtén transcripciones precisas con identificación de hablantes y marcas de tiempo al instante.",
      translate: "Rompe las barreras del idioma: traduce transcripciones a más de 200 idiomas con facilidad.",
  ...
  FolderPage: {
    ...
    endRecord: {
      title: "Aviso",
      content: "Estás grabando. Esta acción terminará la grabación. ¿Quieres terminar la grabación?",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      delete: "Eliminar",
      transcribe: "Transcribir",
      permissionDenied: "Permiso de micrófono denegado o el dispositivo no existe",
      dialog: {
        delete: {
          title: "Advertencia",
        ...
        complete: {
          ...
          label: "La grabación ha alcanzado las 10 horas y se ha detenido automáticamente. Por favor, transcribe.",
          confirm: "Entendido"
        },
        speaker: {
          content:
    ...
    upload: {
      link: {
        ...
        cancel: "Cancelar",
        // 请输入正确的链接
        errorTitle: "La dirección del enlace que ingresaste es incorrecta. Por favor, verifica e inténtalo de nuevo.",
        linkName: "Enlace"
      },
      file: {
      ...
      del: {
        title: "Advertencia",
        content: "Todo el progreso se perderá. ¿Confirmar la cancelación de la transcripción?",
      ...
      shareFilePublicly: "Compartir un archivo públicamente",
      retry: "Reintentar",
      edit: "Editar",
      delete: "Eliminar",
      updateAndRetry: "Actualizar y Reintentar"
    }
  },
  // 转录详情页
  TranscriptionPage: {
    ...
    showMoreTimestamp: "Mostrar marca de tiempo detallada",
    selectMoreTimestamp: "Marca de tiempo detallada",
    hideTimestamp: "Ocultar marca de tiempo",
    showSpeaker: "Hablante",
    ...
    createANewSpeaker: "Crear nuevo hablante",
    ...
    applyToCurrentParagraph: "Aplicar al párrafo actual",
    speakerDuplicate: "El hablante ya existe.",
    ...
    shareTips: "Cualquiera con este enlace puede ver la transcripción y reproducir el archivo multimedia.",
    copyLink: "Copiar enlace",
    copySuccessful: "Copia exitosa",
    copyFail: "Copia fallida",
    closeTrans: "Cancelar traducción",
    upgradeBtn: "Actualizar ahora para desbloquear",
    upgradeTip30: "Desbloquea tu transcripción completa",
    upgradeTipMore: "¡Buenas noticias! Tu archivo completo está transcrito.",
    errorTips: "Algo salió mal.",
    copiedLink: "Enlace copiado",
    copyGotIt: "Entendido",
    upgradeMinPreview: "Actualiza para ver más allá de la vista previa de 30 minutos.",
    silentTip: "No hay audio en el archivo. Verifica e inténtalo de nuevo.",
    outLimit: "Archivo excede límite de duración",
    outLimitTip1: "Las cuentas gratuitas admiten archivos de hasta 30 minutos.",
    outLimitTip2: "¡Regístrate para actualizar y desbloquear el texto transcrito completo ahora!"
  },
  // 登录、注册、修改密码
  IdentityInfoManage: {
    or: "o", // 或
    ...
    logInDirectly: "Esta cuenta ya existe. Por favor, inicia sesión directamente.", // 账户已存在，请直接登录
    ...
    tip: "Consejo",
    tipContentEmail: "Acabamos de enviar la contraseña de acceso de su cuenta a su correo electrónico.",
    tipContentPassword:
  ...
  AccountSettingsPage: {
    ...
    unlimitedNumberOfTimes: "Frecuencia y duración de transcripción ilimitadas.",
    filesUploadedAtOnce: "Cada archivo puede durar hasta 10 horas/5 GB. Sube 50 archivos a la vez.",
    highestPriority: "máxima prioridad",
    weWillGiveTheHighest: "Siempre transcribiremos tus archivos lo antes posible con la máxima prioridad.",
    ...
    automaticRenewal: "Renovación automática fallida, por favor verifique el método de pago.",
    eachYear: "Renovación automática el {time} cada año.",
    returnAccountSetting: "Volver",
    needsToWaitLonger: "Espere un poco más antes de que sus archivos sean transcritos.",
    freeThreeTimesDay: "Transcribe 3 archivos gratis cada día.",
    oneFileUploaded: "Cada archivo puede tener una duración de hasta 30 minutos. Sube 1 archivo a la vez.",
  ...
  demo: {
    ...
    waitlist: {
      cardTitle: "¡Únete a la lista de espera y recibe primero las últimas noticias y descuentos de NuxtPro!",
      placeholder: "Introduce tu correo electrónico",
      button: "Unirse a la lista de espera",
      joinCountMessage: "🔥 ¡El usuario temprano #{count} acaba de unirse a la lista de espera!"
    },
    seo: {
  ...
  videoLang: {
    ...
    HAVE_FUTURE_DATA: "Actualmente y al menos un fotograma de datos está disponible",
    HAVE_ENOUGH_DATA: "Los datos disponibles son suficientes para comenzar a reproducir",
    NETWORK_EMPTY: "El audio/video no ha sido inicializado",
    NETWORK_IDLE: "El audio/video está activo y se han seleccionado recursos, pero no se utiliza la red",
  ...
  privacyPolicy: {
    ...
    servicesDefinition: ', y software (colectivamente, los "Servicios").',
    policyAgreement:
    ...
    collectPrinciple: "Nuestro principio rector es recolectar solo lo necesario. Esto significa en la práctica:",
    ...
    sslTlsLink: "SSL/TLS",
    secureDataContent2: "cuando se transmiten desde nuestros servidores a su navegador.",
    deleteContentContent: "Si elimina cualquier contenido, éste quedará inmediatamente inaccesible.",
    locationContent:
    ...
    contactUsContent1: "Si tiene alguna pregunta, comentario o queja sobre nuestra Política de Privacidad, por favor",
    contactUs: "Contáctanos",
    contactUsContent2: "y nos esforzaremos por atender su queja lo antes posible."
  },
  termsOfService: {
    ...
    accountTerms2: "- No puede utilizar los Servicios para ningún propósito ilegal, poco ético o inmoral.",
    accountTerms3:
    ...
    prohibitedActivitiesUserAgreement: "Como usuario del Sitio, usted acepta no:",
    prohibitedActivity1:
    ...
    prohibitedActivity7: "- Utilizar el Sitio de una manera incompatible con las leyes o reglamentaciones aplicables.",
    prohibitedActivity8: "- Participar en la creación de marcos o enlaces no autorizados al Sitio.",
    prohibitedActivity9:
    ...
    prohibitedActivity20: "- Utilizar un agente de compras o agente de compras para realizar compras en el Sitio.",
    ...
    prohibitedActivity23: "- Utilizar el Sitio para publicitar u ofrecer vender bienes y servicios.",
    prohibitedActivity24: "- Vender o transferir de cualquier otra forma su perfil.",
    featuresContent1:
    ...
    privacyPolicyContent1: "Nos preocupamos por la privacidad y seguridad de los datos. Por favor, revise nuestra",
    ...
    contactUsContent1: "Si tiene alguna pregunta sobre cualquiera de los Términos de Servicio, por favor",
    contactUsContent2: "."
  },
  HeadNavbar: {
    ...
    VideoTranscription: "Transcripción de Video",
    Other: "Otro",
    mp4Transcription: "Transcripción MP4",
  ...
  Footer: {
    ...
    Resources: "Recursos",
    resourcesMenus: ["YouTube a MP4","YouTube a MP3","Transcripción de Video","Transcripción MP4","Transcripción de YouTube"]
  },
  Index: {
    Hero: {
      ...
      subtitleA:
        "La IA de NeverCap transcribe video y convierte audio a texto, procesando 50 archivos a la vez sin límite mensual. Transcripción que se adapta a tus necesidades."
    },
    Stats: {
    ...
    FeaturesGrid: {
      ...
      transparency:
        "No Más Límites Ocultos, No Más Sorpresas - Mientras otros reducen tus minutos en silencio o esconden límites en letra pequeña, creemos en la transparencia radical",
      feat_unltd: "Realmente Ilimitado",
      feat_unltd_desc:
        'Sin "política de uso justo" enterrada en los términos. Sin límites de almacenamiento disfrazados de "ilimitado". Sube todo tu archivo, transcribe todo para todas tus necesidades de transcripción de audio. Lo decimos en serio.',
      feat_bulk: "Libertad de Carga Masiva",
      feat_bulk_desc:
        '¿Cansado de "3 importaciones de por vida" o "10 archivos al mes"? Sube 50 archivos a la vez, tantas veces como necesites. Perfecto para procesar acumulados.',
      feat_batch: "Procesamiento por Lotes",
      feat_batch_desc:
        "Procesa toda tu temporada de podcast en una noche. Sube 50 entrevistas a la vez. Deja que nuestra IA trabaje mientras duermes. Despierta con transcripciones completas.",
      feat_accuracy: "96% de Precisión",
      feat_accuracy_desc:
        "Nuestra IA líder en la industria transcribe audio con puntuación inteligente, diarización de hasta 20 hablantes, y maneja acentos y términos técnicos sin errores.",
      feat_langs: "100+ Idiomas",
      feat_langs_desc:
        "Transcribe video y audio en 100+ idiomas, traduce a 249+. Sin cargos adicionales por diferentes idiomas. Contenido global, un precio simple.",
      feat_pro: "Características Profesionales",
      feat_pro_desc:
        "Marcas de tiempo a nivel de palabra para posicionamiento preciso de audio/video, identificación exacta de hablantes incluso durante cambios rápidos de conversación, y texto perfectamente formateado con párrafos, oraciones y puntuación para fácil lectura.",
      features: "Características"
    },
    UseCases: {
      built_for: "Masivo",
      ...
      join_users:
        'Diseñado para Usuarios Intensivos Como Tú - Únete a YouTubers, creadores de contenido y podcasters que cambiaron de servicios con "shrinkflation"',
      podcasters: {
        title: "Podcasters",
      ...
      questions: [
        {
          ...
          answer:
            "La transcripción por IA es el proceso de convertir automáticamente audio a texto usando inteligencia artificial avanzada. En NeverCap, simplemente subes tus archivos y nuestra IA transcribe el contenido con hasta un 96% de precisión. Nuestro servicio está diseñado para transcribir archivos de video (como MP4, MOV) y audio (como MP3, WAV) en texto legible y editable, con etiquetas de hablantes y marcas de tiempo."
        },
        {
          q: "unlimited_policy",
          question: "¿Es realmente ilimitado? ¿Cuál es el truco?",
          answer:
            "¡Sí, es verdaderamente ilimitado! Sin límites mensuales de minutos, sin cargos adicionales. Los únicos límites son técnicos: los archivos individuales pueden durar hasta 10 horas o pesar 5GB, y puedes procesar 50 archivos a la vez. Pero puedes subir tantos lotes como quieras, todo el mes."
        },
        {
          q: "accuracy",
          question: "¿Qué tan precisa es la transcripción?",
          answer:
            "Garantizamos un 96% de precisión para audio claro. Nuestra IA está entrenada con millones de horas de contenido diverso y maneja acentos, términos técnicos y múltiples hablantes excepcionalmente bien. Para audio difícil, nuestras funciones de mejora inteligente ayudan a mejorar los resultados."
        },
        {
          q: "languages",
          question: "¿Qué idiomas admiten?",
          answer:
            "Admitimos transcripción en más de 100 idiomas, incluyendo inglés, español, mandarín, hindi, árabe, francés y más. Además, puedes traducir tus transcripciones a 249 idiomas diferentes, ideal para contenido global."
        },
        {
          q: "speed",
          question: "¿Qué tan rápida es la transcripción?",
          answer:
            "¡Rápido como un rayo! Un archivo de audio de 1 hora suele procesarse en menos de 5 minutos. Con el procesamiento por lotes, puedes subir 50 archivos simultáneamente y procesarlos en paralelo. La mayoría de los usuarios encuentran toda su biblioteca transcrita al despertar."
        },
        {
          q: "cancellation",
          question: "¿Puedo cancelar en cualquier momento?",
          answer:
            "¡Absolutamente! Sin contratos, sin cargos por cancelación. Puedes mejorar, reducir o cancelar tu suscripción en cualquier momento desde tu panel. Si cancelas, conservarás el acceso hasta el final de tu período de facturación."
        },
        {
          q: "security",
          question: "¿Mis datos están seguros?",
          answer:
            "Tu seguridad es nuestra prioridad. Estamos certificados SOC 2, usamos cifrado de 256 bits para todos los datos y nunca usamos tu contenido para entrenar nuestros modelos. Puedes eliminar tus archivos en cualquier momento, y los borramos automáticamente después de 30 días. Cumplimos con GDPR y CCPA."
        },
        {
          q: "export_formats",
          question: "¿Qué formatos de exportación están disponibles?",
          answer:
            "Descarga tus transcripciones en el formato que necesites: PDF, Word (DOCX), Excel, CSV, subtítulos SRT, texto plano (TXT) y subtítulos VTT. Perfecto para cualquier flujo de trabajo."
        },
        {
          q: "file_formats",
          question: "¿Qué archivos de audio y video puedo subir?",
          answer:
            "Admitimos prácticamente todos los formatos de audio y video que encontrarás: MP3, MP4, M4A, MOV, AAC, WAV, OGG, OPUS, MPEG, WMA, WMV y más. Si puedes reproducirlo, podemos transcribirlo."
        }
      ]
    },
    CTASection: {
      ...
      disclaimer:
        "No se requiere tarjeta de crédito para el Plan Gratis • Actualiza en cualquier momento para acceso ilimitado"
    }
  },
  Features: {
    UnlimitedTranscription: {
      ...
      feature1Description:
        "Deja de contar minutos. Deja de vigilar límites. Ya sea que transcribas 10 horas o 10,000 al mes, pagas la misma tarifa plana. Sin cargos extra. Sin facturas sorpresa.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Otter te da 3 importaciones de por vida en gratis, 10 al mes en Pro. Nosotros te damos ilimitadas. Sube tu backlog de podcasts, todas tus entrevistas, años de grabaciones. Sin restricciones.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        '"Pago $100/año por Otter y me limitan a 10 importaciones de archivos al mes. ¡En cuanto haya una alternativa con importaciones ilimitadas, me voy!" - Usuario real de Reddit',
      feature3Point1Icon: "✓",
    ...
    BulkUpload: {
      ...
      heroSubtitle:
        "Otter te da 3 importaciones de por vida. TRES. Para toda tu vida. Nosotros te damos cargas ilimitadas, 50 archivos a la vez, cuando lo necesites.",
      primaryCta: "Comenzar Carga Masiva →",
      secondaryCta: "Ver los Límites",
      redditQuote:
        '"Tengo 3 años de episodios de podcast para transcribir. Otter me dice que tengo 3 importaciones de por vida. TRES. Esto es insultante."',
      redditAuthorIcon: "📍",
      ...
      feature1Description:
        'Carga 50 archivos antes de dormir. Despierta con transcripciones completas. Sin colas, sin esperas, sin mensajes de "actualiza tu plan". Solo puro poder de procesamiento al alcance de tu mano.',
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Nuestra infraestructura de procesamiento paralelo significa que tus 50 archivos no esperan en cola. Todos se transcriben simultáneamente. Lo que solía tomar semanas ahora toma horas.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        'Mientras otros te hacen esperar en líneas virtuales o pagar por "procesamiento prioritario", nosotros tratamos cada carga con urgencia. Tu contenido importa y no debe esperar.',
      feature3Point1Icon: "✓",
      ...
      useCase1Description:
        "Carga 3 años de episodios de una vez. Crea transcripciones para todo tu catálogo. Genera contenido SEO para cada episodio.",
      useCase2Title: "Creación de cursos",
      useCase2Description:
        "Procesa todos tus videos de clase simultáneamente. Crea transcripciones accesibles para estudiantes. Construye materiales de curso buscables.",
      useCase3Title: "Atraso de entrevistas",
      useCase3Description:
        "Limpia esa montaña de entrevistas sin transcribir. Procesa semanas de investigación en horas. Cumple tus plazos sin pánico.",
      useCase4Title: "Biblioteca de YouTube",
      useCase4Description:
        "Genera subtítulos para todo tu canal. Crea publicaciones de blog a partir de videos. Mejora el SEO en todos tus videos.",
      useCase5Title: "Archivos de reuniones",
      useCase5Description:
        "Sube meses de reuniones grabadas. Crea notas de reuniones buscables. Nunca pierdas decisiones importantes otra vez.",
      useCase6Title: "Datos de Investigación",
      useCase6Description:
        "Procesa grupos focales en masa. Transcribe todas las entrevistas de participantes. Analiza datos cualitativos eficientemente.",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "Precisión líder en la industria en 12 idiomas principales. Marcas de tiempo a nivel de palabra para sincronización perfecta. Identificación inteligente de hablantes que maneja conversaciones rápidas. Formato profesional realmente legible.",
      ...
      feature1Description:
        "Cada palabra está perfectamente sincronizada con su posición en el audio. Crea transcripciones clicables, genera subtítulos precisos o salta a momentos exactos en tus grabaciones. Precisión de 100ms en la que confían los profesionales.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Nuestra IA identifica con precisión a los hablantes incluso durante discursos superpuestos, interrupciones y conversaciones rápidas de ida y vuelta. Perfecto para entrevistas, podcasts y reuniones donde los hablantes intervienen con frecuencia.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "No más bloques de texto. Nuestra IA agrega automáticamente párrafos, oraciones y puntuación exactamente donde corresponde. ¿El resultado? Transcripciones realmente agradables de leer y fáciles de escanear.",
      feature3Point1Icon: "✓",
      ...
      formattingBeforeText:
        "así que hoy vamos a hablar de las nuevas funciones en las que hemos estado trabajando creo que te van a gustar mucho los usuarios las han solicitado durante mucho tiempo y finalmente las terminamos",
  ...
  Pricing: {
    ...
    Cards: {
      ...
      highlighted_text: "Sin Límites Ocultos.",
      description:
        "Elige el plan que se ajuste a tus necesidades. Cambia cuando quieras. Sin contratos, sin sorpresas.",
      plans: [
        {
          name: "Gratis",
          price: "$0",
          ...
          features: {
            ...
            items: ["100+ idiomas", "Etiquetas de hablantes", "Traducción", "Todos los formatos de exportación"]
          },
          cta: {
      ...
      disclaimer:
        '"Ilimitado" significa sin límite mensual ni ralentización artificial. Se aplica uso justo para automatización abusiva o redistribución.'
    },
    ComparisonTable: {
      header: {
        title: "Comparar",
      ...
      plans: ["Funciones", "Gratis", "Pro Mensual", "Pro Anual"],
      features: [
        {
          name: "Precio",
          values: [
      ...
      items: [
        {
          ...
          answer:
            "¡Sí! Los planes Pro no tienen límites mensuales. Los únicos límites son técnicos: duración máxima de archivo de 10 horas y tamaño de archivo de 5GB. Puedes procesar tantos archivos como necesites."
        },
        {
          q: "plan_change",
          question: "¿Puedo cambiar de plan en cualquier momento?",
          answer:
            "¡Absolutamente! Puedes cancelar tu suscripción en cualquier momento desde tu panel. Actualiza o reduce tu plan cuando lo necesites."
        },
        {
          q: "payment_methods",
        ...
        },
        {
          ...
          answer:
            "¡Sí! Prueba Pro gratis por 7 días, sin necesidad de tarjeta de crédito. Además, obtén un 45% de descuento en tu primer mes al suscribirte."
        },
        {
          q: "file_retention",
          question: "¿Cuánto tiempo guardan mis archivos?",
          answer:
            "Plan gratuito: 30 días. Planes Pro: ¡Para siempre! Tus transcripciones siempre estarán disponibles en tu cuenta."
        },
        {
          q: "data_security",
          question: "¿Qué hay de la seguridad de los datos?",
          answer:
            "Estamos certificados SOC 2 y usamos encriptación de 256 bits. Nunca usamos tu contenido para entrenar nuestros modelos. Tus datos son tuyos."
        }
      ]
    },
    CTA: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description:
          "Sube todo tu archivo de podcast de una vez. Genera notas del programa, mejora el SEO y reutiliza contenido sin contar minutos.",
        benefits: {
      ...
      journalists: {
        ...
        description:
          "Sube en lote todas las entrevistas antes del plazo. Busca en las transcripciones al instante y nunca pierdas una cita crucial.",
        benefits: {
      ...
      contentCreators: {
        ...
        description:
          "Subtitula todo tu canal de YouTube. Genera subtítulos en múltiples idiomas y mejora tu SEO de video al instante.",
        benefits: {
      ...
      researchers: {
        ...
        description:
          "Procesa estudios de investigación completos de una vez. Maneja grupos focales, entrevistas y paneles con identificación perfecta de hablantes.",
        benefits: {
      ...
      businessTeams: {
        ...
        description:
          "Graba reuniones directamente o sube archivos de audio para transcripción instantánea. Crea archivos buscables de conversaciones ilimitadas y nunca pierdas discusiones importantes.",
        benefits: {
      ...
      educators: {
        ...
        description:
          "Simplemente pega enlaces de YouTube para obtener transcripciones instantáneas y subtítulos generados automáticamente. Convierte cualquier video educativo en contenido accesible y buscable.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter:
              'sin transcribir. Otter me pedía elegir 3. TRES. NeverCap me permitió subir los 150 episodios en un fin de semana."',
            name: "Mike Rodríguez",
            role: "Anfitrión de podcast"
          },
          jessica: {
            ...
            highlight: "$100/mes",
            textAfter:
              'de Trint, pero tampoco puedo trabajar con el límite de 10 archivos mensuales de Otter. NeverCap salvó mi carrera."',
            name: "Jessica Park",
            role: "Periodista independiente"
          },
          sarah: {
            ...
            highlight: "200 horas",
            textAfter:
              'de grabaciones de grupos focales. Procesamos todo en un fin de semana en lugar de racionar minutos mensuales."',
            name: "Dra. Sarah Chen",
      ...
      heroSubtitleA:
        "Desde podcasters con años de retraso hasta investigadores con cientos de entrevistas. Descubre cómo los profesionales usan {NeverCap} para liberarse de los límites de carga y de minutos."
    },
    Podcasters: {
      ...
      heroSubtitle:
        "Sube todo tu catálogo anterior. Crea notas del programa para cada episodio. Sin tener que elegir qué episodios transcribir.",
      ...
      problems: {
        problem1: {
          ...
          description:
            "Otter te da 3 importaciones de por vida en gratis, 10 por mes en Pro. ¿Cómo transcribes 3 años de episodios?"
        },
        problem2: {
          title: "Oportunidades SEO Perdidas",
          description:
            "Cada episodio no transcrito es tráfico SEO perdido. Pero Descript te limita a 30 horas/mes como máximo."
        },
        problem3: {
          title: "Los Costos Explotan con el Crecimiento",
          description:
            "A medida que crece tu podcast, los costos de transcripción se disparan. Tarifas excedentes de $2/hora hacen imposible escalar."
        }
      },
      solutionTitle: "La",
      ...
      features: {
        feature1: {
          ...
          description:
            "Identifica y etiqueta automáticamente hasta 20 hablantes. Perfecto para debates, entrevistas y programas con coanfitriones."
        },
        feature2: {
          title: "Capítulos con Marcas de Tiempo",
          description:
            "Genera marcas de tiempo clicables para descripciones de YouTube. Permite que los oyentes salten a sus segmentos favoritos al instante."
        },
        feature3: {
          title: "Formateo Inteligente",
          description:
            "Agrega automáticamente párrafos, oraciones y puntuación. Obtén transcripciones limpias y legibles. Ahorra horas en postproducción."
        },
        feature4: {
          title: "Optimización SEO",
          description:
            "Transcripciones formateadas para motores de búsqueda. Aumenta la visibilidad de tu podcast y llega a nuevas audiencias."
        },
        feature5: {
          title: "100+ Idiomas",
          description:
            "Transcribe en cualquier idioma. Traduce a 249+ idiomas. Llega a audiencias globales sin esfuerzo."
        },
        feature6: {
          title: "Procesamiento por Lotes",
          description:
            "Sube 50 episodios antes de dormir. Despierta con transcripciones completas. Procesa todo tu archivo durante la noche."
        }
      },
      ...
      solutionDescriptionA:
        "Con {NeverCap}, obtienes transcripción ilimitada. Sube todo tu archivo. Transcribe cada nuevo episodio. Genera notas de programa a gran escala. Sin límites, solo crecimiento."
    },
    Journalists: {
      hero: {
        ...
        subtitle:
          "Deja de elegir qué entrevistas merecen transcripción. Sube todas las grabaciones a la vez, busca en todo instantáneamente y cumple tus plazos sin la ansiedad de subida.",
      ...
      problem: {
        ...
        problems: {
          uploadLimits: {
            ...
            description:
              "Otter te da 10 importaciones de archivos al mes en Pro. ¿Cómo transcribes 3 semanas de entrevistas de investigación?"
          },
          missingQuotes: {
            title: "Citas Cruciales Perdidas",
            description:
              "Cada entrevista no transcrita podría contener la cita clave de la historia. Pero Trint te limita a 50 horas/mes como máximo."
          },
          costExplosion: {
            title: "Los Costos Se Disparan con los Plazos",
            description:
              "A medida que profundizas en tu investigación, los costos de transcripción se disparan. Las tarifas excedentes de $100/mes hacen imposible las noticias de última hora."
          }
        },
        solution: {
          title: "The",
          ...
          descriptionA:
            "Con {NeverCap}, obtienes transcripción ilimitada. Sube toda tu investigación. Transcribe cada entrevista. Busca todas las citas al instante. Sin límites, sin límites, solo periodismo."
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description:
              "A diferencia del software con límites de minutos, puedes transcribir cada entrevista, desde una charla rápida hasta una discusión de varias horas. Nunca te quedes sin créditos ante un plazo.",
            points: {
          ...
          instantSearch: {
            ...
            description:
              "Recibe tu transcripción en minutos, no en días. Publica historias más rápido que nunca. Nuestra IA procesa horas de audio mientras tomas un café.",
            points: {
          ...
          professionalAccuracy: {
            ...
            description:
              "Nuestra IA ofrece transcripciones altamente precisas, garantizando que las citas que publiques sean exactas y confiables. Transcripción profesional en la que los editores confían.",
            points: {
          ...
          ironclad: {
            ...
            description:
              "Ofrecemos funciones de seguridad robustas para proteger tus datos sensibles de entrevistas y fuentes confidenciales. Cifrado de nivel bancario mantiene seguras tus investigaciones.",
            points: {
      ...
      testimonials: {
        jessica: {
          quote:
            '"Tuve 3 años de entrevistas sin transcribir por límites de subida. NeverCap me permitió procesar todo en un fin de semana. Un cambio radical."',
          name: "Jessica Park",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA:
          "Ya sea que necesites transcribir un video de YouTube, un video de TikTok para reutilizarlo o descubrir cómo transcribir un video de Facebook a texto, {NeverCap} lo gestiona todo a la perfección. Genera subtítulos en más de 100 idiomas sin límites mensuales: pura libertad creativa."
      },
      platforms: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "Nuestra herramienta simplifica cómo transcribes contenido de video. Para transcribir un video de Instagram, solo pega el enlace. Para transcribir un video de Vimeo a texto, haz lo mismo. Procesa el historial completo de tu canal en un fin de semana.",
          points: {
        ...
        globalReach: {
          ...
          titleHighlight: "Sin límites.",
          description:
            "Llega a audiencias globales con traducción automática a 100+ idiomas. Genera subtítulos en múltiples idiomas simultáneamente. Sin cargos adicionales, sin límites mensuales en traducciones.",
          points: {
        ...
        flexibleExport: {
          ...
          description:
            "Exporta en el formato que funcione para tu flujo de trabajo. Desde archivos SRT para YouTube hasta VTT para reproductores web, o documentos editables para guiones. Todas las exportaciones son ilimitadas, todas incluidas en cada plan.",
          points: {
      ...
      testimonials: {
        ...
        carlos: {
          ...
          textAfter:
            "para un alcance más amplio. Sin límites, solo crecimiento. Las vistas de mi canal aumentaron 3 veces después de agregar subtítulos multilingües.",
          highlight: "traduce al inglés",
          name: "Carlos Martínez",
        ...
        sarah: {
          ...
          textAfter:
            ". Tengo 500+ videos acumulados. NeverCap me permitió procesar todo en un fin de semana. El impulso en SEO de los subtítulos se pagó solo el primer mes.",
          highlight: "30 horas",
          name: "Sarah Lee",
        ...
        jake: {
          textBefore: "La",
          textAfter:
            "función es revolucionaria. Ya no descargo nada. Solo pega, transcribe, listo. Procesar mis clips de podcast para TikTok nunca fue tan fácil.",
        ...
        yuki: {
          ...
          textAfter:
            ". NeverCap me da traducciones ilimitadas. Mi audiencia internacional creció un 400% desde que empecé a usar subtítulos nativos adecuados.",
        ...
        questions: [
          {
            ...
            answer:
              "Es simple. Encuentra el video de YouTube que deseas transcribir, copia su URL y pégala en nuestra app. Nuestra IA obtendrá el video y te dará una transcripción completa en minutos."
          },
          {
            question: "P: ¿Cuál es la mejor forma de transcribir un video de Facebook a texto?",
            answer:
              "La forma más fácil es usar un enlace directo. Copia la URL del video de Facebook y nuestra plataforma hará el resto, convirtiendo el habla en texto con hasta un 96% de precisión, ahorrándote la transcripción manual."
          },
          {
            question: "P: ¿Puedo transcribir videos de TikTok e Instagram?",
            answer:
              "Absolutamente. Soportamos transcripción para videos de TikTok e Instagram. Es ideal para creadores que quieren reutilizar su contenido en formato corto para posts, artículos o actualizaciones en redes sociales."
          },
          {
            question: "P: ¿Cómo transcribo un video de Vimeo a texto?",
            answer:
              "Transcribir videos de Vimeo es tan fácil como en otras plataformas. Simplemente copia la URL del video de Vimeo y pégala en NeverCap. Nuestra IA procesará el video y generará una transcripción precisa que puedes descargar en múltiples formatos."
          }
        ]
      }
    },
    Researchers: {
      ...
      heroSubtitle:
        "Deja de elegir qué grupos focales transcribir. Procesa todos tus datos cualitativos con un 96% de precisión e identificación perfecta de hablantes—incluso con 20 participantes hablando al mismo tiempo.",
      ...
      problemCard2Desc:
        "Cada entrevista no transcrita podría contener descubrimientos clave. Pero Rev cobra $2/minuto como mínimo.",
      problemCard3Title: "El Dinero de Subvenciones Desaparece",
      problemCard3Desc:
        "A medida que crece tu conjunto de datos, los costos de transcripción se disparan. $500 por grupo focal hace imposible escalar.",
      solutionTitle: "Solución NeverCap",
      feature1Label: "Sin Límites",
      feature1Title: "Gestionamos su",
      feature1Desc:
        'Sube las 200 horas de entrevistas esta noche. Despierta con transcripciones completas y buscables. Sin topes mensuales, sin límites por archivo, sin tonterías de "uso justo".',
      ...
      feature2Desc:
        "Nuestra IA rastrea hasta 20 hablantes incluso cuando se interrumpen, hablan al mismo tiempo o intervienen todos a la vez. Cada voz se captura y etiqueta correctamente.",
      ...
      feature3Desc:
        "Maneja jerga técnica, acentos marcados y terminología específica como un profesional. Suficientemente preciso para publicaciones, revisión por pares y tu comité de tesis.",
      ...
      feature4Desc:
        "Tus datos de investigación sensibles están protegidos con seguridad empresarial. Cumple con GDPR, opciones listas para HIPAA y auditorías completas para requisitos IRB.",
      ...
      useCase1Desc:
        "Maneja 8-20 participantes con habla superpuesta. Identificación perfecta de hablantes incluso en discusiones acaloradas. Exporta directamente a software de análisis cualitativo.",
      useCase2Title: "Entrevistas en Profundidad",
      useCase2Desc:
        "Procesa cientos de entrevistas individuales simultáneamente. Mantén la coherencia en todo tu conjunto de datos. Busca en todas las transcripciones al instante.",
      useCase3Title: "Investigación Clínica",
      useCase3Desc:
        "Opciones compatibles con HIPAA para entrevistas con pacientes. Transcripción precisa de terminología médica. Manejo seguro de datos de salud sensibles.",
      useCase4Title: "Estudios Etnográficos",
      useCase4Desc:
        "Grabaciones en entornos naturales. Maneja ruido de fondo y múltiples hablantes. Compatibilidad con 100+ idiomas y dialectos.",
      useCase5Title: "Proyectos de Historia Oral",
      useCase5Desc:
        "Preserva archivos completos sin límites. Crea registros históricos buscables. Ideal para estudios longitudinales y generacionales.",
      useCase6Title: "Investigación para Tesis",
      useCase6Desc:
        "Precios accesibles para estudiantes con todas las funciones. Procesa todo tu conjunto de datos económicamente. Cumple plazos ajustados con procesamiento por lotes.",
      testimonialTitle: "Confiado por",
      testimonialText:
        "Nuestro equipo de investigación tenía 200 horas de grabaciones de grupos focales de nuestro estudio de salud comunitaria. Otros servicios nos pedían elegir qué sesiones transcribir debido al costo. NeverCap nos permitió procesar todo en un fin de semana. La identificación de 20 hablantes realmente funcionó, incluso en nuestras discusiones más caóticas donde todos hablaban al mismo tiempo. Esta herramienta ha cambiado por completo cómo manejamos los datos cualitativos.",
      ...
      testimonialText3:
        "de grabaciones de grupos focales de nuestro estudio de salud comunitario. Otros servicios querían que seleccionáramos qué sesiones transcribir por el costo. NeverCap nos permitió procesar",
      testimonialText4Hl: "todo en un fin de semana",
      testimonialText5:
        ". La identificación de 20 hablantes realmente funcionó, incluso en nuestras discusiones más caóticas donde todos hablaban al mismo tiempo. Esta herramienta ha",
      testimonialText6Hl: "cambiado completamente",
      testimonialText7: "cómo manejamos datos cualitativos.",
      solutionDescA:
        "Con {NeverCap}, obtienes transcripción ilimitada. Sube tu estudio completo. Transcribe cada entrevista. Analiza todos tus datos. Sin límites, solo investigación."
    },
    BusinessTeams: {
      ...
      featuresSubtitle:
        "Desde grabación en vivo hasta subidas instantáneas, hemos eliminado todos los puntos de fricción",
      feature1Title: "Graba Directamente en tu Navegador",
      feature1Desc:
        "Sin descargas, sin complementos. Comienza a grabar al instante con un clic. Calidad de audio perfecta, detección automática de hablantes.",
      ...
      feature2Desc:
        "¿Tienes grabaciones de Zoom, Teams o tu teléfono? Súbelas al instante. Compatibilidad con todos los formatos principales de audio y video. Procesa múltiples archivos simultáneamente sin esperar.",
      ...
      feature3Desc:
        "Comparte transcripciones con tu equipo al instante. Escuchen grabaciones juntos, exporten transcripciones en múltiples formatos y asegúrense de que todos estén alineados con archivos de reuniones buscables.",
      ...
      feature4Desc:
        "Busca en todas tus reuniones a la vez. Encuentra esa decisión crucial del último trimestre o ese requisito del cliente de hace meses. La búsqueda con IA entiende el contexto, no solo palabras clave.",
      ...
      workflowStep1Desc:
        "Comienza a grabar en vivo o simplemente descarga la grabación de Zoom, Google Meet o Microsoft Teams",
      workflowStep2Title: "Auto-transcribir",
      workflowStep2Desc:
        "Nuestra IA transcribirá automáticamente la grabación a texto con un 96% de precisión en minutos",
      ...
      testimonial1Text:
        '"Pasamos de perder detalles cruciales a tener un archivo buscable de cada conversación. La función de grabación directa significa que nunca olvidamos capturar discusiones importantes."',
      testimonial1AuthorName: "James Kim",
      testimonial1AuthorRole: "Gerente de Producto, TechCorp",
      testimonial2Text:
        '"Otter nos limitaba a 10 subidas de archivos al mes. Ahora subimos todas las llamadas con clientes al instante. Un cambio radical para los seguimientos de nuestro equipo de ventas."',
      testimonial2AuthorName: "Sarah Rodríguez",
      testimonial2AuthorRole: "Directora de Ventas, ConsultPro",
      testimonial3Text:
        '"La capacidad de buscar en meses de reuniones nos salvó durante nuestra auditoría. Encontramos cada decisión y aprobación en segundos."',
      ...
      heroSubtitleA:
        "Graba reuniones directamente en tu navegador o sube archivos de audio al instante. Crea archivos con función de búsqueda a partir de conversaciones ilimitadas. No vuelvas a perder conversaciones importantes con la transcripción ilimitada de {NeverCap}."
    },
    Educators: {
      ...
      heroSubtitle:
        "Simplemente pega enlaces de YouTube para obtener transcripciones instantáneas con subtítulos generados automáticamente. Convierte clases, tutoriales y videos educativos en contenido buscable y accesible para todos los estudiantes.",
      heroCtaPrimary: "Pruébalo gratis - Sin tarjeta",
      ...
      feature1Desc:
        "Solo pega cualquier enlace de video y obtén transcripciones instantáneas. Funciona con YouTube, Vimeo, Facebook, X (Twitter), TikTok, Instagram, Dropbox, Google Drive y más. Sin descargas, sin esperas.",
      ...
      feature2Desc:
        "Crea subtítulos precisos al instante para todos tus videos educativos. Haz que el contenido sea accesible para estudiantes con discapacidad auditiva, no nativos o quienes prefieren leer.",
      ...
      feature3Desc:
        "Crea carpetas para organizar tus transcripciones por curso, materia o semestre. Mantén todo tu contenido educativo ordenado y fácil de buscar. Construye una biblioteca completa de materiales accesibles.",
      ...
      feature4Desc:
        "No solo compartas grabaciones. Transcribe automáticamente clases a texto y otros archivos de audio en guías de estudio detalladas, con resúmenes y conceptos clave para una revisión efectiva. Exporta en formatos TXT, DOCX o PDF.",
      ...
      useCase1Text:
        "Transcribe semestres completos de clases grabadas. Los estudiantes pueden buscar temas específicos, repasar conceptos clave y nunca perderse información importante.",
      useCase2Title: "Cursos en Línea",
      useCase2Text:
        "Haz que tus cursos en línea sean accesibles para estudiantes internacionales con traducciones en 100+ idiomas. Aumenta las inscripciones y la satisfacción.",
      useCase3Title: "Materiales de Estudio",
      useCase3Text:
        "Usa IA para transcribir archivos de audio a guías de estudio desde tutoriales en video y clases. Ideal para estudiantes que prefieren leer o necesitan repasar contenido rápidamente con texto buscable.",
      useCase4Title: "Cumplimiento de Accesibilidad",
      useCase4Text:
        "Cumple con los requisitos de accesibilidad proporcionando subtítulos y transcripciones para todo el contenido en video. Garantiza acceso equitativo para todos los estudiantes.",
      useCase5Title: "Aula Invertida",
      useCase5Text:
        "Comparte video clases con transcripciones antes de la clase. Los estudiantes pueden repasar a su propio ritmo y llegar preparados para las discusiones.",
      useCase6Title: "Investigación y Citas",
      useCase6Text:
        "Ayuda a los estudiantes a citar fuentes de video con precisión usando marcas de tiempo. Perfecto para proyectos de investigación y trabajos académicos.",
      testimonialTitle: "Confiado por",
  ...
  Resources: {
    YouTubeToMP4: {
        ...
        steps: [
          {
            title: "Copiar la URL",
            content:
              "Abre tu video de YouTube objetivo, luego copia el enlace de la barra de direcciones de tu navegador."
          },
          {
        ...
        list: [
          {
            ...
            content:
              "Normalmente, ver videos en YouTube consume muchos datos móviles. Al descargarlos para ver sin conexión, puedes evitar estos costos innecesarios."
          },
          {
            title: "Mira donde sea, cuando sea:",
            content:
              "Disfruta de tus videos sin problemas, incluso con conexiones a internet irregulares. Sin más preocupaciones por el búfer."
          },
          {
            title: "Archivo y preservación fáciles:",
            content:
              "Guardar videos como MP4 hace que sea simple crear tu colección personal, especialmente para contenido que consideres valioso o importante."
          },
          {
            title: "Compartir más fácil:",
            content:
              "Compartir un archivo MP4 es mucho más conveniente que enviar un enlace. Puedes enviar el archivo de video directamente a través de aplicaciones como WhatsApp o Instagram, eliminando el paso adicional de abrir YouTube."
          },
          {
            title: "Visualización instantánea, momentos compartidos:",
            content:
              "¿Emocionado por mostrar un video favorito a amigos o familiares cercanos? Con el MP4 descargado, todos pueden verlo juntos sin problemas, sin pausas incómodas esperando a que se cargue."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Disfruta de una interfaz limpia sin ventanas emergentes, banners o interrupciones, solo conversión de video sin problemas."
          },
          {
            icon: "5",
            color: "#DEE5FF",
            ...
            content:
              "Tus descargas mantienen la resolución completa del video original para una reproducción perfecta cada vez."
          },
          {
            icon: "6",
            color: "#DEF6EE",
      ...
      part7: {
        ...
        list: [
          ...
          },
          {
            ...
            answer:
              "Sí, es segura y confiable. No requerimos información personal de los usuarios y tomamos medidas fuertes contra virus. Te recordamos que siempre tengas precaución al descargar archivos de internet: evita hacer clic en enlaces sospechosos o descargar archivos cuestionables."
          },
          {
          ...
          },
          {
            ...
            answer:
              "Aunque garantizamos la experiencia de descarga más rápida posible, el tiempo de descarga también se ve afectado por factores como la duración del video y la velocidad de tu conexión a internet."
          },
          {
            question: "Cuando descargo un video MP4 usando mi smartphone, ¿dónde se guarda?",
            answer:
              'Después de descargar un MP4 en tu smartphone, normalmente lo encontrarás en la carpeta "Descargas" dentro de la aplicación de administrador de archivos de tu dispositivo.'
          },
          {
            question: "¿Descargar un video de YouTube como MP4 reduce la calidad del video?",
            answer:
              "No. Descargar videos de YouTube como MP4 con nuestra herramienta mantiene la calidad original del video. El proceso de conversión preserva la calidad de origen, asegurando que tengas la misma experiencia de visualización que en YouTube."
          }
        ]
      },
      ...
      videoDownload: {
        ...
        description:
          "¡Gracias por elegir nuestro servicio! Realmente apreciamos tu confianza y esperamos que haya mejorado tu experiencia. Si pudieras compartir nuestro sitio web con tus amigos, sería de gran ayuda.",
        ...
        steps: [
          {
            ...
            content:
              "Convierte archivos de audio y video a texto en segundos. 3 transcripciones gratuitas todos los días."
          },
          {
      ...
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Convierte videos de YouTube a formato MP3 para verlos sin conexión. Descarga videos de alta calidad al instante.",
        AITranscription: "Transcripción de IA",
        AITranscription_des:
          "Transcribe archivos de audio y video con una precisión del 96 %. Transcripción ilimitada para todo tu contenido."
      }
    },
    YouTubeToMP3: {
      ...
      part2: {
        title:
          "Aquí te explicamos cómo convertir un video de YouTube en un archivo MP3 descargable en 3 sencillos pasos",
        steps: [
          {
            title: "Copiar la URL",
            content:
              "Abra el video de YouTube que desea ver y luego copie el enlace desde la barra de direcciones de su navegador."
          },
          {
            title: "Pegar el enlace",
      ...
      part4: {
        content: ["Aquí están los 5 principales beneficios de la conversión", "Vídeos de YouTube a archivos MP3"],
        list: [
          {
            title: "Ahorre en almacenamiento:",
            content:
              "Los archivos MP3 son más pequeños, lo que reduce el consumo de almacenamiento en YouTube. Ahorra datos móviles descargando la versión sin conexión y úsala cuando tengas internet."
          },
          {
            title: "Ahorra batería:",
            content:
              "Para ver videos de YouTube, utilizan un servicio de almacenamiento en búfer que utiliza conexiones fáciles de escuchar. Olvídate de los problemas de almacenamiento en búfer."
          },
          {
            title: "Fácil archivado y conservación:",
            content:
              "Algunos videos o MP3 hacen que sea más fácil crear su biblioteca personal, ya sea para contenido educativo, archivos de música o cosas importantes."
          },
          {
            title: "Compartir más sencillamente:",
            content:
              "Compartir un archivo MP3 es mucho más cómodo que compartir enlaces de YouTube. Puedes enviar archivos a tus amigos a través de aplicaciones como WhatsApp o Instagram, eliminando así el coste de abrir YouTube."
          },
          {
            title: "Visualización instantánea, amplia flexibilidad:",
            content:
              "Acceda a una mayor variedad de videos favoritos a su video favorito convirtiendo videos de YouTube donde los necesite y los formatos MP3 permiten unirlos sin problemas de inmediato, sin pausas incómodas esperando esta carga."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Disfrute de una interfaz limpia sin ventanas emergentes, banners ni interrupciones: solo una conversión fluida e ininterrumpida."
          },
          {
            title: "Calidad original garantizada",
            content:
              "Tus descargas conservan la resolución completa del video de origen para una reproducción con píxeles perfectos en todo momento."
          },
          {
            title: "Funciona en cualquier lugar",
            content: "Totalmente compatible con cualquier navegador, en cualquier dispositivo."
      ...
      part6: {
        title: ["Maximice sus conversiones de YouTube a MP3", "Con nuestro convertidor"],
        ...
        list: [
          {
            ...
            answer:
              "Aunque técnicamente es posible, convertir contenido protegido por derechos de autor sin permiso puede infringir las condiciones de servicio y las leyes de derechos de autor de YouTube. Asegúrate siempre de tener derecho a convertir el contenido o usarlo únicamente con fines personales y no comerciales."
          },
          {
            question: "¿Es segura esta herramienta de conversión?",
            answer:
              "Sí, nuestro convertidor es completamente seguro. No almacenamos tus datos ni archivos, y no hay riesgo de malware ni virus. La conversión se realiza de forma directa y segura."
          },
          {
            question: "¿Qué idiomas admite la conversión de YouTube a MP3?",
            answer:
              "Nuestro conversor es compatible con todos los idiomas disponibles en YouTube. El audio se extraerá exactamente como aparece en el vídeo original, conservando el idioma y la calidad del audio originales."
          },
          {
            question: "¿Qué factores afectan el tiempo que tarda en convertirse un vídeo de YouTube?",
            answer:
              "El tiempo de conversión depende de varios factores: la duración del video, la velocidad de tu conexión a internet y la carga del servidor. La mayoría de los videos de menos de 10 minutos se convierten en menos de 30 segundos."
          },
          {
            question: "Cuando convierto y descargo un MP3 usando mi teléfono inteligente, ¿dónde se guarda?",
            answer:
              "En la mayoría de los smartphones, los archivos MP3 convertidos se guardan en la carpeta Descargas. En iPhone, pueden ir a la app Archivos. En Android, revisa la carpeta Descargas en tu administrador de archivos o app de música."
          },
          {
            question: "¿Convertir un vídeo de YouTube a MP3 reduce la calidad del audio?",
            answer:
              "MP3 es un formato de solo audio, por lo que no incluye vídeo. La calidad del audio se conserva a la tasa de bits más alta disponible del vídeo original, normalmente entre 128 y 320 kbps, dependiendo de la calidad de la carga original."
          }
        ]
      },
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Convierte videos de YouTube a formato MP4 para verlos sin conexión. Descarga videos de alta calidad al instante.",
        AITranscription: "Transcripción de IA",
        AITranscription_des:
          "Transcribe archivos de audio y video con una precisión del 96 %. Transcripción ilimitada para todo tu contenido."
      },
      videoDownload: {
        ...
        description:
          "¡Gracias por elegir nuestro servicio! Agradecemos mucho su confianza y esperamos que haya mejorado su experiencia. Si pudiera compartir nuestro sitio web con sus amigos, sería de gran ayuda.",
        downloadButton: "Descargar",
        TranscribeButton: "Transcribir",
    ...
    Transcription: {
      videoTranscription: {
        hero: {
          title: "Transcripción de Video: Potenciada por IA y Precisión",
          des: "Transcribe videos a texto con alta precisión y soporte para 100+ idiomas. Convierte fácilmente cualquier archivo o enlace en texto editable y expórtalo en múltiples formatos, desde clips cortos hasta videos largos.",
          feature_1: "Soporta 12 Formatos",
          feature_2: "Soporta 100+ Idiomas",
          feature_3: "Exporta en 6 Formatos"
        },
        threeStep: {
          title: "Cómo",
          titleHighlight: "Convertir Video a Texto con NeverCap",
          step_1_title: "Sube o pega",
          step_1_des:
            "Soportamos formatos como MP4, MOV, WMV y MPEG, así como enlaces de YouTube, TikTok, X, Facebook y otras plataformas.",
          step_2_title: "Transcribe video a texto",
          step_2_des:
            'Haz clic en el botón "Transcribir" y espera a que se complete el proceso. Un video de 1 hora suele tardar solo 1–2 minutos en transcribirse.',
          step_3_title: "Exporta o comparte",
          step_3_des:
            "Edita tu texto directamente en línea, luego expórtalo en formatos como TXT, PDF, DOCX, SRT, CSV o VTT. También puedes generar un enlace compartible de tu transcripción."
        },
        whyTran: {
          title: "Por qué",
          titleHighlight: "Transcribir Videos a Texto",
          des: "Es increíblemente valioso en escenarios como aprendizaje, creación de contenido, investigación y trabajo. Esto es por qué:",
          reason_1_title: "Facilita tomar notas y repasar.",
          reason_1_des:
            "Estudiantes, investigadores y creadores suelen necesitar extraer información de videos. La transcripción simplifica tomar notas de estudio, organizar entrevistas de investigación, redactar guiones o artículos y traducir contenido con mayor precisión y rentabilidad.",
          reason_2_title: "Mejora la capacidad de búsqueda.",
          reason_2_des:
            "Con texto, puedes buscar rápidamente palabras clave y ubicar secciones importantes—sin rebobinar ni adelantar el video.",
          reason_3_title: "Ahorra tiempo y aumenta la eficiencia.",
          reason_3_des:
            "Leer texto es mucho más rápido que ver un video, especialmente en contenido como clases, entrevistas o reuniones. El texto permite escanear o saltar directamente a puntos clave.",
          reason_4_title: "Mejora la accesibilidad.",
          reason_4_des:
            "Brinda igual acceso a información para personas sordas, con dificultades auditivas, no nativas o con problemas de audición. También ayuda a plataformas a cumplir estándares como WCAG.",
          reason_5_title: "Permite reutilizar contenido.",
          reason_5_des:
            "Los creadores usan transcripciones para generar rápidamente publicaciones en blogs, contenido en redes sociales, resúmenes o subtítulos—acelerando drásticamente el proceso creativo sin escribir manualmente.",
          reason_6_title: "Favorece mejor comprensión, retención y archivado.",
          reason_6_des:
            "Combinar información visual y textual mejora la comprensión y memoria, mientras que los archivos de texto son fáciles de almacenar, ideales para bases de conocimiento, bibliotecas de documentos o sistemas de archivo."
        },
        whyChoose: {
          title: "Por qué Elegir",
          titleHighlight: "Nuestra Herramienta de Transcripción de Video",
          reason_1_title: "Transcribe y Traduce Globalmente",
          reason_1_des:
            "Soporta transcripción en 100+ idiomas y traducción a otros 249, eliminando barreras lingüísticas.",
          reason_2_title: "Compatibilidad Universal de Formatos",
          reason_2_des:
            "Funciona sin problemas con formatos comunes (MP4, MOV, MKV, etc.) y plataformas como YouTube & TikTok.",
          reason_3_title: "Transcripciones Realmente Ilimitadas",
          reason_3_des:
            "Transcribe 100 o 1,000 videos—tu tarifa plana sigue igual. Sin límites ocultos ni costos sorpresa.",
          reason_4_title: "Precisión en la que Puedes Confiar",
          reason_4_des:
            "Benefíciate de más del 95% de precisión general, con idiomas clave como inglés y español superando el 96%.",
          reason_5_title: "Seguridad de Grado Empresarial",
          reason_5_des:
            "Tus datos están protegidos con cifrado y protocolos de privacidad líderes. Tratamos tu confidencialidad con la máxima seriedad.",
          reason_6_title: "Marcas de Tiempo a Nivel de Palabra",
          reason_6_des:
            "Localiza cualquier momento en tu video al instante. Haz clic en una palabra de la transcripción para saltar al tiempo exacto en el medio original."
        },
        reviews: {
          title: "Reseñas de",
          titleHighlight: "Nuestros Usuarios",
          des: "Descubre por qué miles confían en nosotros para transcripciones sin esfuerzo.",
          people_1_content:
            "¡La transcripción de videos de NeverCap es absolutamente fantástica! Después de probar más de una docena de herramientas, este es el primer servicio verdaderamente ilimitado que encuentro. Puedo transcribir todo lo que quiera sin preocuparme por límites de uso.",
          people_1_job: "Creador de contenido",
          people_2_content:
            "Precios accesibles, manejo de archivos grandes con facilidad y procesamiento de docenas de archivos simultáneamente. La transcripción de videos de NeverCap resuelve casi todos mis problemas.",
          people_2_job: "Investigador",
          people_3_content:
            "Preciso, rápido y compatible con muchos idiomas. Lo más destacado es su manejo de videos largos. NeverCap se ha vuelto esencial en mi trabajo y lo he recomendado a todos mis compañeros.",
          people_3_job: "Candidato a doctorado"
        },
        faq: {
          title: "Preguntas clave sobre",
          titleHighlight: "Transcripción de video",
          question_1: "¿Qué formatos de video soporta NeverCap?",
          answer_1: "Soporta formatos comunes incluyendo MP4, MOV, WMV, MPEG, WebM y MKV.",
          question_2: "¿Cómo transcribo un enlace de video y qué plataformas son compatibles?",
          answer_2:
            'Simplemente copia y pega la URL del video, luego haz clic en "Transcribir". Soporta enlaces de YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram y más.',
          question_3: "¿Qué idiomas soporta la transcripción de video?",
          answer_3:
            "NeverCap soporta 100+ idiomas, incluyendo inglés, español, mandarín, francés, alemán, japonés, coreano, portugués, ruso, italiano, holandés y árabe.",
          question_4: "¿Cuál es la duración y tamaño máximo para transcripción?",
          answer_4: "El tamaño máximo es 5GB y la duración máxima es 10 horas por video.",
          question_5: "¿Cuántos archivos de video puedo subir a la vez?",
          answer_5: "NeverCap permite procesar hasta 50 archivos simultáneamente.",
          question_6: "¿Qué tan rápido es el proceso de transcripción? ¿Debo esperar mucho?",
          answer_6:
            "No requiere esperas largas. En nuestras pruebas, un video de 1 hora tarda unos 3 minutos en transcribirse.",
          question_7: "¿Cuál es la precisión de la transcripción de NeverCap?",
          answer_7:
            "Ofrecemos más del 95% de precisión en todos los idiomas, y más del 96% en idiomas clave como inglés, español, mandarín y francés.",
          question_8: "¿Se puede traducir el texto transcrito a otros idiomas?",
          answer_8: "Sí. Una vez completada la transcripción, puedes traducir el texto a 249 idiomas soportados.",
          question_9: "¿Puedo editar, exportar o compartir el texto transcrito?",
          answer_9:
            "Absolutamente. El texto se puede editar en tiempo real. Opciones de exportación incluyen PDF, DOCX, TXT, TTV, CSV y SRT. También puedes generar un enlace compartible."
        },
        explore: {
          title: "Explorar más",
          transcribeTitle: "Herramientas para transcribir a texto",
          transcribe_1: "Audio a texto",
          transcribe_2: "Voz a texto",
          transcribe_3: "MP3 a texto",
          transcribe_4: "MP4 a texto",
          transcribe_5: "AAC a texto",
          transcribe_6: "AMR a texto",
          transcribe_7: "M4A a texto",
          transcribe_8: "MOV a texto",
          transcribe_9: "MPEG a texto",
          transcribe_10: "OGG a texto",
          transcribe_11: "TS a texto",
          transcribe_12: "WAV a texto",
          transcribe_13: "WEBM a texto",
          otherToolsTitle: "Otras herramientas relacionadas",
          otherTools_1: "Al Notetaker",
          otherTools_2: "Añadir subtítulos a video",
          otherTools_3: "Traducir audio",
          otherTools_4: "Traducir video",
          otherTools_5: "Generador de subtítulos",
          otherTools_6: "Resumidor de video",
          otherTools_7: "Conversor de video"
        }
      },
      mp4Transcription: {
        hero: {
          title: "Convertidor de MP4 a Texto Online",
          des_1: "Convierte tus archivos MP4 a texto en segundos.",
          des_2: "Sin registro required. Ultra-rápido. Precisión de primer nivel.",
          feature_1: "Soporta 12 Formatos",
          feature_2: "Soporta 100+ Idiomas",
          feature_3: "Exporta en 6 Formatos"
        },
        threeStep: {
          title: "Transcribe tu MP4 a",
          titleHighlight: "texto en 3 sencillos pasos",
          step_1_title: "Sube tu archivo MP4",
          step_1_des: "Arrástralo y suéltalo en el área designada, o haz clic en el botón \"Subir Archivo\".",
          step_2_title: "Iniciar la transcripción",
          step_2_des: "Haz clic en el botón \"Transcribir\". El sistema convertirá automáticamente tu MP4 a texto en unos momentos.",
          step_3_title: "Descarga tu transcripción",
          step_3_des: "Tu texto está listo para editar online y puede exportarse en formatos TXT, PDF, DOCX, SRT, CSV, VTT, o compartirse mediante un enlace."
        },
        howToGet: {
          title: "Cómo Obtener los Mejores Resultados de",
          titleHighlight: "Tu Transcripción?",
          fun_1: "Usa el archivo de video original para la transcripción, en lugar de una versión comprimida.",
          fun_2: "Reduce el ruido de fondo, la música de fondo, estática o eco tanto como sea posible.",
          fun_3: "Al descargar un video, selecciona siempre la opción \"Alta Calidad de Audio (HQ)\".",
          fun_4: "Habilita la función \"Identificación de Hablantes\" cuando haya más de un hablante.",
          fun_5: "Selecciona el idioma y acento específico de tu archivo MP4, ej. Inglés → Inglés (EE.UU.) / Inglés (Reino Unido) / Inglés (India).",
          fun_6: "Revisa rápidamente la transcripción una vez que el proceso se complete."
        },
        exportFormats: {
          title: "Formatos de Exportación y",
          titleHighlight: "Sus Usos",
          format_1: "En formato TXT",
          des_1: "Para Notepad, Notepad++ y editores de texto ligeros",
          format_2: "En formato PDF",
          des_2: "Para imprimir, compartir, archivar y visualización multiplataforma",
          format_3: "En formato DOCX",
          des_3: "Para Microsoft Word, Google Docs y edición de texto enriquecido",
          format_4: "En formato SRT",
          des_4: "Para subtítulos de YouTube, carga de subtítulos de video y reproductores multimedia",
          format_5: "En formato CSV",
          des_5: "Para Excel, Google Sheets y herramientas de análisis de datos",
          format_6: "En formato VTT",
          des_6: "Para subtítulos de video web, reproductores HTML5 y herramientas de accesibilidad"
        },
        howToUse: {
          title: "Cuál es el valor de convertir MP4 a texto,",
          titleHighlight: "y cómo puedes aprovecharlo al máximo?",
          effect_1: "Lee los puntos clave al instante.",
          des_1: "Explora transcripciones más rápido que volver a ver videos y localiza rápidamente información esencial.",
          effect_2: "Organiza estudios e investigación.",
          des_2: "Convierte conferencias, entrevistas y clips de investigación en notas limpias que puedes resaltar, citar y reutilizar.",
          effect_3: "Aumenta la productividad laboral.",
          des_3: "Crea resúmenes de reuniones, haz seguimiento de elementos de acción y almacena contenido en documentación o bases de conocimiento.",
          effect_4: "Apoya la creación de contenido.",
          des_4: "Extrae guiones, esquemas, borradores de artículos y exporta subtítulos para edición o localización.",
          effect_5: "Haz que el contenido sea buscable y traducible.",
          des_5: "Búsqueda de texto completo y traduce transcripciones para uso multilingüe.",
          effect_6: "Simplifica el archivo.",
          des_6: "El texto es más fácil de almacenar, estructurar y reutilizar, ideal para registros, documentación y bases de conocimiento de IA."
        },
        whyChoose: {
          title: "Por qué",
          titleHighlight: "Nuestra Transcripción de MP4 a Texto se Destaca",
          reason_1_title: "Precisión Líder en la Industria",
          reason_1_des: "Verificada de forma independiente como una de las herramientas de transcripción más precisas disponibles.",
          reason_2_title: "Velocidad de Procesamiento Rápida",
          reason_2_des: "Obtén tu transcripción aproximadamente en una veinteava parte de la longitud del video original.",
          reason_3_title: "Identificación de Hablantes",
          reason_3_des: "Distingue claramente entre hablantes, haciendo que las transcripciones sean más fáciles de leer y seguir.",
          reason_4_title: "Amplia Cobertura de Idiomas",
          reason_4_des: "Soporta transcripción en 100+ idiomas y traducción a 249 idiomas.",
          reason_5_title: "Simple y Fácil de Usar",
          reason_5_des: "Sin interfaces o pasos complejos. Finaliza tu tarea con solo unos pocos clics.",
          reason_6_title: "Seguridad Total de Datos",
          reason_6_des: "Priorizamos la seguridad y privacidad de tus datos como uno de nuestros compromisos fundamentales."
        },
        faq: {
          title: "Preguntas Sobre",
          titleHighlight: "Convertir MP4 a Texto",
          question_1: "Cuánto tiempo toma transcribir un archivo MP4 a texto?",
          answer_1: "Basado en pruebas, bajo condiciones normales, el proceso de transcripción toma aproximadamente 1/20 a 1/10 de la duración del video. Por ejemplo, un video de 1 hora tomará aproximadamente de 3 a 6 minutos en transcribirse.",
          question_2: "Hay límites en el tamaño del archivo MP4 que subo?",
          answer_2: "Sí. El tamaño máximo del archivo es 5GB y la duración del video no debe exceder las 10 horas. Ten en cuenta que los archivos más grandes pueden requerir más tiempo para procesarse.",
          question_3: "Cuán precisa es la transcripción?",
          answer_3: "Es importante entender que la calidad de la transcripción depende en gran medida de la calidad del audio de tu video. Dicho esto, usamos tecnología de reconocimiento de voz líder en la industria para asegurar los mejores resultados posibles para tu transcripción de MP4.",
          question_4: "Puedo transcribir MP4 a un documento de Word?",
          answer_4: "Absolutamente. Simplemente sube tu archivo MP4, haz clic en \"Transcribir\", y una vez que el proceso se complete, selecciona \"Exportar\" y elige el formato DOCX. Recibirás una transcripción completa en un documento de Word.",
          question_5: "Cómo puedo obtener subtítulos para mi video?",
          answer_5: "Sube tu video y transcríbelo. Después de la transcripción, haz clic en \"Exportar\" y selecciona el formato SRT o VTT para descargar tus subtítulos.",
          question_6: "Es seguro usar esta herramienta de transcripción de MP4?",
          answer_6: "Sí. Nuestra página no tiene anuncios, no requiere registro para procesar y no solicita información personal. También empleamos fuertes medidas técnicas para prevenir virus. Animamos a todos los usuarios a respetar las directrices de derechos de autor y privacidad al descargar, usar o compartir archivos MP4."
        },
        explore: {
          title: "Convertidor de Cualquier cosa a Texto",
          des: "La transcripción agiliza tu flujo de trabajo y te permite concentrarte en el trabajo que impulsa un impacto real.",
          tool_1: "Video a texto",
          tool_2: "MOV a texto",
          tool_3: "TikTok a texto",
          tool_4: "YouTube a texto",
          tool_5: "MP4 a SRT",
          tool_11: "Audio a texto",
          tool_12: "Voz a texto",
          tool_13: "MP3 a texto",
          tool_14: "M4A a texto",
          tool_15: "MP3 a SRT"
      ...
      youtubeTranscription: {
        hero: {
          title: "YouTube a Transcripción Online",
          des_1: "Los vídeos de YouTube se convierten instantáneamente en transcripciones — rápidas, precisas y sin registro requerido.",
          des_2: "Soporta 6 formatos de exportación, +100 idiomas y 249 traducciones."
        },
        threeStep: {
          title: "Cómo obtener",
          titleHighlight: "Resultados Precisos",
          step_1_des: "Copia el enlace del vídeo de YouTube.",
          step_2_des: "Pega el enlace en el cuadro de entrada y haz clic en «Obtener Transcripción del Vídeo».",
          step_3_des: "Espera a que la transcripción se complete y luego accede al texto para editarlo, traducirlo o exportarlo."
        },
        whatYouCan: {
          title: "Qué puedes hacer con",
          titleHighlight: "nuestra herramienta de transcripción de YouTube",
          list_title_1: "Contenido de texto flexible",
          list_des_1: "Convierte cualquier vídeo de YouTube que te guste en transcripciones de texto legibles, copiables y buscables.",
          list_title_2: "Búsqueda y edición rápidas",
          list_des_2: "Localiza fácilmente contenido clave, citas memorables o segmentos importantes del vídeo y edita el texto mientras haces referencia al mismo.",
          list_title_3: "Múltiples formatos de exportación",
          list_des_3: "Exporta transcripciones en varios formatos como TXT, PDF, DOCX, SRT, CSV y VTT, adecuados para subtítulos, edición de documentos, análisis de datos y más."
        },
        whyConvertYouTube: {
          title: "Por qué",
          titleHighlight: "convertir vídeos de YouTube a texto",
          list_title_1: "Documentación, almacenamiento y organización sencillos",
          list_des_1: "El texto es más práctico que el vídeo para tomar notas, organizar entrevistas, extraer puntos clave y crear resúmenes de investigación.",
          list_title_2: "Localizar y recuperar información importante",
          list_des_2: "Busca rápidamente contenido clave sin tener que desplazarse por la línea de tiempo del vídeo.",
          list_title_3: "Aumentar la eficiencia del aprendizaje",
          list_des_3: "Usa el texto para resaltar, referenciar y comparar contenido de forma eficaz.",
          list_title_4: "Buscar y extraer contenido",
          list_des_4: "El texto es buscable y copiable, ideal para extraer citas, hacer referencia a clips o crear guiones.",
          list_title_5: "Accesibilidad entre idiomas",
          list_des_5: "Transcribe fácilmente contenido en idiomas desconocidos y tradúcelo a múltiples idiomas.",
          list_title_6: "Reutilización de contenido",
          list_des_6: "Genera artículos, subtítulos, tarjetas para redes sociales, guiones de vídeo y más a partir de tu transcripción."
        },
        whyPeopleTrust: {
          title: "Por qué",
          titleHighlight: "la gente confía en nuestra herramienta",
          list_title_1: "Herramienta online gratuita",
          list_des_1: "No es necesario iniciar sesión. No es necesario instalar software, complementos ni extensiones.",
          list_title_2: "Cero anuncios, cero distracciones",
          list_des_2: "Una interfaz limpia y sencilla diseñada para satisfacer tus necesidades sin interrumpir tu flujo de trabajo.",
          list_title_3: "Conversión ultrarrápida",
          list_des_3: "Experimenta la velocidad líder en la industria sin limitaciones.",
          list_title_4: "Alta precisión",
          list_des_4: "Impulsado por la última tecnología de reconocimiento de voz para una mayor precisión.",
          list_title_5: "Amplio soporte de idiomas",
          list_des_5: "Transcribe contenido en más de 100 idiomas y lo traduce a 249 idiomas.",
          list_title_6: "Funciones de almacenamiento y edición",
          list_des_6: "Edita transcripciones en tiempo real y guarda tu trabajo para uso futuro."
        },
        howToUse: {
          title: "Formas reales en que la gente usa",
          titleHighlight: "las transcripciones de YouTube",
          list_title_1: "Para quienes toman notas",
          list_des_1: "Tomar notas mientras se ve un vídeo de YouTube puede sentirse apurado y desorganizado. Con una transcripción, puedes copiar fácilmente los puntos clave y los conceptos importantes directamente en tus notas, asegurándote de capturar todo. Incluso puedes introducir la transcripción en herramientas como ChatGPT para generar resúmenes claros, notas de estudio o esquemas.",
          list_title_2: "Para creadores de contenido",
          list_des_2: "Simplemente pega un enlace de YouTube y obtén una versión de texto precisa —un flujo de trabajo mucho más eficiente para los creadores. Usa la transcripción para redactar publicaciones de blog, guiones, subtítulos, boletines informativos o notas detalladas del programa. Ahorra tiempo y esfuerzo, permitiéndote concentrarte en el contenido mismo.",
          list_title_3: "Para profesionales y analistas",
          list_des_3: "Si tu trabajo en campos como el derecho, la medicina, la consultoría o los negocios exige una extracción de información precisa, las transcripciones facilitan el trabajo. Busca rápidamente hechos específicos, marcas de tiempo y citas sin tener que volver a ver el vídeo completo. Es ideal para revisar ponencias de expertos, presentaciones, vídeos de formación y entrevistas con clientes.",
          list_title_4: "Para usuarios con necesidades de accesibilidad",
          list_des_4: "No todo el mundo puede ver o escuchar fácilmente contenido en vídeo. Las transcripciones hacen que YouTube sea accesible para usuarios con problemas auditivos o que simplemente prefieren leer. Con compatibilidad para traducir a 249 idiomas, rompen las barreras lingüísticas, haciendo el contenido global más fácil de entender y compartir.",
          list_title_5: "Para extractores de conocimiento",
          list_des_5: "Para estudiantes, investigadores, creadores y profesionales que necesitan captar rápidamente ideas centrales, las transcripciones son inestimables. Explora, busca y localiza instantáneamente información crucial sin tener que ver vídeos largos, ayudándote a extraer eficientemente puntos clave, resúmenes o marcas de tiempo."
        },
        howToGet: {
          title: "Desbloquea nuevas ideas con",
          titleHighlight: "las transcripciones de YouTube",
          subTitle: "Transforma los vídeos de YouTube en texto fácil de copiar y procesable y combínalo con herramientas de IA como Gemini o ChatGPT para:",
          list_des_1: "Generar rápidamente notas de estudio o resúmenes",
          list_des_2: "Extraer puntos clave y citas o conceptos memorables",
          list_des_3: "Crear cuestionarios, preguntas y respuestas o materiales de estudio",
          list_des_4: "Redactar publicaciones de blog, guiones o artículos",
          list_des_5: "Desarrollar infografías, memes o contenido para redes sociales",
          list_des_6: "Producir preguntas y respuestas de fans, curiosidades o juegos educativos",
          list_des_7: "Profundizar en los temas mencionados en el vídeo",
          summary: "Todo sin complicaciones: solo copia, pega y empieza."
        },
        faq: {
          title: "Preguntas",
          titleHighlight: "Frecuentes",
          question_1: "¿Hay un límite de longitud para la transcripción de vídeos de YouTube?",
          answer_1: "No. Sin embargo, los vídeos más largos requieren más tiempo de procesamiento. Por favor, planifica tus tareas de transcripción en consecuencia.",
          question_2: "¿Funciona con vídeos privados o no listados?",
          answer_2: "Solo funciona con vídeos de YouTube públicamente disponibles. Los vídeos privados o restringidos no se pueden transcribir.",
          question_3: "¿Cuánto tiempo se tarda en obtener la transcripción?",
          answer_3: "Normalmente, el tiempo de procesamiento oscila entre 1/10 y 1/20 de la duración del vídeo. Optimizamos continuamente la velocidad garantizando al mismo tiempo una alta precisión para una mejor experiencia del usuario.",
          question_4: "¿Puede la herramienta distinguir entre diferentes hablantes?",
          answer_4: "Sí. Soporta la detección de hasta 20 hablantes, ideal para transcribir entrevistas, podcasts y discusiones.",
          question_5: "¿Cuál es la precisión de la herramienta de transcripción?",
          answer_5: "Nuestra precisión supera el 96%. Mantiene una alta precisión incluso con varios acentos o hablantes rápidos, aunque una mejor calidad de audio con menos ruido de fondo mejora los resultados.",
          question_6: "¿Qué características están incluidas en la transcripción?",
          answer_6: "La transcripción incluye la identificación automática de hablantes y marcas de tiempo. Puedes editar el texto en línea o exportarlo para un uso posterior.",
          question_7: "¿Puedo guardar mis registros de transcripción?",
          answer_7: "Sí. Simplemente regístrate una cuenta para guardar tus transcripciones después de procesar un enlace de YouTube.",
          question_8: "¿Se mantienen mis datos privados y seguros?",
          answer_8: "Sí. Tus vídeos, transcripciones y archivos se gestionan de forma segura — nunca se utilizan para entrenar modelos de IA ni se comparten con terceros.",
          question_9: "¿Puedo usar el contenido de la transcripción con otras herramientas de IA?",
          answer_9: "Absolutamente. Puedes pegar el texto en ChatGPT u otras herramientas de IA para generar resúmenes, notas, cuestionarios, guiones, artículos y más."
        }
      }
    },
    Upload: {
      ...
      fileTip: "Obtén la transcripción de tu video en segundos",
      linkTitle: "Enlace",
      linkTip: "Pega un enlace de cualquier plataforma para comenzar",
      transcribeProgress: "Transcripción en progreso...",
      transcribeFailed: "Transcripción fallida...",
      retry: "Reintentar",
      search: "Buscar",
      tip1: "¿Quieres guardarlo permanentemente?",
      tip2: "Regístrate gratis",
      tip3: "para gestionar y editar todos tus archivos de transcripción.",
      tip4: "¿Quieres",
      tip5: "guardar",
      tip6: "permanentemente?",
      tip7: "para gestionar y editar",
      tip8: "todos tus archivos de transcripción.",
      linkV1Placeholder: "Pega la URL de YouTube aquí.",
      linkV1Btn: "Obtener Transcripción del Video"
    }
  },
  About: {
    Hero: {
      ...
      title: "Acerca de",
      description:
        "Nuestra misión es proporcionar los servicios de transcripción de audio y video más precisos. Utilizando tecnología de IA líder en la industria, logramos tasas de precisión superiores al 96%. Para algunos idiomas principales, mediante optimización técnica, incluso podemos alcanzar un 99% de precisión."
    },
    Stats: {
      title: "Nuestro",
      ...
      features: [
        {
          ...
          description:
            "Nuestros modelos de IA se perfeccionan continuamente para ofrecer tasas de precisión superiores al 96%, con algunos idiomas principales alcanzando hasta un 99% de precisión mediante optimización avanzada."
        },
        {
          icon: "🌍",
          title: "Soporte de Idiomas Global",
          description:
            "Soporte para más de 100 idiomas en reconocimiento de voz y capacidades de traducción para más de 249 idiomas, haciendo que tu contenido sea verdaderamente global."
        },
        {
          icon: "⚡",
          title: "Procesamiento Relámpago",
          description:
            "Procesa horas de contenido de audio y video en minutos, no en horas. Nuestra canalización de IA optimizada garantiza que obtengas tus transcripciones rápidamente sin sacrificar calidad."
        },
        {
          icon: "🔒",
          title: "Seguridad Empresarial",
          description:
            "La seguridad de tus datos es nuestra prioridad. Usamos encriptación estándar de la industria y cumplimos con regulaciones globales de privacidad para mantener tu contenido seguro y confidencial."
        }
      ]
    },
    Company: {
  ...
  Privacy: {
    ...
    privacyPolicyTitle: "Política de Privacidad",
    policyAgreement:
      "Por favor, lee esta Política de Privacidad cuidadosamente y asegúrate de entenderla. Al usar cualquiera de nuestros Servicios, aceptas esta Política de Privacidad. Si no estás de acuerdo con nuestro uso de tus datos personales conforme a esta Política, debes dejar de usar nuestros Servicios inmediatamente.",
    policyOverview:
      "En esta política, explicamos: qué datos recopilamos y por qué; cómo se manejan tus datos; y tus derechos con respecto a tus datos. No vendemos tus datos.",
    scopeTitle: "1. Alcance de esta Política de Privacidad",
    scopeDescription:
      "Esta Política de Privacidad aplica solo a nuestra recopilación y procesamiento de información sobre usuarios de los Servicios. Esta Política de Privacidad no aplica a ningún servicio, sitio web o software operado por terceros que estén vinculados a nosotros (ya sea que nosotros proporcionemos esos enlaces u otros usuarios los compartan) ni aplica a contenido, datos, aplicaciones o materiales de terceros. Te recomendamos que revises las políticas de privacidad de cualquier sitio web o software de terceros antes de proporcionarles cualquier información.",
    collectionTitle: "2. Qué recopilamos y por qué",
    collectionPrinciple:
      "Nuestro principio rector es recopilar solo lo que necesitamos. Esto es lo que significa en la práctica:",
    identityTitle: "2.1 Identidad y acceso",
    identityDescription:
      "Cuando te registras en uno de nuestros productos, solicitamos información de identificación como tu nombre y dirección de correo electrónico. Esto es para proporcionar funcionalidad esencial del producto y para que podamos enviarte actualizaciones del producto y otra información esencial.",
    billingTitle: "2.2 Información de facturación",
    billingDescription:
      "Si te registras en un producto de pago, se te pedirá que proporciones tu información de pago y dirección de facturación. La información de pago se envía directamente a nuestro procesador de pagos y no llega a nuestros servidores.",
    productInteractionsTitle: "2.3 Interacciones con el producto",
    productInteractionsDescription:
      "Almacenamos en nuestros servidores el contenido que subes, recibes o mantienes en tus cuentas de producto. A menos que elimines este contenido, podemos conservarlo mientras tu cuenta esté activa.",
    ...
    cookiesDescription1:
      "También usamos cookies persistentes propias y algunas cookies de terceros para almacenar ciertas preferencias, facilitar el uso de nuestras aplicaciones, realizar pruebas A/B y apoyar algunos análisis.",
    cookiesDescription2:
    ...
    correspondenceDescription:
      "Cuando nos envías un correo electrónico con una pregunta o para pedir ayuda, guardamos esa correspondencia, incluida tu dirección de correo electrónico, para tener un historial de correspondencia pasada al que hacer referencia si te comunicas en el futuro.",
    accessTitle: "3. Cuándo accedemos o compartimos tu información",
    accessDescription1:
      "Para proporcionar los productos o servicios que has solicitado. Usamos algunos subprocesadores de terceros para ayudar a ejecutar nuestras aplicaciones y proporcionarte los Servicios. Esto incluye proveedores de nube y análisis.",
    accessDescription2:
      "Para investigar, prevenir o tomar medidas respecto al abuso. Acceder a la cuenta de un cliente al investigar un posible abuso es una medida de último recurso. Queremos proteger la privacidad y seguridad tanto de nuestros clientes como de las personas que nos informan sobre problemas, y hacemos todo lo posible para equilibrar esas responsabilidades durante todo el proceso. Si descubrimos que estás usando nuestros productos para un propósito restringido, tomaremos las medidas necesarias, incluida la notificación a las autoridades correspondientes cuando sea pertinente.",
    ...
    preservationRequests:
      "Solicitudes de preservación. De manera similar, nuestra política es cumplir con las solicitudes de preservación de datos solo si estamos obligados por la Ley Federal de Comunicaciones Almacenadas de EE. UU., 18 U.S.C. Sección 2703(f), o por una citación de EE. UU. debidamente servida para asuntos civiles. No compartimos datos preservados a menos que lo exija la ley o lo obligue una orden judicial que decidamos no apelar. Además, a menos que recibamos una orden judicial, orden judicial o citación adecuada antes de que expire el período de preservación requerido, destruiremos cualquier copia preservada de los datos del cliente al final del período de preservación.",
    taxAudits:
      "Si somos auditados por una autoridad fiscal, es posible que debamos compartir información relacionada con la facturación. Si eso ocurre, compartiremos solo lo mínimo necesario, como direcciones de facturación e información de exención de impuestos.",
    securityTitle: "4. Cómo aseguramos tus datos",
    securityDescription:
      "Todos los datos se cifran mediante SSL/TLS cuando se transmiten desde nuestros servidores a tu navegador.",
    ...
    locationDescription:
      "Nuestros productos y otras propiedades web se operan en los Estados Unidos. Si te encuentras en la Unión Europea, el Reino Unido o en cualquier otro lugar fuera de los Estados Unidos, ten en cuenta que cualquier información que nos proporciones será transferida y almacenada en los Estados Unidos. Al usar nuestros sitios web o Servicios y/o proporcionarnos tu información personal, consientes esta transferencia.",
    childrenTitle: "7. Privacidad de los niños",
    updatesTitle: "8. Actualizaciones de esta Política de Privacidad",
    updatesDescription:
      "Podemos actualizar esta política según sea necesario para cumplir con las regulaciones relevantes y reflejar cualquier práctica nueva. Cada vez que hagamos un cambio significativo en nuestras políticas, actualizaremos la fecha en la parte superior de esta página.",
    contactTitle: "9. Contáctanos",
    websiteUrl: "https://www.nevercap.ai/",
    at: "à",
    childrenDescription:
      "Los Servicios no están dirigidos a niños, y no recopilamos intencionalmente Información Personal de menores de 13 años. Si usted tiene menos de 13 años, no envíe información personal a través de los Servicios. Si cree que un menor nos ha proporcionado Información Personal violando esta Política, contáctenos {at} {email} como se indica abajo.",
    contactDescription:
      "Si tiene preguntas, comentarios o quejas sobre nuestra Política de Privacidad, contáctenos {at} {email} y haremos todo lo posible por atender su queja lo antes posible.",
    policyDescriptionA:
      'Esta Política describe cómo {NeverCap} (en adelante denominado "NeverCap", "nuestro", "nosotros", "nos") recopila, usa y divulga su información personal cuando utiliza nuestros servicios, sitios web ({url}) y software (colectivamente, los "Servicios").'
  },
  TermsOfUse: {
    title: "Términos de",
    ...
    servicesDefinition:
      'Cuando decimos "Servicios", nos referimos a cualquier producto creado y mantenido por NeverCap, ya sea entregado en un navegador web, aplicación de escritorio, aplicación móvil u otro formato.',
    termsUpdate:
      "Podemos actualizar estos Términos de Servicio en el futuro. Normalmente, estos cambios han sido para aclarar algunos términos vinculando a una política relacionada ampliada. Siempre que hagamos un cambio significativo en nuestras políticas, actualizaremos la fecha en la parte superior de esta página y tomaremos las medidas adecuadas para notificar a los titulares de cuentas.",
    acceptanceTitle: "1. Aceptación del Acuerdo",
    acceptanceDescription1:
      "Al usar nuestros Servicios, usted indica su aceptación de este Acuerdo, que se convierte en un contrato vinculante entre usted y NeverCap. Usted declara que está legalmente capacitado para aceptar estos Términos y afirma que tiene la edad legal para formar un contrato vinculante. La aceptación de NeverCap está expresamente condicionada a su asentimiento a todos los términos y condiciones de este Acuerdo.",
    eligibilityRequirement:
      "Los Servicios no están destinados y no deben ser utilizados por menores de 18 años. Al usar los Servicios, usted declara y garantiza que cumple con este requisito de elegibilidad.",
    userResponsibility:
      'Los términos "usted", "su", "sí mismo" también incluyen a sus empleados, agentes, representantes comerciales y cualquier otra persona a la que usted proporcione acceso a los Servicios a través de su Cuenta (como se define a continuación). Usted es responsable de asegurarse de que todas las personas que accedan a los Servicios a través de su cuenta conozcan estos Términos y los cumplan.',
    termsRevision:
    ...
    servicesDescription1:
      "Nuestros Servicios permiten a los usuarios transformar conversaciones de voz en texto transcrito que puede ser buscado, traducido y compartido con otros.",
    servicesOptions:
      'Puede elegir si usar la versión gratuita de los Servicios ("Servicios Gratuitos") o la versión de pago por suscripción de los Servicios por la que puede estar obligado a pagar tarifas (los "Servicios de Pago").',
    servicesAccess:
      "Pondremos los Servicios a su disposición. Usted es responsable de realizar todos los arreglos necesarios para tener acceso a los Servicios.",
    accountTermsTitle: "3. Términos de la Cuenta",
    accountSecurity:
      "Usted es responsable de mantener la seguridad de su cuenta. La Compañía no puede ni será responsable por cualquier pérdida o daño derivado de su incumplimiento de esta obligación de seguridad.",
    lawfulUse: "No puede utilizar los Servicios para ningún propósito ilegal, poco ético o inmoral.",
    contentResponsibility:
      "Usted es responsable de todo el contenido publicado y de la actividad que ocurra bajo su cuenta. Eso incluye contenido publicado por otros que: (a) tengan acceso a sus credenciales de inicio de sesión; o (b) tengan sus propios inicios de sesión bajo su cuenta.",
    humanRequirement:
      'Usted debe ser un humano. No se permiten cuentas registradas por "bots" u otros métodos automatizados.',
    paymentTitle: "4. Pago, Reembolsos y Cambios de Plan",
    freeTrial:
      "Para los Servicios de pago que ofrecen una prueba gratuita, explicamos la duración de la prueba cuando se registra. Después del período de prueba, debe pagar por adelantado para seguir usando el Servicio. Si no paga, estos servicios terminarán.",
    upgradePolicy:
      "Si está actualizando de un plan gratuito a un plan de pago, cobraremos su tarjeta inmediatamente y su ciclo de facturación comenzará el día de la actualización.",
    taxes:
      "Todas las tarifas son excluyentes de todos los impuestos, gravámenes o derechos impuestos por las autoridades fiscales. Cuando sea requerido, recaudaremos esos impuestos en nombre de la autoridad fiscal y los remitiremos a las autoridades fiscales. De lo contrario, usted es responsable del pago de todos los impuestos, gravámenes o derechos.",
    refunds:
      "Todas las compras no son reembolsables. Puede cancelar cualquier servicio de pago en cualquier momento iniciando sesión en su cuenta. Para suscripciones de pago, su cancelación tendrá efecto al final del período de pago actual, a menos que se indique lo contrario.",
    cancellationTitle: "5. Cancelación y Terminación",
    cancellationPolicy:
      "Si cancela el Servicio antes del final de cualquier tiempo pagado, su cancelación tendrá efecto inmediato y no se le cobrará nuevamente. No prorrateamos automáticamente el tiempo no utilizado en el último ciclo de facturación.",
    terminationRights:
    ...
    abusePolicy:
      "El abuso verbal, físico, escrito o de otro tipo (incluidas las amenazas de abuso o represalia) de un empleado o funcionario de la Compañía puede resultar en la terminación inmediata de la cuenta.",
    submissionsTitle: "6. Envíos",
    ...
    serviceAvailability:
      'Su uso de los Servicios es bajo su propio riesgo. Proporcionamos estos Servicios "tal cual" y "según disponibilidad". No ofrecemos acuerdos de nivel de servicio para la mayoría de nuestros Servicios, pero nos tomamos en serio el tiempo de actividad de nuestras aplicaciones.',
    throttlingPolicy:
    ...
    dataSecurity:
      "Tomamos muchas medidas para proteger y asegurar sus datos a través de copias de seguridad, redundancias y encriptación. Aplicamos encriptación para la transmisión de datos a través de Internet público.",
    thirdPartyVendors:
      "Utilizamos proveedores externos y socios de alojamiento para proporcionar el hardware, software, redes, almacenamiento y tecnología relacionada necesarios para operar los Servicios.",
    siteManagementTitle: "8. Gestión del Sitio",
    ...
    copyrightCompliance:
      "Todo el contenido publicado en los Servicios debe cumplir con la ley de derechos de autor de EE.UU.",
    ipRights:
      "No reclamamos derechos de propiedad intelectual sobre el material que usted proporciona a los Servicios. Todos los materiales cargados siguen siendo suyos.",
    contentModeration:
      "No revisamos el contenido de antemano, pero nos reservamos el derecho (pero no la obligación) a nuestra sola discreción de rechazar o eliminar cualquier contenido disponible a través del Servicio.",
    prohibitedExploitation:
      "Usted acepta no reproducir, duplicar, copiar, vender, revender o explotar cualquier parte de los Servicios, el uso de los Servicios o el acceso a los Servicios sin el permiso expreso por escrito de la Compañía.",
    impersonationProhibition:
      "No debe modificar otro sitio web para implicar falsamente que está asociado con los Servicios o la Compañía.",
    dmcaPolicy:
    ...
    prohibitedActivitiesTitle: "10. Actividades Prohibidas",
    generalProhibition:
      "No podrás acceder ni usar el Sitio para ningún propósito distinto al que lo ponemos a disposición. El Sitio no podrá usarse en relación con esfuerzos comerciales, excepto aquellos que estén específicamente respaldados o aprobados por nosotros.",
    userObligations: "Como usuario del Sitio, aceptas no:",
    dataScraping:
      "Recuperar sistemáticamente datos u otro contenido del Sitio para crear o compilar, directa o indirectamente, una colección, compilación, base de datos o directorio sin nuestro permiso por escrito.",
    fraud:
      "Engañar, defraudar o inducir a error a nosotros y a otros usuarios, especialmente en cualquier intento de obtener información sensible de cuentas como contraseñas de usuario.",
    securityInterference:
      "Eludir, desactivar o interferir de cualquier manera con las funciones de seguridad del Sitio, incluidas aquellas que previenen o restringen el uso o copia de cualquier Contenido o imponen limitaciones en el uso del Sitio y/o el Contenido incluido en él.",
    ...
    supportAbuse:
      "Hacer un uso indebido de nuestros servicios de soporte o presentar informes falsos de abuso o mala conducta.",
    ...
    malware:
      "Cargar o transmitir (o intentar cargar o transmitir) virus, caballos de Troya u otro material, incluido el uso excesivo de mayúsculas y spam (publicación continua de texto repetitivo), que interfiera con el uso y disfrute ininterrumpido del Sitio por cualquier parte o que modifique, perjudique, interrumpa, altere o interfiera con el uso, características, funciones, operación o mantenimiento del Sitio.",
    automation:
      "Participar en cualquier uso automatizado del sistema, como usar scripts para enviar comentarios o mensajes, o usar cualquier herramienta de minería de datos, robots o herramientas similares de recopilación y extracción de datos.",
    ...
    disruption:
      "Interferir, interrumpir o crear una carga indebida en el Sitio o las redes o servicios conectados al Sitio.",
    employeeHarassment:
      "Acosar, molestar, intimidar o amenazar a cualquiera de nuestros empleados o agentes involucrados en proporcionarte cualquier parte del Sitio.",
    accessCircumvention:
      "Intentar eludir cualquier medida del Sitio diseñada para prevenir o restringir el acceso al Sitio o a cualquier parte del mismo.",
    codeCopying:
      "Copiar o adaptar el software del Sitio, incluidos, entre otros, Flash, PHP, HTML, JavaScript u otro código.",
    reverseEngineering:
      "Excepto según lo permita la ley aplicable, descifrar, descompilar, desensamblar o realizar ingeniería inversa de cualquier software que componga o forme parte del Sitio.",
    ...
    unauthorizedUse:
      "Hacer cualquier uso no autorizado del Sitio, incluida la recopilación de nombres de usuario y/o direcciones de correo electrónico de usuarios por medios electrónicos u otros con el propósito de enviar correos no solicitados, o crear cuentas de usuario por medios automatizados o bajo falsos pretextos.",
    competition:
      "Usar el Sitio como parte de cualquier esfuerzo para competir con nosotros o usar el Sitio y/o el Contenido para cualquier esfuerzo generador de ingresos o empresa comercial.",
    ...
    featuresDescription:
      "Diseñamos nuestros Servicios con cuidado, basándonos en nuestra propia experiencia y en la de los clientes que comparten su tiempo y comentarios. Sin embargo, no existe un servicio que agrade a todos. No garantizamos que nuestros Servicios cumplan con tus requisitos o expectativas específicas.",
    bugsDescription:
      "También probamos todas nuestras funciones antes de lanzarlas. Como cualquier software, nuestros Servicios inevitablemente tienen algunos errores. Rastreamos los errores que nos reportan y los solucionamos, especialmente aquellos relacionados con seguridad o privacidad. No todos los errores reportados se solucionarán y no garantizamos Servicios completamente libres de errores.",
    correctionsTitle: "12. Correcciones",
    informationAccuracy:
  ...
  Blog: {
    Hero: {
      ...
      description:
        "Tutoriales, estrategias y herramientas de inteligencia artificial de {NeverCap} para ayudarte a crear contenido ilimitado con flujos de trabajo de transcripción profesionales."
    },
    Featured: {
  ...
  cello: {
    exclusiveAccess: "{name} te dio acceso exclusivo a NeverCap Pro",
    proMember: "Miembro de NeverCap Pro",
    save: "Ahorra",
    unlimitedTranscription: "en transcripción de IA ilimitada",
    specialPrice: "Tu precio especial: {moneyOne}/mes (Reg. {moneyTwo})",
    whyChose: "Por qué {name} eligió NeverCap:",
    noLimits: "Sin límites mensuales (otros limitan a 120 min/mes)",
    uploadFiles: "Sube 50 archivos a la vez",
    longFiles: "Archivos de 10 horas compatibles",
    accuracy: "96% de precisión garantizada",
    regularPrice: "Precio Regular",
    perMonth: "/mes",
    getsCredit: "{name} obtiene: $50 de crédito",
    whenSubscribe: "cuando te suscribes",
    activateGift: "Activar Regalo de Bob",
    existingAccount: "↓ ¿Ya tienes una cuenta? Aplicar descuento a la cuenta existente",
    offerExpires: "La oferta expira en:",
    activeUsers: "usuarios activos",
    rating: "calificación",
    noCreditCard: "Sin tarjeta de crédito",
    requiredFreeTrial: "requerida para la prueba gratuita",
    yourSpecialPrice: "Tu Precio Especial",
    activateNameGift: "Activar Regalo de {name}",
    year: "año"
  },
  RegisterDialog: {
    transcribeNewFiles: "Transcribir nuevos archivos",
    signUpNow: "Regístrate ahora",
    stillExporting: "Exportando aún",
    tip1: "¡Regístrate gratis para guardar y editar tus archivos permanentemente!",
    tip2: "¡Actualízate para transcripciones ilimitadas!"
  }
};
