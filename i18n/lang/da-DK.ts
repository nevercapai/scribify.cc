...
let message = {
  ...
  HomePage: {
    ...
    tour: {
      ...
      step1: {
        ...
        content: "Understøtter tre transskriptionsmetoder: lokale filer, links og optagelser."
      },
      step2: {
      ...
      step3: {
        ...
        content: "Klik på elementet for at se transskriptionsdetaljer og rediger, oversæt det også."
      },
      next: "næste",
      finish: "Forstået"
    },
    ...
    welcome: {
      ...
      precision: "Få præcise transskriptioner med taleridentifikation og tidsstempler øjeblikkeligt.",
      translate: "Bryd sprogbarrierer: oversæt transskriptioner til mere end 200 sprog nemt og enkelt.",
  ...
  FolderPage: {
    ...
    dialog: {
      ...
      share: {
        title: "Del",
        label: "Alle med følgende sikre link kan se denne transskription og den tilknyttede mediefil.",
        confirm: "Kopier link",
    ...
    endRecord: {
      title: "Prompt",
      content: "Du optager. Denne handling vil afslutte optagelsen. Vil du afslutte optagelsen?",
    ...
    record: {
      ...
      dialog: {
        ...
        complete: {
          ...
          label: "Optagelsen har nået 10 timer og er automatisk stoppet. Transskriber venligst.",
          confirm: "Forstået"
        },
        speaker: {
          content: "Til taleridentifikation er filer begrænset til 3 timer. Fjern markeringen i '{text}'."
        }
      }
    },
    upload: {
      link: {
        ...
        cancel: "Annuller",
        // 请输入正确的链接
        errorTitle: "Linkadressen du indtastede er forkert. Kontroller venligst og prøv igen.",
        linkName: "Link"
      },
      file: {
      ...
      del: {
        title: "Advarsel",
        content: "Al fremskridt vil gå tabt. Bekræft annullering af transskriptionen?",
      ...
      speakerLabel: "Registrer automatisk hvem der taler",
      guest: {
        transcribe: "Transskriber",
        file: "Fil",
        audio: "Lyd-/videofil",
      ...
      howToSetup: "Hvordan konfigureres?",
      shareFilePublicly: "Del en fil offentligt",
      retry: "Prøv igen",
      edit: "Rediger",
      delete: "Slet",
      updateAndRetry: "Opdater og prøv igen"
    }
  },
  // 转录详情页
  TranscriptionPage: {
  ...
  IdentityInfoManage: {
    ...
    newOldCantSame: "Den nye adgangskode skal være forskellig fra den gamle adgangskode.", // 新密码与旧密码不能相同
    ...
    tip: "Tip",
    tipContentEmail: "Vi har netop sendt din konto-loginadgangskode til din e-mail.",
    tipContentPassword: "Tjek venligst din indbakke og log ind med din e-mail og adgangskode.",
    codeToEmail:
  ...
  AccountSettingsPage: {
    ...
    filesUploadedAtOnce: "Hver fil kan være op til 10 timer lang / 5 GB. Upload 50 filer ad gangen.",
    highestPriority: "højeste prioritet",
    weWillGiveTheHighest: "Vi vil altid transskribere dine filer hurtigst muligt med højeste prioritet.",
    ...
    automaticRenewal: "Automatisk fornyelse mislykkedes, tjek venligst betalingsmetoden.",
    ...
    oneFileUploaded: "Hver fil kan være op til 30 minutter lang. Upload 1 fil ad gangen.",
  ...
  demo: {
    ...
    waitlist: {
      cardTitle: "Tilslut dig ventelisten, få de seneste NuxtPro nyheder først OG rabatter!",
  ...
  videoLang: {
    ...
    HAVE_ENOUGH_DATA: "De tilgængelige data er tilstrækkelige til at starte afspilning",
    NETWORK_EMPTY: "Lyd/video er ikke blevet initialiseret",
    NETWORK_IDLE: "Lyd/video er aktiv og er blevet valgt til ressourcer, men intet netværk bruges",
  ...
  privacyPolicy: {
    ...
    deleteContentContent: "Hvis du sletter indhold, bliver det øjeblikkeligt utilgængeligt.",
    locationContent:
    ...
    contactUsContent1: "Hvis du har spørgsmål, kommentarer eller klager vedrørende vores privatlivspolitik, bedes du",
    contactUs: "kontakt os",
    contactUsContent2: "og vi vil bestræbe os på at behandle din klage hurtigst muligt."
  },
  termsOfService: {
    ...
    companyReference: 'Når vi siger "Virksomhed", "vi", "vores" eller "os" i dette dokument, henviser vi til Scribify.',
    servicesDefinition:
    ...
    accountTerms2: "- Du må ikke bruge Tjenesterne til ulovlige, uetiske eller umoralske formål.",
    accountTerms3:
    ...
    prohibitedActivitiesUserAgreement: "Som bruger af webstedet accepterer du ikke at:",
    prohibitedActivity1:
    ...
    prohibitedActivity4: "- Nedgøre, plette eller på anden måde skade os og/eller webstedet efter vores mening.",
    prohibitedActivity5:
    ...
    prohibitedActivity7: "- Bruge webstedet på en måde, der er uforenelig med gældende love eller regler.",
    prohibitedActivity8: "- Deltage i uautoriseret framing af eller linkning til webstedet.",
    prohibitedActivity9:
    ...
    prohibitedActivity11: "- Slet meddelelsen om ophavsret eller andre ejendomsrettigheder fra ethvert indhold.",
    ...
    prohibitedActivity20: "- Brug en indkøbsagent eller en indkøbsagent til at foretage køb på webstedet.",
    ...
    prohibitedActivity23: "- Bruge webstedet til at annoncere eller tilbyde at sælge varer og tjenester.",
    ...
    privacyPolicyContent1: "Vi bekymrer os om databeskyttelse og -sikkerhed. Gennemgå venligst vores",
    ...
    liabilityIntro: "Vi nævner ansvar i alle disse vilkår, men for at samle det hele i ét afsnit:",
    liabilityContent:
    ...
    contactUsContent1: "Hvis du har spørgsmål til nogen af servicevilkårene, bedes du venligst",
    contactUsContent2: "."
  },
  HeadNavbar: {
    Features: "Funktioner",
    ...
    Other: "Andet",
    mp4Transcription: "MP4-transskription",
    youtubeTranscription: "YouTube-transskription"
  },
  Footer: {
    ...
    Resources: "Ressourcer",
    resourcesMenus: ["YouTube til MP4","YouTube til MP3","Video-transskription","MP4-transskription","YouTube-transskription"]
  },
  Index: {
    Hero: {
      ...
      subtitleA:
        "NeverCaps AI transskriberer video og konverterer lyd til tekst og behandler 50 filer på én gang uden månedlige begrænsninger. Transskription, der virkelig skalerer med dig."
    },
    Stats: {
    ...
    FeaturesGrid: {
      ...
      transparency:
        "Ingen Skjulte Begrænsninger, Ingen Overraskelser - Mens andre stille reducerer dine minutter eller skjuler grænser i småt, tror vi på radikal gennemsigtighed",
      feat_unltd: "Faktisk Ubegrænset",
      feat_unltd_desc:
        'Ingen "fair use policy" gemt i vilkår. Ingen lagerbegrænsninger forkldt som "ubegrænset." Upload hele dit arkiv, transskriber alt til alle dine lydtransskriptionsbehov. Vi mener det.',
      feat_bulk: "Massuploadfrihed",
      feat_bulk_desc:
        'Træt af "3 livstidsimports" eller "10 filer om måneden"? Upload 50 filer ad gangen, så mange gange du har brug for. Perfekt til at bearbejde efterslæb.',
      feat_batch: "Batchbehandling",
      feat_batch_desc:
        "Bearbejd hele din podcast-sæson på én nat. Upload 50 interviews ad gangen. Lad vores AI arbejde, mens du sover. Vågn op til færdige transskriptioner.",
      feat_accuracy: "96% Nøjagtighed",
      feat_accuracy_desc:
        "Vores førende AI transskriberer lyd med smart tegnsætning, talerdiarisering for op til 20 talere og håndterer accenter og tekniske udtryk fejlfrit.",
      feat_langs: "100+ Sprog",
      feat_langs_desc:
        "Transskriber video og lyd på 100+ sprog, oversæt til 249+. Ingen ekstra gebyrer for forskellige sprog. Globalt indhold, én simpel pris.",
      feat_pro: "Professionelle Funktioner",
      feat_pro_desc:
        "Ord-niveau tidsstempler til præcis lyd-/videopositionering, nøjagtig taleridentifikation selv under hurtige samtaleskift og perfekt formateret tekst med afsnit, sætninger og tegnsætning til let læsning.",
      features: "Funktioner"
    },
    UseCases: {
      ...
      join_users:
        'Bygget til Tunge Brugere Som Dig - Tilslut dig YouTubere, indholdsproducenter og podcast-værter, der er skiftet fra "shrinkflation"-tjenester',
      podcasters: {
    ...
    FAQSection: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Ja, det er helt ubegrænset! Ingen månedlige minutgrænser, ingen ekstra gebyrer. De eneste begrænsninger er tekniske: enkelte filer kan være op til 10 timer lange eller 5GB i størrelse, og du kan behandle 50 filer ad gangen. Men du kan uploade så mange batches, du vil, hele måneden."
        },
        {
          q: "accuracy",
          question: "Hvor nøjagtig er transskriptionen?",
          answer:
            "Vi garanterer 96% nøjagtighed for klar lyd. Vores AI er trænet på millioner af timers diversificeret indhold og håndterer accenter, fagtermer og flere talere exceptionelt godt. For udfordrende lyd hjælper vores smarte forbedringsfunktioner med at forbedre resultaterne."
        },
        {
          q: "languages",
          question: "Hvilke sprog understøtter I?",
          answer:
            "Vi understøtter transskription i over 100 sprog, herunder engelsk, spansk, mandarin, hindi, arabisk, fransk og mere. Derudover kan du oversætte dine transskriptioner til 249 forskellige sprog, hvilket gør det perfekt til globalt indhold."
        },
        {
          q: "speed",
          question: "Hvor hurtig er transskriptionen?",
          answer:
            "Lynhurtig! En 1-times lydfil behandles typisk på under 5 minutter. Med batchbehandling kan du uploade 50 filer samtidig og lade dem behandle parallelt. De fleste brugere vågner op og opdager, at hele deres bibliotek er transskriberet over natten."
        },
        {
          q: "cancellation",
          question: "Kan jeg annullere når som helst?",
          answer:
            "Absolut! Ingen kontrakter, ingen annulleringsgebyrer. Du kan opgradere, nedgradere eller annullere dit abonnement når som helst fra dit dashboard. Hvis du annullerer, beholder du adgang indtil slutningen af din faktureringsperiode."
        },
        {
          q: "security",
          question: "Er mine data sikre?",
          answer:
            "Din sikkerhed er vores prioritet. Vi er SOC 2-certificerede, bruger 256-bit kryptering til alle data og bruger aldrig dit indhold til at træne vores modeller. Du kan slette dine filer når som helst, og vi sletter dem automatisk efter 30 dage. Overholder GDPR og CCPA."
        },
        {
          q: "export_formats",
          question: "Hvilke eksportformater er tilgængelige?",
          answer:
            "Download dine transskriptioner i det format, du har brug for: PDF, Word (DOCX), Excel, CSV, SRT-undertekster, ren tekst (TXT) og VTT-undertekster. Perfekt til enhver arbejdsgang."
        },
        {
          q: "file_formats",
          question: "Hvilke lyd- og videofiler kan jeg uploade?",
          answer:
            "Vi understøtter stort set alle lyd- og videoformater, du vil støde på: MP3, MP4, M4A, MOV, AAC, WAV, OGG, OPUS, MPEG, WMA, WMV og mere. Hvis du kan afspille det, kan vi transskribere det."
        }
      ]
    },
    CTASection: {
  ...
  Features: {
    UnlimitedTranscription: {
      ...
      feature1Description:
        "Stop med at tælle minutter. Stop med at holde øje med begrænsninger. Uanset om du transskriberer 10 timer eller 10.000 timer om måneden, betaler du den samme flade pris. Ingen ekstra gebyrer. Ingen overraskelsesregninger.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Otter giver dig 3 livstidsimports gratis, 10 om måneden på Pro. Vi giver dig ubegrænset. Upload din podcastbaglog, alle dine interviews, års optagelser. Ingen begrænsninger.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        '"Jeg betaler $100/år for Otter, og de begrænser mig til 10 filimports om måneden. Det øjeblik der er et alternativ med ubegrænsede imports, er jeg væk!" - Rigtig Reddit-bruger',
      feature3Point1Icon: "✓",
    ...
    BulkUpload: {
      ...
      heroSubtitle:
        "Otter giver dig 3 livstidsimports. TRE. For hele dit liv. Vi giver dig ubegrænset upload, 50 filer ad gangen, når du har brug for det.",
      primaryCta: "Start Massesupload →",
      secondaryCta: "Se Begrænsningerne",
      redditQuote:
        '"Jeg har 3 års podcastafsnit, der skal transskriberes. Otter fortæller mig, jeg får 3 livstidsimports. TRE. Det er fornærmende."',
      redditAuthorIcon: "📍",
      ...
      feature1Description:
        'Upload 50 filer før sengetid. Vågn op til færdige transskriptioner. Ingen kø, ingen ventetid, ingen "opgrader venligst"-beskeder. Ren behandlingskraft lige ved hånden.',
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Vores parallelle behandlingsinfrastruktur betyder, at dine 50 filer ikke venter i kø. De transskriberes alle samtidigt. Hvad der før tog uger, tager nu timer.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        'Mens andre lader dig vente i virtuelle køer eller opgraderer for "prioriteret behandling," behandler vi hver upload med hast. Dit indhold betyder noget, og det bør ikke vente.',
      feature3Point1Icon: "✓",
      ...
      useCase1Description:
        "Upload 3 års afsnit på én gang. Lav transskriptioner for hele din bagkatalog. Generer SEO-indhold til hvert afsnit.",
      useCase2Title: "Kursusoprettelse",
      useCase2Description:
        "Behandl alle dine foredragsvideoer samtidigt. Lav tilgængelige transskriptioner til studerende. Byg søgbare kursusmaterialer.",
      useCase3Title: "Interviewefterslæb",
      useCase3Description:
        "Ryd den bjerg af ubehandlede interviews. Behandl ugers research på timer. Overhold din deadline uden panik.",
      useCase4Title: "YouTube-bibliotek",
      useCase4Description:
        "Generer undertekster til hele din kanal. Lav blogindlæg fra videoindhold. Forbedr SEO på alle videoer.",
      useCase5Title: "Mødearkiver",
      useCase5Description:
        "Upload måneder af optagede møder. Opret søgbare mødenoter. Mist aldrig vigtige beslutninger igen.",
      useCase6Title: "Forskningsdata",
      useCase6Description:
        "Behandle fokusgrupper i bulk. Transskriber alle deltagerinterviews. Analyser kvalitative data effektivt.",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "Brancheførende nøjagtighed på 12 hovedsprog. Ord-niveau tidsstempler til perfekt synkronisering. Smart højttaleridentifikation, der håndterer hurtige samtaler. Professionel formatering, der faktisk er læsevenlig.",
      ...
      feature1Description:
        "Hvert ord er perfekt synkroniseret med dets lydposition. Opret klikbare transskriptioner, generer præcise undertekster, eller hop til nøjagtige øjeblikke i dine optagelser. 100ms præcision, som professionelle stoler på.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Vores AI identificerer nøjagtigt talere, selv under overlappende tale, afbrydelser og hurtige frem-og-tilbage-samtaler. Perfekt til interviews, podcasts og møder, hvor talere ofte afbryder.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "Ikke flere tekstmure. Vores AI tilføjer automatisk afsnit, sætninger og tegnsætning præcis, hvor de hører til. Resultatet? Transskriptioner, der faktisk er behagelige at læse og nemme at skimme.",
      feature3Point1Icon: "✓",
      ...
      formattingBeforeText:
        "så i dag skal vi tale om de nye funktioner vi har arbejdet på jeg tror du vil synes rigtig godt om dem de er blevet efterspurgt af brugerne i lang tid og vi har endelig fået dem færdige",
  ...
  Pricing: {
    Hero: {
      ...
      highlighted_text: "Ingen skjulte begrænsninger",
      description:
        "Vælg den plan, der passer til dine behov. Opgrader eller nedgrader når som helst. Ingen binding, ingen overraskelser."
    },
    Cards: {
      title: "Enkle, gennemsigtige priser.",
      highlighted_text: "Ingen skjulte begrænsninger.",
      ...
      plans: [
        {
          ...
          features: {
            title: "Funktioner",
            items: ["100+ sprog", "Talermærkater", "Oversættelse", "Alle eksportformater"]
          },
          cta: {
      ...
      disclaimer:
        '"Ubegrænset" betyder ingen månedlig grænse og ingen kunstig nedbremsning. Fair-use gælder for misbrug af automatisering eller redistribution.'
    },
    ComparisonTable: {
      header: {
        title: "Sammenlign",
      ...
      plans: ["Funktioner", "Gratis", "Pro Månedlig", "Pro Årlig"],
      features: [
        {
          name: "Pris",
          values: [
      ...
      items: [
        {
          ...
          answer:
            "Ja! Pro-planer har ingen månedlige minutgrænser. De eneste begrænsninger er tekniske: maksimal filvarighed på 10 timer og filstørrelse på 5GB. Du kan behandle så mange filer, du har brug for."
        },
        {
          q: "plan_change",
          question: "Kan jeg skifte plan når som helst?",
          answer:
            "Absolut! Du kan annullere dit abonnement når som helst fra dit dashboard. Opgrader eller nedgrader, når du har brug for det."
        },
        {
          q: "payment_methods",
        ...
        },
        {
          ...
          answer:
            "Ja! Prøv Pro gratis i 7 dage, ingen kreditkort nødvendigt. Plus, få din første måned med 45% rabat, når du abonnerer."
        },
        {
          q: "file_retention",
        ...
        },
        {
          ...
          answer:
            "Vi er SOC 2-certificerede og bruger 256-bit kryptering. Vi bruger aldrig dit indhold til at træne vores modeller. Dine data tilhører dig."
        }
      ]
    },
    CTA: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description:
          "Upload hele dit podcastarkiv på én gang. Generer shownoter, forbedr SEO og genanvend indhold uden at tælle minutter.",
        benefits: {
      ...
      journalists: {
        ...
        description:
          "Upload alle interviews i batch før deadline. Søg i transskriptioner med det samme og gå aldrig glip af et afgørende citat.",
        benefits: {
      ...
      contentCreators: {
        ...
        description:
          "Tekst hele din YouTube-kanal. Generer undertekster på flere sprog og forbedr din video-SEO med det samme.",
        benefits: {
      ...
      researchers: {
        ...
        description:
          "Behandl hele forskningsstudier på én gang. Håndter fokusgrupper, interviews og paneldiskussioner med perfekt talergenkendelse.",
        benefits: {
      ...
      businessTeams: {
        ...
        description:
          "Optag møder direkte eller upload lydfiler til øjeblikkelig transskription. Byg søgbare arkiver fra ubegrænsede samtaler og mist aldrig vigtige diskussioner igen.",
        benefits: {
      ...
      educators: {
        ...
        description:
          "Indsæt blot YouTube-links for at få øjeblikkelige transskriptioner og automatisk genererede undertekster. Gør enhver undervisningsvideo tilgængelig og søgbar.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter:
              'som ikke var transskriberet. Otter ville have mig til at vælge 3. TRE. NeverCap lod mig uploade alle 150 afsnit på en weekend."',
            name: "Mike Rodriguez",
            role: "Podcastvært"
          },
          jessica: {
            ...
            highlight: "$100/måned",
            textAfter:
              ', men jeg kan heller ikke arbejde med Otters grænse på 10 filer om måneden. NeverCap reddede min karriere."',
            name: "Jessica Park",
            role: "Freelancejournalist"
          },
          sarah: {
            ...
            highlight: "200 timer",
            textAfter:
              'med fokusgruppeoptagelser. Vi behandlede alt på en weekend i stedet for at rationere månedlige minutter."',
            name: "Dr. Sarah Chen",
      ...
      heroSubtitleA:
        "Fra podcastere med mange års efterslæb til forskere med hundredvis af interviews. Se, hvordan professionelle bruger {NeverCap} til at bryde fri fra uploadgrænser og minutbegrænsninger."
    },
    Podcasters: {
      ...
      heroSubtitle:
        "Upload hele din bagkatalog. Opret shownoter til hver episode. Ikke mere at vælge hvilke episoder der skal transkriberes.",
      ...
      problems: {
        problem1: {
          ...
          description:
            "Otter giver dig 3 livstidsimports gratis, 10 om måneden på Pro. Hvordan transkriberer du 3 års episoder?"
        },
        problem2: {
          title: "Manglende SEO-muligheder",
          description:
            "Hver utranskriberet episode er mistet SEO-trafik. Men Descript begrænser dig til højst 30 timer/måned."
        },
        problem3: {
          title: "Omkostninger eksploderer med vækst",
          description:
            "Når din podcast vokser, eksploderer transskriptionsomkostningerne. $2/time overforbrug gør skalering umulig."
        }
      },
      solutionTitle: "Det",
      ...
      features: {
        feature1: {
          ...
          description:
            "Registrerer og mærker automatisk op til 20 talere. Perfekt til paneldebatter, interviews og co-hostede shows."
        },
        feature2: {
          title: "Tidsstempelkapitler",
          description:
            "Generér klikbare tidsstempler til YouTube-beskrivelser. Lad lyttere hoppe til deres yndlingssegmenter med det samme."
        },
        feature3: {
          title: "Smart Formatering",
          description:
            "Tilføjer automatisk afsnit, sætninger og tegnsætning. Få rene, læsevenlige transskriptioner. Spar timer på postproduktion."
        },
        feature4: {
        ...
        feature6: {
          ...
          description:
            "Upload 50 episoder før sengetid. Vågn op til færdige transskriptioner. Behandl hele dit arkiv på én nat."
        }
      },
      ...
      solutionDescriptionA:
        "Med {NeverCap} får du ægte ubegrænset transskription. Upload hele dit arkiv. Transskriber alle nye episoder. Generer shownoter i stor skala. Ingen begrænsninger, ingen grænser, kun vækst."
    },
    Journalists: {
      hero: {
        ...
        subtitle:
          "Stop med at vælge, hvilke interviews der fortjener transskription. Upload alle optagelser på én gang, søg på tværs af alt med det samme, og overhold dine deadlines uden upload-angst.",
      ...
      problem: {
        ...
        problems: {
          uploadLimits: {
            ...
            description:
              "Otter giver dig 10 filimport pr. måned på Pro. Hvordan transskriberer du 3 uger med undersøgelsesinterviews?"
          },
          missingQuotes: {
            title: "Mangler Afgørende Citater",
            description:
              "Hvert utransskriberet interview kunne indeholde historiens nøglecitat. Men Trint begrænser dig til højst 50 timer/måned."
          },
          costExplosion: {
            title: "Omkostninger Eksploderer med Deadlines",
            description:
              "Når din undersøgelse uddybes, skynder transskriptionsomkostningerne sig. $100/måned i overforbrug gør breaking news umuligt."
          }
        },
        solution: {
          title: "The",
          ...
          descriptionA:
            "Med {NeverCap} får du ægte ubegrænset transskription. Upload hele din undersøgelse. Transskriber alle interviews. Søg i alle citater med det samme. Ingen store bogstaver, ingen begrænsninger, kun journalistik."
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description:
              "I modsætning til software med minutbegrænsninger kan du transskribere hvert interview, fra en hurtig snak til en flertimers diskussion. Bekymre dig aldrig for at løbe tør for kredit ved en deadline.",
            points: {
          ...
          instantSearch: {
            ...
            description:
              "Få din interviewtransskription tilbage på minutter, ikke dage. Lav historier hurtigere end nogensinde. Vores AI behandler timers lyd, mens du tager en kop kaffe.",
            points: {
          ...
          professionalAccuracy: {
            ...
            description:
              "Vores AI leverer højt nøjagtige transskriptioner, der sikrer, at de citater du offentliggør er præcise og pålidelige. Professionel transskription som redaktører stoler på.",
            points: {
          ...
          ironclad: {
            ...
            description:
              "Vi tilbyder robuste sikkerhedsfunktioner til at beskytte dine følsomme interviewdata og fortrolige kilder. Bankniveau kryptering sikrer dine undersøgelser.",
            points: {
      ...
      testimonials: {
        jessica: {
          quote:
            "Jeg havde 3 års interviews, der ikke var transskriberet på grund af uploadbegrænsninger. NeverCap lod mig behandle alt på én weekend. Et vendepunkt.",
          name: "Jessica Park",
      ...
      cta: {
        ...
        subtitle:
          "Tilslut dig tusindvis af journalister, der stoppede med at tælle uploads og begyndte at fokusere på historier",
    ...
    ContentCreators: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "Vores værktøj forenkler transskription af videoindhold. For at transskribere en Instagram-video, indsæt blot linket. Det samme gælder for Vimeo-videoer. Bearbejd hele din kanals baglog på en weekend.",
          points: {
        ...
        globalReach: {
          ...
          description:
            "Ræk ud til et globalt publikum med automatisk oversættelse til 100+ sprog. Generer undertekster på flere sprog samtidig. Ingen ekstra omkostninger, ingen månedlige loft for oversættelser.",
          points: {
        ...
        flexibleExport: {
          ...
          description:
            "Eksporter i det format, der passer til din arbejdsproces. Fra SRT-filer til YouTube til VTT til webafspillere eller redigerbare dokumenter til manuskripter. Alle eksporter ubegrænsede, alle inkluderet i enhver plan.",
          points: {
      ...
      testimonials: {
        ...
        carlos: {
          ...
          textAfter:
            "for større rækkevidde. Ingen begrænsninger, kun vækst. Mine kanalvisninger steg 3x efter tilføjelse af flersprogede undertekster.",
        ...
        sarah: {
          ...
          textAfter:
            ". Jeg har 500+ videoer i baglog. NeverCap lod mig behandle alt på én weekend. SEO-gevinsten fra underteksterne betalte for sig selv i den første måned.",
          highlight: "30 timer",
          name: "Sarah Lee",
        ...
        jake: {
          textBefore: "Dette",
          textAfter:
            "funktionen er en game-changer. Jeg downloader ikke længere noget. Bare indsæt, transskriber, færdig. Behandling af mine podcastklip til TikTok har aldrig været nemmere.",
        ...
        yuki: {
          ...
          textAfter:
            ". NeverCap giver mig ubegrænsede oversættelser. Min internationale publikum voksede med 400% siden jeg begyndte at bruge rigtige native undertekster.",
        ...
        questions: [
          {
            ...
            answer:
              "Det er enkelt. Find bare den YouTube-video, du vil transskribere, kopier dens URL, og indsæt den i vores app. Vores AI vil automatisk hente videoen og levere en fuld teksttransskription på få minutter."
          },
          {
            question: "Q: Hvad er den bedste måde at transskribere en Facebook-video til tekst?",
            answer:
              "Den nemmeste måde er at bruge et direkte link. Kopier URL'en for Facebook-videoen, og vores platform håndterer resten, konverterer talen til tekst med op til 96% nøjagtighed og sparer dig for manuel transskription."
          },
          {
            question: "Q: Kan jeg transskribere TikTok- og Instagram-videoer?",
            answer:
              "Absolut. Vi understøtter transskription for både TikTok- og Instagram-videoer. Dette er perfekt til indholdsskabere, der vil genbruge deres kortformatsvideoindhold til blogindlæg, artikler eller tekstbaserede sociale medieopdateringer."
          },
          {
            question: "Q: Hvordan transskriberer jeg en Vimeo-video til tekst?",
            answer:
              "Transskription af Vimeo-videoer er lige så nemt som på enhver anden platform. Bare kopier Vimeo-videoens URL og indsæt den i NeverCap. Vores AI behandler videoen og genererer en præcis teksttransskription, som du kan downloade i flere formater."
          }
        ]
      }
    },
    Researchers: {
      ...
      heroSubtitle:
        "Stop med at vælge hvilke fokusgrupper der skal transskriberes. Behandl alle dine kvalitative data med 96% nøjagtighed og fejlfri taleridentifikation - selv med 20 deltagere der taler over hinanden.",
      ...
      problemCard2Desc:
        "Hvert utransskriberet interview kunne indeholde banebrydende indsigter. Men Rev tager minimum $2/minut.",
      problemCard3Title: "Tilskudspenge Forsvinder",
      problemCard3Desc:
        "Når din datasæt vokser, eksploderer transskriptionsomkostningerne. $500 pr. fokusgruppe gør skalering umulig.",
      solutionTitle: "NeverCap Løsning",
      feature1Label: "Ingen Grænser",
      feature1Title: "Håndter dit",
      feature1Desc:
        'Upload alle 200 timers interviews i aften. Vågn op til færdige, søgbare transskriptioner. Ingen månedlige begrænsninger, ingen filgrænser, ingen "fair use" BS.',
      ...
      feature2Desc:
        "Vores AI sporer op til 20 talere, selv når de taler over hinanden, afbryder eller svarer på én gang. Hver stemme fanges og mærkes korrekt.",
      ...
      feature3Desc:
        "Håndterer fagterminologi, tykke accenter og fagspecifikt sprog som en pro. Nøjagtigt nok til publikation, fagfællebedømmelse og dit afhandlingsudvalg.",
      ...
      feature4Desc:
        "Dine følsomme forskningsdata er beskyttet med virksomhedsklasse sikkerhed. GDPR-kompatibel, HIPAA-klar muligheder og fulde revisionsspor til IRB-krav.",
      ...
      useCase1Desc:
        "Håndter 8-20 deltagere med overlappende tale. Perfekt taleridentifikation selv under heftige diskussioner. Eksporter direkte til kvalitativ analyse software.",
      useCase2Title: "Dybdegående Interviews",
      useCase2Desc:
        "Behandl hundredvis af en-til-en interviews samtidig. Oprethold konsistens i hele dit datasæt. Søg på tværs af alle transskriptioner med det samme.",
      useCase3Title: "Klinisk Forskning",
      useCase3Desc:
        "HIPAA-kompatible muligheder for patientinterviews. Præcis transskription af medicinsk terminologi. Sikker håndtering af følsomme sundhedsdata.",
      useCase4Title: "Etnografiske Studier",
      useCase4Desc:
        "Optagelser i naturlige omgivelser. Håndter baggrundsstøj og flere talere. Understøttelse af 100+ sprog og dialekter.",
      useCase5Title: "Mundtlige Historieprojekter",
      useCase5Desc:
        "Bevar hele arkiver uden begrænsninger. Opret søgbare historiske optegnelser. Perfekt til længerevarende og generationelle studier.",
      useCase6Title: "Afhandlingsforskning",
      useCase6Desc:
        "Studievejledende priser med alle funktioner. Behandl hele dit datasæt til en overkommelig pris. Overhold stramme deadlines med batchbehandling.",
      testimonialTitle: "Betroet af",
      testimonialText:
        "Vores forskerteam havde 200 timers fokusgruppeoptagelser fra vores sundhedsundersøgelse. Andre tjenester bad os vælge, hvilke sessioner der skulle transskriberes på grund af omkostningerne. NeverCap lod os behandle alt i løbet af en weekend. 20-talergenkendelsen fungerede faktisk – selv under vores mest rodede diskussioner, hvor alle talte på én gang. Dette værktøj har fuldstændig ændret, hvordan vi håndterer kvalitative data.",
      ...
      testimonialText3:
        "af fokusgruppeoptagelser fra vores samfundssundhedsundersøgelse. Andre tjenester bad os vælge hvilke sessioner der skulle transskriberes på grund af omkostningerne. NeverCap lod os behandle",
      testimonialText4Hl: "alt i løbet af en weekend",
      testimonialText5:
        ". 20-talshøjttaleridentifikationen fungerede faktisk - selv under vores mest rodede diskussioner hvor alle talte på én gang. Dette værktøj har",
      testimonialText6Hl: "helt ændret",
      testimonialText7: "hvordan vi håndterer kvalitative data.",
      solutionDescA:
        "Med {NeverCap} får du ægte ubegrænset transskription. Upload hele din undersøgelse. Transskriber alle interviews. Analysér alle dine data. Ingen begrænsninger, ingen begrænsninger, kun research."
    },
    BusinessTeams: {
      ...
      feature1Desc:
        "Ingen downloads, ingen plugins. Start optagelse med ét klik. Perfekt lydkvalitet, automatisk talergenkendelse.",
      ...
      feature2Desc:
        "Har du optagelser fra Zoom, Teams eller din telefon? Upload dem med det samme. Understøttelse af alle større lyd- og videoformater. Behandl flere filer samtidig uden ventetid.",
      ...
      feature3Desc:
        "Del transskriptioner med dit team med det samme. Lyt til optagelser sammen, eksporter transskriptioner i flere formater, og sikr at alle forbliver på samme side med søgbare mødearkiver.",
      ...
      feature4Desc:
        "Søg på tværs af alle dine møder på én gang. Find den afgørende beslutning fra sidste kvartal eller kundekravet fra måneder siden. AI-drevet søgning forstår kontekst, ikke kun nøgleord.",
      ...
      workflowStep1Desc:
        "Start liveoptagelse eller download blot mødeoptagelsen fra Zoom, Google Meet eller Microsoft Teams",
      ...
      testimonial1Text:
        '"Vi gik fra at gå glip af afgørende detaljer til at have et søgbart arkiv over hver samtale. Den direkte optagefunktion betyder, at vi aldrig glemmer at fange vigtige diskussioner."',
      testimonial1AuthorName: "James Kim",
      testimonial1AuthorRole: "Produktchef, TechCorp",
      testimonial2Text:
        '"Otter begrænsede os til 10 filupload pr. måned. Nu uploader vi alle vores kundeopkald med det samme. En gamechanger for vores salgsteams opfølgning."',
      testimonial2AuthorName: "Sarah Rodriguez",
      testimonial2AuthorRole: "Salgsdirektør, ConsultPro",
      testimonial3Text:
        '"Evnen til at søge på tværs af måneders møder reddede os under vores revision. Fandt enhver beslutning og godkendelse på sekunder."',
      ...
      heroSubtitleA:
        "Optag møder direkte i din browser, eller upload lydfiler med det samme. Opbyg søgbare arkiver fra ubegrænsede samtaler. Mist aldrig vigtige diskussioner igen med virkelig ubegrænset transskription fra {NeverCap}."
    },
    Educators: {
      ...
      heroSubtitle:
        "Indsæt blot YouTube-links for at få øjeblikkelige transskriptioner med automatisk genererede undertekster. Omform forelæsninger, tutorials og undervisningsvideoer til søgbart, tilgængeligt indhold, som alle elever kan lære af.",
      heroCtaPrimary: "Prøv gratis - ingen kreditkort",
      ...
      feature1Desc:
        "Bare indsæt enhver videolink og få øjeblikkelige transskriptioner. Virker med YouTube, Vimeo, Facebook, X (Twitter), TikTok, Instagram, Dropbox, Google Drive og mere. Ingen download, ingen ventetid.",
      ...
      feature2Desc:
        "Opret præcise tekster til alle dine undervisningsvideoer med det samme. Gør indhold tilgængeligt for studerende med hørehandicap, ikke-indfødte talere eller dem der foretrækker at læse med.",
      ...
      feature3Desc:
        "Opret mapper for at organisere dine transskriptioner efter kursus, fag eller semester. Hold alt dit undervisningsindhold pænt kategoriseret og nemt søgbart. Byg en omfattende bibliotek af tilgængelige kursusmaterialer.",
      ...
      feature4Desc:
        "Del ikke bare optagelser. Transskriber automatisk forelæsninger til tekst og andre lydfiler til detaljerede studievejledninger, komplet med resuméer og nøglebegreber til effektiv studerenderevision. Eksporter i TXT, DOCX eller PDF-formater.",
      ...
      useCase1Text:
        "Transskriber hele semestres optagne forelæsninger. Studerende kan søge efter specifikke emner, gennemgå nøglebegreber og undgå at gå glip af vigtig information.",
      useCase2Title: "Onlinekurser",
      useCase2Text:
        "Gør dine onlinekurser tilgængelige for internationale studerende med oversættelser i 100+ sprog. Øg tilmelding og tilfredshed.",
      useCase3Title: "Studiematerialer",
      useCase3Text:
        "Brug AI til at transskribere lydfiler til studieguider fra videovejledninger og forelæsninger. Perfekt til studerende, der foretrækker at læse eller har brug for at gennemgå indhold hurtigt med søgbar tekst.",
      useCase4Title: "Tilgængelighedsoverholdelse",
      useCase4Text:
        "Opfyld tilgængelighedskrav ved at levere undertekster og transskriptioner for alt videoindhold. Sikrer lige adgang for alle studerende.",
      useCase5Title: "Flipped Classroom",
      useCase5Text:
        "Del videoforelæsninger med transskriptioner før timen. Studerende kan gennemgå i deres eget tempo og komme forberedt til diskussioner.",
      useCase6Title: "Forskning & Citater",
      useCase6Text:
        "Hjælp studerende med at citere videokilder præcist med tidsstempler. Perfekt til forskningsprojekter og akademiske artikler.",
      testimonialTitle: "Betroet af",
      ...
      testimonialTextA:
        '"Jeg har brugt {NeverCap} til at transskribere hele min YouTube-kanal med matematikvejledninger. Det, der plejede at tage uger med andre tjenester, tager nu timer. Muligheden for at indsætte links direkte og få øjeblikkelige transskriptioner har transformeret den måde, jeg skaber tilgængeligt indhold på. Mine internationale studerende elsker især de flersprogede undertekster!"'
    }
  },
  Resources: {
    YouTubeToMP4: {
        ...
        list: [
          {
            ...
            content:
              "Normalt forbruger det betydelig mobildata at se videoer på YouTube. Ved at downloade til offlineafspilning kan du undgå disse unødvendige omkostninger."
          },
          {
            title: "Se hvor som helst, når som helst:",
            content:
              "Nyd dine videoer problemfrit, selv med ustabil internetforbindelse. Ingen buffering at bekymre sig om."
          },
          {
            title: "Nem arkivering og opbevaring:",
            content:
              "At gemme videoer som MP4-filer gør det nemt at opbygge din personlige samling, især for indhold, du finder virkelig værdifuldt eller vigtigt."
          },
          {
            title: "Nemmere deling:",
            content:
              "Det er meget mere bekvemt at dele en MP4-fil end at sende et link. Du kan sende videofilen direkte via apps som WhatsApp eller Instagram og undgå det ekstra trin med at åbne YouTube."
          },
          {
            title: "Øjeblikkelig visning, delte øjeblikke:",
            content:
              "Vil du glædeligt vise en yndlingsvideo til venner eller familie i nærheden? Med MP4'en downloadet kan I alle se den glat sammen med det samme uden akavede pauser, mens den loader."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Nyd et rent interface uden pop-ups, bannere eller afbrydelser – bare problemfri videokonvertering."
          },
          {
            icon: "5",
            color: "#DEE5FF",
        ...
        list: [
          {
            ...
            answer:
              "Det er ulovligt at downloade ophavsretsbeskyttede YouTube-videoer uden ophavsretshaverens tilladelse."
          },
          {
            question: "Er dette downloadværktøj sikkert?",
            answer:
              "Ja, det er sikkert og pålideligt. Vi kræver ikke personlige oplysninger fra brugerne og tager stærke forholdsregler mod virus. Vi minder dig om altid at være forsigtig, når du downloader filer fra internettet: Undgå at klikke på mistænkelige links eller downloade tvivlsomme filer."
          },
          {
          ...
          },
          {
            ...
            answer:
              "Selvom vi sikrer den hurtigst mulige downloadoplevelse, påvirkes downloadtiden også af faktorer som videolængde og din internetforbindelses hastighed."
          },
          {
            question: "Hvor bliver MP4-videoen gemt, når jeg downloader den på min smartphone?",
            answer:
              'Efter at have downloadet en MP4-fil på din smartphone, kan du normalt finde den i mappen "Downloads" i din enheds filhåndteringsapp.'
          },
          {
            question: "Reducerer download af en YouTube-video som MP4 videokvaliteten?",
            answer:
              "Nej. Download af YouTube-videoer som MP4 med vores værktøj bevarer den originale videokvalitet. Konverteringsprocessen bevarer kildens kvalitet, så du får den samme visningsoplevelse som på YouTube."
          }
        ]
      },
      ...
      videoDownload: {
        ...
        description:
          "Tak fordi du valgte vores service! Vi sætter stor pris på din tillid og håber, det forbedrede din oplevelse. Hvis du vil dele vores hjemmeside med dine venner, ville det være en stor hjælp.",
      ...
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Konverter YouTube-videoer til MP3-format til offlinevisning. Download videoer i høj kvalitet med det samme.",
        AITranscription: "AI-transkription",
        AITranscription_des:
          "Transskriber lyd- og videofiler med 96% nøjagtighed. Ubegrænset transskription af alt dit indhold."
      }
    },
    YouTubeToMP3: {
      err1: "Fejl i YouTube-linkformat.",
      ...
      part4: {
        content: ["Her er de 5 største fordele ved at konvertere", "YouTube-videoer til MP3-filer"],
        list: [
          {
            title: "Spar på lagerplads:",
            content:
              "MP3-filer er mindre, hvilket reducerer lagerplads på YouTube. Spar på mobildata ved at downloade offlinevisning, og brug dem, når der er internetforbindelse."
          },
          {
            title: "Sparer batteri:",
            content:
              "For at se YouTube-videoer bruger de en bufferingtjeneste, der bruger forbindelser, der er nemme at lytte til. Slut med bekymringer om buffering."
          },
          {
            title: "Nem arkivering og bevaring:",
            content:
              "Nogle videoer eller MP3-filer gør det nemt at opbygge dit personlige bibliotek – uanset om det er til uddannelsesmæssigt indhold, musikarkiver eller vigtige ting."
          },
          {
            title: "Enklere deling:",
            content:
              "Det er meget mere praktisk at dele en MP3-fil end YouTube-links. Du kan sende filer til venner via apps som WhatsApp eller Instagram, hvilket eliminerer omkostningerne ved at åbne YouTube."
          },
          {
            title: "Øjeblikkelig visning, bred fleksibilitet:",
            content:
              "Få adgang til en bredere vifte af yndlingsvideoer ved at konvertere YouTube-videoer, hvor du har brug for dem, og MP3-formater giver mulighed for problemfri sammensætning med det samme, uden akavede pauser i ventetiden på denne indlæsning."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Nyd en ren brugerflade uden pop op-vinduer, bannere eller afbrydelser - bare problemfri og uafbrudt konvertering."
          },
          {
      ...
      part6: {
        title: ["Maksimér dine YouTube til MP3-konverteringer", "Med vores konverter"],
        ...
        list: [
          {
            ...
            answer:
              "Selvom det er teknisk muligt, kan konvertering af ophavsretligt beskyttet indhold uden tilladelse være i strid med YouTubes servicevilkår og ophavsretslove. Sørg altid for, at du har ret til at konvertere indhold eller bruge det udelukkende til personlige, ikke-kommercielle formål."
          },
          {
            question: "Er dette konverteringsværktøj sikkert?",
            answer:
              "Ja, vores konverter er fuldstændig sikker. Vi gemmer ikke dine data eller filer, og der er ingen risiko for malware eller virus. Konverteringen sker direkte og sikkert."
          },
          {
            question: "Hvilke sprog understøtter YouTube til MP3-konvertering?",
            answer:
              "Vores konverter understøtter alle sprog, der er tilgængelige på YouTube. Lyden udtrækkes præcis som den vises i den originale video, hvilket bevarer det originale sprog og lydkvaliteten."
          },
          {
            question: "Hvilke faktorer påvirker den tid det tager at konvertere en YouTube-video?",
            answer:
              "Konverteringstiden afhænger af flere faktorer: videoens længde, din internetforbindelses hastighed og den aktuelle serverbelastning. De fleste videoer under 10 minutter konverteres på under 30 sekunder."
          },
          {
            question: "Når jeg konverterer og downloader en MP3 med min smartphone, hvor gemmes den så?",
            answer:
              "På de fleste smartphones gemmes konverterede MP3-filer i din Downloads-mappe. På iPhone kan de gå til din Filer-app. På Android skal du tjekke din Downloads-mappe i din filhåndtering eller musikapp."
          },
          {
            question: "Forringer konvertering af en YouTube-video til MP3 lydkvaliteten?",
            answer:
              "MP3 er et format, der kun indeholder lyd, så der er ingen videokomponent. Lydkvaliteten bevares ved den højest tilgængelige bitrate fra kildevideoen, typisk 128-320 kbps afhængigt af den oprindelige uploadkvalitet."
          }
        ]
      },
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Konverter YouTube-videoer til MP4-format til offlinevisning. Download videoer i høj kvalitet med det samme.",
        AITranscription: "AI-transkription",
        AITranscription_des:
          "Transskriber lyd- og videofiler med 96% nøjagtighed. Ubegrænset transskription af alt dit indhold."
      },
      videoDownload: {
        ...
        description:
          "Tak fordi du valgte vores service! Vi sætter stor pris på din tillid og håber, at det har forbedret din oplevelse. Det ville være en stor hjælp, hvis du ville dele vores hjemmeside med dine venner.",
        downloadButton: "Download",
        TranscribeButton: "Transskriber",
    ...
    Transcription: {
      ...
      mp4Transcription: {
        hero: {
          title: "Online MP4 til Tekst Konverter",
          des_1: "Konvertér dine MP4-filer til tekst på få sekunder.",
          des_2: "Ingen tilmelding påkrævet. Lynhurtig. Top-nøjagtighed.",
          feature_1: "Understøtter 12 Formater",
          feature_2: "Understøtter 100+ Sprog",
          feature_3: "Eksporter i 6 Formater"
        },
        threeStep: {
          title: "Transskriber din MP4 til",
          titleHighlight: "tekst i 3 nemme trin",
          step_1_title: "Upload din MP4-fil",
          step_1_des: "Træk og slip den blot i det udpegede område, eller klik på \"Upload Fil\"-knappen.",
          step_2_title: "Start Transskription",
          step_2_des: "Klik på \"Transskriber\"-knappen. Systemet vil automatisk konvertere din MP4 til tekst på øjeblikke.",
          step_3_title: "Download Din Transskription",
          step_3_des: "Din tekst er klar til online redigering og kan eksporteres i TXT, PDF, DOCX, SRT, CSV, VTT formater, eller deles via et link."
        },
        howToGet: {
          title: "Hvordan Får du de Bedste Resultater fra",
          titleHighlight: "Din Transskription?",
          fun_1: "Brug den originale videofil til transskription, frem for en komprimeret version.",
          fun_2: "Reducer baggrundsstøj, baggrundsmusik, støj eller ekko så meget som muligt.",
          fun_3: "Når du downloader en video, skal du altid vælge \"Høj Lydkvalitet (HQ)\"-indstillingen.",
          fun_4: "Aktivér \"Højtaleridentifikation\"-funktionen, når der er mere end én højtaler.",
          fun_5: "Vælg det specifikke sprog og accent for din MP4-fil, f.eks. Engelsk → Engelsk (US) / Engelsk (UK) / Engelsk (Indien).",
          fun_6: "Gennemgå hurtigt transskriptionen, når processen er færdig."
        },
        exportFormats: {
          title: "Eksportformater &",
          titleHighlight: "Deres Anvendelse",
          format_1: "I TXT-format",
          des_1: "Til Notesblok, Notepad++ og lette teksteditorer",
          format_2: "I PDF-format",
          des_2: "Til print, deling, arkivering og tv-platform visning",
          format_3: "I DOCX-format",
          des_3: "Til Microsoft Word, Google Docs og rig-tekst redigering",
          format_4: "I SRT-format",
          des_4: "Til YouTube undertekster, video undertekst uploads og medieafspillere",
          format_5: "I CSV-format",
          des_5: "Til Excel, Google Sheets og dataanalyseværktøjer",
          format_6: "I VTT-format",
          des_6: "Til web video undertekster, HTML5 afspillere og tilgængelighedsværktøjer"
        },
        howToUse: {
          title: "Hvad er værdien af at konvertere MP4 til tekst,",
          titleHighlight: "og hvordan kan du få mest ud af det?",
          effect_1: "Læs nøglepunkter med det samme.",
          des_1: "Gennemse transskriptioner hurtigere end at gen-se videoer og hurtigt lokalisere essentiel information.",
          effect_2: "Organisér studier og forskning.",
          des_2: "Omdan forelæsninger, interviews og forskningsklip til rene noter, du kan fremhæve, citere og genbruge.",
          effect_3: "Forbedr arbejdsproduktiviteten.",
          des_3: "Opret mødeopsummeringer, følgHandlingsemner, og gem indhold i dokumentation eller vidensbaser.",
          effect_4: "Støt indholds skabelse.",
          des_4: "Udtræk scripts, outlines, kladder, og eksporter undertekster til redigering eller lokalisering.",
          effect_5: "Gør indhold søgbart og oversætteligt.",
          des_5: "Fuldtekstsøgning og oversæt transskriptioner for flersproget brug.",
          effect_6: "Forenkl arkivering.",
          des_6: "Tekst er lettere at opbevare, strukturere og genbruge—ideel til optegnelser, dokumentation og AI vidensbaser."
        },
        whyChoose: {
          title: "Hvorfor",
          titleHighlight: "Vores MP4 til Tekst Transskription er Fremragende",
          reason_1_title: "Brancheførende Nøjagtighed",
          reason_1_des: "Uafhængigt verificeret som et af de mest nøjagtige transskriptionsværktøjer tilgængelige.",
          reason_2_title: "Hurtig Behandlingshastighed",
          reason_2_des: "Få din transskription på cirka en tyvendedel af den oprindelige videos længde.",
          reason_3_title: "Højtaleridentifikation",
          reason_3_des: "Skelner klart mellem højttalere, hvilket gør transskriptioner lettere at læse og følge.",
          reason_4_title: "Bred Sprogdækning",
          reason_4_des: "Understøtter transskription på 100+ sprog og oversættelse til 249 sprog.",
          reason_5_title: "Simpelt og Brugervenligt",
          reason_5_des: "Ingen komplekse interfaces eller trin. Fuldfør din opgave med få klik.",
          reason_6_title: "Fuld Datasikkerhed",
          reason_6_des: "Vi prioriterer sikkerheden og privatlivet for dine data som et af vores kerneengagementer."
        },
        faq: {
          title: "Spørgsmål om",
          titleHighlight: "Konvertering af MP4 til Tekst",
          question_1: "Hvor lang tid tager det at transskribere en MP4-fil til tekst?",
          answer_1: "Baseret på tests, under normale forhold, tager transskriptionsprocessen cirka 1/20 til 1/10 af videoens varighed. For eksempel, en 1-times video vil tage cirka 3 til 6 minutter at transskribere.",
          question_2: "Er der grænser for størrelsen af den MP4-fil, jeg uploader?",
          answer_2: "Ja. Den maksimale filstørrelse er 5GB, og videoens længde må ikke overstige 10 timer. Bemærk, at større filer kan kræve mere tid at behandle.",
          question_3: "Hvor nøjagtig er transskriptionen?",
          answer_3: "Det er vigtigt at forstå, at transskriptionskvaliteten i høj grad afhænger af lydkvaliteten af din video. Det sagt, vi bruger brancheførende talegenkendelsesteknologi for at sikre de bedst mulige resultater for din MP4 transskription.",
          question_4: "Kan jeg transskribere MP4 til et Word-dokument?",
          answer_4: "Absolut. Upload blot din MP4-fil, klik \"Transskriber\", og når processen er færdig, vælg \"Eksporter\" og vælg DOCX-formatet. Du vil modtage en fuld transskription i et Word-dokument.",
          question_5: "Hvordan kan jeg få undertekster til min video?",
          answer_5: "Upload din video og transskriber den. Efter transskription, klik \"Eksporter\" og vælg enten SRT eller VTT formatet for at downloade dine undertekster.",
          question_6: "Er dette MP4 transskriptionsværktøj sikkert at bruge?",
          answer_6: "Ja. Vores side er reklamefri, kræver ingen registrering for behandling og beder ikke om personlige oplysninger. Vi bruger også stærke tekniske forholdsregler for at forhindre virus. VI opfordrer alle brugere til at respektere ophavsrets- og privatlivsvejledninger, når de downloader, bruger eller deler MP4-filer."
        },
        explore: {
          title: "Alt-til-Tekst Konverter",
          des: "Transskription strømliner din arbejdsgang og lader dig koncentrere dig om det arbejde, der skaber reel effekt.",
          tool_1: "Video til tekst",
          tool_2: "MOV til tekst",
          tool_3: "TikTok til tekst",
          tool_4: "YouTube til tekst",
          tool_5: "MP4 til SRT",
          tool_11: "Audio til tekst",
          tool_12: "Stemme til tekst",
          tool_13: "MP3 til tekst",
          tool_14: "M4A til tekst",
          tool_15: "MP3 til SRT"
        }
      },
      youtubeTranscription: {
        hero: {
          title: "YouTube til tekst online",
          des_1: "YouTube-videoer konverteres øjeblikkeligt til tekster — hurtige, præcise og uden registrering påkrævet.",
          des_2: "Understøtter 6 eksportformater, 100+ sprog og 249 oversættelser."
        },
        threeStep: {
          title: "Sådan får du",
          titleHighlight: "præcise resultater",
          step_1_des: "Kopiér linket til YouTube-videoen.",
          step_2_des: "Indsæt linket i inputfeltet og klik på \"Få video-tekst\".",
          step_3_des: "Vent til transskriptionen er færdig. Få derefter adgang til teksten for at redigere, oversætte eller eksportere."
        },
        whatYouCan: {
          title: "Hvad du kan med vores",
          titleHighlight: "YouTube-transskriptionværktøj",
          list_title_1: "Fleksibelt tekstindhold",
          list_des_1: "Konvertér enhver YouTube-video, du kan lide, til læselige, kopierbare og søgbare tekster.",
          list_title_2: "Hurtig søgning og redigering",
          list_des_2: "Find nemt nøgleindhold, mindeværdige citater eller vigtige segmenter i videoen, og rediger teksten under henvisning til videoen.",
          list_title_3: "Flere eksportformater",
          list_des_3: "Eksportér tekster i forskellige formater som TXT, PDF, DOCX, SRT, CSV og VTT, velegnet til undertekster, dokumentredigering, dataanalyse og mere."
        },
        whyConvertYouTube: {
          title: "Hvorfor",
          titleHighlight: "konvertere YouTube-videoer til tekst",
          list_title_1: "Nem dokumentation, lagring og organisation",
          list_des_1: "Tekst er mere praktisk end video til at tage noter, organisere interviews, udtrække nøglepunkter og lave forskningssammenfattninger.",
          list_title_2: "Lokaliser og genfind vigtig information",
          list_des_2: "Find hurtigt nøgleindhold uden at skulle scrolle gennem videoens tidslinje.",
          list_title_3: "Forbedr læreeffektivitet",
          list_des_3: "Brug tekst til effektivt at fremhæve, referere og sammenligne indhold.",
          list_title_4: "Søg og udtræk indhold",
          list_des_4: "Tekst er søgbar og kopierbar, ideel til at udtrække citater, henvise til klip eller skrive manuskripter.",
          list_title_5: "Flersproget tilgængelighed",
          list_des_5: "Transskribér let indhold i ukendte sprog og oversæt det til flere sprog.",
          list_title_6: "Genbrug af indhold",
          list_des_6: "Generér artikler, undertekster, sociale medier-kort, videoscripter og mere fra din tekst."
        },
        whyPeopleTrust: {
          title: "Hvorfor folk",
          titleHighlight: "stoler på vores værktøj",
          list_title_1: "Gratis online værktøj",
          list_des_1: "Intet login krævet. Ingen software, plugins eller extensions at installere.",
          list_title_2: "Nul annoncer, nul distraktioner",
          list_des_2: "En ren og simpel grænseflade designet til at opfylde dine behov uden at afbryde din workflow.",
          list_title_3: " lynhurtig konvertering",
          list_des_3: "Oplev brancheførende hastighed uden begrænsninger.",
          list_title_4: "Høj præcision",
          list_des_4: "Drevet af den nyeste talegenkendelsesteknologi for forbedret præcision.",
          list_title_5: "Bred sprogunderstøttelse",
          list_des_5: "Transskribér indhold på over 100 sprog og oversæt til 249 sprog.",
          list_title_6: "Lagrings- og redigeringsfunktioner",
          list_des_6: "Redigér tekster i realtid og gem dit arbejde til fremtidig brug."
        },
        howToUse: {
          title: "Virkelige måder folk bruger",
          titleHighlight: "YouTube-tekster",
          list_title_1: "For notattegnere",
          list_des_1: "At tage noter, mens man ser en YouTube-video, kan føles forhastet og uorganiseret. Med en tekst kan du nemt kopiere nøglepunkter og vigtige koncepter direkte i dine noter, sikker på at fange alt. Du kan endda indtaste teksten i værktøjer som ChatGPT for at generere klare sammenfatninger, studienoter eller dispositioner.",
          list_title_2: "For indholdsskabere",
          list_des_2: "Indsæt blot et YouTube-link og få en nøjagtig tekstversion — et meget mere effektivt workflow for skabere. Brug teksten til at udforme blogindlæg, manuskripter, undertekster, nyhedsbreve eller detaljerede programnoter. Det sparer tid og indsats og lader dig fokusere på selve indholdet.",
          list_title_3: "For fagfolk og analytikere",
          list_des_3: "Hvis dit arbejde inden for områder som jura, medicin, rådgivning eller forretning kræver præcis informationsudtrækning, gør tekster arbejdet lettere. Søg hurtigt specifikke fakta, tidsstempler og citater uden at skulle se hele videoen igen. Ideel til at gennemgå ekspertforedrag, præsentationer, træningsvideoer og kundeinterviews.",
          list_title_4: "For brugere med tilgængelighedsbehov",
          list_des_4: "Ikke alle kan nemt se eller høre videoindhold. Tekster gør YouTube tilgængeligt for brugere med høreproblemer eller dem, der simpelthen foretrækker at læse. Med understøttelse for oversættelse til 249 sprog, bryder de sprogbarrierer, hvilket gør globalt indhold lettere at forstå og dele.",
          list_title_5: "For videnskabsudtrækere",
          list_des_5: "For studerende, forskere, skabere og fagfolk, der hurtigt skal forstå centrale idéer, er tekster uvurderlige. Gennemse, søg og identificeres straks afgørende information uden at skulle sidde igennem lange videoer, og hjælp dig med effektivt at udtrække nøglepunkter, sammenfatninger eller tidsstempler."
        },
        howToGet: {
          title: "Lås nye idéer op med",
          titleHighlight: "YouTube-tekster",
          subTitle: "Transformer YouTube-videoer til let kopierbar, handlingsorienteret tekst og kombiner med AI-værktøjer som Gemini eller ChatGPT for at:",
          list_des_1: "Hurtigt generere studienoter eller sammenfatninger",
          list_des_2: "Udtrække nøglepunkter og mindeværdige citater eller koncepter",
          list_des_3: "Oprette quizzer, Q&A's eller studiemateriale",
          list_des_4: "Udarbejde blogindlæg, manuskripter eller artikler",
          list_des_5: "Udvikle infografikker, memes eller indhold til sociale medier",
          list_des_6: "Producere fan Q&A's, trivia eller pædagogiske spil",
          list_des_7: "Dykkere ned i emner nævnt i videoen",
          summary: "Alt uden besvær: kopier, indsæt og begynd."
        },
        faq: {
          title: "Ofte stillede",
          titleHighlight: "spørgsmål",
          question_1: "Er der en længdegrænse for tekst af YouTube-videoer?",
          answer_1: "Nej. Dog kræver længere videoer mere behandlingstid. Planlæg dine tekstopgaver derefter.",
          question_2: "Virker det med private eller ikke-listede videoer?",
          answer_2: "Det virker kun med offentligt tilgængelige YouTube-videoer. Private eller begrænsede videoer kan ikke transskriberes.",
          question_3: "Hvor lang tid tager det at få teksten?",
          answer_3: "Typisk varierer behandlingstiden fra 1/10 til 1/20 af videoens varighed. Vi optimerer konstant hastigheden samtidig med at vi sikrer høj præcision for en bedre brugeroplevelse.",
          question_4: "Kan værktøjet skelne mellem forskellige talere?",
          answer_4: "Ja. Det understøtter detektion af op til 20 talere, ideelt til tekster af interviews, podcasts og diskussioner.",
          question_5: "Hvor præcis er tekstenværktøjet?",
          answer_5: "Vores præcision overstiger 96%. Det bevarer høj præcision selv med forskellige accenter eller hurtige talere, selvom bedre lydkvalitet med mindre baggrundsstøj forbedrer resultaterne.",
          question_6: "Hvilke funktioner er inkluderet i teksten?",
          answer_6: "Teksten inkluderer automatisk taleridentifikation og tidsstempler. Du kan redigere teksten online eller eksportere den til senere brug.",
          question_7: "Kan jeg gemme mine tekstoptegnelser?",
          answer_7: "Ja. Registrer blot en konto for at gemme dine tekster efter behandling af et YouTube-link.",
          question_8: "Holdes mine data private og sikre?",
          answer_8: "Ja. Dine videoer, tekster og filer behandles sikkert — de bruges aldrig til at træne AI-modeller eller deles med tredjeparter.",
          question_9: "Kan jeg bruge tekstindhold med andre AI-værktøjer?",
          answer_9: "Absolut. Du kan indsætte teksten i ChatGPT eller andre AI-værktøjer for at generere sammenfatninger, noter, quizzer, manuskripter, artikler og mere."
        }
      }
    },
    Upload: {
      ...
      linkV1Placeholder: "Indsæt YouTube URL her.",
      linkV1Btn: "Hent Video Transkription"
    }
  },
  About: {
    Hero: {
      ...
      title: "Om",
      description:
        "Vores mission er at levere de mest præcise lyd- og videotranskriberingstjenester. Ved at udnytte industrieledende AI-teknologi opnår vi transkriptionsnøjagtighed på over 96%. For nogle større sprog kan vi endda nå 99% nøjagtighed gennem teknisk optimering."
    },
    Stats: {
      title: "Vores",
      ...
      features: [
        {
          ...
          description:
            "Vores AI-modeller forbedres kontinuerligt for at levere transkriptionsnøjagtighed over 96%, med nogle større sprog der når op til 99% nøjagtighed gennem avanceret optimering."
        },
        {
          icon: "🌍",
          title: "Global sprogunderstøttelse",
          description:
            "Understøttelse af over 100 sprog i talegenkendelse og oversættelsesfunktioner til mere end 249 sprog, så dit indhold bliver virkelig globalt."
        },
        {
          icon: "⚡",
          title: "Lynhurtig behandling",
          description:
            "Behandl timer af lyd- og videoindhold på minutter, ikke timer. Vores optimerede AI-pipeline sikrer at du får dine transkriptioner hurtigt uden at gå på kompromis med kvaliteten."
        },
        {
          icon: "🔒",
          title: "Enterprise-grade sikkerhed",
          description:
            "Din datasikkerhed er vores prioritet. Vi bruger industristandard kryptering og overholder globale privatlivsregler for at holde dit indhold sikkert og fortroligt."
        }
      ]
    },
    Company: {
  ...
  Privacy: {
    ...
    privacyPolicyTitle: "Privatlivspolitik",
    policyAgreement:
      "Læs venligst denne privatlivspolitik omhyggeligt og sørg for at forstå den. Ved at bruge nogen af vores tjenester accepterer du denne privatlivspolitik. Hvis du ikke accepterer vores brug af dine personoplysninger i overensstemmelse med denne politik, skal du straks stoppe med at bruge vores tjenester.",
    policyOverview:
      "I denne politik beskriver vi: hvilke data vi indsamler og hvorfor; hvordan dine data håndteres; og dine rettigheder med hensyn til dine data. Vi sælger ikke dine data.",
    scopeTitle: "1. Anvendelsesområde for denne privatlivspolitik",
    scopeDescription:
      "Denne privatlivspolitik gælder kun for vores indsamling og behandling af oplysninger om brugere af tjenesterne. Denne privatlivspolitik gælder ikke for tjenester, websteder eller software drevet af tredjeparter, der er linket til os (uanset om vi leverer disse links eller andre brugere deler dem), ej heller gælder den for indhold, data, applikationer eller materialer fra tredjeparter. Vi råder dig til at kontrollere privatlivspolitikkerne for enhver tredjeparts hjemmeside eller software, før du giver dem oplysninger.",
    collectionTitle: "2. Hvad vi indsamler og hvorfor",
    collectionPrinciple:
      "Vores ledende princip er kun at indsamle det, vi har brug for. Her er, hvad det betyder i praksis:",
    identityTitle: "2.1 Identitet & adgang",
    identityDescription:
      "Når du tilmelder dig et af vores produkter, beder vi om identifikationsoplysninger såsom dit navn og e-mailadresse. Dette er for at levere essentiel produktfunktionalitet og så vi kan sende dig produktopdateringer og anden essentiel information.",
    billingTitle: "2.2 Faktureringsoplysninger",
    billingDescription:
      "Hvis du tilmelder dig et betalingsprodukt, bliver du bedt om at angive dine betalingsoplysninger og faktureringsadresse. Betalingsoplysninger sendes direkte til vores betalingsprocessor og når ikke vores servere.",
    productInteractionsTitle: "2.3 Produktinteraktioner",
    productInteractionsDescription:
      "Vi gemmer på vores servere det indhold, du uploader, modtager eller opbevarer i dine produktkonti. Medmindre du sletter dette indhold, kan vi beholde det, så længe din konto er aktiv.",
    websiteInteractionsTitle: "2.4 Webstedsinteraktioner",
    ...
    cookiesTitle: "2.5 Cookies",
    cookiesDescription1:
      "Vi bruger også vedvarende first-party cookies og nogle third-party cookies til at gemme visse præferencer, gøre det nemmere for dig at bruge vores applikationer og udføre A/B-testning samt understøtte nogle analyser.",
    cookiesDescription2:
      "En cookie er en tekststreng, der gemmes af din browser. Den kan hjælpe med at huske loginoplysninger og webstedspræferencer. Den kan også indsamle oplysninger såsom din browsertype, operativsystem, besøgte websider, besøgstid, vist indhold og andre klikstrømsdata. Du kan justere cookie-opbevaringsindstillinger og acceptere eller blokere enkelte cookies i dine browserindstillinger, selvom vores apps ikke vil fungere, og andre aspekter af vores tjeneste muligvis ikke fungerer korrekt, hvis du slår cookies fra.",
    correspondenceTitle: "2.6 Frivillig korrespondance",
    correspondenceDescription:
      "Når du e-mailer os med et spørgsmål eller beder om hjælp, gemmer vi denne korrespondance, inklusive din e-mailadresse, så vi har en historik over tidligere korrespondance at henvise til, hvis du kontakter os i fremtiden.",
    accessTitle: "3. Når vi får adgang til eller deler dine oplysninger",
    accessDescription1:
      "For at levere produkter eller tjenester, du har anmodet om. Vi bruger nogle tredjeparts underbehandlere til at hjælpe med at køre vores applikationer og levere tjenesterne til dig. Dette inkluderer cloud- og analyseudbydere.",
    accessDescription2:
    ...
    locationTitle: "6. Placering af websted og data",
    locationDescription:
      "Vores produkter og andre webegenskaber drives i USA. Hvis du befinder dig i EU, Storbritannien eller andetsteds uden for USA, skal du være opmærksom på, at alle oplysninger, du giver os, vil blive overført til og opbevaret i USA. Ved at bruge vores websteder eller tjenester og/eller give os dine personoplysninger samtykker du til denne overførsel.",
    childrenTitle: "7. Børns privatliv",
    updatesTitle: "8. Opdateringer af denne privatlivspolitik",
    updatesDescription:
      "Vi kan opdatere denne politik efter behov for at overholde relevante regulativer og afspejle nye praksisser. Når vi foretager en væsentlig ændring af vores politikker, opdaterer vi datoen øverst på denne side.",
    ...
    contactDescription:
      "Hvis du har spørgsmål, kommentarer eller klager angående vores privatlivspolitik, skal du kontakte os {at} {email}, og vi vil stræbe efter at behandle din klage hurtigst muligt.",
    policyDescriptionA:
      'Denne politik beskriver, hvordan {NeverCap} (herefter benævnt "NeverCap", "vores", "vi", "os") indsamler, bruger og videregiver dine personlige oplysninger, når du bruger vores tjenester, websteder ({url}) og software (samlet kaldet "Tjenesterne").'
  },
  TermsOfUse: {
    ...
    servicesDefinition:
      'Når vi siger "Tjenester", mener vi ethvert produkt skabt og vedligeholdt af NeverCap, uanset om det leveres via en webbrowser, desktopapplikation, mobilapplikation eller andet format.',
    termsUpdate:
      "Vi kan opdatere disse Servicevilkår i fremtiden. Typisk er disse ændringer foretaget for at præcisere nogle af vilkårene ved at henvise til en udvidet relateret politik. Når vi foretager en væsentlig ændring af vores politikker, opdaterer vi datoen øverst på denne side og tager andre passende skridt for at underrette kontohavere.",
    ...
    eligibilityRequirement:
      "Tjenesterne er ikke beregnet til og bør ikke bruges af nogen under 18 år. Ved at bruge Tjenesterne erklærer og garanterer du, at du opfylder ovenstående berettigelseskrav.",
    userResponsibility:
      'Udtrykkene "du", "din", "dig selv" omfatter også dine medarbejdere, agenter, forretningsrepræsentanter og enhver anden person, du giver adgang til Tjenesterne gennem din Konto (som defineret nedenfor). Du er ansvarlig for at sikre, at alle personer, der får adgang til Tjenesterne gennem din konto, kender disse Vilkår og overholder dem.',
    termsRevision:
    ...
    servicesDescription1:
      "Vores Tjenester gør det muligt for brugere at omdanne stemmesamtaler til transskriberet tekst, der kan søges, oversættes og deles med andre.",
    servicesOptions:
      'Du kan vælge at bruge den gratis version af Tjenesterne ("Gratis Tjenester") eller den abonnementsbaserede betalte version af Tjenesterne, som du muligvis skal betale for ("Betalte Tjenester").',
    servicesAccess:
      "Vi vil gøre Tjenesterne tilgængelige for dig. Du er ansvarlig for at træffe alle nødvendige foranstaltninger for at få adgang til Tjenesterne.",
    accountTermsTitle: "3. Kontobetingelser",
    accountSecurity:
      "Du er ansvarlig for at opretholde sikkerheden for din konto. Virksomheden kan ikke og vil ikke være ansvarlig for noget tab eller skade som følge af din manglende overholdelse af denne sikkerhedsforpligtelse.",
    lawfulUse: "Du må ikke bruge Tjenesterne til noget ulovligt, uetisk eller umoralsk formål.",
    contentResponsibility:
      "Du er ansvarlig for alt indhold og alle aktiviteter, der forekommer under din konto. Dette inkluderer indhold opslået af andre, der enten: (a) har adgang til dine loginoplysninger; eller (b) har deres egne logins under din konto.",
    humanRequirement:
      'Du skal være et menneske. Konti registreret af "bots" eller andre automatiske metoder er ikke tilladt.',
    paymentTitle: "4. Betaling, Refusion og Planændringer",
    freeTrial:
      "For betalte Tjenester, der tilbyder en gratis prøveperiode, forklarer vi længden af prøveperioden, når du tilmelder dig. Efter prøveperioden skal du betale i forvejen for at fortsætte med at bruge Tjenesten. Hvis du ikke betaler, ophører disse tjenester.",
    upgradePolicy:
      "Hvis du opgraderer fra en gratis plan til en betalt plan, vil vi trække dit kort med det samme, og din faktureringscyklus starter på opgraderingsdagen.",
    taxes:
      "Alle gebyrer er eksklusive alle skatter, afgifter eller told pålagt af skattemyndigheder. Hvis det er påkrævet, vil vi indkræve disse skatter på vegne af skattemyndigheden og indbetale dem til skattemyndighederne. Ellers er du ansvarlig for betaling af alle skatter, afgifter eller told.",
    refunds:
      "Alle køb kan ikke refunderes. Du kan annullere enhver betalt tjeneste til enhver tid ved at logge ind på din konto. For betalte abonnementer vil din annullering træde i kraft ved udløbet af den nuværende betalte periode, medmindre andet er angivet.",
    cancellationTitle: "5. Annullering og Ophør",
    cancellationPolicy:
      "Hvis du annullerer Tjenesten før udløbet af enhver betalt periode, træder din annullering i kraft med det samme, og du vil ikke blive opkrævet igen. Vi fratrækker ikke automatisk ubrugt tid i den sidste faktureringscyklus.",
    terminationRights:
      "Vi har ret til at suspendere eller afslutte din konto og nægte enhver og al nuværende eller fremtidig brug af vores Tjenester af enhver grund til enhver tid. Suspension betyder, at du ikke vil kunne få adgang til kontoen eller noget indhold i kontoen. Afslutning vil desuden resultere i sletning af din konto eller din adgang til din konto samt tab og afgivelse af alt indhold i din konto. Vi forbeholder os også retten til at nægte brug af Tjenesterne til enhver af enhver grund til enhver tid. Vi har denne klausul, fordi der statistisk set blandt hundredtusindvis af konti på vores Tjenester altid er mindst én, der foretager sig noget skadeligt.",
    abusePolicy:
      "Verbale, fysiske, skriftlige eller andre former for misbrug (inklusive trusler om misbrug eller gengældelse) af en virksomhedsmedarbejder eller -leder kan medføre øjeblikkelig kontosuspension.",
    submissionsTitle: "6. Indsendelser",
    submissionsDescription:
      'Du anerkender og accepterer, at eventuelle spørgsmål, kommentarer, forslag, idéer, feedback eller anden information vedrørende webstedet ("Indsendelser"), som du giver os, er ikke fortrolige og bliver vores eneste ejendom. Vi skal have eksklusive rettigheder, herunder alle immaterielle rettigheder, og være berettiget til ubegrænset brug og spredning af disse Indsendelser til ethvert lovligt formål, kommercielt eller andet, uden anerkendelse eller kompensation til dig. Du frafalder herved alle moralske rettigheder til sådanne Indsendelser, og du garanterer herved, at sådanne Indsendelser er originale fra dig eller at du har ret til at indsende sådanne Indsendelser. Du accepterer, at der ikke kan rejses krav mod os for påstået eller faktisk krænkelse eller tilegnelse af nogen ejendomsret i dine Indsendelser.',
    uptimeTitle: "7. Oppetid og Sikkerhed",
    serviceAvailability:
      'Din brug af Tjenesterne sker på eget ansvar. Vi leverer disse Tjenester "som de er" og "som tilgængelige". Vi tilbyder ikke serviceaftaler for de fleste af vores Tjenester, men tager oppetiden for vores applikationer alvorligt.',
    throttlingPolicy:
      "Vi forbeholder os retten til midlertidigt at begrænse eller begrænse konto adgang i sjældne tilfælde, hvor en brugers aktivitet verificeres at have en negativ indvirkning på Tjenestens stabilitet og ydeevne for andre brugere. I alle andre end de mest kritiske tilfælde vil vi kontakte dig for at finde en løsning, før vi handler.",
    dataSecurity:
      "Vi tager mange foranstaltninger for at beskytte og sikre dine data gennem backup, redundans og kryptering. Vi håndhæver kryptering for datatransmission over det offentlige internet.",
    thirdPartyVendors:
      "Vi bruger tredjepartsleverandører og hostingpartnere til at levere den nødvendige hardware, software, netværk, lagring og relateret teknologi, der kræves for at køre Tjenesterne.",
    ...
    ipRights:
      "Vi gør ikke krav på nogen immaterielle rettigheder over det materiale, du giver til Tjenesterne. Alt uploadet materiale forbliver dit.",
    contentModeration:
      "Vi gennemser ikke indhold på forhånd, men forbeholder os retten (men ikke forpligtelsen) efter eget skøn at afvise eller fjerne ethvert indhold, der er tilgængeligt via Tjenesten.",
    prohibitedExploitation:
      "Du accepterer ikke at gengive, duplikere, kopiere, sælge, videresælge eller udnytte nogen del af Tjenesterne, brugen af Tjenesterne eller adgangen til Tjenesterne uden udtrykkelig skriftlig tilladelse fra Virksomheden.",
    impersonationProhibition:
      "Du må ikke modificere et andet websted på en måde, der falskt antyder, at det er forbundet med Tjenesterne eller Virksomheden.",
    dmcaPolicy:
      "Vi respekterer andres immaterielle rettigheder. Hvis du mener, at noget materiale, der er tilgængeligt på eller via webstedet, krænker en ophavsret, du ejer eller kontrollerer, skal du straks kontakte os. En kopi af din Meddelelse vil blive sendt til den person, der har offentliggjort eller lagret det pågældende materiale. Vær opmærksom på, at du i henhold til gældende lovgivning kan blive holdt ansvarlig for erstatning, hvis du fremsætter væsentlige urigtige oplysninger i en Meddelelse. Hvis du derfor ikke er sikker på, at materiale, der findes på eller er linket til af webstedet, krænker din ophavsret, bør du overveje først at kontakte en advokat.",
    prohibitedActivitiesTitle: "10. Forbudte aktiviteter",
    generalProhibition:
      "Du må ikke tilgå eller bruge webstedet til andre formål end dem, vi gør det tilgængeligt for. Webstedet må ikke bruges i forbindelse med kommercielle bestræbelser, medmindre de er specifikt godkendt af os.",
    userObligations: "Som bruger af webstedet accepterer du ikke at:",
    dataScraping:
      "Systematisk hente data eller andet indhold fra webstedet for at oprette eller samle, direkte eller indirekte, en samling, kompilering, database eller fortegnelse uden skriftlig tilladelse fra os.",
    fraud:
      "Bedrage, snyde eller vildlede os og andre brugere, især i forsøg på at få adgang til følsomme kontooplysninger som brugeradgangskoder.",
    securityInterference:
      "Omgå, deaktivere eller på anden måde forstyrre sikkerhedsrelaterede funktioner på webstedet, herunder funktioner der forhindrer eller begrænser brugen eller kopiering af indhold eller håndhæver begrænsninger i brugen af webstedet og/eller dets indhold.",
    ...
    malware:
      "Uploade eller overføre (eller forsøge at uploade eller overføre) vira, trojanske heste eller andet materiale, herunder overdreven brug af store bogstaver og spam (gentagen posting af det samme indhold), der forstyrrer brugernes uforstyrrede brug af webstedet eller ændrer, forringer, afbryder eller forstyrrer webstedets funktioner, drift eller vedligeholdelse.",
    automation:
      "Bruge automatiserede systemer som scripts til at sende kommentarer eller beskeder, eller bruge datamining, robotter eller lignende dataindsamlingsværktøjer.",
    ...
    spyware:
      'Uploade eller overføre (eller forsøge at uploade eller overføre) materiale der fungerer som passiv eller aktiv informationsindsamlings- eller overføringsmekanisme, herunder "gifs", 1×1 pixels, web bugs, cookies eller lignende enheder (også kaldet "spyware" eller "passive collection mechanisms" eller "pcms").',
    disruption: "Forstyrre, afbryde eller skabe uberettiget belastning på webstedet eller dets netværk og tjenester.",
    employeeHarassment:
      "Chikanere, irritere, true eller intimidere vores medarbejdere eller agenter der yder tjenester til dig via webstedet.",
    accessCircumvention:
      "Forsøge at omgå webstedets sikkerhedsforanstaltninger designet til at forhindre eller begrænse adgang til webstedet eller dele af det.",
    codeCopying:
      "Kopiere eller tilpasse webstedets software, herunder men ikke begrænset til Flash, PHP, HTML, JavaScript eller anden kode.",
    reverseEngineering:
      "Medmindre tilladt ved lov, dechifrere, dekompilere, disassemblere eller reverse engineer nogen del af webstedets software.",
    ...
    unauthorizedUse:
      "Foretage uautoriseret brug af webstedet, herunder indsamling af brugernavne og/eller e-mailadresser med henblik på at sende uønsket e-mail, eller oprette brugerkonti via automatiserede midler eller under falske forudsætninger.",
    competition:
      "Bruge webstedet som del af konkurrence mod os eller til indtægtsgenererende eller kommercielle formål.",
    ...
    featuresDescription:
      "Vi designer vores tjenester omhyggeligt baseret på egne erfaringer og feedback fra brugere. Ingen tjeneste kan dog tilfredsstille alle. Vi garanterer ikke at vores tjenester opfylder dine specifikke krav eller forventninger.",
    bugsDescription:
      "Vi tester alle funktioner før udrulning. Som al software har vores tjenester uundgåeligt fejl. Vi registrerer rapporterede fejl og arbejder med dem, især sikkerheds- og privathedsrelaterede. Ikke alle fejl bliver rettet, og vi garanterer ikke fejlfrie tjenester.",
    correctionsTitle: "12. Rettelser",
    informationAccuracy:
      "Webstedet kan indeholde trykfejl, unøjagtigheder eller udeladelser i beskrivelser, priser, tilgængelighed og anden information. Vi forbeholder os retten til at rette fejl og opdatere information uden varsel.",
    siteAvailability:
    ...
    companyDefinitionA:
      'Når vi siger "Virksomhed", "vi", "vores" eller "os" i dette dokument, henviser vi til {NeverCap}.'
  },
  Blog: {
    Hero: {
      title: "Bliv en",
      ...
      description:
        "Tutorials, strategier og AI-værktøjer fra {NeverCap}, der hjælper dig med at skabe ubegrænset indhold med professionelle transskriptionsworkflows."
    },
    Featured: {
    ...
    ListSection: {
      ...
      categories: ["Alle indlæg", "Vejledninger", "Podcasting", "Indholdsskabelse", "Forretning", "AI-tips"]
    },
    Detail: {
      Home: "Hjem",
      Blog: "Blog",
  ...
  cello: {
    ...
    specialPrice: "Din særlige pris: {moneyOne}/md (Reg. {moneyTwo})",
