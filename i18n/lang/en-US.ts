...
let message = {
  ...
  FolderPage: {
    ...
    dialog: {
      ...
      share: {
        ...
        label: "Anyone with this link can view the transcript and play the media.",
        confirm: "Copy Link",
        success: "Copy successful"
      },
      export: {
        title: "Export Transcript",
        select: "Select format to download",
        settings: "Settings",
        speaker: "Include speaker",
        timecodes: "Include timestamps",
        confirm: "Export",
        cancel: "Cancel",
  ...
  TranscriptionPage: {
    ...
    showMoreTimestamp: "Show more detailed timestamp",
    selectMoreTimestamp: "Detailed timestamp",
    ...
    applyToCurrentParagraph: "Apply to the current paragraph",
    speakerDuplicate: "The speaker already exists.",
    ...
    shareTips: "Anyone with this link can view the transcript and play the media.",
    copyLink: "Copy Link",
    copySuccessful: "Copy successful",
    copyFail: "Copy fail",
    closeTrans: "Cancel Translation",
    upgradeBtn: "Upgrade Now to Unlock",
    upgradeTip30: "Unlock Your Full Transcript",
    upgradeTipMore: "Great news! Your entire file is transcribed.",
    errorTips: "Something went wrong.",
    copiedLink: "Link copied ",
    copyGotIt: "Got it",
    upgradeMinPreview: "Upgrade to view beyond the 30-min preview.",
    silentTip: "No audio in the file. Check and try again.",
    outLimit: "File Exceeds Length Limit",
    outLimitTip1: "Free accounts support files up to 30 minutes.",
    outLimitTip2: "Register to upgrade and unlock the full transcribed text now!"
  },
  RegisterDialog: {
  ...
  Resources: {
    ...
    Upload: {
      ...
      fileTip: "Get your video transcript in seconds",
      linkTitle: "Link",
      linkTip: "Paste a link from any platform to begin",
      transcribeProgress: "Transcription in Progress...",
