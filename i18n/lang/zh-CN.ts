let message = {
  ...
  Index: {
    Hero: {
      ...
      subtitleA:
        "NeverCap 的 AI 可以转录视频并将音频转换为文本，一次可处理 50 个文件，且无月度上限。真正实现随您扩展的转录。"
    },
    Stats: {
      monthlyMinutes: "月度时长",
      fileUploads: "文件上传",
      ...
      questions: [
        {
          ...
          answer:
            "AI转录是通过先进人工智能将音频自动转换为文本的过程。在NeverCap，您只需上传文件，我们的AI就能以高达96%的准确率转录内容。我们的服务可将视频文件（如MP4、MOV）和音频文件（如MP3、WAV）转换为可读可编辑的文本，包含说话人标签和时间戳。"
        },
        {
          q: "unlimited_policy",
          question: "真的无限量吗？有什么限制？",
          answer:
            "是的，真正无限量！无月度时长限制，无超额费用。仅有的技术限制是：单个文件最长10小时或5GB大小，可同时处理50个文件。但您整个月都可以上传任意批次的文件。"
        },
        {
          q: "accuracy",
          question: "转录准确率如何？",
          answer:
            "我们保证清晰音频96%的准确率。我们的AI经过数百万小时多样化内容训练，能出色处理口音、专业术语和多说话人场景。针对复杂音频，智能增强功能可提升效果。"
        },
        {
          q: "languages",
          question: "支持哪些语言？",
          answer:
            "我们支持100多种语言的转录，包括英语、西班牙语、普通话、印地语、阿拉伯语、法语等。此外，您可将转录文本翻译成249种语言，完美适配全球内容。"
        },
        {
          q: "speed",
          question: "转录速度多快？",
          answer:
            "闪电速度！1小时音频文件通常在5分钟内完成。通过批量处理，可同时上传50个文件并行处理。多数用户睡醒就发现整个资料库已完成转录。"
        },
        {
          q: "cancellation",
          question: "可以随时取消吗？",
          answer:
            "当然！无合约绑定，无取消费用。您可以在控制面板随时升级、降级或取消订阅。取消后仍可访问服务至当前结算周期结束。"
        },
        {
          q: "security",
          question: "我的数据安全吗？",
          answer:
            "安全是我们的首要任务。我们通过SOC 2认证，对所有数据采用256位加密，绝不使用您的内容训练模型。您可以随时删除文件，我们会在30天后自动清除。符合GDPR和CCPA标准。"
        },
        {
          q: "export_formats",
          question: "支持哪些导出格式？",
          answer:
            "可按需下载转录文本：PDF、Word (DOCX)、Excel、CSV、SRT字幕、纯文本(TXT)和VTT字幕。完美适配任何工作流程。"
        },
        {
          q: "file_formats",
          question: "支持上传哪些音视频格式？",
          answer:
            "支持几乎所有常见音视频格式：MP3、MP4、M4A、MOV、AAC、WAV、OGG、OPUS、MPEG、WMA、WMV等。只要您能播放，我们就能转录。"
        }
      ]
    },
    CTASection: {
  ...
  Features: {
    UnlimitedTranscription: {
      ...
      feature2Description:
        "Otter免费版仅提供3次终身导入，Pro版每月10次。我们提供无限次。上传您的播客积压内容、所有采访及多年录音。无限制。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "“我每年支付100美元使用Otter，但他们限制我每月只能导入10个文件。一旦有无限导入的替代方案，我立刻换！” - 真实Reddit用户",
      feature3Point1Icon: "✓",
    ...
    BulkUpload: {
      ...
      feature2Description:
        "我们的并行处理架构让您的50个文件无需排队，全部同时转录。以往需要数周的工作，现在仅需数小时。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "当其他服务让您在虚拟队列中等待或付费升级“优先处理”时，我们紧急处理每次上传。您的内容很重要，不该等待。",
      feature3Point1Icon: "✓",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "12种主要语言的行业顶尖准确率。单词级时间戳实现完美同步。智能发言人识别应对快速对话。专业排版清晰易读。",
      primaryCta: "测试准确率 →",
      secondaryCta: "查看语言",
      ...
      feature1Description:
        "每个单词都与音频位置完美同步。创建可点击的文本记录，生成精准字幕，或跳转到录音中的精确时刻。专业信赖的100毫秒精度。",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "即使在重叠语音、插话和快速对答场景中，我们的AI也能准确识别说话者。特别适合频繁插话的访谈、播客和会议场景。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "告别文字墙。我们的AI自动在恰当位置添加段落、句子和标点符号。结果如何？真正易于阅读和浏览的转录文本。",
      feature3Point1Icon: "✓",
      ...
      formattingBeforeText:
        "所以今天我们要讨论我们一直在开发的新功能我想你们会很喜欢这些功能用户们要求很久了我们终于完成了",
      formattingAfterLabel: "✓ NeverCap：",
      formattingAfterText:
        "今天，我们将讨论我们一直在开发的新功能。我想你们会很喜欢。这些功能用户们要求了很久，我们终于完成了。",
  ...
  Pricing: {
    ...
    ComparisonTable: {
      ...
      features: [
        ...
        {
          name: "每日文件限制",
          values: ["每天 3 个文件", "无限", "无限"]
        },
        {
          name: "最大文件时长",
          values: ["10小时", "10小时", "10小时"]
        },
        {
          name: "最大文件大小",
      ...
      items: [
        {
          ...
          question: "真的是无限制吗？",
          answer:
            "是的！Pro 计划没有每月分钟数限制。唯一限制是技术性的：文件最长 10 小时，最大 5GB。您可以处理任意数量的文件。"
        },
        {
          q: "plan_change",
          question: "我可以随时更改计划吗？",
  ...
  UseCases: {
    AllUseCases: {
      ...
      heroSubtitleA:
        "从积压多年工作的播客，到进行数百次采访的研究人员，了解专业人士如何使用 {NeverCap} 突破上传限制和分钟数上限。"
    },
    Podcasters: {
      badge: "专为播客主打造",
      heroTitle: "转录您的",
      ...
      solutionDescriptionA:
        "使用 {NeverCap}，您可以获得真正的无限转录。上传您的整个存档。转录每一集新剧集。批量生成节目笔记。没有上限，没有限制，任您增长。"
    },
    Journalists: {
      hero: {
        badge: "记者与作家专享",
      ...
      problem: {
        ...
        solution: {
          ...
          descriptionA:
            "使用 {NeverCap}，您可以获得真正的无限转录。上传您的整个调查。转录每一次采访。立即搜索所有引述。无上限，无限制，只为新闻报道。"
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            title: "所有访谈的无限容量",
            description:
              "不同于有时间限制的软件，您可以转录从简短对谈到数小时讨论的所有访谈。永远不必担心在截稿时耗尽额度。",
            points: {
          ...
          instantSearch: {
            ...
            title: "匹配您新闻周期的速度",
            description:
              "数分钟内获取访谈转录，无需等待数天。前所未有地快速完成报道。当您喝咖啡时，我们的AI已处理数小时音频。",
            points: {
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA:
          "无论您是需要转录 YouTube 视频、转录 TikTok 视频以供再利用，还是想将 Facebook 视频转录为文本，{NeverCap} 都能无缝处理。生成 100 多种语言的字幕，无月费限制，尽享纯粹的创作自由。"
      },
      platforms: {
        title: "从任意平台抓取并转录",
        platformNames: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "我们的工具简化视频内容转录流程。转录Instagram视频只需粘贴链接，Vimeo视频转录同样操作。一个周末即可处理完整个频道的积压内容。",
          points: {
        ...
        flexibleExport: {
          ...
          titleHighlight: "一应俱全",
          description:
            "导出适配您工作流程的格式。从YouTube的SRT文件到网页播放器的VTT，或可编辑的脚本文档。所有导出无限制，所有方案均包含。",
          points: {
      ...
      testimonials: {
        ...
        sarah: {
          ...
          textAfter:
            "。我有500多个视频积压。NeverCap让我在一个周末处理完所有内容。字幕带来的SEO提升在第一个月就回本了。",
          highlight: "30小时",
          name: "莎拉·李",
          role: "生活方式博主 • 18万订阅者"
        },
        jake: {
          textBefore: "这个",
          textAfter:
            "功能改变了游戏规则。我不再需要下载任何内容。只需粘贴、转录、完成。为TikTok处理播客片段从未如此简单。",
        ...
        questions: [
          {
            ...
            answer:
              "很简单。找到要转录的YouTube视频，复制其URL并粘贴到我们的应用中。我们的AI将自动获取视频并在几分钟内提供完整文本转录。"
          },
          {
            question: "问：将Facebook视频转录为文本的最佳方式是什么？",
            answer:
              "最简单的方法是使用直接链接。复制Facebook视频的URL，我们的平台将处理其余工作，以高达96%的准确率将语音转换为文本，免去手动转录的麻烦。"
          },
          {
            question: "问：可以转录TikTok和Instagram视频吗？",
            answer:
              "当然可以。我们支持TikTok和Instagram视频转录。非常适合希望将短视频内容转化为博客文章、文章或文本社交媒体更新的内容创作者。"
          },
          {
            question: "问：如何将Vimeo视频转录为文本？",
            answer:
              "转录Vimeo视频与其他平台一样简单。只需复制Vimeo视频URL并粘贴到NeverCap中。我们的AI将处理视频并生成准确的文本转录，您可以下载多种格式。"
          }
        ]
      }
    },
    Researchers: {
      ...
      heroTitle2: "分析所有数据。",
      heroSubtitle:
        "无需选择转录哪些焦点小组。以96%的准确率和完美的说话人识别处理所有定性数据——即使20位参与者同时发言。",
      ...
      feature1Title: "处理您的",
      feature1Desc:
        '今晚上传200小时访谈录音，醒来即可获得完整可搜索的转录稿。无月度上限，无单文件限制，没有所谓的"合理使用"限制。',
      ...
      feature2Title: "精准把握",
      feature2Desc:
        "我们的AI可追踪多达20名发言者，即使他们同时发言、互相打断或集体插话。每个声音都能被准确捕捉并标记。",
      ...
      solutionDescA:
        "使用 {NeverCap}，您可以获得真正的无限转录。上传您的整个研究。转录每一次访谈。分析所有数据。没有上限，没有限制，只需研究。"
    },
    BusinessTeams: {
      heroBadge: "面向商业团队",
      heroTitle1: "会议录音",
      ...
      feature3Desc:
        "即时与团队分享转录文本。一起听录音，以多种格式导出转录文本，通过可搜索的会议档案确保所有人保持一致。",
      ...
      feature4Desc:
        "一键搜索所有会议。快速找到上季度的关键决策或数月前的客户需求。AI智能搜索理解上下文，而非仅关键词。",
      ...
      heroSubtitleA:
        "直接在浏览器中录制会议，或立即上传音频文件。从无限量的对话中构建可搜索的存档。使用 {NeverCap} 真正无限量的转录，再也不会丢失重要的讨论。"
    },
    Educators: {
      heroBadge: "教育工作者专区",
      heroTitle1: "让学习",
      heroTitle2: "人人可及",
      heroSubtitle:
        "粘贴YouTube链接即可获得自动生成字幕的即时转录。将讲座/教程/教育视频转化为所有学生都可搜索学习的内容。",
      heroCtaPrimary: "免费试用 - 无需信用卡",
      ...
      feature1Desc:
        "只需粘贴视频链接即可获取即时转录。支持YouTube、Vimeo、Facebook、X（Twitter）、TikTok、Instagram、Dropbox、Google Drive等平台。无需下载，无需等待。",
      ...
      feature3Desc:
        "创建文件夹按课程、学科或学期管理转录稿。让所有教育内容分类清晰、易于检索，建立完整的无障碍课程资料库。",
      ...
      feature4Desc:
        "不止分享录音。自动将讲座和其他音频文件转为详细学习指南，包含摘要和关键概念，助力学生高效复习。支持TXT、DOCX或PDF格式导出。",
      ...
      testimonialTextA:
        "我一直在使用 {NeverCap} 转录我的整个 YouTube 数学教程频道。以前用其他服务需要几周时间，现在只需几个小时。直接粘贴链接即可获得即时转录的功能彻底改变了我创建无障碍内容的方式。我的国际学生尤其喜欢它的多语言字幕！"
    }
  },
  Resources: {
    YouTubeToMP4: {
      ...
      part4: {
        ...
        list: [
          ...
          },
          {
            title: "分享更简单：",
            content:
              "分享MP4文件比发送链接方便得多。您可以直接通过WhatsApp或Instagram等应用发送视频文件，省去打开YouTube的额外步骤。"
          },
          {
            title: "即时观看，共享时刻：",
            content:
              "想兴奋地向附近的朋友或家人展示喜爱的视频？下载MP4后，你们可以立即流畅地一起观看，无需尴尬地等待加载。"
          }
        ]
      },
      part5: {
      ...
      part7: {
        ...
        list: [
          ...
          },
          {
            question: "这个下载工具安全吗？",
            answer:
              "是的，它安全可靠。我们不会要求用户提供任何个人信息，并采取强力措施防范病毒。我们提醒您始终谨慎下载网络文件：避免点击可疑链接或下载可疑文件。"
          },
          {
          ...
          },
          {
            ...
            answer:
              "不会。使用我们的工具将YouTube视频下载为MP4会保留原始画质。转换过程保持源画质，确保您获得与YouTube相同的观看体验。"
          }
        ]
      },
      err1: "YouTube链接格式错误。",
      ...
      videoDownload: {
        ...
        description:
          "感谢您选择我们的服务！我们衷心感谢您的信任，并希望它提升了您的体验。如果您能向朋友分享我们的网站，将是极大的帮助。",
        downloadButton: "下载",
        downloadError: "下载错误",
        TranscribeButton: "录制"
      },
      ...
      YouTubeToMP3: {
            ...
            "part7": {
              ...
              "list": [
                ...
                {
                  "question": "YouTube 到 MP3 的转换支持哪些语言？",
  ...
  About: {
    Hero: {
      ...
      title: "关于",
      description:
        "我们的使命是提供最精准的音视频转录服务。依托行业领先的AI技术，实现96%以上的转录准确率。通过技术优化，部分主要语言准确率可达99%。"
    },
    Stats: {
      title: "我们的",
  ...
  Privacy: {
    ...
    privacyPolicyTitle: "隐私政策",
    policyAgreement:
      "请仔细阅读本隐私政策并确保您理解其内容。使用我们的任何服务即表示您同意本隐私政策。如果您不同意我们按照本政策使用您的个人数据，必须立即停止使用我们的服务。",
    policyOverview:
      "本政策阐述了：我们收集哪些数据及原因；您的数据如何处理；以及您对数据的权利。我们不会出售您的数据。",
    scopeTitle: "1. 隐私政策适用范围",
    scopeDescription:
      "本隐私政策仅适用于我们对服务用户信息的收集和处理。不适用于任何第三方运营的关联服务/网站/软件（无论链接由我们提供还是用户分享），也不适用于第三方内容/数据/应用/材料。建议您在向第三方提供信息前查阅其隐私政策。",
    ...
    websiteInteractionsDescription:
      "我们会收集浏览行为信息用于分析和统计（如转化率测试和新产品设计实验），包括浏览器/操作系统版本、IP地址、访问页面及加载时长、引荐来源等。登录状态下这些数据会与IP地址和账户关联直至账户失效。",
    cookiesTitle: "2.5 Cookie",
    cookiesDescription1:
      "我们使用持久性第一方Cookie和部分第三方Cookie来存储偏好设置、简化应用使用、进行A/B测试及支持分析。",
    cookiesDescription2:
    ...
    accessDescription2:
      "调查、预防或处理滥用行为。仅在最后手段时才会调查性访问客户账户。我们既要保护客户隐私安全，也要兼顾问题举报者的权益，并全程平衡这些责任。如发现产品被用于受限用途，将采取必要措施（包括在适当时通知相关机构）。",
    accessDescription3: "根据适用法律要求。",
    dataRequests:
      "用户数据请求。我们的政策是除非受法律程序强制或紧急情况，否则不响应政府数据请求。但若美国执法部门出示有效搜查令、刑事传票或法庭命令，我们必须配合。对于境外政府请求，仅在美国政府通过司法互助条约规定的程序要求时才会响应。除非法律禁止，我们会在共享数据前通知受影响用户（紧急情况除外）。",
    preservationRequests:
      "数据保留请求。我们仅根据《美国联邦存储通信法》第2703(f)条或适格民事传票要求保留数据。除非法律要求或不可上诉的法庭命令，否则不会共享保留数据。若在保留期内未收到适格令状/命令/传票，将在保留期结束时销毁所有客户数据副本。",
  ...
  TermsOfUse: {
    ...
    thankYou: "感谢您使用我们的产品！",
    servicesDefinition:
      "“服务”指由NeverCap创建和维护的任何产品，无论通过网页浏览器、桌面应用、移动应用或其他形式提供。",
    termsUpdate:
      "我们可能会在未来更新这些服务条款。通常这些更新是为了通过链接到扩展的相关政策来澄清某些条款。每当我们对政策进行重大更改时，我们将更新本页顶部的日期，并采取其他适当措施通知账户持有人。",
    acceptanceTitle: "1. 协议接受",
    acceptanceDescription1:
      "使用我们的服务即表示您接受本协议，该协议将成为您与NeverCap之间的有约束力的合同。您声明您有法律能力接受这些条款，并确认您已达到签订有约束力合同的法定年龄。NeverCap的接受明确以您同意本协议所有条款和条件为前提。",
    eligibilityRequirement:
      "服务不适用于18岁以下的任何人，也不应由其使用。使用服务即表示您声明并保证您符合上述资格要求。",
    userResponsibility:
      "“您”、“您的”、“您自己”还包括您的员工、代理人、业务代表以及您通过账户（定义如下）提供访问服务的任何其他个人。您有责任确保通过您账户访问服务的所有人员知晓并遵守这些条款。",
    termsRevision:
    ...
    refunds:
      "所有购买均不可退款。您可以随时登录账户取消任何付费服务。对于付费订阅，除非另有说明，您的取消将在当前付费期结束时生效。",
    ...
    malware:
      "上传或传输（或试图上传或传输）病毒、木马或其他干扰任何一方正常使用本网站的材料，包括过度使用大写字母和垃圾信息（连续发布重复文本），或修改、损害、干扰、改变本网站的使用、功能、操作或维护。",
    automation:
      "从事任何自动化系统使用行为，例如使用脚本发送评论或消息，或使用任何数据挖掘、机器人或类似的数据收集和提取工具。",
    ...
    featuresDescription:
      "我们基于自身经验及分享时间和反馈的客户经验精心设计服务。但没有任何服务能让所有人满意。我们不保证服务能满足您的特定要求或期望。",
    bugsDescription:
      "我们在发布前会测试所有功能。与任何软件一样，我们的服务不可避免地存在一些缺陷。我们会跟踪并修复报告的缺陷，尤其是与安全或隐私相关的缺陷。并非所有报告的缺陷都会被修复，我们也不保证服务完全无错误。",
    correctionsTitle: "12. 更正",
    informationAccuracy:
      "本网站上的信息可能存在印刷错误、不准确或遗漏，包括描述、价格、可用性及其他各种信息。我们保留随时更正任何错误、不准确或遗漏以及更改或更新网站信息的权利，恕不另行通知。",
    siteAvailability:
      "我们无法保证本网站始终可用。可能会遇到硬件、软件或其他问题，或需要进行与网站相关的维护，导致中断、延迟或错误。我们保留随时或出于任何原因更改、修订、更新、暂停、终止或以其他方式修改本网站的权利，恕不另行通知。您同意，对于因网站停机或终止期间无法访问或使用网站而造成的任何损失、损害或不便，我们不承担任何责任。本服务条款中的任何内容均不应解释为要求我们维护和支持本网站或提供任何更正、更新或发布。",
    userDataTitle: "13. 用户数据",
    userDataDescription:
      "我们将保留您传输至本网站的某些数据以管理网站性能，以及与您使用网站相关的数据。尽管我们会定期备份数据，但您需对传输的任何数据或使用网站进行的任何活动全权负责。您同意，对于任何此类数据的丢失或损坏，我们不对您承担任何责任，您特此放弃因任何此类数据丢失或损坏而对我们采取的任何行动权利。",
    privacyPolicyTitle: "14. 隐私政策",
    liabilityTitle: "15. 责任",
    liabilityIntroduction: "我们在本条款中多次提及责任，现统一说明如下：",
    liabilityWaiver:
      "您明确理解并同意，在法律或衡平法上，公司对您或任何第三方不承担任何直接、间接、附带、利润损失、特殊、后果性、惩罚性或惩戒性损害赔偿（即使公司已被告知此类损害的可能性），包括但不限于因以下原因造成的利润、商誉、使用、数据或其他无形损失：(1) 使用或无法使用服务；(2) 内容和材料的错误、不准确；(3) 因访问和使用网站导致的任何性质的人身伤害或财产损失；(4) 因通过服务购买、获取商品、数据、信息或服务或接收消息或进行交易而产生的替代商品和服务的采购成本；(5) 对我们安全服务器及其中存储的任何和所有个人信息和/或财务信息的未经授权访问或使用；(6) 与网站的传输中断或停止；(7) 任何第三方传输至或通过网站的任何缺陷、病毒、木马等；(8) 任何内容和材料的错误或遗漏，或因使用通过网站发布、传输或以其他方式提供的任何内容而导致的任何类型的损失或损害；(9) 服务上任何第三方的声明或行为；(10) 或与本服务条款或服务相关的任何其他事项，无论是基于违约、侵权（包括主动或被动过失）还是任何其他责任理论。",
    miscellaneousTitle: "16. 其他",
    miscellaneousDescription:
      "本服务条款及我们在网站上发布的任何政策或操作规则构成您与我们之间的完整协议和理解。我们未能行使或执行本服务条款的任何权利或规定，不应视为对该权利或规定的放弃。本服务条款在法律允许的最大范围内适用。我们可随时将任何或全部权利和义务转让给他人。对于超出我们合理控制范围的任何原因造成的损失、损害、延迟或未能采取行动，我们不承担责任。如果本服务条款的任何规定或部分规定被认定为非法、无效或不可执行，则该规定或部分规定应被视为可分割的，不影响其余规定的有效性和可执行性。本服务条款或使用本网站不会在您与我们之间建立合资、合伙、雇佣或代理关系。您同意，不应因我们起草了本服务条款而对其作出不利解释。您特此放弃基于本服务条款的电子形式及双方未签署本服务条款而可能提出的任何抗辩。",
    contactTitle: "17. 联系我们",
    site: "网站",
    services: "服务",
    at: "：",
    trademarkProtection:
      "本服务的名称、外观及设计均属公司版权所有。未经公司书面许可，严禁复制、拷贝或重用任何HTML、CSS、JavaScript代码或视觉设计元素。如需使用公司标志或服务标志进行宣传，必须事先申请授权。请发送邮件至 {at} {email} 申请标志使用权。若您违反本服务条款，我们有权撤回授权。",
  ...
  Blog: {
    ...
    ListSection: {
      title: "最新的",
      highlighted_text: "文章",
      subtitle: "无限转录的专家提示和教程",
      categories: ["所有帖子", "教程", "播客", "内容创作", "商业", "AI技巧"]
    },
    Detail: {
      Home: "主页",
      Blog: "博客",
