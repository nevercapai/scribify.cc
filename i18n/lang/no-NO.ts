...
let message = {
  ...
  HomePage: {
    ...
    tour: {
      ...
      step1: {
        ...
        content: "Støtter tre transkripsjonsmetoder: lokale filer, lenker og opptak."
      },
      step2: {
        title: "Opprett en mappe",
        content: 'Klikk på "+" for å opprette en mappe og organisere filene dine.'
      },
      step3: {
        title: "Vis transkripsjonsdetaljer og rediger",
        content: "Klikk på elementet for å vise transkripsjonsdetaljer og redigere, samt oversette det."
      },
      next: "neste",
      finish: "Forstått"
    },
    ...
    welcome: {
      ...
      precision: "Få nøyaktige transkripsjoner med talegjenkjenning og tidsstempler øyeblikkelig.",
      translate: "Bryt språkbarrierer: oversett transkripsjoner til mer enn 200 språk med letthet.",
  ...
  FolderPage: {
    ...
    dialog: {
      ...
      share: {
        title: "Del",
        label: "Alle med følgende sikre lenke kan se denne transkripsjonen og den tilknyttede mediefilen.",
    ...
    endRecord: {
      title: "Varsel",
      content: "Du tar opp. Denne handlingen vil avslutte opptaket. Vil du avslutte opptaket?",
  ...
  FileUploadAndRecording: {
    record: {
      ...
      delete: "Slett",
      transcribe: "Transkriber",
      permissionDenied: "Mikrofontillatelse nektet eller enheten eksisterer ikke",
      dialog: {
        delete: {
          title: "Advarsel",
        ...
        complete: {
          ...
          label: "Opptaket har nådd 10 timer og har automatisk stoppet. Vennligst transkriber.",
          confirm: "Forstått"
        },
        speaker: {
          content: "For talergjenkjenning er filer begrenset til 3 timer. Fjern krysset i '{text}'."
        }
      }
    },
    upload: {
      link: {
        ...
        cancel: "Avbryt",
        // 请输入正确的链接
        errorTitle: "Lenkeadressen du har oppgitt er feil. Vennligst sjekk og prøv igjen.",
        linkName: "Lenke"
      },
      file: {
      ...
      del: {
        title: "Advarsel",
        content: "All fremgang vil gå tapt. Bekreft avbrytelse av transkripsjonen?",
      ...
      howToSetup: "Hvordan sette opp?",
      shareFilePublicly: "Del en fil offentlig",
      retry: "Prøv igjen",
      edit: "Rediger",
      delete: "Slett",
      updateAndRetry: "Oppdater og prøv igjen"
    }
  },
  // 转录详情页
  TranscriptionPage: {
    ...
    showMoreTimestamp: "Vis mer detaljert tidsstempel",
    selectMoreTimestamp: "Detaljert tidsstempel",
    ...
    export: "Eksporter",
    speaker: "Taler_{ id }",
    unassignSpeaker: "Fjern tilordning av taler",
    play: "Spill av",
    save: "Lagre",
    undo: "Angre",
    redo: "Gjør om",
    ...
    applyToCurrentParagraph: "Bruk på gjeldende avsnitt",
    speakerDuplicate: "Taleren finnes allerede.",
    cancelTranslation: "Avbryt oversettelse",
    showVideo: "Vis videoen",
    hideVideo: "Skjul videoen",
    notFund: "Ikke funnet",
    notFundDesc: "Vi finner ikke det du leter etter.",
    shareTips: "Alle med denne lenken kan se transkripsjonen og spille av mediet.",
    copyLink: "Kopier lenke",
    copySuccessful: "Kopiering vellykket",
    copyFail: "Kopiering feilet",
    closeTrans: "Avbryt oversettelse",
    upgradeBtn: "Oppgrader nå for å låse opp",
    upgradeTip30: "Lås opp full transkripsjon",
    upgradeTipMore: "Gode nyheter! Hele filen er transkribert.",
    errorTips: "Noe gikk galt.",
    copiedLink: "Lenke kopiert",
    copyGotIt: "Forstått",
    upgradeMinPreview: "Oppgrader for å se utover 30-minutters forhåndsvisningen.",
    silentTip: "Ingen lyd i filen. Sjekk og prøv på nytt.",
    outLimit: "Filen overskrider lengdegrensen",
    outLimitTip1: "Gratiskontoer støtter filer på opptil 30 minutter.",
    outLimitTip2: "Registrer deg for å oppgradere og låse opp den fullstendige transkripsjonen nå!"
  },
  // 登录、注册、修改密码
  IdentityInfoManage: {
    or: "eller", // 或
    ...
    logInDirectly: "Denne kontoen eksisterer allerede. Vennligst logg inn direkte.", // 账户已存在，请直接登录
    ...
    newOldCantSame: "Det nye passordet må være forskjellig fra det gamle passordet.", // 新密码与旧密码不能相同
    passwordResetOk: "Passordet er tilbakestilt!", // 密码重置成功！
    signupToSaveProgress: "Fullfør registreringen for å lagre fremgangen din",
    tip: "Tips",
    tipContentEmail: "Vi har nettopp sendt innloggingspassordet for kontoen din til e-postadressen din.",
    tipContentPassword: "Vennligst sjekk innboksen din og logg inn med e-postadressen og passordet ditt.",
    codeToEmail:
  ...
  AccountSettingsPage: {
    ...
    filesUploadedAtOnce: "Hver fil kan være opptil 10 timer lang / 5 GB. Last opp 50 filer samtidig.",
    highestPriority: "høyeste prioritet",
    weWillGiveTheHighest: "Vi vil alltid transkribere filene dine så raskt som mulig med høyest prioritet.",
    ...
    automaticRenewal: "Automatisk fornyelse mislyktes, vennligst sjekk betalingsmetoden.",
    ...
    oneFileUploaded: "Hver fil kan være opptil 30 minutter lang. Last opp 1 fil om gangen.",
  ...
  demo: {
    ...
    waitlist: {
      cardTitle: "Bli med på ventelisten, få de siste NuxtPro-nyhetene først OG rabatter!",
      placeholder: "Skriv inn e-postadressen din",
      button: "Bli med på ventelisten",
      joinCountMessage: "🔥 Tidlig bruker #{count} har nettopp blitt med på ventelisten!"
    },
    seo: {
  ...
  videoLang: {
    ...
    HAVE_ENOUGH_DATA: "Tilgjengelige data er tilstrekkelig for å starte avspilling",
    NETWORK_EMPTY: "Lyd/video har ikke blitt initialisert",
    NETWORK_IDLE: "Lyd/video er aktiv og er valgt for ressurser, men ingen nettverk brukes",
  ...
  privacyPolicy: {
    ...
    collectPrinciple: "Vårt veiledende prinsipp er å bare samle inn det vi trenger. Her er hva det betyr i praksis:",
    ...
    sslTlsLink: "SSL/TLS",
    secureDataContent2: "når den overføres fra serverne våre til nettleseren din.",
    deleteContentContent: "Hvis du sletter innhold, blir det umiddelbart utilgjengelig.",
    locationContent:
    ...
    contactUsContent1: "Hvis du har spørsmål, kommentarer eller klager angående vår personvernerklæring, vennligst",
    contactUs: "kontakt oss",
    contactUsContent2: "og vi vil gjøre vårt beste for å behandle klagen din så snart som mulig."
  },
  termsOfService: {
    ...
    companyReference: "Når vi sier «Selskap», «vi», «vår» eller «oss» i dette dokumentet, refererer vi til Scribify.",
    servicesDefinition:
    ...
    accountTerms2: "- Du har ikke lov til å bruke Tjenestene til noe ulovlig, uetisk eller umoralsk formål.",
    accountTerms3:
    ...
    copyrightContent1: "– Alt innhold som legges ut på Tjenestene må være i samsvar med amerikansk lov om opphavsrett.",
    copyrightContent2:
    ...
    prohibitedActivitiesUserAgreement: "Som bruker av nettstedet samtykker du i å ikke:",
    prohibitedActivity1:
    ...
    prohibitedActivity4: "- Nedsette, sverte eller på annen måte skade oss og/eller nettstedet etter vår mening.",
    prohibitedActivity5:
    ...
    prohibitedActivity7: "- Bruke nettstedet på en måte som er uforenlig med gjeldende lover eller forskrifter.",
    prohibitedActivity8: "- Delta i uautorisert innramming av eller lenking til nettstedet.",
    prohibitedActivity9:
    ...
    prohibitedActivity11: "- Slett opphavsretts- eller annen eiendomsrettserklæring fra alt innhold.",
    ...
    prohibitedActivity20: "- Bruk en innkjøpsagent eller innkjøpsagent for å foreta kjøp på nettstedet.",
    ...
    prohibitedActivity23: "- Bruk nettstedet til å annonsere eller tilby salg av varer og tjenester.",
    ...
    privacyPolicyContent1: "Vi bryr oss om personvern og sikkerhet. Vennligst les vår",
    ...
    liabilityIntro: "Vi nevner ansvar gjennomgående i disse vilkårene, men for å samle alt i én seksjon:",
    liabilityContent:
    ...
    contactUsContent1: "Hvis du har et spørsmål om noen av tjenestevilkårene, vennligst",
    contactUsContent2: "."
  },
  HeadNavbar: {
    Features: "Funksjoner",
    ...
    VideoTranscription: "Videotranskripsjon",
    Other: "Annet",
    mp4Transcription: "MP4-transkripsjon",
    youtubeTranscription: "YouTube-transkripsjon"
  },
  Footer: {
    ...
    Resources: "Ressurser",
    resourcesMenus: ["YouTube til MP4","YouTube til MP3","Videotranskripsjon","MP4-transkripsjon","YouTube-transkripsjon"]
  },
  Index: {
    Hero: {
  ...
  Features: {
    ...
    Accuracy: {
      ...
      comparisonDes2: "stable opp mot konkurrentene"
    }
  },
  Pricing: {
    Hero: {
      ...
      plans: [
        {
          ...
          features: {
            title: "Funksjoner",
            items: ["100+ språk", "Talermerker", "Oversettelse", "Alle eksportformater"]
          },
          cta: {
  ...
  Resources: {
    YouTubeToMP4: {
      ...
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Konverter YouTube-videoer til MP3-format for visning uten nett. Last ned videoer av høy kvalitet umiddelbart.",
        AITranscription: "AI-transkripsjon",
        AITranscription_des:
          "Transkriber lyd- og videofiler med 96 % nøyaktighet. Ubegrenset transkripsjon for alt innholdet ditt."
      }
    },
    YouTubeToMP3: {
      ...
      part4: {
        content: ["Her er de 5 største fordelene med å konvertere", "YouTube-videoer til MP3-filer"],
        list: [
          {
            title: "Spar på lagringsplass:",
            content:
              "MP3-filer er mindre, noe som reduserer lagringsplassen på YouTube. Spar mobildata ved å laste ned offline-visning, og bruk dem når det er internettilgang."
          },
          {
            title: "Sparer batteri:",
            content:
              "For å se YouTube-videoer bruker de en buffertjeneste som bruker lettlyttede forbindelser. Ikke mer bekymringer om buffering."
          },
          {
            title: "Enkel arkivering og bevaring:",
            content:
              "Noen videoer eller MP3-filer gjør det enkelt å bygge ditt personlige bibliotek – enten det er for pedagogisk innhold, musikkarkiver eller viktige ting."
          },
          {
            title: "Enklere deling:",
            content:
              "Det er mye enklere å dele en MP3-fil enn YouTube-lenker. Du kan sende filer til venner via apper som WhatsApp eller Instagram, og dermed slippe å bruke YouTube på å åpne."
          },
          {
            title: "Øyeblikkelig visning, bred fleksibilitet:",
            content:
              "Få tilgang til en bredere favorittvideo til favorittvideoen din ved å konvertere YouTube-videoer der du trenger dem, og MP3-formater gir mulighet for jevn sammenkobling med en gang, uten vanskelige pauser i venting på denne lasten."
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            content:
              "Nyt et rent grensesnitt uten popup-vinduer, bannere eller avbrudd – bare jevn og uavbrutt konvertering."
          },
          {
            title: "Original kvalitet garantert",
            content:
              "Nedlastingene dine beholder kildevideoens fulle oppløsning for pikselperfekt avspilling hver gang."
          },
          {
      ...
      part6: {
        title: ["Maksimer YouTube til MP3-konverteringene dine", "Med vår konverter"],
        ...
        list: [
          {
            ...
            answer:
              "Selv om det er teknisk mulig, kan konvertering av opphavsrettsbeskyttet innhold uten tillatelse være i strid med YouTubes tjenestevilkår og lover om opphavsrett. Sørg alltid for at du har rett til å konvertere innhold eller bruke det kun til personlige, ikke-kommersielle formål."
          },
          {
            question: "Er dette konverteringsverktøyet trygt?",
            answer:
              "Ja, konverteren vår er fullstendig trygg og sikker. Vi lagrer ingen av dataene eller filene dine, og det er ingen risiko for skadelig programvare eller virus. Konverteringen skjer direkte og sikkert."
          },
          {
            question: "Hvilke språk støttes av konvertering fra YouTube til MP3?",
            answer:
              "Konverteringsprogrammet vårt støtter alle språk som er tilgjengelige på YouTube. Lyden blir hentet ut nøyaktig slik den vises i den originale videoen, og originalspråket og lydkvaliteten bevares."
          },
          {
            question: "Hvilke faktorer påvirker tiden det tar å konvertere en YouTube-video?",
            answer:
              "Konverteringstiden avhenger av flere faktorer: videoens lengde, internettforbindelsens hastighet og gjeldende serverbelastning. De fleste videoer under 10 minutter konverteres på under 30 sekunder."
          },
          {
            question: "Når jeg konverterer og laster ned en MP3-fil med smarttelefonen min, hvor lagres den?",
            answer:
              "På de fleste smarttelefoner lagres konverterte MP3-filer i Nedlastinger-mappen. På iPhone kan de havne i Filer-appen. På Android kan du sjekke Nedlastinger-mappen i filbehandleren eller musikkappen."
          },
          {
            question: "Reduserer konvertering av YouTube-video til MP3 lydkvaliteten?",
            answer:
              "MP3 er et kun lydformat, så det er ingen videokomponent. Lydkvaliteten bevares med den høyeste tilgjengelige bithastigheten fra kildevideoen, vanligvis 128–320 kbps, avhengig av den opprinnelige opplastingskvaliteten."
          }
        ]
      },
      MoreFreeTools: {
        ...
        YouTubeToMP_des:
          "Konverter YouTube-videoer til MP4-format for visning uten nett. Last ned videoer av høy kvalitet umiddelbart.",
        AITranscription: "AI-transkripsjon",
        AITranscription_des:
          "Transkriber lyd- og videofiler med 96 % nøyaktighet. Ubegrenset transkripsjon for alt innholdet ditt."
      },
      videoDownload: {
        ...
        description:
          "Takk for at du valgte tjenesten vår! Vi setter stor pris på tilliten du ga oss, og håper at den forbedret opplevelsen din. Det ville vært til stor hjelp hvis du kunne dele nettsiden vår med vennene dine.",
        downloadButton: "Last ned",
        TranscribeButton: "Transkribere",
    ...
    Transcription: {
      videoTranscription: {
        hero: {
          title: "Videotranskripsjon: Drevet av AI & Nøyaktig",
          des: "Transkriber videoer til tekst med høy nøyaktighet og støtte for 100+ språk. Konverter enkelt enhver fil eller lenke til redigerbar tekst og eksporter i flere formater, fra korte klipp til lange videoer.",
          feature_1: "Støtter 12 formater",
          feature_2: "Støtter 100+ språk",
          feature_3: "Eksporter i 6 formater"
        },
        threeStep: {
          title: "Hvordan",
          titleHighlight: "Konverter video til tekst med NeverCap",
          step_1_title: "Last opp eller lim inn",
          step_1_des:
            "Vi støtter videoformater som MP4, MOV, WMV og MPEG, samt lenker fra YouTube, TikTok, X, Facebook og andre plattformer.",
          step_2_title: "Transkriber video til tekst",
          step_2_des:
            'Klikk på "Transkriber"-knappen og vent til prosessen er fullført. En 1-times video tar vanligvis kun 1–2 minutter å transkribere.',
          step_3_title: "Eksporter eller del",
          step_3_des:
            "Rediger teksten din direkte på nettet, og eksporter den deretter i flere formater som TXT, PDF, DOCX, SRT, CSV eller VTT. Du kan også generere en delbar lenke til transkripsjonen din."
        },
        whyTran: {
          title: "Hvorfor",
          titleHighlight: "Transkriber videoer til tekst",
          des: "Det er utrolig verdifullt i scenarier som læring, innholdsproduksjon, forskning og arbeid. Her er hvorfor:",
          reason_1_title: "Gjør notataking og gjennomgang enklere.",
          reason_1_des:
            "Studenter, forskere og skapere trenger ofte å trekke ut informasjon fra videoer. Transkripsjon gjør det enkelt å ta studienotater, organisere forskningsintervjuer, utkaste manus eller artikler og oversette innhold mer nøyaktig og kostnadseffektivt.",
          reason_2_title: "Forbedrer søkbarhet.",
          reason_2_des:
            "Med tekst kan du raskt søke etter nøkkelord og finne viktige deler – ikke mer tilbakespoling eller framforspoling gjennom videoen.",
          reason_3_title: "Sparer tid og øker effektiviteten.",
          reason_3_des:
            "Å lese tekst er mye raskere enn å se en video, spesielt for innhold som forelesninger, intervjuer eller møter. Tekst lar deg skumlese eller hoppe direkte til hovedpunkter.",
          reason_4_title: "Forbedrer tilgjengelighet.",
          reason_4_des:
            "Det gir lik tilgang til informasjon for døve eller hørselshemmede, ikke-morsmålstalende eller de med hørselsvansker. Det hjelper også plattformer med å oppfylle standarder som WCAG.",
          reason_5_title: "Muliggjør gjenbruk av innhold.",
          reason_5_des:
            "Skere bruker ofte transkripsjoner til raskt å generere blogginnlegg, sosiale medie-innhold, sammendrag eller videotekster – noe som dramatisk fremskynder den kreative prosessen uten manuell innskriving.",
          reason_6_title: "Støtter bedre forståelse, husking og arkivering.",
          reason_6_des:
            "Kombinasjonen av visuell og tekstbasert informasjon forbedrer forståelse og hukommelse, mens tekstfiler er enkle å lagre, ideelle for å bygge kunnskapsbaser, dokumentbiblioteker eller arkivsystemer."
        },
        whyChoose: {
          title: "Hvorfor velge",
          titleHighlight: "Vårt videotranskripsjonsverktøy",
          reason_1_title: "Transkriber & Oversett Globalt",
          reason_1_des:
            "Støtter transkripsjon på 100+ språk og oversettelse til 249 andre, og bryter ned alle språkbarrierer.",
          reason_2_title: "Universell formatkompatibilitet",
          reason_2_des:
            "Fungerer sømløst med alle vanlige videoformater (MP4, MOV, MKV osv.) og plattformer som YouTube & TikTok.",
          reason_3_title: "Virkelig ubegrensede transkripsjoner",
          reason_3_des:
            "Transkriber 100 eller 1000 videoer – din faste pris forblir den samme. Ingen skjulte grenser, ingen overraskelseskostnader.",
          reason_4_title: "Nøyaktighet du kan stole på",
          reason_4_des:
            "Dra nytte av over 95 % samlet nøyaktighet, med viktige språk som engelsk og spansk på over 96 %.",
          reason_5_title: "Bedriftsgraders sikkerhet",
          reason_5_des:
            "Dataene dine er beskyttet av ledende krypterings- og personvernprotokoller. Vi behandler din konfidensialitet med største alvor.",
          reason_6_title: "Ordspesifikke tidsstempler",
          reason_6_des:
            "Finn frem til hvilket som helst øyeblikk i videoen din umiddelbart. Klikk på et ord i transkripsjonen for å hoppe direkte til nøyaktig tidspunkt i originalmediet."
        },
        reviews: {
          title: "Anmeldelser fra",
          titleHighlight: "Våre brukere",
          des: "Se hvorfor tusenvis stoler på oss for enkel transkripsjon.",
          people_1_content:
            "NeverCaps videotranskripsjon er helt fantastisk! Etter å ha prøvd over et dusin transkripsjonsverktøy, er dette den første tjenesten som virkelig er ubegrenset. Jeg kan transkribere så mye jeg vil uten å bekymre meg for bruksgrenser.",
          people_1_job: "Innholdsprodusent",
          people_2_content:
            "Rimelige priser, håndterer store filer med letthet og behandler dusinvis av filer samtidig. NeverCaps videotranskripsjon dekker nesten alle problemområder jeg har hatt.",
          people_2_job: "Forsker",
          people_3_content:
            "Nøyaktig, rask og støtter mange språk. Det som virkelig skiller seg ut er hvor godt den håndterer lange videoer. NeverCap har blitt en essentiel del av verktøykassen min, og jeg har anbefalt det til alle medstudenter.",
          people_3_job: "PhD-kandidat"
        },
        faq: {
          title: "Sentrale spørsmål om",
          titleHighlight: "Videotranskripsjon",
          question_1: "Hvilke videoformater støtter NeverCap?",
          answer_1: "Vi støtter vanlige videoformater inkludert MP4, MOV, WMV, MPEG, WebM og MKV.",
          question_2: "Hvordan transkriberer jeg en videolenke, og hvilke plattformer støttes?",
          answer_2:
            'Bare kopier og lim inn video-URLen, så klikker du på "Transkriber". Vi støtter lenker fra YouTube, Facebook, X, Dropbox, Google Drive, Vimeo, TikTok, Instagram og mer.',
          question_3: "Hvilke språk støttes for videotranskripsjon?",
          answer_3:
            "NeverCap støtter over 100 språk, inkludert engelsk, spansk, mandarin, fransk, tysk, japansk, koreansk, portugisisk, russisk, italiensk, nederlandsk og arabisk.",
          question_4: "Hva er maksimal varighet og filstørrelse for transkripsjon?",
          answer_4: "Maksimal filstørrelse er 5GB, og maksimal varighet er 10 timer per video.",
          question_5: "Hvor mange videofiler kan jeg laste opp samtidig?",
          answer_5: "NeverCap tillater at inntil 50 filer behandles samtidig.",
          question_6: "Hvor rask er transkripsjonsprosessen? Må jeg vente lenge?",
          answer_6:
            "Ingen lange ventetider nødvendig. I våre tester tar en 1-times video vanligvis rundt 3 minutter å transkribere.",
          question_7: "Hvor nøyaktig er NeverCaps transkripsjon?",
          answer_7:
            "Vi leverer over 95% nøyaktighet på alle språk, og over 96% for viktige språk som engelsk, spansk, mandarin og fransk.",
          question_8: "Kan den transkriberte teksten oversettes til andre språk?",
          answer_8: "Ja. Når transkripsjonen er fullført, kan du oversette teksten til 249 støttede språk.",
          question_9: "Kan jeg redigere, eksportere eller dele den transkriberte teksten?",
          answer_9:
            "Absolutt. Transkribert tekst kan redigeres i sanntid. Eksporteringsalternativer inkluderer PDF, DOCX, TXT, TTV, CSV og SRT-formater. Du kan også generere en delbar lenke til transkripsjonen."
        },
        explore: {
          title: "Utforsk mer",
          transcribeTitle: "Verktøy for transkripsjon til tekst",
          transcribe_1: "Lyd til tekst",
          transcribe_2: "Tale til tekst",
          ...
          otherToolsTitle: "Andre relaterte verktøy",
          otherTools_1: "Al Notetaker",
          otherTools_2: "Legge til undertekster på video",
          otherTools_3: "Oversette lyd",
          otherTools_4: "Oversette video",
          otherTools_5: "Undertekstgenerator",
          otherTools_6: "Videosammendrag",
          otherTools_7: "Videokonverter"
        }
      },
      mp4Transcription: {
        hero: {
          title: "Online MP4 til Tekst Konverterer",
          des_1: "Konverter dine MP4-filer til tekst på sekunder.",
          des_2: "Ingen registrering påkrevd. Lynrask. Topp-nøyaktighet.",
          feature_1: "Støtter 12 Formater",
          feature_2: "Støtter 100+ Språk",
          feature_3: "Eksporter i 6 Formater"
        },
        threeStep: {
          title: "Skriv ned MP4-en din til",
          titleHighlight: "tekst i 3 enkle steg",
          step_1_title: "Last opp MP4-filen din",
          step_1_des: "Bare dra og slipp den i det utpekte området, eller klikk på \"Last opp Fil\"-knappen.",
          step_2_title: "Start Transkripsjon",
          step_2_des: "Klikk på \"Skriv ned\"-knappen. Systemet vil automatisk konvertere MP4-en din til tekst på øyeblikket.",
          step_3_title: "Last Ned Nedskrivningen Din",
          step_3_des: "Teksten din er klar for online redigering og kan eksporteres i TXT, PDF, DOCX, SRT, CSV, VTT formater, eller deles via en lenke."
        },
        howToGet: {
          title: "Hvordan Få Du Beste Resultater fra",
          titleHighlight: "Din Nedskrivning?",
          fun_1: "Bruk den originale videofilen for nedskrivning, i stedet for en komprimert versjon.",
          fun_2: "Reduser bakgrunnsstøy, bakgrunnsmusikk, statisk støy eller ekko så mye som mulig.",
          fun_3: "Hvis du laster ned en video, velg alltid \"Høy Lydkvalitet (HQ)\"-alternativet.",
          fun_4: "Aktiver \"Høytaler Identifikasjon\"-funksjonen når det er mer enn én høytaler.",
          fun_5: "Velg det spesifikke språket og aksenten til MP4-filen din, f.eks. Engelsk → Engelsk (US) / Engelsk (UK) / Engelsk (India).",
          fun_6: "Se raskt over nedskrivningen når prosessen er ferdig."
        },
        exportFormats: {
          title: "Eksportformater &",
          titleHighlight: "Deres Bruk",
          format_1: "I TXT-format",
          des_1: "For Notisblokk, Notepad++ og lette tekstredigerere",
          format_2: "I PDF-format",
          des_2: "For utskrift, deling, arkivering og kryssplattformvisning",
          format_3: "I DOCX-format",
          des_3: "For Microsoft Word, Google Docs og rik-tekst redigering",
          format_4: "I SRT-format",
          des_4: "For YouTube undertekster, video undertekst opplastinger og mediespillere",
          format_5: "I CSV-format",
          des_5: "For Excel, Google Sheets og dataanalyseverktøy",
          format_6: "I VTT-format",
          des_6: "For webvideo undertekster, HTML5 spillere og tilgjengelighetsverktøy"
        },
        howToUse: {
          title: "Hva er verdien av å konvertere MP4 til tekst,",
          titleHighlight: "og hvordan kan du få mest ut av det?",
          effect_1: "Les nøkkelpunkter umiddelbart.",
          des_1: "Bla gjennom nedskrivninger raskere enn å se videoer på nytt, og finn raskt essensiell informasjon.",
          effect_2: "Organiser studier og forskning.",
          des_2: "Gjør om forelesninger, intervjuer og forskningsklipp til rene notater du kan fremheve, sitere og gjenbruke.",
          effect_3: "Øk jobbproduktiviteten.",
          des_3: "Lag møtesammendrag, spor handlingspunkter, og lagre innhold i dokumentasjon eller kunnskapsbaser.",
          effect_4: "Støtt innholdsskaping.",
          des_4: "Pakk ut manuskripter, disposisjoner, artikler, og eksporter undertekster for redigering eller lokalisering.",
          effect_5: "Gjør innhold søkbart og oversettbart.",
          des_5: "Fulltekstsøk og oversett nedskrivninger for flerspråklig bruk.",
          effect_6: "Forenkle arkivering.",
          des_6: "Tekst er enklere å lagre, strukturere og gjenbruke—ideelt for poster, dokumentasjon og AI kunnskapsbaser."
        },
        whyChoose: {
          title: "Hvorfor",
          titleHighlight: "Vår MP4-til-Tekst Nedskrivning Utmerker Seg",
          reason_1_title: "Bransjeledende Nøyaktighet",
          reason_1_des: "Uavhengig verifisert som ett av de mest nøyaktige nedskrivingsverktøyene tilgjengelig.",
          reason_2_title: "Rask Behandlingshastighet",
          reason_2_des: "Få nedskrivningen din på omtrent en tyvendedel av lengden på den originale videoen.",
          reason_3_title: "Høytaler Identifikasjon",
          reason_3_des: "Skiller tydelig mellom høyttalere, og gjør nedskrivninger enklere å lese og følge.",
          reason_4_title: "Bred Språkdekning",
          reason_4_des: "Støtter nedskrivning på 100+ språk og oversettelse til 249 språk.",
          reason_5_title: "Enkel og Brukervennlig",
          reason_5_des: "Ingen komplekse grensesnitt eller steg. Fullfør oppgaven din med bare noen få klikk.",
          reason_6_title: "Full Datasikkerhet",
          reason_6_des: "Vi prioriterer sikkerheten og personvernet til dine data som en av våre kjerneforpliktelser."
        },
        faq: {
          title: "Spørsmål om",
          titleHighlight: "Å Konvertere MP4 til Tekst",
          question_1: "Hvor lang tid tar det å skrive ned en MP4-fil til tekst?",
          answer_1: "Basert på tester, under normale forhold, tar nedskrivningsprosessen omtrent 1/20 til 1/10 av videoens lengde. For eksempel, en 1-times video vil ta omtrent 3 til 6 minutter å skrive ned.",
          question_2: "Er det grenser for størrelsen på MP4-filen jeg laster opp?",
          answer_2: "Ja. Maksimal filstørrelse er 5GB, og videolengden skal ikke overstige 10 timer. Vær oppmerksom på at større filer kan kreve mer tid å behandle.",
          question_3: "Hvor nøyaktig er nedskrivningen?",
          answer_3: "Det er viktig å forstå at nedskrivningskvaliteten i stor grad avhenger av lydkvaliteten på videoen din. Det sagt, vi bruker bransjeledende talegjenkjenningsteknologi for å sikre best mulige resultater for din MP4 nedskrivning.",
          question_4: "Kan jeg skrive ned MP4 til et Word-dokument?",
          answer_4: "Absolutt. Bare last opp MP4-filen din, klikk \"Skriv ned\", og når prosessen er fullført, velg \"Eksporter\" og velg DOCX-formatet. Du vil motta en fullstendig nedskrivning i et Word-dokument.",
          question_5: "Hvordan kan jeg få undertekster for videoen min?",
          answer_5: "Last opp videoen din og skriv den ned. Etter nedskrivning, klikk \"Eksporter\" og velg enten SRT eller VTT-formatet for å laste ned undertekstene dine.",
          question_6: "Er dette MP4 nedskrivningsverktøyet trygt å bruke?",
          answer_6: "Ja. Vår side er reklamefri, krever ingen registrering for behandling, og ber ikke om personlig informasjon. Vi bruker også sterke tekniske tiltak for å forhindre virus. Vi oppfordrer alle brukere til å respektere opphavsretts- og personvernsretningslinjer når de laster ned, bruker eller deler MP4-filer."
        },
        explore: {
          title: "Alt-til-Tekst Konverterer",
          des: "Nedskrivning strømlinjeformer arbeidsflyten din og lar deg konsentrere deg om arbeidet som gir reell effekt.",
          tool_1: "Video til tekst",
          tool_2: "MOV til tekst",
          tool_3: "TikTok til tekst",
          tool_4: "YouTube til tekst",
          tool_5: "MP4 til SRT",
          tool_11: "Lyd til tekst",
      ...
      youtubeTranscription: {
        hero: {
          ...
          des_1: "YouTube-videoer konverteres umiddelbart til transkripsjoner — raske, nøyaktige og uten registrering påkrevd.",
          des_2: "Støtter 6 eksportformater, 100+ språk og 249 oversettelser."
        },
        threeStep: {
          title: "Slik får du",
          titleHighlight: "nøyaktige resultater",
          step_1_des: "Kopier lenken til YouTube-videoen.",
          step_2_des: "Lim inn lenken i inputboksen og klikk på \"Få video-tekst\".",
          step_3_des: "Vent til transkripsjonen er fullført, så få tilgang til teksten for å redigere, oversette eller eksportere."
        },
        whatYouCan: {
          title: "Hva du kan gjøre med",
          titleHighlight: "vårt transkripsjonsverktøy for YouTube",
          list_title_1: "Fleksibelt tekstinnhold",
          list_des_1: "Konverter enhver YouTube-video du liker til lesbare, kopierbare og søkbare tekster.",
          list_title_2: "Raskt søk og redigering",
          list_des_2: "Finn enkelt nøkkelinnhold, minneverdige sitater eller viktige segmenter i videoen, og rediger teksten mens du refererer til videoen.",
          list_title_3: "Flere eksportformater",
          list_des_3: "Eksporter transkripsjoner i ulike formater som TXT, PDF, DOCX, SRT, CSV og VTT, egnet for undertekster, dokumentredigering, dataanalyse og mer."
        },
        whyConvertYouTube: {
          title: "Hvorfor",
          titleHighlight: "konvertere YouTube-videoer til tekst",
          list_title_1: "Enkel dokumentasjon, lagring og organisering",
          list_des_1: "Tekst er mer praktisk enn video for notatskriving, organisering av intervjuer, uttrekk av nøkkelpunkter og laging av forskningssammendrag.",
          list_title_2: "Lokalisere og hente viktig informasjon",
          list_des_2: "Finn raskt nøkkelinnhold uten å måtte scrolle gjennom videoens tidslinje.",
          list_title_3: "Øke læringseffektivitet",
          list_des_3: "Bruk tekst til å effektivt fremheve, referere og sammenligne innhold.",
          list_title_4: "Søk og uttrekk innhold",
          list_des_4: "Tekst er søkbar og kopierbar, ideell for uttrekk av sitater, referanse til klipp eller laging av manuskripter.",
          list_title_5: "Flerspråklig tilgjengelighet",
          list_des_5: "Transkriber enkelt innhold i ukjente språk og oversett til flere språk.",
          list_title_6: "Gjenbruk av innhold",
          list_des_6: "Generer artikler, undertekster, sosiale medier-kort, videoskript og mer fra din transkripsjon."
        },
        whyPeopleTrust: {
          title: "Hvorfor folk",
          titleHighlight: "stoler på vårt verktøy",
          list_title_1: "Gratis online verktøy",
          list_des_1: "Ingen innlogging kreves. Ingen programvare, plugins eller utvidelser å installere.",
          list_title_2: "Null annonser, null distraksjoner",
          list_des_2: "En ren og enkel grensesnitt designet for å møte dine behov uten å avbryte din arbeidsflyt.",
          list_title_3: " lynrask konvertering",
          list_des_3: "Opplev bransjeledende hastighet uten begrensninger.",
          list_title_4: "Høy nøyaktighet",
          list_des_4: "Drevet av den nyeste talegjenkjenningsteknologien for forbedret presisjon.",
          list_title_5: "Bred språkstøtte",
          list_des_5: "Transkriber innhold på over 100 språk og oversett til 249 språk.",
          list_title_6: "Lagrings- og redigeringsfunksjoner",
          list_des_6: "Rediger transkripsjoner i sanntid og lagre arbeidet ditt for fremtidig bruk."
        },
        howToUse: {
          title: "Virkelige måter folk bruker",
          titleHighlight: "YouTube-transkripsjoner",
          list_title_1: "For notattegnere",
          list_des_1: "Å ta notater mens man ser en YouTube-video kan føles stressende og uorganisert. Med en transkripsjon kan du enkelt kopiere nøkkelpunkter og viktige konsepter direkte inn i notatene dine, sikker på å fange alt. Du kan til og med sette inn transkripsjonen i verktøy som ChatGPT for å generere klare sammendrag, studienotater eller disposisjoner.",
          list_title_2: "For innholdsskapere",
          list_des_2: "Bare lim inn en YouTube-lenke og få en nøyaktig tekstversjon — en mye mer effektiv arbeidsflyt for skapere. Bruk transkripsjonen til å utforme blogginnlegg, manuskripter, undertekster, nyhetsbrev eller detaljerte programnotater. Det sparer tid og krefter, og lar deg fokusere på selve innholdet.",
          list_title_3: "For profesjonelle og analytikere",
          list_des_3: "Hvis arbeidet ditt innen områder som jus, medisin, rådgivning eller forretning krever presis informasjonsuttrekk, gjør transkripsjoner oppgaven enklere. Søk raskt spesifikke fakta, tidsstemple og sitater uten å måtte se hele videoen på nytt. Ideelt for å gjennomgå ekspertforedrag, presentasjoner, treningsvideoer og kundeintervjuer.",
          list_title_4: "For brukere med tilgjengelighetsbehov",
          list_des_4: "Ikke alle kan enkelt se eller høre videoinnhold. Transkripsjoner gjør YouTube tilgjengelig for brukere med hørselsproblemer eller de som rett og slett foretrekker å lese. Med støtte for oversettelse til 249 språk, bryter de ned språkbarrierer, noe som gjør globalt innhold enklere å forstå og dele.",
          list_title_5: "For kunnskapsuttrekkere",
          list_des_5: "For studenter, forskere, skapere og profesjonelle som raskt må forstå sentrale ideer, er transkripsjoner uvurderlige. Bla gjennom, søk og identifiser umiddelbart avgjørende informasjon uten å måtte sitte gjennom lange videoer, og hjelp deg å effektivt trekke ut nøkkelpunkter, sammendrag eller tidsstemple."
        },
        howToGet: {
          title: "Lås opp nye ideer med",
          titleHighlight: "YouTube-transkripsjoner",
          subTitle: "Transformer YouTube-videoer til lett kopierbar, handlingsorientert tekst og kombiner med AI-verktøy som Gemini eller ChatGPT for å:",
          list_des_1: "Raskt generere studienotater eller sammendrag",
          list_des_2: "Uttrekke nøkkelpunkter og minneverdige sitater eller konsepter",
          list_des_3: "Opprette quizzer, spørsmål og svar eller studiemateriell",
          list_des_4: "Utarbeide blogginnlegg, manuskripter eller artikler",
          list_des_5: "Utvikle infografikk, memes eller innhold for sosiale medier",
          list_des_6: "Produsere fan Q&A's, trivia eller pedagogiske spill",
          list_des_7: "Dykk dypere ned i temaer nevnt i videoen",
          summary: "Alt uten bryderi: kopier, lim inn og begynn."
        },
        faq: {
          title: "Ofte stilte",
          titleHighlight: "spørsmål",
          question_1: "Er det en lengdebegrensning for tekst av YouTube-videoer?",
          answer_1: "Nei. Men lengre videoer krever mer behandlingstid. Planlegg dine tekstoppgaver deretter.",
          question_2: "Fungerer dette med private eller ikke-listede videoer?",
          answer_2: "Dette fungerer kun med offentlig tilgjengelige YouTube-videoer. Private eller begrensede videoer kan ikke transskriberes.",
          question_3: "Hvor lang tid tar det å få teksten?",
          answer_3: "Typisk varierer behandlingstiden fra 1/10 til 1/20 av videoens varighet. Vi_optimaliserer kontinuerlig hastigheten samtidig som vi sikrer høy nøyaktighet for en bedre brukeropplevelse.",
          question_4: "Kan verktøyet skille mellom forskjellige talere?",
          answer_4: "Ja. Det støtter deteksjon av opptil 20 talere, ideelt for transkripsjon av intervjuer, podkaster og diskusjoner.",
          question_5: "Hvor nøyaktig er transkripsjonsverktøyet?",
          answer_5: "Vår nøyaktighet overstiger 96%. Det opprettholder høy presisjon selv med ulike aksenter eller raske talere, selv om bedre lydkvalitet med mindre bakgrunnsstøy forbedrer resultatene.",
          question_6: "Hvilke funksjoner er inkludert i transkripsjonen?",
          answer_6: "Transkripsjonen inkluderer automatisk taleridentifikasjon og tidsstemple. Du kan redigere teksten online eller eksportere den for senere bruk.",
          question_7: "Kan jeg lagre mine tekstopptak?",
          answer_7: "Ja. Bare registrer en konto for å lagre dine transkripsjoner etter behandling av en YouTube-lenke.",
          question_8: "Blir dataene mine lagret privat og sikkert?",
          answer_8: "Ja. Dine videoer, transkripsjoner og filer behandles sikkert — de brukes aldri til å trene AI-modeller eller deles med tredjeparter.",
          question_9: "Kan jeg bruke tekstinnhold med andre AI-verktøy?",
          answer_9: "Absolutt. Du kan lime inn teksten i ChatGPT eller andre AI-verktøy for å generere sammendrag, notater, quizzer, manuskripter, artikler og mer."
        }
      }
    },
    Upload: {
      ...
      fileTip: "Få videotranskripsjonen din på sekunder",
      linkTitle: "Lenke",
      linkTip: "Lim inn en lenke fra hvilken som helst plattform for å begynne",
      transcribeProgress: "Transkribering pågår...",
      transcribeFailed: "Transkribering mislyktes...",
      retry: "Prøv på nytt",
      search: "Søk",
      tip1: "Vil du lagre den permanent?",
      tip2: "Registrer deg gratis",
      tip3: "for å håndtere og redigere alle dine transkripsjonsfiler.",
      tip4: "Vil du",
      tip5: "lagre",
      tip6: "den permanent?",
      tip7: "for å håndtere og redigere",
      tip8: "alle dine transkripsjonsfiler.",
      linkV1Placeholder: "Lim inn YouTube URL her.",
      linkV1Btn: "Hent Video Transkripsjon"
    }
  },
  About: {
    Hero: {
  ...
  Blog: {
    ...
    ListSection: {
      ...
      categories: ["Alle innlegg", "Veiledninger", "Podkasting", "Innholdsskaping", "Forretninger", "AI-tips"]
    },
    Detail: {
      Home: "Hjem",
      Blog: "Blogg",
  ...
  cello: {
    exclusiveAccess: "{name} ga deg eksklusiv tilgang til NeverCap Pro",
    proMember: "NeverCap Pro Medlem",
    save: "Spar",
    unlimitedTranscription: "på ubegrenset AI-transkripsjon",
    specialPrice: "Din spesialpris: {moneyOne}/mnd (Reg. {moneyTwo})",
    whyChose: "Hvorfor {name} valgte NeverCap:",
    noLimits: "Ingen månedlige grenser (andre begrenser til 120 min/måned)",
    uploadFiles: "Last opp 50 filer samtidig",
    longFiles: "10-timers filer støttet",
    accuracy: "96% nøyaktighet garantert",
    regularPrice: "Vanlig Pris",
    perMonth: "/måned",
    getsCredit: "{name} får: $50 kreditt",
    whenSubscribe: "når du abonnerer",
    activateGift: "Aktiver Bobs Gave",
    existingAccount: "↓ Har du allerede en konto? Bruk rabatt på eksisterende konto",
    offerExpires: "Tilbudet utløper om:",
    activeUsers: "aktive brukere",
    rating: "vurdering",
    noCreditCard: "Ingen kredittkort",
    requiredFreeTrial: "nødvendig for gratis prøveperiode",
    yourSpecialPrice: "Din Spesialpris",
    activateNameGift: "Aktiver {name}'s Gave",
    year: "år"
  },
  RegisterDialog: {
    transcribeNewFiles: "Transkriber nye filer",
    signUpNow: "Registrer deg nå",
    stillExporting: "Eksporterer fortsatt",
    tip1: "Registrer deg gratis for å lagre og redigere filene dine permanent!",
    tip2: "Oppgrader for ubegrenset transkripsjon!"
  }
};
