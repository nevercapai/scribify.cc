...
let message = {
  ...
  TranscriptionPage: {
    ...
    cancel: "キャンセル",
    addNew: "新規追加",
    createANewSpeaker: "新しい話者を作成",
    speakerName: "話者名",
    addSpeaker: "話者を追加",
    applyToAllMatchingSpeakers: "一致する話者すべてに適用",
    applyToCurrentParagraph: "現在の段落に適用",
    speakerDuplicate: "話者は既に存在します。",
    ...
    upgradeTip30: "完全な文字起こしをロック解除",
    upgradeTipMore: "朗報です！ファイル全体が文字起こしされました。",
    errorTips: "問題が発生しました。",
    copiedLink: "リンクをコピーしました",
    copyGotIt: "了解",
    upgradeMinPreview: "30分のプレビューを超えて表示するにはアップグレードしてください。",
    silentTip: "ファイルに音声が含まれていません。確認して再度お試しください。",
    outLimit: "ファイルの長さ制限を超えています",
    outLimitTip1: "無料アカウントは最大30分のファイルをサポートしています。",
    outLimitTip2: "今すぐ登録してアップグレードし、完全な文字起こしテキストをロック解除しましょう！"
  },
  // 登录、注册、修改密码
  IdentityInfoManage: {
    or: "または",
  ...
  HeadNavbar: {
    ...
    Other: "その他",
    mp4Transcription: "MP4文字起こし",
    youtubeTranscription: "YouTube 文字起こし"
  },
  Footer: {
    ...
    Resources: "リソース",
    resourcesMenus: ["YouTube を MP4 に","YouTube を MP3 に","ビデオ文字起こし","MP4 文字起こし","YouTube 文字起こし"]
  },
  Index: {
    Hero: {
      ...
      subtitleA:
        "NeverCapのAIは、動画を文字起こしし、音声をテキストに変換します。月額利用制限なしで、一度に50ファイルまで処理できます。お客様のニーズに合わせて拡張可能な文字起こしサービスです。"
    },
    Stats: {
      monthlyMinutes: "月間分数",
    ...
    FeaturesGrid: {
      ...
      transparency:
        "隠れた制限もサプライズもなし - 他社が細則で分数を減らしたり制限を隠す中、私たちは徹底的な透明性を信じています",
      feat_unltd: "真の無制限",
      feat_unltd_desc:
        "利用規約に埋もれた「公正使用ポリシー」なし。「無制限」を装ったストレージ制限なし。アーカイブ全体をアップロードし、全ての音声文字起こしニーズに対応。本気です。",
      feat_bulk: "一括アップロードの自由",
      feat_bulk_desc:
        "「生涯3回インポート」や「月10ファイル」に疲れていませんか？必要なだけ何度でも50ファイルを一度にアップロード。バックログ処理に最適。",
      feat_batch: "バッチ処理",
      feat_batch_desc:
        "ポッドキャストシーズン全体を一晩で処理。50のインタビューを一度にアップロード。あなたが寝ている間にAIが作業。完成した文字起こしで目覚めましょう。",
      feat_accuracy: "96%の精度",
      feat_accuracy_desc:
        "業界をリードするAIがスマートな句読点、最大20話者の話者分離、アクセントや専門用語を完璧に処理。",
      feat_langs: "100+言語",
      feat_langs_desc:
        "100+言語で動画・音声を文字起こし、249+言語に翻訳。言語による追加料金なし。グローバルコンテンツ、シンプルな1価格。",
      feat_pro: "プロフェッショナル機能",
      feat_pro_desc:
        "正確な音声/動画位置特定のための単語レベルタイムスタンプ、急速な会話切り替え時でも正確な話者識別、読みやすい段落・文・句読点で完璧にフォーマットされたテキスト。",
      features: "機能"
    },
    UseCases: {
      built_for: "一括",
      ...
      join_users:
        "あなたのようなヘビーユーザー向けに構築 - 「シュリンクフレーション」サービスから乗り換えたYouTuber、コンテンツクリエイター、ポッドキャスターに参加しよう",
      podcasters: {
        title: "ポッドキャスター",
      ...
      questions: [
        {
          ...
          answer:
            "AI文字起こしは高度な人工知能で音声を自動的にテキスト化する技術です。NeverCapではファイルをアップロードするだけで、最大96%の精度でコンテンツを変換。MP4、MOVなどの動画ファイルやMP3、WAVなどの音声ファイルを、話者識別とタイムスタンプ付きの編集可能なテキストに変換します。"
        },
        {
          q: "unlimited_policy",
          question: "本当に無制限？裏は？",
          answer:
            "はい、真に無制限です！月間分数制限も超過料金もなし。技術的な制限のみ：個別ファイルは最大10時間または5GB、同時処理50ファイルまで。ただし月を通していくつでもバッチアップロード可能。"
        },
        {
          q: "accuracy",
          question: "文字起こしの精度は？",
          answer:
            "クリアな音声なら96%の精度を保証。何百万時間もの多様なコンテンツで訓練されたAIは、アクセント・専門用語・複数話者にも対応。難解な音声にはスマート補正機能で精度向上。"
        },
        {
          q: "languages",
          question: "対応言語は？",
          answer:
            "英語、スペイン語、中国語、ヒンディー語、アラビア語、フランス語など100言語以上に対応。さらに249言語への翻訳も可能で、グローバルコンテンツに最適。"
        },
        {
          q: "speed",
          question: "処理速度は？",
          answer:
            "超高速！1時間の音声ファイルは通常5分未満。バッチ処理で50ファイル同時アップロード可能。多くのユーザーが朝にはライブラリ全体が文字起こし済みに。"
        },
        {
          q: "cancellation",
          question: "いつでも解約できる？",
          answer:
            "もちろん！契約縛りも解約料もなし。ダッシュボードからいつでもプラン変更・解約可能。解約後も課金期間終了までは利用できます。"
        },
        {
          q: "security",
          question: "データは安全？",
          answer:
            "セキュリティ最優先。SOC 2認証取得、256ビット暗号化、モデル訓練にコンテンツを一切使用しません。ファイルはいつでも削除可能、30日後に自動消去。GDPR/CCPA準拠。"
        },
        {
          q: "export_formats",
          question: "出力形式は？",
          answer:
            "必要な形式でダウンロード：PDF、Word（DOCX）、Excel、CSV、SRT字幕、プレーンテキスト（TXT）、VTTキャプション。あらゆるワークフローに対応。"
        },
        {
          q: "file_formats",
          question: "対応音声/動画形式は？",
          answer:
            "MP3、MP4、M4A、MOV、AAC、WAV、OGG、OPUS、MPEG、WMA、WMVなどほぼ全ての形式に対応。再生可能なら文字起こし可能。"
        }
      ]
    },
    CTASection: {
  ...
  Features: {
    UnlimitedTranscription: {
      ...
      feature1Description:
        "分数を数えるのをやめましょう。制限を気にするのをやめましょう。月10時間でも10,000時間でも、同じ定額料金。超過料金なし。予想外の請求なし。",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Otterの無料プランでは3回、Proでは月10回のインポート制限があります。私たちは無制限です。ポッドキャストのバックログ、すべてのインタビュー、何年分もの録音をアップロードできます。制限なし。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "「Otterに年$100払ってるのに月10ファイルしかインポートできない。無制限の代替手段が出たら即乗り換える！」- 実際のRedditユーザー",
      feature3Point1Icon: "✓",
    ...
    BulkUpload: {
      ...
      heroSubtitle:
        "Otterは生涯3回のインポートを提供。たったの3回。一生涯です。私たちは無制限のアップロードを提供し、必要な時に50ファイルずつ処理できます。",
      primaryCta: "一括アップロードを開始 →",
      secondaryCta: "制限を確認",
      redditQuote:
        '"3年分のポッドキャストエピソードを文字起こししたい。Otterは生涯3回のインポートしか許可しない。3回だ。これは侮辱的だ。"',
      redditAuthorIcon: "📍",
      ...
      feature1Description:
        '寝る前に50ファイルをアップロード。起きれば完成した文字起こしが。待ち行列なし、待機なし、"アップグレードしてください"メッセージなし。ただ純粋な処理能力が手の届くところに。',
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "当社の並列処理インフラにより、50ファイルも順番待ちなし。すべて同時に文字起こしされます。以前は数週間かかっていた処理が、今では数時間で完了します。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "他社では仮想待ち行列や「優先処理」のアップグレードを要求されますが、当社はすべてのアップロードを緊急処理します。あなたのコンテンツは重要であり、待つ必要はありません。",
      feature3Point1Icon: "✓",
      ...
      useCase6Title: "調査データ",
      useCase6Description:
        "フォーカスグループを一括処理。参加者インタビューを全て文字起こし。定性データを効率的に分析。",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "12の主要言語で業界トップレベルの精度。完璧な同期のための単語レベルのタイムスタンプ。速い会話にも対応するスマートな話者識別。実際に読みやすいプロフェッショナルなフォーマット。",
      primaryCta: "精度を試す →",
      ...
      feature1Description:
        "すべての単語が音声の位置と完全に同期しています。クリック可能な文字起こしを作成し、正確な字幕を生成したり、録音の正確な瞬間にジャンプしたりできます。プロが信頼する100msの精度。",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "当社のAIは、重なる発話、中断、高速なやり取りでも正確に話者を識別します。インタビュー、ポッドキャスト、話者が頻繁に割り込む会議に最適です。",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "テキストの壁とはお別れ。AIが自動的に段落、文、句読点を適切な位置に追加します。結果？読みやすくスキャンしやすい文字起こしです。",
      feature3Point1Icon: "✓",
  ...
  Pricing: {
    Hero: {
      ...
      description:
        "ニーズに合ったプランを選択。いつでもアップグレード/ダウングレード可能。契約縛りなし、予期せぬ請求なし。"
    },
    Cards: {
      title: "シンプルで透明な料金体系。",
      highlighted_text: "隠れた制限なし。",
      ...
      plans: [
        {
          ...
          features: {
            title: "機能",
            items: ["100+言語対応", "話者ラベル", "翻訳", "全エクスポート形式"]
          },
          cta: {
      ...
      disclaimer:
        "「無制限」とは月間制限や人為的な速度低下がないことを意味します。悪用や再配布にはフェアユースが適用されます。"
    },
    ComparisonTable: {
      header: {
        title: "比較",
      ...
      plans: ["機能", "Free", "Pro Monthly", "Pro Annual"],
      features: [
        {
          name: "価格",
          values: [
        ...
        {
          name: "1日のファイル制限",
          values: ["1日3ファイル", "無制限", "無制限"]
        },
        {
          name: "最大ファイル継続時間",
          values: ["10時間", "10時間", "10時間"]
        },
        {
          name: "最大ファイルサイズ",
          values: ["5GB", "5GB", "5GB"]
      ...
      items: [
        {
          ...
          question: "本当に無制限ですか？",
          answer:
            "はい！Proプランには月間の制限時間がありません。唯一の制限は技術的なものです：最大10時間のファイル長と5GBのファイルサイズです。必要なだけファイルを処理できます。"
        },
        {
          q: "plan_change",
          question: "いつでもプランを変更できますか？",
          answer:
            "もちろんです！ダッシュボードからいつでもサブスクリプションをキャンセルできます。必要に応じてアップグレードまたはダウングレードしてください。"
        },
        {
          q: "payment_methods",
        ...
        },
        {
          ...
          answer:
            "はい！クレジットカード不要で7日間無料でProをお試しください。さらに、初月は45%オフでご利用いただけます。"
        },
        {
          q: "file_retention",
        ...
        },
        {
          ...
          answer:
            "当社はSOC 2認証を取得し、256ビット暗号化を使用しています。お客様のコンテンツをモデルのトレーニングに使用することはありません。データはすべてお客様のものです。"
        }
      ]
    },
    CTA: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description:
          "ポッドキャストの全アーカイブを一括アップロード。番組ノートの自動作成、SEO対策、コンテンツの再利用が時間を気にせず行えます。",
        benefits: {
      ...
      researchers: {
        ...
        description:
          "研究データを一括処理。フォーカスグループ、インタビュー、パネルディスカッションを完璧な話者識別で処理。",
        benefits: {
      ...
      businessTeams: {
        ...
        pain: "「会議の録音は簡単であるべき」",
        description:
          "直接会議を録音するか、音声ファイルをアップロードして即座に文字起こし。無制限の会話から検索可能なアーカイブを作成し、重要な議論を二度と失わない。",
        benefits: {
      ...
      educators: {
        ...
        description:
          "YouTubeリンクを貼り付けるだけで即座に文字起こしと自動生成キャプションを取得。教育動画をアクセス可能で検索可能なコンテンツに変換。",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            textBefore:
              "「3年分のエピソードが文字起こしされずに放置されていました。Otterは3つだけ選ぶよう要求。たった3つ。NeverCapなら150エピソード全部を週末にアップロードできました。」",
            highlight: "3年分のエピソード",
            textAfter:
              "文字起こしされずに放置。Otterは3つだけ選ぶよう要求。3つだけ。NeverCapなら150エピソード全部を週末にアップロードできた。",
            name: "マイク・ロドリゲス",
            role: "ポッドキャストホスト"
          },
          jessica: {
          ...
          carlos: {
            textBefore:
              "「私はスペイン語で教育コンテンツを作成しています。NeverCapは完璧に文字起こしし、より広い範囲に届けるために英語に翻訳。制限なく、ただ成長。」",
            highlight: "英語に翻訳",
      ...
      industries: {
        ...
        subtitle:
          "Professionals everywhere are switching to truly unlimited → プロフェッショナルが真の無制限に切り替えています",
        list: {
      ...
      heroSubtitleA:
        "何年ものバックログを抱えるポッドキャスターから、何百ものインタビューを抱える研究者まで。プロフェッショナルが{NeverCap}を使って、アップロード制限や時間制限から解放される様子をご覧ください。"
    },
    Podcasters: {
      ...
      problems: {
        ...
        problem2: {
          ...
          description:
            "Every untranscribed episode is lost SEO traffic. But Descript limits you to 30 hours/month at best. → 書き起こされないエピソードはSEOトラフィックを失います。Descriptは最大30時間/月に制限。"
        },
        problem3: {
          title: "Costs Explode with Growth → 成長と共にコストが爆発",
          description:
            "As your podcast grows, transcription costs skyrocket. $2/hour overage fees make scaling impossible. → ポッドキャストが成長すると書き起こしコストが急騰。$2/時間の超過料金で拡張が不可能に。"
        }
      },
      ...
      workflow: {
        step1: {
          ...
          description:
            "Drop 50 episodes at once. MP3, MP4, WAV - we handle them all. → 一度に50エピソードをドロップ。MP3、MP4、WAV - すべて対応。"
        },
        step2: {
          title: "AI Transcribes → AIが書き起こし",
          description:
            "96% accuracy with speaker identification. Perfect for interviews. → 話者識別付き96%精度。インタビューに最適。"
        },
        step3: {
      ...
      features: {
        feature1: {
          title: "複数話者検出",
          description:
            "最大20人の話者を自動識別・ラベル付け。パネルディスカッション、インタビュー、共同ホスト番組に最適"
        },
        feature2: {
          title: "タイムスタンプ章",
        ...
        feature4: {
          title: "SEO最適化",
          description:
            "検索エンジン向けにフォーマットされた文字起こし。ポッドキャストの発見性を向上させ新規リスナーを獲得"
        },
        feature5: {
          title: "100+言語対応",
    ...
    Journalists: {
      hero: {
        ...
        subtitle:
          "どのインタビューを文字起こしするか選ぶのをやめましょう。すべての録音を一度にアップロードし、即座に検索して、アップロードの不安なく締め切りに間に合わせます。",
      ...
      problem: {
        ...
        problems: {
          uploadLimits: {
            ...
            description:
              "OtterのProプランでは月10ファイルのインポートしかできません。3週間分の調査インタビューをどう文字起こししますか？"
          },
          missingQuotes: {
            title: "重要な引用を見逃す",
            description:
              "文字起こしされていないインタビューには、記事のキークォートが含まれている可能性があります。しかしTrintでは最大でも月50時間までです。"
          },
          costExplosion: {
            title: "締め切りでコストが急騰",
        ...
        solution: {
          ...
          descriptionA:
            "{NeverCap}なら、真の無制限の書き起こしが実現します。調査内容を丸ごとアップロード。あらゆるインタビューを書き起こし。すべての引用を瞬時に検索。大文字・小文字の区別なし、制限なし、まさにジャーナリズム。"
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description:
              "時間制限のあるソフトと異なり、短い会話から数時間の議論まで文字起こし可能。締切間際にクレジット切れを心配する必要はありません。",
            points: {
          ...
          instantSearch: {
            ...
            description:
              "インタビュー文字起こしが数日ではなく数分で完了。これまで以上に速く記事を仕上げられます。コーヒーを飲んでいる間にAIが数時間の音声を処理。",
            points: {
          ...
          professionalAccuracy: {
            ...
            title: "そのまま引用できる正確さ",
            description:
              "当社AIは高精度の文字起こしを提供し、掲載する引用が正確で信頼性あることを保証。編集者が信頼するプロ仕様の文字起こし。",
            points: {
          ...
          ironclad: {
            ...
            title: "鉄壁の情報源保護",
            description:
              "機密インタビューデータと秘密情報源を保護する堅牢なセキュリティ機能を提供。銀行レベルの暗号化で調査を安全に保管。",
            points: {
      ...
      testimonials: {
        jessica: {
          quote:
            "アップロード制限のため3年分のインタビューが未文字起こしでした。NeverCapで週末1回で全て処理できました。革命的な変化です。",
          name: "ジェシカ・パーク",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA:
          "YouTube動画の文字起こし、TikTok動画の文字起こし（再利用用）、Facebook動画の文字起こし（テキスト化）など、{NeverCap}ならあらゆるニーズにシームレスに対応します。100以上の言語で字幕を生成でき、月額利用制限はありません。まさにクリエイティブな自由を体感できます。"
      },
      platforms: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "当社のツールは動画コンテンツの文字起こしを簡単にします。Instagram動画の文字起こしにはリンクを貼るだけ。Vimeo動画の文字起こしも同様です。週末1つでチャンネル全体のバックログを処理できます。",
          points: {
        ...
        globalReach: {
          ...
          titleHighlight: "制限なし",
          description:
            "100+言語への自動翻訳で全世界の視聴者にリーチ。複数言語の字幕を同時生成。追加料金なし、翻訳数の月間制限なし。",
          points: {
        ...
        flexibleExport: {
          ...
          titleHighlight: "が必要",
          description:
            "ワークフローに合った形式でエクスポート。YouTube用SRTからWebプレーヤー用VTT、編集可能な脚本用ドキュメントまで。全エクスポート無制限、全プランに含まれます。",
          points: {
      ...
      testimonials: {
        ...
        sarah: {
          ...
          textAfter:
            "。500本以上の動画が未処理でした。NeverCapで週末1回ですべて処理できました。字幕によるSEO効果で最初の月で元が取れました。",
          highlight: "30時間",
          name: "サラ・リー",
        ...
        jake: {
          textBefore: "この",
          textAfter:
            "機能は革命的です。もう何もダウンロードする必要がありません。貼り付けて、文字起こしして、完了。TikTok用のポッドキャストクリップの処理がこれまでになく簡単になりました。",
        ...
        yuki: {
          ...
          textAfter:
            "を請求します。NeverCapは無制限の翻訳を提供します。適切なネイティブ字幕を使い始めてから、国際的な視聴者が400%増加しました。",
          highlight: "翻訳ごと",
          name: "田中ユキ",
        ...
        questions: [
          {
            ...
            answer:
              "簡単です。文字起こししたいYouTube動画を見つけ、URLをコピーして私たちのアプリに貼り付けるだけです。AIが自動的に動画を取得し、数分で全文の文字起こしを提供します。"
          },
          {
            question: "Q: Facebook動画をテキストに文字起こしする最良の方法は？",
            answer:
              "最も簡単な方法は直接リンクを使うことです。Facebook動画のURLをコピーすれば、私たちのプラットフォームが残りを処理し、最大96%の精度で音声をテキストに変換します。手動での文字起こしから解放されます。"
          },
          {
            question: "Q: TikTokやInstagramの動画も文字起こしできますか？",
            answer:
              "もちろんです。TikTokとInstagramの動画両方の文字起こしをサポートしています。ショートフォーム動画コンテンツをブログ記事や記事、テキストベースのSNS投稿に再利用したいコンテンツクリエイターに最適です。"
          },
          {
            question: "Q: Vimeo動画をテキストに文字起こしするには？",
            answer:
              "Vimeo動画の文字起こしも他のプラットフォームと同様に簡単です。Vimeo動画のURLをコピーしてNeverCapに貼り付けるだけです。AIが動画を処理し、複数形式でダウンロード可能な正確な文字起こしを生成します。"
          }
        ]
      }
    },
    Researchers: {
      ...
      heroSubtitle:
        "文字起こしするフォーカスグループを選ぶ必要はもうありません。20人の参加者が同時に話していても、96%の精度で完璧な話者識別を行い、すべての定性データを処理できます。",
      ...
      problemCard1Desc:
        "Otterは生涯3回のインポートしか許可しません。200時間のフォーカスグループをどう文字起こししますか？",
      problemCard2Title: "重要なデータが見逃される",
      problemCard2Desc:
        "文字起こしされていないインタビューには画期的な知見が含まれている可能性があります。しかしRevは最低$2/分を請求します。",
      problemCard3Title: "助成金が消える",
      problemCard3Desc:
        "データセットが増えるほど、文字起こしコストが急増します。フォーカスグループごとに500ドルでは拡張が不可能です。",
      solutionTitle: "NeverCapソリューション",
      feature1Label: "制限なし",
      feature1Title: "あなたの",
      feature1Desc:
        "今夜中に200時間分のインタビューを全てアップロード。朝には完全で検索可能な文字起こしデータが完成。月間制限なし、ファイルごとの制限なし、「公平利用」などの制約もなし。",
      ...
      solutionDescA:
        "{NeverCap}なら、真の無制限の文字起こしが実現します。研究全体をアップロード。すべてのインタビューを文字起こし。すべてのデータを分析。制限も制限もなく、研究に集中できます。"
    },
    BusinessTeams: {
      heroBadge: "ビジネスチーム向け",
      heroTitle1: "会議録音",
      ...
      feature3Desc:
        "文字起こしをチームと即時共有。録音を一緒に聴き、複数形式で書き起こしをエクスポート、検索可能な会議アーカイブで全員の認識を統一。",
      ...
      feature4Desc:
        "全ての会議を一括検索。前四半期の重要な決定や数ヶ月前のクライアント要件も発見。AI検索はキーワードだけでなく文脈も理解。",
      ...
      testimonial1Text:
        '"重要な詳細を見逃していた状態から、全ての会話が検索可能なアーカイブに。直接録音機能で重要な議論を逃しません"',
      ...
      heroSubtitleA:
        "ブラウザで直接会議を録音したり、音声ファイルを即座にアップロードしたりできます。無制限の会話から検索可能なアーカイブを作成できます。{NeverCap}の真の無制限の文字起こし機能で、重要な議論を二度と見逃すことはありません。"
    },
    Educators: {
      heroBadge: "教育関係者向け",
      heroTitle1: "学びを",
      ...
      heroSubtitle:
        "YouTubeリンクを貼るだけで自動生成キャプション付きの即時文字起こしを取得。講義、チュートリアル、教育動画を検索可能でアクセシブルな教材に変換",
      heroCtaPrimary: "無料で試す - クレジットカード不要",
      ...
      feature2Desc:
        "教育動画の正確なキャプションを即時作成。聴覚障害者、非ネイティブスピーカー、読みながら学びたい学生にもアクセシブルに。",
      ...
      feature3Desc:
        "コース、科目、学期別にフォルダを作成。教育コンテンツを整理し検索可能に。アクセシブルな教材ライブラリを構築。",
      ...
      feature4Desc:
        "録音を共有するだけでは終わらせない。講義や音声ファイルを自動で文字起こしし、要約と重要概念を含む詳細な学習ガイドに。TXT、DOCX、PDF形式でエクスポート。",
      ...
      useCase4Text:
        "すべての動画コンテンツに字幕と文字起こしを提供してアクセシビリティ要件を満たす。すべての学生に平等なアクセスを保証。",
      useCase5Title: "反転授業",
      useCase5Text:
        "授業前に文字起こし付きのビデオ講義を共有。学生は自分のペースで復習し、ディスカッションに備えることができます。",
      useCase6Title: "研究＆引用",
      useCase6Text:
        "タイムスタンプ付きでビデオソースを正確に引用できるよう学生を支援。研究プロジェクトや学術論文に最適。",
      testimonialTitle: "信頼されている",
      ...
      testimonialTextA:
        "「{NeverCap}を使って、YouTubeの数学チュートリアルチャンネル全体の文字起こしをしています。以前は他のサービスでは数週間かかっていたのが、今では数時間で完了します。リンクを直接貼り付けてすぐに文字起こしができるので、分かりやすいコンテンツの作成方法が変わりました。特に海外の生徒たちは、多言語字幕をとても気に入っています！」"
    }
  },
  Resources: {
    YouTubeToMP4: {
        ...
        list: [
          {
            title: "データ通信量の節約:",
            content:
              "通常、YouTubeで動画を視聴すると多くのモバイルデータを消費します。オフライン視聴用にダウンロードすれば、これらの不要なコストを回避できます。"
          },
          {
            title: "いつでもどこでも視聴可能:",
            content:
              "インターネット接続が不安定な場合でも、スムーズに動画を楽しめます。バッファリングの心配はもうありません。"
          },
          {
            title: "簡単なアーカイブ＆保存:",
            content:
              "動画をMP4として保存すれば、特に価値があるまたは重要なコンテンツを簡単に個人コレクションとして構築できます。"
          },
          {
            title: "シンプルな共有:",
            content:
              "MP4ファイルを共有するのは、リンクを送るよりもはるかに便利です。WhatsAppやInstagramなどのアプリを通じて直接動画ファイルを送信でき、YouTubeを開く手間が省けます。"
          },
          {
            title: "即時視聴、共有の瞬間:",
            content:
              "お気に入りの動画を近くの友人や家族に見せたいですか？MP4をダウンロードしておけば、読み込みを待つことなく、すぐに全員でスムーズに視聴できます。"
          }
        ]
      },
      part5: {
        ...
        cards: [
          ...
          },
          {
            ...
            title: "オリジナル品質保証",
            content:
              "ダウンロードした動画は、ソース動画の完全な解像度を保持し、毎回ピクセルパーフェクトな再生を実現します。"
          },
          {
            icon: "6",
            color: "#DEF6EE",
      ...
      videoDownload: {
        ...
        description:
          "当サービスをご利用いただきありがとうございます！お客様の信頼に心から感謝し、体験を向上させられたことを願っています。友人と当サイトを共有していただけると大変助かります",
        ...
        steps: [
          {
            title: "無料のオーディオとビデオ",
            content:
              "オーディオ ファイルとビデオ ファイルを数秒でテキストに変換します。毎日 3 つのトランスクリプトが無料で提供されます。"
          },
          {
    ...
    Transcription: {
      videoTranscription: {
        hero: {
          title: "動画文字起こし：AI駆動＆高精度",
          des: "100言語以上対応の高精度動画文字起こし。動画ファイルやリンクを簡単に編集可能なテキストに変換し、複数形式で出力。短いクリップから長尺動画まで。",
          feature_1: "12形式対応",
          feature_2: "100+言語対応",
          feature_3: "6形式で出力"
        },
        threeStep: {
          title: "使い方",
          titleHighlight: "NeverCapで動画をテキスト化",
          step_1_title: "アップロードまたは貼り付け",
          step_1_des: "MP4、MOV、WMV、MPEG形式やYouTube、TikTok、X、Facebookなどのリンクに対応",
          step_2_title: "動画をテキスト化",
          step_2_des: "「文字起こし」ボタンをクリックし完了を待つ。1時間の動画なら1-2分で処理",
          step_3_title: "出力または共有",
          step_3_des: "オンラインで直接編集後、TXT、PDF、DOCX、SRT、CSV、VTT形式で出力。共有可能なリンクも生成可"
        },
        whyTran: {
          title: "特長",
          titleHighlight: "動画テキスト変換",
          des: "学習、コンテンツ制作、研究、業務など様々な場面で価値を発揮",
          reason_1_title: "メモ作成・復習が容易に",
          reason_1_des:
            "学生・研究者・制作者向け。研究ノート取り、インタビュー整理、脚本/記事作成、正確で低コストな翻訳が可能",
          reason_2_title: "検索性向上",
          reason_2_des: "キーワード検索で重要な箇所を即座に特定。巻き戻し不要",
          reason_3_title: "時間節約＆効率化",
          reason_3_des: "講義・インタビュー・会議などはテキストの方が早く読め、要点にすぐアクセス可能",
          reason_4_title: "アクセシビリティ向上",
          reason_4_des: "聴覚障害者、非母語話者、難聴者にも公平な情報アクセスを提供。WCAGなどの基準対応にも",
          reason_5_title: "コンテンツ再利用可能",
          reason_5_des: "ブログ記事、SNS投稿、要約、字幕作成など創作プロセスを大幅に加速",
          reason_6_title: "理解・記憶・保管の強化",
          reason_6_des: "視覚とテキスト情報の組み合わせで理解度向上。テキストファイルは知識ベース構築に最適"
        },
        whyChoose: {
          title: "選ばれる理由",
          titleHighlight: "当社の動画文字起こしツール",
          reason_1_title: "グローバルな文字起こし＆翻訳",
          reason_1_des: "100+言語の文字起こしと249言語への翻訳対応。言語障壁を解消",
          reason_2_title: "万能フォーマット互換性",
          reason_2_des: "MP4、MOV、MKV等主要動画形式とYouTube＆TikTokなど主要プラットフォーム全てに対応",
          reason_3_title: "真の無制限変換",
          reason_3_des: "100本でも1000本でも定額制。隠れた制限や追加費用なし",
          reason_4_title: "信頼の高精度",
          reason_4_des: "全体95%以上の精度。英語・スペイン語など主要言語は96%超",
          reason_5_title: "企業級セキュリティ",
          reason_5_des: "業界トップクラスの暗号化とプライバシープロトコルでデータ保護",
          reason_6_title: "単語レベルタイムスタンプ",
          reason_6_des: "トランスクリプトの単語をクリックして該当箇所に即時ジャンプ"
        },
        reviews: {
          title: "ユーザーの声",
          titleHighlight: "私たちのユーザー",
          des: "簡単な文字起こしを数千人が選ぶ理由を見る",
          people_1_content:
            "NeverCapの動画文字起こしは素晴らしい！数多くの類似ツールを試しましたが、本当に無制限に使えるのは初めてです。使用制限を気にせず好きなだけ文字起こしできます。",
          people_1_job: "コンテンツクリエイター",
          people_2_content:
            "手頃な価格で大容量ファイルも簡単処理、数十ファイルを同時に処理可能。NeverCapの動画文字起こしはほぼすべての悩みを解決します。",
          people_2_job: "研究者",
          people_3_content:
            "正確で高速、多くの言語対応。長時間動画の処理が特に秀逸。NeverCapは必須ツールになり、クラスメート全員に薦めました。",
          people_3_job: "博士課程学生"
        },
        faq: {
          title: "よくある質問",
          titleHighlight: "動画文字起こしについて",
          question_1: "NeverCapが対応している動画形式は？",
          answer_1: "MP4、MOV、WMV、MPEG、WebM、MKVなどの一般的な動画形式に対応しています。",
          question_2: "動画リンクの文字起こし方法と対応プラットフォームは？",
          answer_2:
            '動画URLをコピー＆ペーストし、"文字起こし"をクリック。YouTube、Facebook、X、Dropbox、Google Drive、Vimeo、TikTok、Instagramなどに対応。',
          question_3: "動画文字起こしに対応している言語は？",
          answer_3:
            "NeverCapは英語、スペイン語、中国語、フランス語、ドイツ語、日本語、韓国語、ポルトガル語、ロシア語、イタリア語、オランダ語、アラビア語など100以上の言語に対応。",
          question_4: "文字起こし可能な最大時間とファイルサイズは？",
          answer_4: "最大ファイルサイズ5GB、動画あたり最大10時間まで。",
          question_5: "一度にアップロードできる動画ファイル数は？",
          answer_5: "NeverCapでは最大50ファイルを同時処理可能です。",
          question_6: "文字起こしの速度は？長時間待つ必要がありますか？",
          answer_6: "長時間待機不要。1時間の動画でも約3分で文字起こし可能。",
          question_7: "NeverCapの文字起こし精度は？",
          answer_7: "全ての言語で95%以上、英語・スペイン語・中国語・フランス語などの主要言語では96%以上の精度を実現。",
          question_8: "文字起こししたテキストを他の言語に翻訳できますか？",
          answer_8: "はい。文字起こし完了後、249の対応言語への翻訳が可能です。",
          question_9: "文字起こしテキストの編集・エクスポート・共有は可能ですか？",
          answer_9:
            "もちろん可能。リアルタイム編集可。PDF、DOCX、TXT、TTV、CSV、SRT形式でエクスポート可能。共有用リンクも生成できます。"
        },
        explore: {
          title: "さらに詳しく",
          transcribeTitle: "テキスト変換ツール",
          transcribe_1: "音声からテキスト",
          transcribe_2: "音声認識",
          transcribe_3: "MP3からテキスト",
          transcribe_4: "MP4からテキスト",
          transcribe_5: "AACからテキスト",
          transcribe_6: "AMRからテキスト",
          transcribe_7: "M4Aからテキスト",
          transcribe_8: "MOVからテキスト",
          transcribe_9: "MPEGからテキスト",
          transcribe_10: "OGGからテキスト",
          transcribe_11: "TSからテキスト",
          transcribe_12: "WAVからテキスト",
          transcribe_13: "WEBMからテキスト",
          otherToolsTitle: "その他の関連ツール",
          otherTools_1: "AIノートテイカー",
          otherTools_2: "動画に字幕を追加",
          otherTools_3: "音声翻訳",
          otherTools_4: "動画翻訳",
          otherTools_5: "字幕ジェネレーター",
          otherTools_6: "動画要約ツール",
          otherTools_7: "動画コンバーター"
        }
      },
      mp4Transcription: {
        hero: {
          title: "オンラインMP4からテキストへの変換",
          des_1: "MP4ファイルを数秒でテキストに変換します。",
          des_2: "登録不要。超高速。トップクラスの精度。",
          feature_1: "12の形式をサポート",
          feature_2: "100以上の言語をサポート",
          feature_3: "6つの形式でエクスポート"
        },
        threeStep: {
          title: "MP4をテキストに",
          titleHighlight: "簡単3ステップで変換",
          step_1_title: "MP4ファイルをアップロード",
          step_1_des: "指定されたエリアにドラッグ＆ドロップするか、「ファイルをアップロード」ボタンをクリックするだけです。",
          step_2_title: "文字起こしを開始",
          step_2_des: "「文字起こし」ボタンをクリックします。システムが瞬時にMP4を自動でテキストに変換します。",
          step_3_title: "文字起こしをダウンロード",
          step_3_des: "テキストはオンラインで編集でき、TXT、PDF、DOCX、SRT、CSV、VTT形式でエクスポートするか、リンクで共有できます。"
        },
        howToGet: {
          title: "最高の結果を得るには",
          titleHighlight: "どうすればよいですか？",
          fun_1: "圧縮版ではなく、元の動画ファイルを使用してください。",
          fun_2: "可能な限り背景ノイズ、BGM、静電気、エコーを減らしてください。",
          fun_3: "動画をダウンロードする際は、常に「高音質（HQ）」オプションを選択してください。",
          fun_4: "話者が複数いる場合は、「話者識別」機能を有効にしてください。",
          fun_5: "MP4ファイルの特定の言語・アクセント（例：英語→英語（米国）/英語（英国）/英語（インド））を選択してください。",
          fun_6: "プロセス完了後、速やかにテキストを見直してください。"
        },
        exportFormats: {
          title: "エクスポート形式と",
          titleHighlight: "その用途",
          format_1: "TXT形式",
          des_1: "メモ帳、Notepad++、軽量テキストエディタ向け",
          format_2: "PDF形式",
          des_2: "印刷、共有、アーカイブ、クロスプラットフォーム閲覧向け",
          format_3: "DOCX形式",
          des_3: "Microsoft Word、Google Docs、リッチテキスト編集向け",
          format_4: "SRT形式",
          des_4: "YouTube字幕、動画キャプションアップロード、メディアプレイヤー向け",
          format_5: "CSV形式",
          des_5: "Excel、Googleスプレッドシート、データ分析ツール向け",
          format_6: "VTT形式",
          des_6: "ウェブ動画字幕、HTML5プレイヤー、アクセシビリティツール向け"
        },
        howToUse: {
          title: "MP4をテキストに変換する価値は何か、",
          titleHighlight: "どうすれば最大限に活用できますか？",
          effect_1: "重要なポイントを即座に読む。",
          des_1: "動画を再生し直すよりテキストを素早くスクロールし、必須情報を素早く見つけます。",
          effect_2: "学習と研究を整理する。",
          des_2: "講義、インタビュー、研究クリップをハイライト、引用、再利用可能なクリーンなノートに変換します。",
          effect_3: "仕事の生産性を向上させる。",
          des_3: "議事録を作成し、アクションアイテムを追跡し、コンテンツをドキュメントやナレッジベースに保存します。",
          effect_4: "コンテンツ作成をサポートする。",
          des_4: "スクリプト、アウトライン、記事の下書きを抽出し、編集やローカライズ用に字幕をエクスポートします。",
          effect_5: "コンテンツを検索・翻訳可能にする。",
          des_5: "全文検索と多言語対応のためのテキスト翻訳。",
          effect_6: "アーカイブを簡素化する。",
          des_6: "テキストは保存、構造化、再利用が容易で、記録、文書化、AIナレッジベースに最適です。"
        },
        whyChoose: {
          title: "なぜ私たちの",
          titleHighlight: "MP4→テキスト文字起こしが優れているのか",
          reason_1_title: "業界トップクラスの精度",
          reason_1_des: "独立して検証され、利用可能な最も正確な文字起こしツールの一つとして評価されています。",
          reason_2_title: "高速な処理速度",
          reason_2_des: "元の動画の長さの約20分の1でテキストを取得できます。",
          reason_3_title: "話者識別",
          reason_3_des: "話者間を明確に区別し、テキストを読みやすく、追いやすくします。",
          reason_4_title: "幅広い言語対応",
          reason_4_des: "100以上の言語での文字起こしと、249言語への翻訳をサポートします。",
          reason_5_title: "シンプルで使いやすい",
          reason_5_des: "複雑なインターフェースや手順は不要。数回のクリックでタスクを完了できます。",
          reason_6_title: "完全なデータセキュリティ",
          reason_6_des: "データの安全性とプライバシーを核心的なコミットメントの一つとして優先します。"
        },
        faq: {
          title: "MP4をテキストに変換する",
          titleHighlight: "ことについての質問",
          question_1: "MP4ファイルをテキストに文字起こしするのにどのくらい時間がかかりますか？",
          answer_1: "テストによると、通常の条件下で、文字起こしプロセスは動画の長さの約1/20～1/10かかります。例えば、1時間の動画は約3〜6分で文字起こしされます。",
          question_2: "アップロードするMP4ファイルのサイズに制限はありますか？",
          answer_2: "はい。最大ファイルサイズは5GB、動画の長さは10時間を超えてはいけません。大きなファイルは処理に時間がかかる場合があることに注意してください。",
          question_3: "文字起こしの精度はどのくらいですか？",
          answer_3: "文字起こしの品質は、主に動画の音声品質に依存することを理解することが重要です。とはいえ、業界トップクラスの音声認識技術を使用して、MP4文字起こしの可能な限り最良の結果を保証しています。",
          question_4: "MP4をWord文書に文字起こしできますか？",
          answer_4: "もちろんです。MP4ファイルをアップロードし、「文字起こし」をクリックし、プロセス完了後に「エクスポート」を選択してDOCX形式を選んでください。Word文書で完全な文字起こしを受け取れます。",
          question_5: "動画の字幕を取得するにはどうすればよいですか？",
          answer_5: "動画をアップロードして文字起こしします。文字起こし後、「エクスポート」をクリックし、SRTまたはVTT形式を選択して字幕をダウンロードしてください。",
          question_6: "このMP4文字起こしツールは安全ですか？",
          answer_6: "はい。私たちのページは広告なしで、処理に登録不要で、個人情報を要求しません。また、ウイルスを防ぐための強力な技術的措置を採用しています。MP4ファイルをダウンロード、使用、共有する際は、すべてのユーザーに著作権とプライバシーのガイドラインを尊重するよう奨励しています。"
        },
        explore: {
          title: "あらゆるものをテキストに変換",
          des: "文字起こしでワークフローを効率化し、真のインパクトをもたらす仕事に集中できます。",
          tool_1: "動画をテキストに",
          tool_2: "MOVをテキストに",
          tool_3: "TikTokをテキストに",
          tool_4: "YouTubeをテキストに",
          tool_5: "MP4をSRTに",
          tool_11: "音声をテキストに",
          tool_12: "音声をテキストに",
          tool_13: "MP3をテキストに",
      ...
      youtubeTranscription: {
        hero: {
          title: "YouTube テキスト起こし オンライン",
          des_1: "YouTube動画が即座に書き起こしに変換 — 速く、正確で、サインアップ不要。",
          des_2: "6つのエクスポート形式、100以上の言語、249の翻訳をサポート。"
        },
        threeStep: {
          title: "方法",
          titleHighlight: "正確な結果を取得",
          step_1_des: "YouTube動画のリンクをコピーします。",
          step_2_des: "リンクを入力ボックスに貼り付け、「ビデオ文字起こしを取得」をクリックします。",
          step_3_des: "書き起こしの完了を待ち、テキストにアクセスして編集、翻訳、またはエクスポートします。"
        },
        whatYouCan: {
          title: "YouTube 文字起こしツールで",
          titleHighlight: "できること",
          list_title_1: "柔軟なテキスト内容",
          list_des_1: "お好きなYouTube動画を、読める、コピーできる、検索可能なテキスト書き起こしに変換。",
          list_title_2: "検索と編集",
          list_des_2: "動画内の重要なコンテンツ、記憶に残る引用、重要なセグメントを簡単に見つけ、動画を参照しながらテキストを編集。",
          list_title_3: "複数のエクスポート形式",
          list_des_3: "TXT、PDF、DOCX、SRT、CSV、VTTなど多様な形式で書き起こしをエクスポート、字幕作成、ドキュメント編集、データ分析等に適しています。"
        },
        whyConvertYouTube: {
          title: "なぜ",
          titleHighlight: "YouTube動画をテキストに変換するか",
          list_title_1: "簡単な記録、保存、整理",
          list_des_1: "テキストは、メモ作成、インタビュー整理、重要ポイント抽出、研究要約作成においてビデオより実用的です。",
          list_title_2: "重要な情報の特定と取得",
          list_des_2: "ビデオタイムラインをスクロールせずに迅速に重要なコンテンツを見つけられます。",
          list_title_3: "学習効率の向上",
          list_des_3: "テキストを使い、コンテンツを効果的に強調、引用、比較できます。",
          list_title_4: "コンテンツの検索と抽出",
          list_des_4: "テキストは検索可能でコピー可能、引用抽出、クリップ参照、スクリプト作成に最適です。",
          list_title_5: "多言語アクセシビリティ",
          list_des_5: "未知の言語のコンテンツを容易に書き起こし、複数の言語に翻訳できます。",
          list_title_6: "コンテンツの再利用",
          list_des_6: "書き起こしから記事、字幕、ソーシャルメディアカード、ビデオスクリプトなどを生成できます。"
        },
        whyPeopleTrust: {
          title: "なぜ",
          titleHighlight: "人々が私たちのツールを信頼するか",
          list_title_1: "無料オンラインツール",
          list_des_1: "ログイン不要。ソフトウェア、プラグイン、拡張機能のインストール不要。",
          list_title_2: "広告ゼロ、集中ゼロ",
          list_des_2: "ワークフローを中断することなく、ニーズに応える設計のクリーンでシンプルなインターフェース。",
          list_title_3: "超高速変換",
          list_des_3: "業界をリードするスピードを無制限に体験できます。",
          list_title_4: "高精度",
          list_des_4: "精度向上のため、最新の音声認識技術で駆動しています。",
          list_title_5: "幅広い言語サポート",
          list_des_5: "100以上の言語でコンテンツを書き起こし、249言語に翻訳できます。",
          list_title_6: "保存と編集機能",
          list_des_6: "書き起こしをリアルタイムで編集し、将来の使用のために作業を保存できます。"
        },
        howToUse: {
          title: "実際の使用方法",
          titleHighlight: "YouTube 書き起こし",
          list_title_1: "メモ作成者向け",
          list_des_1: "YouTube動画を見ながらメモを取ると、急いでだらしなく感じるかもしれません。Transcriptがあれば、重要なポイントや主要な概念を簡単にノートにコピーでき、すべてをキャプチャー確保。ChatGPTなどにTranscriptを入力して、明確な要約、学習ノート、アウトラインを生成することも可能です。",
          list_title_2: "コンテンツ制作者向け",
          list_des_2: "YouTubeリンクを貼り付けるだけで、正確なテキスト版が取得 —クリエイターにとって遥かに効率的なワークフローです。Transcriptを使ってブログ記事、スクリプト、字幕、ニュースレター、詳細なshownotesを作成。時間と労力を節約し、コンテンツ自体に集中できます。",
          list_title_3: "専門家・アナリスト向け",
          list_des_3: "法律、医療、コンサルティング、ビジネスなどの分野で精密な情報抽出が必要な場合、Transcriptは作業を容易にします。特定の事実、タイムスタンプ、引用をビデオ全体を再視聴することなく迅速に検索。専門家のトーク、プレゼンテーション、研修ビデオ、顧客インタビューのレビューに最適です。",
          list_title_4: "アクセシビリティユーザー向け",
          list_des_4: "誰もが容易にビデオコンテンツを見たり聞いたりできるわけではありません。Transcriptは、聴覚障害を持つユーザーや単純に読むことを好むユーザーにとってアクセシブルにします。249言語への翻訳サポートにより、言語の壁を打破し、グローバルコンテンツをより理解しやすく、共有しやすくします。",
          list_title_5: "知識抽出者向け",
          list_des_5: "中心的洞察を素早く理解する必要のある学生、研究者、制作者、専門家にとって、Transcriptは計り知れない価値があります。長いビデオを見ることなく、すぐにブラウズ、検索、重要な情報を特定し、効率的に重要ポイント、要約、タイムスタンプを抽出するのに役立ちます。"
        },
        howToGet: {
          title: "YouTube 書き起こしで",
          titleHighlight: "新しいアイデアを解き放つ",
          subTitle: "YouTube動画をコピーしやすい、実行可能なテキストに変換し、GeminiまたはChatGPTなどのAIツールと組み合わせて、次のことができます：",
          list_des_1: "迅速に学習ノートや要約を生成",
          list_des_2: "重要ポイントや記憶に残る引用や概念を抽出",
          list_des_3: "クイズ、Q&A、学習教材を作成",
          list_des_4: "ブログ記事、スクリプト、記事のドラフト",
          list_des_5: "インフォグラフィック、ミーム、ソーシャルメディアコンテンツを開発",
          list_des_6: "ファンQ&A、トリビア、教育ゲームを制作",
          list_des_7: "ビデオで触れられたテーマを深掘り",
          summary: "すべて手間なく — コピー、貼り付け、スタート。"
        },
        faq: {
          title: "よくある",
          titleHighlight: "質問",
          question_1: "YouTubeビデオの書き起こしに長さ制限はありますか？",
          answer_1: "いいえ。ただし、長いビデオは処理時間が増加します。書き起こし作業を適宜計画してください。",
          question_2: "非公開またはリストされていないビデオで動作しますか？",
          answer_2: "公開的に利用可能なYouTubeビデオでのみ機能します。非公開または制限されたビデオは書き起こせません。",
          question_3: "書き起こしを得るのにどのくらいかかりますか？",
          answer_3: "通常、処理時間はビデオ長の1/10から1/20の範囲です。高い精度を確保しながら継続的に速度を最適化し、より良いユーザー体験のために努めています。",
          question_4: "ツールは異なる話者を区別できますか？",
          answer_4: "はい。最大20人の話者を検出し、インタビュー、ポッドキャスト、議論の書き起こしに理想的です。",
          question_5: "書き起こしツールの精度はどのくらいですか？",
          answer_5: "当社の精度は96%を超えています。様々なアクセントや早口でも高精度を維持しますが、より良い音質で背景ノイズが少ないほど結果が向上します。",
          question_6: "書き起こしにはどのような機能が含まれていますか？",
          answer_6: "書き起こしには自動話者認識とタイムスタンプが含まれています。テキストをオンラインで編集するか、後で利用するためにエクスポートできます。",
          question_7: "自分の記録を保存できますか？",
          answer_7: "はい。アカウントに登録するだけで、YouTubeリンクを処理した後に記録を保存できます。",
          question_8: "私のデータはプライベートに、安全に保管されていますか？",
          answer_8: "はい。あなたの動画、記録、ファイルは安全に処理されます — AIモデルのトレーニングや第三者との共有には決して使用されません。",
          question_9: "他のAIツールで記録内容を使用できますか？",
          answer_9: "もちろんです。ChatGPTや他のAIツールにテキストを貼り付けて、要約、ノート、クイズ、スクリプト、記事などを生成できます。"
        }
      }
    },
    Upload: {
      ...
      pasteLink: "リンクを貼り付け",
      fileTip: "動画の文字起こしを秒速で取得",
      linkTitle: "リンク",
      linkTip: "開始するには任意のプラットフォームからリンクを貼り付けてください",
      ...
      tip1: "永続的に保存しますか？",
      tip2: "無料で登録",
      tip3: "すべての文字起こしファイルを管理・編集できます",
      tip4: "永続的に",
      tip5: "保存",
      tip6: "しますか？",
      tip7: "管理・編集が",
      tip8: "可能になります",
      linkV1Placeholder: "こちらにYouTubeのURLを貼り付けてください。",
      linkV1Btn: "動画の文字起こしを取得"
    }
  },
  About: {
    Hero: {
      ...
      title: "会社概要",
      description:
        "当社の使命は、最も正確な音声・動画文字起こしサービスを提供することです。業界をリードするAI技術を活用し、96%以上の文字起こし精度を実現。主要言語では技術的最適化により99%の精度に達することもあります。"
    },
    Stats: {
      title: "当社の",
      highlighted_text: "実績",
      ...
      features: [
        {
          ...
          title: "圧倒的な精度",
          description:
            "当社のAIモデルは継続的に改良され、96%を超える文字起こし精度を実現。主要言語では高度な最適化により99%の精度に達します。"
        },
        {
          icon: "🌍",
          title: "グローバル言語対応",
          description:
            "100以上の言語の音声認識と249以上の言語への翻訳機能をサポートし、コンテンツを真にグローバルにします。"
        },
        {
          icon: "⚡",
          title: "超高速処理",
          description:
            "数時間分の音声・動画コンテンツを数分で処理。最適化されたAIパイプラインで、品質を損なうことなく迅速に文字起こしを提供します。"
        },
        {
          icon: "🔒",
          title: "企業レベルのセキュリティ",
          description:
            "データセキュリティを最優先。業界標準の暗号化を使用し、グローバルなプライバシー規制に準拠してコンテンツを安全に保護します。"
        }
      ]
    },
    Company: {
  ...
  Privacy: {
    ...
    privacyPolicyTitle: "プライバシーポリシー",
    policyAgreement:
      "本プライバシーポリシーをよくお読みいただき、内容を理解してください。当社のサービスを利用することで、本プライバシーポリシーに同意したものとみなされます。本ポリシーに沿った個人データの利用に同意できない場合は、直ちにサービスの利用を中止してください。",
    policyOverview:
      "本ポリシーでは、収集するデータとその目的、データの取り扱い方法、データに関するお客様の権利について説明します。当社はお客様のデータを販売しません。",
    scopeTitle: "1. 本プライバシーポリシーの適用範囲",
    scopeDescription:
    ...
    billingDescription:
      "有料製品に登録する場合、支払い情報と請求先住所の提供を求めます。支払い情報は当社のサーバーを経由せず、直接決済プロセッサーに送信されます。",
    productInteractionsTitle: "2.3 製品とのやり取り",
    productInteractionsDescription:
      "お客様が製品アカウントでアップロード、受信、または保持するコンテンツを当社のサーバーに保存します。お客様がこのコンテンツを削除しない限り、アカウントが有効な間は保持する場合があります。",
    websiteInteractionsTitle: "2.4 ウェブサイトとのやり取り",
    websiteInteractionsDescription:
      "コンバージョン率のテストや新製品デザインの実験などの分析・統計目的で、閲覧活動に関する情報を収集します。これには、ブラウザやOSのバージョン、IPアドレス、訪問したウェブページとその読み込み時間、参照元サイトなどが含まれます。アカウントがありログインしている場合、これらのウェブ分析データはIPアドレスとユーザーアカウントに紐付けられ、アカウントが無効になるまで保持されます。",
    cookiesTitle: "2.5 Cookie",
    cookiesDescription1:
      "また、特定の設定を保存し、アプリケーションの利用を容易にし、A/Bテストを実施し、分析をサポートするために、永続的なファーストパーティCookieと一部のサードパーティCookieを使用します。",
    cookiesDescription2:
      "Cookieはブラウザに保存されるテキストデータです。ログイン情報やサイト設定を記憶するのに役立ちます。また、ブラウザの種類、OS、訪問したウェブページ、訪問時間、閲覧したコンテンツ、その他のクリックストリームデータなどの情報を収集する場合があります。ブラウザ設定でCookieの保持期間を調整したり個別のCookieを許可・ブロックできますが、Cookieを無効にするとアプリが動作しなくなるなど、サービスの一部が正常に機能しない場合があります。",
    correspondenceTitle: "2.6 任意の連絡",
    correspondenceDescription:
      "質問やヘルプを求めてメールを送信いただいた場合、今後の参照用として、メールアドレスを含むその通信記録を保持します。",
    accessTitle: "3. 情報へのアクセスまたは共有する場合",
    accessDescription1:
      "お客様が要求した製品やサービスを提供するため。当社はアプリケーションの運営とサービスの提供を支援するため、いくつかのサードパーティサブプロセッサーを使用します。これにはクラウドプロバイダーや分析プロバイダーが含まれます。",
    accessDescription2:
      "不正使用を調査、防止、または対応するため。潜在的な不正使用を調査する際に顧客アカウントにアクセスするのは最終手段です。当社は顧客と問題を報告する方々のプライバシーと安全を保護したいと考えており、その責任をプロセス全体でバランスよく果たすよう最善を尽くします。制限された目的で製品を利用していることが判明した場合、必要に応じて適切な当局への通知を含む対応を取ります。",
    accessDescription3: "適用される法律で要求される場合。",
    dataRequests:
      "ユーザーデータの要求。当社の方針は、法的手続きによって強制されない限り、または緊急要請の限られた状況を除き、政府からのユーザーデータ要求に応じないことです。ただし、米国法執行当局がデータ共有を要求する必要な令状、刑事召喚状、または裁判所命令を有している場合は、従わなければなりません。同様に、米国外の政府当局からの要求には、米国政府が相互法律援助条約または協定に基づく手続きを通じて強制する場合にのみ応じます。当社の方針は、法律で禁止されていない限り、および緊急の場合を除き、データを共有する前に影響を受けるユーザーに通知することです。",
    preservationRequests:
      "データ保存の要求。同様に、当社の方針は、米国連邦保存通信法（18 U.S.C. Section 2703(f)）または民事事件の適切な米国召喚状によって強制される場合にのみ、データ保存要求に従うことです。保存されたデータは、法律で要求されるか、控訴しないことを選択した裁判所命令によって強制されない限り共有しません。さらに、必要な保存期間が満了する前に適切な令状、裁判所命令、または召喚状を受領しない限り、保存期間の終了時に顧客データの保存コピーを破棄します。",
    taxAudits:
    ...
    updatesDescription:
      "関連規制に準拠し、新しい慣行を反映するため、必要に応じて本ポリシーを更新する場合があります。ポリシーに重要な変更を加える際は、常に本ページ上部の日付を更新します。",
    contactTitle: "9. お問い合わせ",
    websiteUrl: "https://www.nevercap.ai/",
    at: "：",
    childrenDescription:
      "本サービスは子どもを対象としたものではなく、当社は13歳未満の子どもから個人情報を故意に収集しません。13歳未満の方は、本サービスを通じて個人情報を送信しないでください。13歳未満の子どもが本ポリシーに違反して個人情報を提供したと思われる場合は、以下の {email} までご連絡ください。",
    contactDescription:
      "プライバシーポリシーに関するご質問、コメント、苦情がある場合は、{email} までご連絡ください。できるだけ早く対応いたします。",
    policyDescriptionA:
      "本ポリシーは、{NeverCap}（以下「NeverCap」、「当社」、「私たち」）が、お客様が当社のサービス、ウェブサイト（{url}）、およびソフトウェア（総称して「サービス」）を使用する際に、お客様の個人情報を収集、使用、開示する方法について説明します。"
  },
  TermsOfUse: {
    title: "利用",
    titleGradient: "規約",
    ...
    servicesDefinition:
      "「Services」とは、NeverCapが作成・維持する製品全般を指し、Webブラウザ、デスクトップアプリケーション、モバイルアプリケーション、その他の形式で提供されるものを含みます。",
    termsUpdate:
      "当社は将来これらの利用規約を更新する場合があります。通常、変更は関連ポリシーへのリンクを追加することで規約を明確化するものです。重要な変更を行う際は、このページ上部の日付を更新し、適切な方法でアカウント保有者に通知します。",
    acceptanceTitle: "1. 本契約の承諾",
    acceptanceDescription1:
      "当社のサービスを利用することで、本契約に同意したものとみなされ、あなたとNeverCapの間で拘束力のある契約が成立します。あなたはこれらの規約を法的に受け入れる資格があり、契約を締結する法的年齢に達していることを表明します。NeverCapの承諾は、本契約の全条件に対するあなたの同意を明示的な条件とします。",
    eligibilityRequirement:
      "本サービスは18歳未満の方による利用を意図しておらず、使用を認めていません。サービスを利用することで、あなたはこの資格要件を満たしていることを表明・保証します。",
    userResponsibility:
      "「you」「your」「yourself」には、あなたの従業員、代理人、業務代表者、およびあなたのアカウントを通じてサービスにアクセスする他の個人も含まれます。あなたのアカウントを通じてサービスにアクセスするすべての人がこれらの規約を理解し遵守する責任はあなたにあります。",
    termsRevision:
      "NeverCapは単独の裁量でこれらの規約を随時改訂・更新する権利を留保します。変更は投稿された時点で直ちに有効となります。改訂後の規約の投稿後もサービスを利用し続けることで、あなたは変更に同意したものとみなされます。変更内容を確認するため、随時このページをチェックしてください。",
    ...
    contentResponsibility:
      "あなたのアカウント下で投稿されるすべてのコンテンツと発生する活動について責任を負います。これには、(a)あなたのログイン資格情報にアクセスできる他人、または(b)あなたのアカウント下で独自のログインを持つ他人による投稿も含まれます。",
    humanRequirement:
      "あなたは人間でなければなりません。「ボット」やその他の自動化手段によるアカウント登録は禁止されています。",
    paymentTitle: "4. 支払い、返金、プラン変更",
    freeTrial:
      "無料トライアルを提供する有料サービスの場合、登録時にトライアル期間を説明します。トライアル期間後は、サービスを継続利用するために事前支払いが必要です。支払わない場合、これらのサービスは終了します。",
    upgradePolicy:
      "無料プランから有料プランにアップグレードする場合、即時にカードに課金され、課金サイクルはアップグレード日から開始します。",
    taxes:
      "すべての料金には、税務当局が課す税金、課徴金、関税は含まれていません。必要な場合、当社は税務当局に代わってこれらの税金を徴収・納付します。それ以外の場合、すべての税金、課徴金、関税の支払いはあなたの責任です。",
    refunds:
      "すべての購入は返金不可です。いつでもアカウントにログインして有料サービスをキャンセルできます。有料サブスクリプションの場合、特に記載がない限り、キャンセルは現在の有料期間終了時に有効になります。",
    cancellationTitle: "5. 解約と終了",
    cancellationPolicy:
      "有料期間終了前にサービスを解約した場合、解約は即時有効となり、再課金は行われません。最終課金サイクルの未使用期間について自動的に按分返金は行いません。",
    terminationRights:
      "当社はいつでもいかなる理由でも、あなたのアカウントを停止または終了し、サービスの現在および将来の利用を拒否する権利を有します。停止とはアカウントまたはアカウント内コンテンツにアクセスできなくなることを意味します。終了とはさらにアカウントまたはアカウントアクセスの削除、およびアカウント内コンテンツの没収・放棄を伴います。また、いつでもいかなる理由でもサービスの利用を拒否する権利を留保します。",
    abusePolicy:
      "会社の従業員または役員に対する口頭、身体的、書面その他の虐待（虐待または報復の脅迫を含む）は、アカウント即時終了の原因となります。",
    submissionsTitle: "6. 提出物",
    submissionsDescription:
      "あなたが当社に提供するサイトに関する質問、コメント、提案、アイデア、フィードバックその他の情報（「提出物」）は非機密扱いとなり、当社の独占的財産となることに同意します。当社はこれらの提出物に対し、すべての知的財産権を含む独占的権利を有し、いかなる合法的目的（商業的その他）に対しても、あなたへの承認または補償なしに、無制限に使用・頒布する権利を有します。あなたはこれらの提出物に関するすべての著作者人格権を放棄し、提出物がオリジナルであるか、または提出する権利を有していることを保証します。提出物の所有権に関する侵害または横領の主張に対し、当社に責任を問わないことに同意します。",
    uptimeTitle: "7. 稼働時間とセキュリティ",
    serviceAvailability:
      "サービスの利用はあなたの自己責任です。当社はサービスを「現状有姿」で提供します。ほとんどのサービスについてサービスレベル契約は提供しませんが、アプリケーションの稼働時間を重視しています。",
    throttlingPolicy:
      "ユーザーの活動が他のユーザーに対するサービスの安定性とパフォーマンスに悪影響を及ぼすことが確認された稀な場合、アカウントアクセスを一時的に制限する権利を留保します。最も重大な場合を除き、措置を講じる前に解決策を見つけるためあなたに連絡します。",
    dataSecurity:
      "バックアップ、冗長化、暗号化を通じてデータの保護とセキュリティ確保に努めています。公共インターネット上のデータ伝送には暗号化を義務付けています。",
    thirdPartyVendors:
      "サービス運営に必要なハードウェア、ソフトウェア、ネットワーク、ストレージ、関連技術を提供するため、第三者ベンダーとホスティングパートナーを利用しています。",
    siteManagementTitle: "8. サイト管理",
    ...
    contentModeration:
      "コンテンツを事前に審査しませんが、サービス経由で利用可能なコンテンツを拒否または削除する権利を留保します。",
    prohibitedExploitation:
      "会社の明示的な書面による許可なしに、サービスの一部、サービスの利用、またはサービスへのアクセスを複製、複写、コピー、販売、転売、または悪用しないことに同意します。",
    impersonationProhibition:
      "他のウェブサイトを改変し、サービスまたは会社と関連があると誤解させるような行為をしてはなりません。",
    dmcaPolicy:
      "他人の知的財産権を尊重します。サイト上またはサイト経由で利用可能な素材があなたの著作権を侵害していると考える場合は、直ちに当社に連絡してください。通知の写しは、通知の対象となった素材を投稿または保存した人物に送信されます。適用される法律に従い、通知に重大な虚偽記載があった場合、あなたは損害賠償責任を負う可能性があることに注意してください。したがって、サイト上またはサイトにリンクされた素材が著作権を侵害しているか確信が持てない場合は、まず弁護士に相談することを検討してください。",
    prohibitedActivitiesTitle: "10. 禁止行為",
    generalProhibition:
      "当サイトは、当方が提供する目的以外でのアクセスまたは使用は禁止されています。当サイトは、当方が特に承認または認可した場合を除き、いかなる商業目的にも使用できません。",
    userObligations: "当サイトのユーザーとして、以下をしないことに同意します：",
    dataScraping:
      "当方の書面による許可なしに、体系的にデータやコンテンツを取得し、直接または間接的にコレクション、データベース、ディレクトリを作成または編成しないこと。",
    fraud:
      "当方や他のユーザーを騙したり、誤解させたり、特にユーザーパスワードなどの機密アカウント情報を入手しようと試みないこと。",
    ...
    featuresDescription:
      "当社は、自社の経験や顧客のフィードバックを基にサービスを慎重に設計しています。ただし、すべての人に満足されるサービスは存在しません。当社は、サービスが特定の要件や期待を満たすことを保証しません。",
    bugsDescription:
      "すべての機能はリリース前にテストされますが、ソフトウェアには必ずバグが含まれます。セキュリティやプライバシー関連のバグを優先的に対処しますが、すべてのバグが修正されるわけではなく、完全にエラーのないサービスを保証しません。",
    correctionsTitle: "12. 修正",
    informationAccuracy:
      "当サイトには誤字、誤り、省略（説明、価格、在庫など）が含まれる場合があります。当社は予告なくこれらを修正または更新する権利を留保します。",
    siteAvailability:
      "当サイトの常時利用を保証しません。ハードウェア・ソフトウェアの問題やメンテナンスにより中断や遅延が発生する可能性があります。当社は予告なくサイトを変更、更新、停止する権利を有し、ダウンタイムによる利用不能について一切の責任を負いません。",
    userDataTitle: "13. ユーザーデータ",
    userDataDescription:
      "当社はサイト運営のためにユーザーが送信したデータを保持します。定期的なバックアップを行いますが、データの送信やサイト利用に関連するすべてのデータについてユーザーが単独で責任を負います。データの損失や破損について当社は責任を負わず、ユーザーはこれに対する法的措置を放棄します。",
    privacyPolicyTitle: "14. プライバシーポリシー",
    liabilityTitle: "15. 責任",
    liabilityIntroduction: "本規約全体にわたる責任事項を以下にまとめます：",
    liabilityWaiver:
      "当社は、サービスの利用不能、コンテンツの誤り、人身・財産損害、代替品の調達費用、サーバーへの不正アクセス、伝送の中断、ウイルス感染、コンテンツの誤り・欠落、第三者の行為、その他本規約またはサービスに関連する一切の損害（利益、のれん、データなどの無形損失を含む）について、契約違反、不法行為（過失の有無を問わず）、その他の責任理論に基づき、直接的・間接的・特別・懲罰的・結果的損害賠償責任を負いません。",
    miscellaneousTitle: "16. 雑則",
    miscellaneousDescription:
      "本規約と当サイトに掲載されたポリシーは、ユーザーと当社間の完全な合意を構成します。権利や条項の不行使はその放棄を意味しません。本規約は法律の許す最大限の範囲で適用されます。当社は権利・義務を第三者に譲渡できます。合理的な支配不能な原因による損失・損害について責任を負いません。本規約の一部が無効でも、残りの条項は有効です。本規約により共同事業、雇用、代理関係は生じません。電子形式や署名不足を理由に本規約を争うことはできません。",
  ...
  Blog: {
    Hero: {
      ...
      description:
        "{NeverCap} のチュートリアル、戦略、AI ツールは、プロフェッショナルなトランスクリプション ワークフローを使用して無制限のコンテンツを作成するのに役立ちます。"
    },
    Featured: {
  ...
  RegisterDialog: {
    ...
    signUpNow: "今すぐサインアップ",
    stillExporting: "エクスポート中",
    tip1: "無料登録でファイルを永久保存・編集！",
    tip2: "無制限変換にアップグレード！"
  }
};
