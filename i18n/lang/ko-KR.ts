...
let message = {
  ...
  HomePage: {
    ...
    tour: {
      ...
      step1: {
        title: "파일 트랜스크립션",
        content: "로컬 파일, 링크, 녹음 등 세 가지 트랜스크립션 방법을 지원합니다."
      },
      step2: {
        title: "폴더 만들기",
      ...
      step3: {
        ...
        content: "항목을 클릭하여 트랜스크립션 세부 정보를 보고 편집하며 번역할 수도 있습니다."
      },
      next: "다음",
      finish: "이해했습니다"
    },
    ...
    welcome: {
      ...
      precision: "화자 구분 및 타임스탬프가 포함된 정확한 문서를 즉시 받아보세요.",
      translate: "언어 장벽 허물기: 200개 이상의 언어로 문서를 쉽게 번역해 보세요.",
  ...
  FolderPage: {
    ...
    dialog: {
      ...
      share: {
        title: "공유",
        label: "다음 보안 링크가 있는 모든 사람이 이 트랜스크립트와 관련 미디어 파일을 볼 수 있습니다.",
        confirm: "링크 복사",
        success: "복사 성공"
      },
      export: {
    ...
    endRecord: {
      title: "알림",
      content: "녹음 중입니다. 이 작업을 수행하면 녹음이 종료됩니다. 녹음을 종료하시겠습니까?",
      confirm: "녹음 계속",
      cancel: "녹음 종료"
    }
  },
  ...
  FileUploadAndRecording: {
    record: {
      ...
      dialog: {
        ...
        complete: {
          title: "녹음 완료",
          label: "녹음이 10시간에 도달하여 자동으로 중지되었습니다. 트랜스크립션하세요.",
          confirm: "확인"
        },
        speaker: {
          content: "발화자 인식을 위해 파일은 3시간以内로 제한됩니다. '{text}' 선택을 해제해 주세요."
        }
      }
    },
    upload: {
      link: {
        ...
        cancel: "취소",
        // 올바른 링크를 입력하세요
        errorTitle: "입력한 링크 주소가 올바르지 않습니다. 확인 후 다시 시도하세요.",
        linkName: "링크"
      },
      file: {
        orTitle: "URL에서 필사",
      ...
      del: {
        title: "경고",
        content: "모든 진행 상황이 손실됩니다. 트랜스크립션 취소를 확인하시겠습니까?",
        cancel: "취소 확인",
        confirm: "트랜스크립션 계속"
      },
      files: "파일",
      ...
      fileEmpty: "파일이 비어있습니다",
      howToSetup: "설정 방법은?",
      shareFilePublicly: "파일 공개 공유",
      retry: "다시 시도",
      edit: "편집",
      delete: "삭제",
      updateAndRetry: "업데이트 후 다시 시도"
    }
  },
  // 트랜스크립션 상세 페이지
  TranscriptionPage: {
  ...
  IdentityInfoManage: {
    ...
    tip: "팁",
    tipContentEmail: "고객님의 계정 로그인 비밀번호를 이메일로 발송해 드렸습니다.",
    tipContentPassword: "수신함을 확인하신 후 이메일과 비밀번호로 로그인해 주세요.",
    codeToEmail: "인증 코드를 이메일로 보냈습니다. 수신함을 확인하고 위에 인증 코드를 붙여넣어 주세요."
  },
  // 공유 세부 페이지
  Sharepage: {},
  // 초기화 페이지
  ...
  AccountSettingsPage: {
    ...
    filesUploadedAtOnce: "각 파일 최대 10시간/5GB. 한 번에 50개 파일 업로드 가능",
    ...
    oneFileUploaded: "각 파일은 최대 30분까지 가능합니다. 한 번에 1개의 파일을 업로드하세요.",
  ...
  demo: {
    ...
    thirdPartyLink: "깃허브 →",
    waitlist: {
      cardTitle: "대기자 명단에 가입하고 최신 넉스트프로 뉴스와 할인 혜택을 가장 먼저 받아보세요!",
      placeholder: "이메일 입력",
      button: "대기자 명단 가입",
      joinCountMessage: "🔥 초기 사용자 #{count}님이 방금 대기자 명단에 가입했습니다!"
    },
    seo: {
  ...
  videoLang: {
    ...
    NETWORK_IDLE: "오디오/비디오가 활성화되어 리소스로 선택되었지만 네트워크가 사용되지 않습니다",
  ...
  privacyPolicy: {
    ...
    contactUsContent1: "개인정보 보호정책에 대해 질문, 의견 또는 불만 사항이 있는 경우",
    contactUs: "문의하기",
    contactUsContent2: "귀하의 불만 사항은 최대한 빨리 처리되도록 노력하겠습니다."
  },
  termsOfService: {
    termsOfServiceTitle: "서비스 약관",
    lastUpdated: "최종 업데이트: 2022년 9월 21일",
    thankYouMessage: "저희 제품을 이용해 주셔서 감사합니다!",
    companyReference: '본 문서에서 "회사", "우리", "저희"라는 표현은 Scribify를 지칭합니다.',
    servicesDefinition:
    ...
    accountTerms2: "- 귀하는 불법적, 비윤리적 또는 부도덕한 목적으로 서비스를 이용할 수 없습니다.",
    accountTerms3:
    ...
    accountTerms4: '- 반드시 인간이어야 합니다. "봇"이나 기타 자동화된 방법으로 등록된 계정은 허용되지 않습니다.',
    paymentContent1:
    ...
    copyrightContent1: "- 서비스에 게시된 모든 콘텐츠는 미국 저작권법을 준수해야 합니다.",
    copyrightContent2:
    ...
    prohibitedActivitiesUserAgreement: "사이트 사용자로서 귀하는 다음 사항에 동의하지 않습니다.",
    prohibitedActivity1:
    ...
    prohibitedActivity4: "- 당사의 판단에 따라 당사 및/또는 사이트를 비방, 훼손하거나 기타 방식으로 해를 끼칩니다.",
    prohibitedActivity5: "- 사이트에서 얻은 정보를 이용해 다른 사람을 괴롭히거나, 학대하거나, 해를 끼치는 행위.",
    prohibitedActivity6:
      "- 당사의 지원 서비스를 부적절하게 이용하거나, 학대 또는 부정 행위에 대한 허위 신고를 제출합니다.",
    prohibitedActivity7: "- 해당 법률이나 규정에 맞지 않게 사이트를 사용하는 경우",
    ...
    prohibitedActivity11: "- 모든 콘텐츠에서 저작권이나 기타 소유권 고지를 삭제합니다.",
    prohibitedActivity12: "- 다른 사용자나 사람을 사칭하거나 다른 사용자의 사용자 이름을 사용하려고 시도합니다.",
    ...
    prohibitedActivity20: "- 사이트에서 구매를 하기 위해 구매 대행인이나 구매대행인을 이용하세요.",
    ...
    prohibitedActivity23: "- 본 사이트를 이용하여 상품 및 서비스를 광고하거나 판매를 제안합니다.",
    ...
    privacyPolicyContent1: "저희는 데이터 개인정보 보호 및 보안을 중요하게 생각합니다.",
    ...
    liabilityIntro: "본 약관 전반에 걸쳐 책임에 대해 언급하고 있지만, 모든 내용을 한 섹션에 정리하면 다음과 같습니다.",
    liabilityContent:
  ...
  HeadNavbar: {
    ...
    Other: "기타",
    mp4Transcription: "MP4 전사",
    youtubeTranscription: "YouTube 텍스트 변환"
  },
  Footer: {
    ...
    Resources: "자원",
    resourcesMenus: ["YouTube를 MP4로","YouTube를 MP3로","동영상 텍스트 변환","MP4 텍스트 변환","YouTube 텍스트 변환"]
  },
  Index: {
    Hero: {
      ...
      subtitleA:
        "NeverCap의 AI는 비디오를 텍스트로 변환하고 오디오를 텍스트로 변환하여 월 사용량 제한 없이 최대 50개의 파일을 한 번에 처리합니다. 사용자와 함께 확장 가능한 진정한 텍스트 변환 서비스입니다."
    },
    Stats: {
    ...
    FeaturesGrid: {
      ...
      transparency:
        "더 이상 숨겨진 제한과 놀라움 없음 - 다른 곳에서는 몰래 시간을 줄이거나 세밀한 글씨로 제한을 숨기지만, 우리는 철저한 투명성을 믿습니다.",
      feat_unltd: "진정한 무제한",
      feat_unltd_desc:
        '약관에 숨겨진 "공정 사용 정책" 없음. "무제한"으로 위장한 저장 공간 제한 없음. 전체 아카이브를 업로드하고 모든 오디오 인식 요구 사항을 충족하세요. 진심입니다.',
      feat_bulk: "대량 업로드 자유",
      feat_bulk_desc:
        '"평생 3회 업로드"나 "월 10개 파일"에 지치셨나요? 필요할 때마다 한 번에 50개의 파일을 업로드하세요. 미처리 작업 처리에 완벽합니다.',
      feat_batch: "일괄 처리",
      feat_batch_desc:
        "팟캐스트 시즌 전체를 하룻밤에 처리하세요. 한 번에 50개의 인터뷰를 업로드하세요. 당신이 자는 동안 AI가 작업합니다. 완성된 텍스트로 깨어나세요.",
      feat_accuracy: "96% 정확도",
      feat_accuracy_desc:
        "업계 최고 수준의 AI가 스마트 구두점, 최대 20명의 화자 식별, 악센트 및 전문 용어를 완벽하게 처리합니다.",
      feat_langs: "100개 이상의 언어",
      feat_langs_desc:
        "100개 이상의 언어로 동영상 및 오디오를 텍스트로 변환하고 249개 이상의 언어로 번역합니다. 다른 언어에 대한 추가 비용 없음. 글로벌 콘텐츠, 단순한 가격.",
      feat_pro: "전문가용 기능",
      feat_pro_desc:
        "정확한 오디오/동영상 위치 지정을 위한 단어 수준 타임스탬프, 빠른 대화 전환 중에도 정확한 화자 식별, 문단, 문장 및 구두점으로 완벽하게 형식화된 텍스트로 쉽게 읽을 수 있습니다.",
      features: "기능"
    },
    UseCases: {
      built_for: "대량",
      ...
      join_users:
        '당신 같은 고급 사용자를 위해 제작됨 - "슈링크플레이션" 서비스에서 전환한 YouTuber, 콘텐츠 제작자 및 팟캐스터와 함께하세요',
      podcasters: {
        title: "팟캐스터",
    ...
    Testimonials: {
      ...
      titleA: "50,000명 이상의 사용자에게 사랑받고 있습니다."
    },
    PricingPreview: {
      title: "투명한 가격 정책",
      ...
      questions: [
        {
          ...
          answer:
            "AI 필사는 고급 인공 지능을 사용하여 오디오를 자동으로 텍스트로 변환하는 과정입니다. NeverCap에서는 파일을 업로드하기만 하면 AI가 최대 96%의 정확도로 내용을 필사합니다. 우리 서비스는 비디오 파일(MP4, MOV 등)과 오디오 파일(MP3, WAV 등)을 읽고 편집 가능한 텍스트로 변환하도록 설계되었으며, 화자 레이블과 타임스탬프가 포함됩니다."
        },
        {
          q: "unlimited_policy",
          question: "정말 무제한인가요? 어떤 조건이 있나요?",
          answer:
            "네, 진정한 무제한입니다! 월간 제한 없음, 초과 요금 없음. 유일한 제한은 기술적인 것입니다: 개별 파일은 최대 10시간 길이 또는 5GB 크기이며 한 번에 50개의 파일을 처리할 수 있습니다. 하지만 원하는 만큼 여러 번 업로드할 수 있습니다."
        },
        {
          q: "accuracy",
          question: "필사의 정확도는 어떻게 되나요?",
          answer:
            "우리는 명확한 오디오에 대해 96%의 정확도를 보장합니다. 우리의 AI는 수백만 시간의 다양한 콘텐츠로 훈련되었으며 악센트, 전문 용어, 여러 화자를 매우 잘 처리합니다. 어려운 오디오의 경우 스마트 향상 기능이 결과를 개선하는 데 도움이 됩니다."
        },
        {
          q: "languages",
          question: "어떤 언어를 지원하나요?",
          answer:
            "우리는 영어, 스페인어, 중국어, 힌디어, 아랍어, 프랑스어 등 100개 이상의 언어 필사를 지원합니다. 또한 필사본을 249개의 다른 언어로 번역할 수 있어 글로벌 콘텐츠에 완벽합니다."
        },
        {
          q: "speed",
          question: "필사 속도는 얼마나 빠른가요?",
          answer:
            "번개처럼 빠릅니다! 1시간 오디오 파일은 일반적으로 5분 이내에 처리됩니다. 일괄 처리를 사용하면 50개의 파일을 동시에 업로드하고 병렬로 처리할 수 있습니다. 대부분의 사용자는 하룻밤 사이에 전체 라이브러리가 필사된 것을 발견합니다."
        },
        {
          q: "cancellation",
          question: "언제든지 취소할 수 있나요?",
          answer:
            "물론입니다! 계약 없음, 취소 수수료 없음. 대시보드에서 언제든지 구독을 업그레이드, 다운그레이드 또는 취소할 수 있습니다. 취소하면 결제 기간이 끝날 때까지 액세스 권한이 유지됩니다."
        },
        {
          q: "security",
          question: "내 데이터는 안전한가요?",
          answer:
            "여러분의 보안이 우리의 최우선 순위입니다. 우리는 SOC 2 인증을 받았으며 모든 데이터에 256비트 암호화를 사용하고 여러분의 콘텐츠로 모델을 훈련하지 않습니다. 언제든지 파일을 삭제할 수 있으며 30일 후에 자동으로 삭제됩니다. GDPR 및 CCPA 준수."
        },
        {
          q: "export_formats",
          question: "어떤 내보내기 형식을 사용할 수 있나요?",
          answer:
            "필요한 형식으로 필사본을 다운로드하세요: PDF, Word (DOCX), Excel, CSV, SRT 자막, 일반 텍스트 (TXT), VTT 캡션. 어떤 워크플로에도 완벽합니다."
        },
        {
          q: "file_formats",
          question: "어떤 오디오 및 비디오 파일을 업로드할 수 있나요?",
          answer:
            "우리는 MP3, MP4, M4A, MOV, AAC, WAV, OGG, OPUS, MPEG, WMA, WMV 등 거의 모든 오디오 및 비디오 형식을 지원합니다. 재생할 수 있는 파일이라면 필사할 수 있습니다."
        }
      ]
    },
    CTASection: {
  ...
  Features: {
    UnlimitedTranscription: {
      ...
      feature1Description:
        "분을 세지 마세요. 제한을 신경 쓰지 마세요. 월 10시간이든 10,000시간이든 동일한 요금입니다. 초과 요금 없음. 깜짝 청구 없음.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "Otter는 무료 평생 3회, Pro는 월 10회 임포트를 제공합니다. 우리는 무제한을 제공합니다. 팟캐스트 백로그, 모든 인터뷰, 수년간의 녹음을 업로드하세요. 제한 없습니다.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        '"나는 Otter에 연간 $100를 지불하지만 월 10개 파일 임포트로 제한됩니다. 무제한 임포트 대안이 나오는 순간, 나는 갑니다!" - 실제 Reddit 사용자',
      feature3Point1Icon: "✓",
      ...
      heroSubtitle1: "Trint는 한 달에 최대 50시간으로 제한하고 Otter는 한 달에 최대 10개의 파일로 제한합니다.",
      heroSubtitle2: "실제로 약속한 바를 실현해 드립니다. 숨겨진 대문자 없이 무제한으로 필사해 드립니다."
    },
    BulkUpload: {
      heroBadgeIcon: "📁",
      ...
      heroSubtitle:
        "Otter는 평생 3번의 가져오기를 제공합니다. 세 번. 평생 동안. 우리는 필요할 때마다 무제한 업로드, 한 번에 50개 파일을 제공합니다.",
      primaryCta: "대량 업로드 시작 →",
      secondaryCta: "제한 사항 보기",
      redditQuote:
        '"3년 분의 팟캐스트 에피소드를 자막으로 변환해야 하는데, Otter는 평생 3번의 가져오기만 준다고 합니다. 세 번. 이건 모욕이에요."',
      redditAuthorIcon: "📍",
      ...
      feature1Description:
        '잠자기 전 50개 파일을 업로드하세요. 완성된 자막으로 깨어나세요. 대기열 없음, 기다림 없음, "업그레이드하세요" 메시지 없음. 순수한 처리 능력을 손끝에서 느껴보세요.',
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "당사의 병렬 처리 인프라로 50개의 파일이 순서를 기다리지 않습니다. 모든 파일이 동시에 텍스트로 변환됩니다. 몇 주 걸리던 작업이 이제는 몇 시간이면 됩니다.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        '다른 곳에서는 가상 대기열이나 "우선 처리"를 위해 업그레이드하라고 하지만, 우리는 모든 업로드를 긴급하게 처리합니다. 당신의 콘텐츠는 중요하며, 기다릴 필요가 없습니다.',
      feature3Point1Icon: "✓",
      ...
      useCase1Description:
        "3년 분량 에피소드를 한 번에 업로드. 전체 백 카탈로그에 대한 텍스트 생성. 모든 에피소드에 대한 SEO 콘텐츠 생성.",
      useCase2Title: "강의 제작",
      useCase2Description:
        "모든 강의 동영상을 동시에 처리. 학생들을 위한 접근성 있는 텍스트 생성. 검색 가능한 강의 자료 구축.",
      useCase3Title: "인터뷰 백로그",
      useCase3Description:
        "텍스트로 변환되지 않은 인터뷰 더미를 정리하세요. 몇 주 분량 연구를 몇 시간 만에 처리. 당황하지 않고 마감을 맞추세요.",
      useCase4Title: "YouTube 라이브러리",
      useCase4Description: "전체 채널에 대한 자막 생성. 동영상 콘텐츠로 블로그 게시물 작성. 모든 동영상의 SEO 개선.",
      useCase5Title: "회의 아카이브",
      useCase5Description:
        "수개월 분량의 회의 녹음을 업로드하세요. 검색 가능한 회의 노트를 생성하세요. 중요한 결정을 다시는 놓치지 마세요.",
      useCase6Title: "연구 데이터",
      useCase6Description:
        "포커스 그룹을 일괄 처리하세요. 모든 참가자 인터뷰를 자동으로 필사하세요. 질적 데이터를 효율적으로 분석하세요.",
    ...
    Accuracy: {
      ...
      heroSubtitle:
        "12개 주요 언어에서 업계 최고의 정확도. 완벽한 동기화를 위한 단어 단위 타임스탬프. 빠른 대화도 처리하는 스마트 발화자 식별. 실제로 읽기 쉬운 전문적인 포맷팅.",
      ...
      feature1Description:
        "모든 단어가 오디오 위치와 완벽하게 동기화됩니다. 클릭 가능한 대본 생성, 정밀한 자막 제작 또는 녹음에서 정확한 지점으로 이동할 수 있습니다. 전문가들이 신뢰하는 100ms 정밀도.",
      feature1Point1Icon: "✓",
      ...
      feature2Description:
        "중첩된 발화, 방해, 빠른 주고받기 대화 중에도 화자를 정확히 식별합니다. 화자가 자주 끼어드는 인터뷰, 팟캐스트, 회의에 완벽합니다.",
      feature2Point1Icon: "✓",
      ...
      feature3Description:
        "더 이상 텍스트 벽이 아닙니다. 저희 AI는 문단, 문장, 구두점을 정확히 필요한 위치에 자동으로 추가합니다. 결과는? 읽기 편하고 쉽게 훑어볼 수 있는 기록물입니다.",
      feature3Point1Icon: "✓",
      ...
      comparisonDes1: "방법을 확인하세요",
      comparisonDes2: "경쟁자들과 맞서다"
    }
  },
  Pricing: {
    Hero: {
      ...
      highlighted_text: "숨겨진 제한 없음",
      description:
        "필요에 맞는 요금제 선택. 언제든 업그레이드 또는 다운그레이드 가능. 계약 없음, 예상치 못한 비용 없음."
    },
    Cards: {
      title: "간단하고 투명한 가격 정책.",
      highlighted_text: "숨겨진 제한 없음.",
      ...
      plans: [
        {
          ...
          features: {
            title: "기능",
            items: ["100개 이상 언어 지원", "화자 레이블", "번역", "모든 내보내기 형식"]
          },
          cta: {
            text: "무료 시작. 신용카드 불필요.",
            button: "현재 플랜"
        ...
        },
        {
          ...
          limits: {
            title: "월간 제한 없음",
            items: ["무제한 총 사용 시간", "파일당 최대 10시간 / 5 GB", "한 번에 50개 파일 업로드", "우선순위 큐"]
          },
          features: {
            title: "무료 플랜 포함, 추가로",
            items: ["단어 단위 타임스탬프", "고급 화자 식별", "서식 있는 문단 & 문장 부호", "우선 지원"]
          },
          cta: {
      ...
      disclaimer:
        '"무제한"은 월간 제한 없고 인위적인 속도 저하 없음을 의미합니다. 남용 자동화 또는 재배포 시 공정 사용 정책이 적용됩니다.'
    },
    ComparisonTable: {
      header: {
        title: "비교",
      ...
      features: [
        ...
        {
          name: "일일 파일 제한",
          values: ["3개 파일/일", "제한 없는", "제한 없는"]
        },
        {
          name: "최대 파일 기간",
          values: ["10시간", "10시간", "10시간"]
        },
        {
          name: "최대 파일 크기",
          values: ["5GB", "5GB", "5GB"]
      ...
      items: [
        {
          ...
          question: "정말 무제한인가요?",
          answer:
            "네! Pro 플랜은 월별 사용 시간 제한이 없습니다. 유일한 제한은 기술적인 사항입니다: 최대 10시간 파일 길이와 5GB 파일 크기입니다. 필요한 만큼 파일을 처리할 수 있습니다."
        },
        {
          q: "plan_change",
          question: "언제든지 플랜을 변경할 수 있나요?",
          answer:
            "물론입니다! 대시보드에서 언제든지 구독을 취소할 수 있습니다. 필요할 때마다 업그레이드 또는 다운그레이드하세요."
        },
        {
          q: "payment_methods",
        ...
        },
        {
          ...
          answer:
            "우리는 SOC 2 인증을 받았으며 256비트 암호화를 사용합니다. 당신의 콘텐츠로 모델을 훈련시키지 않습니다. 당신의 데이터는 당신의 것입니다."
        }
      ]
    },
    CTA: {
  ...
  UseCases: {
    AllUseCases: {
      ...
      podcasters: {
        ...
        description:
          "팟캐스트 아카이브를 한 번에 업로드하세요. 쇼 노트 생성, SEO 개선, 시간 제한 없이 콘텐츠 재활용이 가능합니다.",
        benefits: {
      ...
      researchers: {
        ...
        description:
          "전체 연구 자료를 한 번에 처리하세요. 포커스 그룹, 인터뷰, 패널 토론을 완벽한 발화자 식별로 관리하세요.",
        benefits: {
      ...
      businessTeams: {
        ...
        description:
          "직접 회의를 녹음하거나 오디오 파일을 업로드해 즉시 전사할 수 있습니다. 무제한 대화에서 검색 가능한 아카이브를 구축하고 중요한 논의를 다시는 잃지 마세요.",
        benefits: {
      ...
      educators: {
        ...
        description:
          "YouTube 링크를 붙여넣기만 하면 즉시 전사본과 자동 생성 자막을 얻을 수 있습니다. 모든 교육 동영상을 접근 가능하고 검색 가능한 콘텐츠로 변환하세요.",
        benefits: {
      ...
      quotes: {
        ...
        testimonials: {
          mike: {
            ...
            textAfter:
              '가 전사되지 않은 채 있었습니다. Otter는 3개만 선택하라고 했어요. NeverCap은 주말 동안 150개 에피소드를 모두 업로드할 수 있게 해주었습니다."',
            name: "Mike Rodriguez",
            role: "팟캐스트 호스트"
          },
          jessica: {
            ...
            highlight: "$100/월",
            textAfter:
              '을 감당할 수 없지만, Otter의 월 10개 파일 제한도 작업에 적합하지 않았습니다. NeverCap은 제 경력을 구했습니다."',
            name: "Jessica Park",
            role: "프리랜서 저널리스트"
          },
          sarah: {
            ...
            highlight: "200시간",
            textAfter:
              '의 포커스 그룹 녹음을 보유하고 있었습니다. 월별 할당량을 나누는 대신 주말 동안 모든 것을 처리했습니다."',
            name: "Dr. Sarah Chen",
            role: "수석 연구원"
          },
          carlos: {
      ...
      heroSubtitleA:
        "수년간의 백로그를 보유한 팟캐스터부터 수백 건의 인터뷰를 진행하는 연구자까지, 전문가들이 {NeverCap}을 사용하여 업로드 제한과 시간 제한에서 어떻게 벗어나는지 알아보세요."
    },
    Podcasters: {
      badge: "팟캐스터를 위해 제작됨",
      heroTitle: "당신의",
      ...
      heroSubtitle:
        "전체 백 카탈로그를 업로드하세요. 모든 에피소드에 쇼 노트를 생성합니다. 더 이상 오디오 변환할 에피소드를 선택할 필요가 없습니다.",
      ...
      problems: {
        problem1: {
          ...
          description:
            "Otter는 무료 평생 3회, Pro 월 10회 임포트를 제공합니다. 3년 분량의 에피소드를 어떻게 변환하시겠습니까?"
        },
        problem2: {
          title: "SEO 기회 놓침",
          description:
            "텍스트 변환되지 않은 모든 에피소드는 SEO 트래픽을 잃습니다. 하지만 Descript는 최대 월 30시간으로 제한합니다."
        },
        problem3: {
          title: "성장에 따른 비용 폭발",
          description:
            "팟캐스트가 성장함에 따라 텍스트 변환 비용이 급증합니다. 시간당 $2의 초과 요금으로 확장이 불가능합니다."
        }
      },
      solutionTitle: "이것",
      ...
      features: {
        feature1: {
          title: "다중 화자 감지",
          description:
            "최대 20명의 화자를 자동으로 식별하고 라벨링합니다. 패널 토론, 인터뷰 및 공동 진행 쇼에 완벽합니다."
        },
        feature2: {
          title: "타임스탬프 챕터",
          description:
            "YouTube 설명을 위한 클릭 가능한 타임스탬프 생성. 청취자가 즉시 좋아하는 부분으로 이동할 수 있습니다."
        },
        feature3: {
          title: "스마트 포맷팅",
          description:
            "자동으로 문단, 문장 및 구두점을 추가합니다. 깔끔하고 읽기 쉬운 텍스트를 얻으세요. 후반 작업 시간을 절약하세요."
        },
        feature4: {
          title: "SEO 최적화",
        ...
        feature6: {
          title: "일괄 처리",
          description:
            "잠자기 전 50개 에피소드를 업로드하세요. 아침에 완성된 텍스트를 확인하세요. 하룻밤 사이에 전체 아카이브를 처리하세요."
        }
      },
      ...
      solutionDescriptionA:
        "{NeverCap}을 사용하면 무제한으로 자막을 제작할 수 있습니다. 전체 아카이브를 업로드하고, 모든 새 에피소드를 자막으로 제작하고, 대규모 쇼 노트를 생성하세요. 제한이나 제한 없이, 오직 성장만 있을 뿐입니다."
    },
    Journalists: {
      hero: {
        badge: "저널리스트 & 작가를 위한",
        ...
        subtitle:
          "어떤 인터뷰를 자막화할지 고르지 마세요. 모든 녹음을 한 번에 업로드하고, 즉시 검색하며, 업로드 스트레스 없이 마감을 맞추세요.",
      ...
      problem: {
        ...
        problems: {
          ...
          missingQuotes: {
            title: "중요한 발언 놓침",
            description:
              "자막화되지 않은 모든 인터뷰에는 기사의 핵심 발언이 있을 수 있습니다. 하지만 Trint는 최대 월 50시간만 허용합니다."
          },
          costExplosion: {
        ...
        solution: {
          ...
          descriptionA:
            "{NeverCap}을 사용하면 무제한으로 기사를 작성할 수 있습니다. 조사 내용 전체를 업로드하고, 모든 인터뷰를 기록하고, 모든 인용문을 즉시 검색할 수 있습니다. 대문자도, 제한도 없이, 오직 저널리즘의 정수를 담을 수 있습니다."
        }
      },
      solution: {
        title: "1",
        ...
        solutions: {
          unlimitedUploads: {
            ...
            description:
              "분량 제한이 있는 소프트웨어와 달리, 간단한 대화부터 여러 시간에 걸친 토론까지 모든 인터뷰를 필사할 수 있습니다. 마감일에 크레딧이 부족할 걱정은 이제 끝입니다.",
            points: {
          ...
          instantSearch: {
            ...
            title: "뉴스 사이클에 맞는 속도",
            description:
              "인터뷰 필사본을 며칠이 아니라 몇 분 안에 받아보세요. 그 어느 때보다 빠르게 기사를 완성하세요. 커피 한 잔 마시는 동안 AI가 몇 시간 분량의 오디오를 처리합니다.",
            points: {
          ...
          professionalAccuracy: {
            ...
            title: "인용할 수 있는 정확도",
            description:
              "저희 AI는 높은 정확도의 필사본을 제공하여 게시하는 인용문이 정확하고 신뢰할 수 있도록 합니다. 편집자들이 신뢰하는 전문가급 필사 품질.",
            points: {
          ...
          ironclad: {
            ...
            title: "철통 같은 출처 보호",
            description:
              "민감한 인터뷰 데이터와 기밀 출처를 보호하기 위한 강력한 보안 기능을 제공합니다. 은행급 암호화로 조사 내용을 안전하게 보관하세요.",
            points: {
      ...
      testimonials: {
        jessica: {
          quote:
            '"업로드 제한 때문에 3년간 방치된 인터뷰들이 있었어요. NeverCap로 주말 만에 전부 처리했죠. 게임 체인저예요."',
          name: "제시카 박",
    ...
    ContentCreators: {
      hero: {
        ...
        subtitleA:
          "YouTube 동영상 대본 작성, TikTok 동영상의 용도 변경, Facebook 동영상의 텍스트 변환 등 어떤 작업이든 {NeverCap}이 완벽하게 처리해 드립니다. 월별 제한 없이 100개 이상의 언어로 자막을 생성하세요. 순수한 창작의 자유를 만끽하세요."
      },
      platforms: {
      ...
      features: {
        ...
        oneClickImport: {
          ...
          description:
            "저희 도구는 동영상 콘텐츠 자막 생성을 간편하게 합니다. 인스타그램 동영상 링크를 붙여넣기만 하세요. Vimeo 동영상도 동일한 방법으로 텍스트 변환 가능합니다. 채널의 모든 백로그를 주말 동안 처리하세요.",
          points: {
        ...
        globalReach: {
          ...
          description:
            "100개 이상 언어 자동 번역으로 글로벌 시청자에게 도달하세요. 다국어 자막을 동시에 생성합니다. 추가 비용 없음, 월별 번역량 제한 없음.",
          points: {
        ...
        flexibleExport: {
          ...
          titleHighlight: "제공",
          description:
            "워크플로우에 맞는 형식으로 내보내기. YouTube용 SRT부터 웹 플레이어용 VTT, 편집 가능한 문서까지. 모든 내보내기 무제한, 모든 플랜에 포함.",
          points: {
      ...
      testimonials: {
        ...
        sarah: {
          ...
          textAfter:
            ". 저는 500개 이상의 비디오가 쌓여 있었죠. NeverCap으로 한 주말 만에 모두 처리했습니다. 자막으로 인한 SEO 향상은 첫 달에 이미 비용을 충당했어요.",
          highlight: "30시간",
          name: "사라 리",
        ...
        jake: {
          textBefore: "이것",
          textAfter:
            "기능은 게임 체인저입니다. 더는 아무것도 다운로드할 필요 없어요. 그냥 붙여넣고, 변환하고, 완료. TikTok용 팟캐스트 클립 처리가 이렇게 쉬웠던 적이 없어요.",
        ...
        yuki: {
          ...
          textAfter:
            ". NeverCap은 무제한 번역을 제공해요. 제대로 된 현지 자막을 사용하기 시작한 후 국제 시청자가 400% 증가했습니다.",
          highlight: "번역당",
          name: "유키 타나카",
        ...
        questions: [
          {
            ...
            answer:
              "간단합니다. 변환하려는 YouTube 비디오를 찾아 URL을 복사하고 저희 앱에 붙여넣기만 하면 됩니다. 저희 AI가 자동으로 비디오를 가져와 몇 분 안에 전체 텍스트 변환본을 제공할 거예요."
          },
          {
            question: "Q: Facebook 비디오를 텍스트로 변환하는 가장 좋은 방법은 무엇인가요?",
            answer:
              "가장 쉬운 방법은 직접 링크를 사용하는 것입니다. Facebook 비디오의 URL을 복사하면 저희 플랫폼이 나머지를 처리해 음성을 텍스트로 최대 96% 정확도로 변환해줍니다. 수동 변환에서 벗어나세요."
          },
          {
            question: "Q: TikTok 및 Instagram 비디오도 변환할 수 있나요?",
            answer:
              "물론이죠. TikTok 및 Instagram 비디오 변환을 모두 지원합니다. 짧은 형식의 비디오 콘텐츠를 블로그 글, 기사 또는 텍스트 기반 소셜 미디어 업데이트로 재활용하려는 콘텐츠 크리에이터에게 완벽합니다."
          },
          {
            question: "Q: Vimeo 비디오를 텍스트로 어떻게 변환하나요?",
            answer:
              "Vimeo 비디오 변환은 다른 플랫폼만큼 쉽습니다. Vimeo 비디오 URL을 복사해 NeverCap에 붙여넣기만 하면 됩니다. 저희 AI가 비디오를 처리하고 여러 형식으로 다운로드할 수 있는 정확한 텍스트 변환본을 생성할 거예요."
          }
        ]
      }
    },
    Researchers: {
      ...
      heroSubtitle:
        "어떤 포커스 그룹을 변환할지 선택하는 것을 멈추세요. 20명의 참가자가 동시에 말해도 96% 정확도와 완벽한 화자 식별로 모든 질적 데이터를 처리하세요.",
      ...
      problemCard2Desc:
        "변환되지 않은 모든 인터뷰에는 획기적인 통찰력이 담겨 있을 수 있습니다. 하지만 Rev는 최소 $2/분을 청구합니다.",
      ...
      feature1Title: "당신의",
      feature1Desc:
        '오늘 밤 200시간 분량의 인터뷰를 모두 업로드하세요. 완성된 검색 가능한 필사본으로 아침을 맞이하세요. 월간 제한 없음, 파일별 제한 없음, "공정 사용" 같은 허튼소리 없음.',
      ...
      feature2Desc:
        "우리의 AI는 서로 말을 끊거나 동시에 말해도 최대 20명의 화자를 추적합니다. 모든 목소리가 정확하게 캡처되고 라벨링됩니다.",
      ...
      feature3Desc:
        "전문 용어, 강한 악센트, 분야별 용어를 전문가처럼 처리합니다. 출판, 동료 검토, 논문 위원회에 충분한 정확도.",
      ...
      feature4Desc:
        "민감한 연구 데이터는 기업급 보안으로 보호됩니다. GDPR 준수, HIPAA 준수 옵션, IRB 요구 사항을 위한 완전한 감사 추적.",
      ...
      useCase1Desc:
        "중복 발화가 있는 8-20명의 참가자 처리. 열띤 토론 중에도 완벽한 화자 식별. 질적 분석 소프트웨어로 직접 내보내기.",
      useCase2Title: "심층 인터뷰",
      useCase2Desc:
        "수백 건의 1:1 인터뷰를 동시에 처리하세요. 전체 데이터셋의 일관성을 유지하고 모든 기록을 즉시 검색할 수 있습니다.",
      useCase3Title: "임상 연구",
      ...
      useCase5Desc:
        "제한 없이 전체 아카이브를 보존하세요. 검색 가능한 역사적 기록 생성. 종단 및 세대 연구에 이상적입니다.",
      useCase6Title: "논문 연구",
      useCase6Desc:
        "학생 친화적인 가격으로 모든 기능을 이용하세요. 저렴한 비용으로 전체 데이터셋을 처리하고 일괄 처리로 빠른 마감을 맞추세요.",
      testimonialTitle: "신뢰받는 기관",
      testimonialText:
        "우리 연구팀은 지역사회 건강 연구에서 200시간의 포커스 그룹 녹음을 보유했습니다. 다른 서비스는 비용 때문에 전사할 세션을 선택하라고 했습니다. NeverCap은 주말 동안 모든 것을 처리할 수 있게 해주었습니다. 20명의 화자 식별 기능은 심지어 모두가 동시에 말하는 혼란스러운 토론 중에도 작동했습니다. 이 도구는 우리가 질적 데이터를 처리하는 방식을 완전히 바꿔놓았습니다.",
      ...
      testimonialText3:
        "우리의 지역사회 건강 연구에서 나온 포커스 그룹 녹음입니다. 다른 서비스는 비용 때문에 어떤 세션을 기록할지 선택하라고 했습니다. NeverCap을 사용하면",
      testimonialText4Hl: "주말 동안 모든 것을 처리할 수 있었습니다",
      testimonialText5:
        ". 20명 스피커 식별 기능이 실제로 작동했습니다—심지어 모두가 동시에 말하는 가장 혼란스러운 토론 중에도 말이죠. 이 도구는",
      testimonialText6Hl: "완전히 변화시켰습니다",
      testimonialText7: "우리가 질적 데이터를 처리하는 방식을.",
      solutionDescA:
        "{NeverCap}을 사용하면 무제한으로 텍스트 변환을 할 수 있습니다. 연구 자료 전체를 업로드하고, 모든 인터뷰를 텍스트로 변환하고, 모든 데이터를 분석하세요. 제한이나 제한 없이, 오직 연구만 가능합니다."
    },
    BusinessTeams: {
      ...
      feature1Desc:
        "다운로드나 플러그인 없음. 한 번의 클릭으로 즉시 녹음을 시작하세요. 완벽한 오디오 품질, 자동 화자 감지.",
      ...
      feature2Desc:
        "Zoom, Teams 또는 휴대폰에서 녹음한 파일이 있나요? 즉시 업로드하세요. 모든 주요 오디오 및 비디오 형식 지원. 기다릴 필요 없이 여러 파일을 동시에 처리하세요.",
      ...
      feature3Desc:
        "팀원들과 즉시 전사본을 공유하세요. 함께 녹음을 듣고, 여러 형식으로 전사본을 내보내며, 검색 가능한 회의 아카이브로 모두가 일관성을 유지하도록 하세요.",
      ...
      feature4Desc:
        "모든 회의를 한 번에 검색하세요. 지난 분기의 중요한 결정이나 몇 달 전의 클라이언트 요구사항을 찾아보세요. AI 기반 검색은 키워드뿐만 아니라 문맥도 이해합니다.",
      ...
      workflowStep1Desc:
        "실시간 녹음을 시작하거나 Zoom, Google Meet, Microsoft Teams에서 회의 녹음을 간편하게 다운로드하세요.",
      ...
      testimonial1Text:
        '"중요한 세부 사항을 놓치던 시절에서 모든 대화가 검색 가능한 아카이브로 바뀌었습니다. 직접 녹음 기능으로 중요한 논의를 절대 놓치지 않습니다."',
      testimonial1AuthorName: "제임스 킴",
      testimonial1AuthorRole: "테크코프 제품 매니저",
      testimonial2Text:
        '"Otter는 월 10개 파일 업로드만 허용했습니다. 이제 모든 고객 통화를 즉시 업로드합니다. 영업팀의 후속 작업에 게임 체인저입니다."',
      testimonial2AuthorName: "사라 로드리게스",
      testimonial2AuthorRole: "컨설트프로 영업 디렉터",
      testimonial3Text:
        '"몇 달치 회의를 검색할 수 있는 기능이 감사 기간에 우리를 구했습니다. 모든 결정과 승인을 몇 초 만에 찾았습니다."',
      ...
      heroSubtitleA:
        "브라우저에서 직접 회의를 녹화하거나 오디오 파일을 즉시 업로드하세요. 무제한 대화로 검색 가능한 아카이브를 구축하세요. {NeverCap}의 무제한 텍스트 변환 기능으로 중요한 대화를 더 이상 놓치지 마세요."
    },
    Educators: {
      heroBadge: "교육자 및 교사용",
      heroTitle1: "학습을",
      ...
      heroSubtitle:
        "YouTube 링크를 붙여넣기만 하면 자동 생성 자막과 함께 즉시 대본을 얻을 수 있습니다. 강의, 튜토리얼, 교육용 동영상을 모든 학생이 학습할 수 있는 검색 가능한 콘텐츠로 변환하세요.",
      heroCtaPrimary: "무료로 사용해보기 - 신용카드 불필요",
      ...
      feature1Desc:
        "어떤 동영상 링크든 붙여넣기만 하면 즉시 자막 생성. YouTube, Vimeo, Facebook, X (Twitter), TikTok, Instagram, Dropbox, Google Drive 등과 호환. 다운로드나 대기 없이 이용 가능.",
      ...
      feature2Desc:
        "교육용 동영상을 위한 정확한 자막 즉시 생성. 청각 장애 학생, 비원어민 또는 읽기를 선호하는 학생들을 위해 콘텐츠를 접근 가능하게.",
      ...
      feature3Desc:
        "강좌, 주제 또는 학기별로 폴더를 생성하여 자막을 정리하세요. 모든 교육 콘텐츠를 깔끔하게 분류하고 쉽게 검색 가능하게. 접근 가능한 강좌 자료의 포괄적인 라이브러리 구축.",
      ...
      feature4Desc:
        "단순히 녹음 파일을 공유하지 마세요. 강의 및 기타 오디오 파일을 자동으로 텍스트로 변환하고 요약 및 주요 개념이 포함된 상세한 학습 가이드로 만들어 학생들의 효과적인 복습을 지원하세요. TXT, DOCX 또는 PDF 형식으로 내보내기 가능.",
      ...
      useCase1Title: "녹화 강의",
      useCase1Text:
        "한 학기 분량의 녹화 강의를 텍스트로 변환하세요. 학생들은 특정 주제를 검색하고 핵심 개념을 복습하며 중요한 정보를 놓치지 않을 수 있습니다.",
      useCase2Title: "온라인 강의",
      useCase2Text:
        "100개 이상의 언어로 번역하여 국제 학생들이 온라인 강의를 이용할 수 있도록 하세요. 등록률과 만족도를 높이세요.",
      useCase3Title: "학습 자료",
      useCase3Text:
        "AI를 사용해 비디오 강의와 튜토리얼의 오디오 파일을 학습 가이드로 변환하세요. 읽기를 선호하거나 검색 가능한 텍스트로 빠르게 복습해야 하는 학생들에게 완벽합니다.",
      useCase4Title: "접근성 준수",
      useCase4Text:
        "모든 비디오 콘텐츠에 자막과 텍스트를 제공하여 접근성 요구 사항을 충족하세요. 모든 학생이 동등하게 이용할 수 있도록 보장합니다.",
      useCase5Title: "플립드 클래스룸",
      useCase5Text:
        "수업 전에 텍스트가 포함된 비디오 강의를 공유하세요. 학생들은 자신의 속도로 복습하고 토론에 준비된 상태로 올 수 있습니다.",
      useCase6Title: "연구 및 인용",
      useCase6Text:
        "타임스탬프로 학생들이 비디오 출처를 정확하게 인용할 수 있도록 도와주세요. 연구 프로젝트와 학술 논문에 완벽합니다.",
      ...
      testimonialTextA:
        '"저는 {NeverCap}을 사용해서 수학 튜토리얼 YouTube 채널 전체를 텍스트로 변환하고 있습니다. 다른 서비스에서는 몇 주씩 걸리던 작업이 이제는 몇 시간 만에 완료됩니다. 링크를 직접 붙여넣고 즉시 텍스트 변환을 받을 수 있게 되면서 접근성 높은 콘텐츠를 만드는 방식이 완전히 달라졌습니다. 특히 제 유학생들은 다국어 자막을 정말 좋아해요!"'
    }
  },
  Resources: {
    YouTubeToMP4: {
        ...
        list: [
          {
            title: "데이터 비용 절약:",
            content:
              "일반적으로 YouTube에서 동영상을 보는 것은 많은 모바일 데이터를 소모합니다. 오프라인 시청을 위해 다운로드하면 이러한 불필요한 비용을 피할 수 있습니다."
          },
          {
            title: "어디서나, 언제든 시청:",
          ...
          },
          {
            title: "손쉬운 보관 및 저장:",
            content:
              "동영상을 MP4로 저장하면 개인 컬렉션을 쉽게 구축할 수 있습니다. 특히 가치 있거나 중요한 콘텐츠에 유용합니다."
          },
          {
            title: "간편한 공유:",
            content:
              "링크를 보내는 것보다 MP4 파일을 공유하는 것이 훨씬 편리합니다. WhatsApp이나 Instagram과 같은 앱으로 동영상 파일을 직접 보낼 수 있어 YouTube를 열어야 하는 번거로움을 줄일 수 있습니다."
          },
          {
            title: "즉시 시청, 함께하는 순간:",
            content:
              "친구나 가족에게 좋아하는 동영상을 보여주고 싶나요? MP4를 다운로드하면 로딩을 기다리는 불편함 없이 바로 함께 부드럽게 시청할 수 있습니다."
          }
        ]
      },
      part5: {
      ...
      part7: {
        ...
        list: [
          ...
          },
          {
            ...
            answer:
              "예, 안전하고 신뢰할 수 있습니다. 사용자의 개인 정보를 요구하지 않으며 바이러스에 대한 강력한 대책을 마련하고 있습니다. 인터넷에서 파일을 다운로드할 때는 항상 주의를 기울이세요: 의심스러운 링크를 클릭하거나 문제가 있는 파일을 다운로드하지 마세요."
          },
          {
          ...
          },
          {
            ...
            answer:
              "우리는 최대한 빠른 다운로드 환경을 제공하지만, 다운로드 시간은 동영상 길이와 인터넷 연결 속도와 같은 요소에 따라 영향을 받습니다."
          },
          {
            question: "스마트폰으로 MP4 동영상을 다운로드하면 어디에 저장되나요?",
            answer:
              '스마트폰에서 MP4를 다운로드한 후에는 일반적으로 기기의 파일 관리자 앱 내 "다운로드" 폴더에서 찾을 수 있습니다.'
          },
          {
            question: "YouTube 동영상을 MP4로 다운로드하면 화질이 떨어지나요?",
            answer:
              "아닙니다. 우리 도구를 사용하여 YouTube 동영상을 MP4로 다운로드하면 원본 화질이 유지됩니다. 변환 과정에서 원본 품질이 보존되므로 YouTube에서와 동일한 시청 경험을 할 수 있습니다."
          }
        ]
      },
      ...
      videoDownload: {
        ...
        description:
          "저희 서비스를 선택해 주셔서 감사합니다! 신뢰에 깊이 감사드리며 더 좋은 경험이 되었기를 바랍니다. 친구들에게 저희 웹사이트를 공유해 주시면 큰 도움이 됩니다.",
        downloadButton: "다운로드",
      ...
      MoreFreeTools: {
        title: "더 많은 무료 도구",
        title_des: "다른 무료 변환 도구도 살펴보세요",
        YouTubeToMP: "유튜브에서 MP3로",
        YouTubeToMP_des:
          "YouTube 동영상을 오프라인 감상을 위해 MP3 형식으로 변환하세요. 고화질 동영상을 즉시 다운로드하세요.",
        AITranscription: "AI 전사",
        AITranscription_des:
          "96% 정확도로 오디오 및 비디오 파일을 텍스트로 변환하세요. 모든 콘텐츠에 대해 무제한 텍스트 변환이 가능합니다."
      }
    },
    YouTubeToMP3: {
      err1: "YouTube 링크 형식 오류.",
      err2: "죄송합니다! 현재는 YouTube 링크만 지원합니다. 다른 사이트에 대한 지원이 필요하시면 향후 추가될 때마다 알려드리겠습니다.",
      part1: {
        title: "YouTube 비디오를 MP3로 변환",
        title_des: "몇 초 만에 YouTube 동영상에서 오디오 추출",
        placeholder: "여기에 유튜브 링크를 붙여 넣으세요",
        clear_icon: "명확한 입력",
        Download: "전환하다",
        loading_text: "변환 링크를 처리하는 중입니다. 페이지에 머물러 주세요.",
        howToDownload: "어떻게 변환하나요?",
        tutorial: "튜토리얼을 시청하세요"
      },
      freeResources: {
        linkTitle: "{NeverCap}에서 제공",
        linkTitle2: "- 완전 무제한 AI 필사",
        title: "무료 리소스",
        stepsNew: [
          {
            title: "무료 오디오 및 비디오 필사",
            content: "몇 초 만에 오디오 및 비디오 파일을 텍스트로 변환합니다. 매일 3개의 파일을 필사합니다."
          },
          {
            title: "오디오 파일을 텍스트로 추출",
            content: "MP3, MP4, WAV, MOV를 업로드하세요.",
            content2: "DOCX, TXT, SRT 등을 다운로드하세요."
          },
          {
            title: "YouTube 동영상 필사",
            content: "YouTube 동영상을 정확한 텍스트나 자막으로 변환하고 링크를 무료로 붙여넣으세요."
          }
        ]
      },
      part2: {
        title: "3가지 간단한 단계로 YouTube 비디오를 다운로드 가능한 MP3 파일로 변환하는 방법은 다음과 같습니다.",
        steps: [
          {
            title: "URL을 복사하세요",
            content: "대상 YouTube 동영상을 열고 브라우저의 주소 표시줄에서 링크를 복사합니다."
          },
          {
            title: "링크를 붙여넣으세요",
            content: "비디오 다운로더 도구에 삽입하고 URL을 입력 필드에 붙여넣습니다."
          },
          {
            title: "변환 및 다운로드",
            content: "변환이 완료되면 MP3 파일을 다운로드하여 저장하세요."
          }
        ]
      },
      part3: {
        content: [
          "언제든지 들을 수 있도록 YouTube 동영상을 MP3로 변환하고 싶으신가요?",
          "지하철이나 비행기 안에서든, 팟캐스트, 강의 콘텐츠, 중요한 자료 등을 정리하고 있든, 언제든 원하는 자료를 찾을 수 없다는 사실에 종종 어려움을 겪습니다. 저희 변환 도구가 이러한 문제를 해결해 드립니다.",
          "YouTube 링크를 복사하여 변환기에 붙여넣기만 하면 클릭 한 번으로 비디오를 고품질 MP3 오디오로 변환할 수 있습니다. 인터넷 연결 없이도 언제든지 저장, 청취, 보관할 수 있습니다."
        ]
      },
      part4: {
        content: ["변환의 5가지 주요 이점은 다음과 같습니다.", "YouTube 비디오를 MP3 파일로"],
        list: [
          {
            title: "저장 공간을 절약하세요:",
            content:
              "MP3 파일은 크기가 더 작아 YouTube 사용 시 저장 공간이 줄어듭니다. 오프라인 시청을 위해 다운로드하고 인터넷 서비스가 가능할 때 사용하면 모바일 데이터를 절약할 수 있습니다."
          },
          {
            title: "배터리 절약:",
            content:
              "YouTube 동영상을 시청하려면 쉽게 들을 수 있는 연결을 사용하는 버퍼링 서비스를 이용하세요. 더 이상 버퍼링 걱정은 없습니다."
          },
          {
            title: "간편한 보관 및 보존:",
            content:
              "일부 비디오나 MP3를 이용하면 교육 콘텐츠, 음악 보관소 또는 중요한 콘텐츠 등 개인 라이브러리를 쉽게 구축할 수 있습니다."
          },
          {
            title: "더욱 간편한 공유:",
            content:
              "MP3 파일을 공유하는 것은 YouTube 링크보다 훨씬 편리합니다. WhatsApp이나 Instagram 같은 앱을 통해 친구에게 파일을 보낼 수 있으므로 YouTube를 여는 데 드는 비용이 들지 않습니다."
          },
          {
            title: "즉각적인 시청, 폭넓은 유연성:",
            content:
              "YouTube 동영상을 필요한 곳 ​​어디에서나 변환하여 좋아하는 동영상을 더 폭넓게 감상할 수 있으며, MP3 형식을 지원하므로 어색한 대기 없이 바로 원활하게 감상할 수 있습니다."
          }
        ]
      },
      part5: {
        title: "왜 우리 변환기가 돋보이는가",
        cards: [
          {
            title: "원클릭 간편함",
          ...
          {
            title: "초고속, 무제한",
            content: "최고 속도로 변환하고 다운로드하세요. 제한이나 제한이 없습니다."
          },
          {
            title: "즉시 변환",
          ...
          },
          {
            ...
            content:
              "팝업, 배너 또는 방해 요소 없이 깔끔한 인터페이스를 즐겨보세요. 원활하고 중단 없는 전환이 가능합니다."
          },
          {
            title: "정품 품질 보장",
            content:
              "다운로드한 영상은 원본 영상의 전체 해상도를 그대로 유지하므로 항상 픽셀 단위로 완벽하게 재생할 수 있습니다."
          },
          {
            title: "어디서나 작동합니다",
      ...
      part6: {
        title: ["YouTube에서 MP3로의 변환을 극대화하세요", "우리의 변환기로"],
        title_des: "간편한 YouTube MP3 변환 - 빠르고 간편하며 무료",
        content: [
          "저희가 탁월한 역량을 발휘하는 부분이 바로 여기에 있습니다. 사용자 친화적인 인터페이스는 누구나 쉽게 사용할 수 있도록 설계되었으며, 전문적인 지식은 필요하지 않습니다. 경험 수준에 관계없이 비디오를 즉시 변환할 수 있습니다. 가입도 필요 없고, 바로 시작할 수 있습니다. 다운로드한 MP3 파일은 YouTube에서 시청했던 원본 비디오 화질과 선명도를 그대로 유지합니다.",
          "속도도 중요합니다. 여러 파일을 빠르게 다운로드할 수 있으며, 광고나 기기에 구애받지 않습니다. Windows, macOS, Linux, Android, iOS 등 스마트폰, 태블릿, 데스크톱 등 어떤 운영체제를 사용하든 비디오를 손쉽게 다운로드할 수 있습니다."
        ]
      },
      part7: {
        title: "YouTube를 MP3로 변환하는 것에 대한 주요 질문",
        list: [
          {
            question: "저작권이 있는 YouTube 동영상을 MP3로 변환할 수 있나요?",
            answer:
              "기술적으로는 가능하지만, 저작권이 있는 콘텐츠를 허가 없이 변환하는 것은 YouTube 서비스 약관 및 저작권법을 위반할 수 있습니다. 콘텐츠를 변환하거나 개인적, 비상업적 목적으로만 사용할 권리가 있는지 항상 확인하세요."
          },
          {
            question: "이 변환 도구는 안전한가요?",
            answer:
              "네, 저희 변환기는 완벽하게 안전합니다. 고객님의 데이터나 파일을 저장하지 않으며, 악성코드나 바이러스 감염 위험도 없습니다. 변환은 직접 안전하게 진행됩니다."
          },
          {
            question: "YouTube에서 MP3로 변환하는 기능은 어떤 언어를 지원하나요?",
            answer:
              "저희 변환기는 YouTube에서 제공되는 모든 언어를 지원합니다. 오디오는 원본 영상에 표시된 그대로 추출되며, 원래 언어와 오디오 품질은 그대로 유지됩니다."
          },
          {
            question: "YouTube 동영상을 변환하는 데 걸리는 시간에 영향을 미치는 요소는 무엇입니까?",
            answer:
              "변환 시간은 동영상 길이, 인터넷 연결 속도, 현재 서버 부하 등 여러 요인에 따라 달라집니다. 10분 미만의 동영상은 대부분 30초 이내에 변환됩니다."
          },
          {
            question: "스마트폰을 이용해 MP3를 변환하고 다운로드하면 어디에 저장되나요?",
            answer:
              "대부분의 스마트폰에서 변환된 MP3 파일은 다운로드 폴더에 저장됩니다. iPhone에서는 파일 앱에 저장될 수 있습니다. Android에서는 파일 관리자나 음악 앱에서 다운로드 폴더를 확인하세요."
          },
          {
            question: "YouTube 동영상을 MP3로 변환하면 오디오 품질이 저하되나요?",
            answer:
              "MP3는 오디오 전용 형식이므로 비디오 구성 요소가 없습니다. 오디오 품질은 원본 비디오에서 사용 가능한 최대 비트레이트(일반적으로 원본 업로드 품질에 따라 128~320kbps)로 유지됩니다."
          }
        ]
      },
      MoreFreeTools: {
        title: "더 많은 무료 도구",
        title_des: "다른 무료 변환 도구도 살펴보세요",
        YouTubeToMP: "유튜브에서 MP4로",
        YouTubeToMP_des:
          "YouTube 동영상을 오프라인에서 볼 수 있도록 MP4 형식으로 변환하세요. 고화질 동영상을 즉시 다운로드하세요.",
        AITranscription: "AI 전사",
        AITranscription_des:
          "96% 정확도로 오디오 및 비디오 파일을 텍스트로 변환하세요. 모든 콘텐츠에 대해 무제한 텍스트 변환이 가능합니다."
      },
      videoDownload: {
        title: "YouTube 링크를 MP3로 변환하세요. 무료이고 빠르며 광고가 없습니다.",
        description:
          "저희 서비스를 선택해 주셔서 감사합니다! 진심으로 감사드리며, 더 나은 경험을 하셨기를 바랍니다. 저희 웹사이트를 친구들과 공유해 주시면 큰 도움이 될 것입니다.",
        downloadButton: "다운로드",
        TranscribeButton: "고쳐 쓰다",
        downloadError: "변환 오류."
      }
    ...
    Transcription: {
      ...
      mp4Transcription: {
        hero: {
          title: "온라인 MP4 텍스트 변환기",
          des_1: "MP4 파일을 몇 초 만에 텍스트로 변환하세요.",
          des_2: "가입 불필요. 번개 같은 속도. 최고 수준의 정확도.",
          feature_1: "12가지 지원 형식",
          feature_2: "100개 이상의 지원 언어",
          feature_3: "6가지 형식으로 내보내기"
        },
        threeStep: {
          title: "MP4를 텍스트로",
          titleHighlight: "쉬운 3단계로 변환",
          step_1_title: "MP4 파일 업로드",
          step_1_des: "지정된 영역으로 끌어다 놓거나 \"파일 업로드\" 버튼을 클릭하기만 하면 됩니다.",
          step_2_title: "전사 시작",
          step_2_des: "\"전사\" 버튼을 클릭하세요. 시스템이 순식간에 MP4를 자동으로 텍스트로 변환합니다.",
          step_3_title: "전사 내용 다운로드",
          step_3_des: "텍스트가 온라인 편집 준비되었으며, TXT, PDF, DOCX, SRT, CSV, VTT 형식으로 내보내거나 링크로 공유할 수 있습니다."
        },
        howToGet: {
          title: "최고의 결과를 얻으려면",
          titleHighlight: "어떻게 해야 하나요?",
          fun_1: "압축 버전이 아닌 원본 비디오 파일을 전사에 사용하세요.",
          fun_2: "가능한 한 배경 소음, 배경 음악, 정전기 또는 에코를 줄이세요.",
          fun_3: "비디오를 다운로드할 때는 항상 \"고음질(HQ)\" 옵션을 선택하세요.",
          fun_4: "화자가 두 명 이상일 때 \"화자 식별\" 기능을 활성화하세요.",
          fun_5: "MP4 파일의 특정 언어와 억양을 선택하세요. 예: 영어 → 영어(미국) / 영어(영국) / 영어(인도).",
          fun_6: "프로세스 완료 후 즉시 전사 내용을 검토하세요."
        },
        exportFormats: {
          title: "내보내기 형식 및",
          titleHighlight: "그 용도",
          format_1: "TXT 형식으로",
          des_1: "메모장, Notepad++ 및 경량 텍스트 편집기용",
          format_2: "PDF 형식으로",
          des_2: "인쇄, 공유, 보관 및 크로스 플랫폼 보기용",
          format_3: "DOCX 형식으로",
          des_3: "Microsoft Word, Google Docs 및 리치 텍스트 편집용",
          format_4: "SRT 형식으로",
          des_4: "YouTube 자막, 비디오 자막 업로드 및 미디어 플레이어용",
          format_5: "CSV 형식으로",
          des_5: "Excel, Google Sheets 및 데이터 분석 도구용",
          format_6: "VTT 형식으로",
          des_6: "웹 비디오 자막, HTML5 플레이어 및 접근성 도구용"
        },
        howToUse: {
          title: "MP4를 텍스트로 변환하는 가치는 무엇이며,",
          titleHighlight: "최대한 활용하는 방법은 무엇인가요?",
          effect_1: "핵심 포인트를 즉시 읽으세요.",
          des_1: "비디오를 다시 보는 것보다 전사 내용을 더 빠리게 훑어보고 필수 정보를 신속하게 찾으세요.",
          effect_2: "학습과 연구를 정리하세요.",
          des_2: "강의, 인터뷰, 연구 클립을 강조, 인용, 재사용 가능한 깨끗한 노트로 변환하세요.",
          effect_3: "업무 생산성을 높이세요.",
          des_3: "회의 요약을 작성하고, 행동 항목을 추적하며, 콘텐츠를 문서나 지식 베이스에 저장하세요.",
          effect_4: "콘텐츠 제작을 지원하세요.",
          des_4: "스크립트, 개요, 기사 초안을 추출하고, 편집이나 현지화를 위해 자막을 내보내세요.",
          effect_5: "콘텐츠를 검색 및 번역 가능하게 하세요.",
          des_5: "전문 텍스트 검색 및 다국어 사용을 위한 전사 내용 번역.",
          effect_6: "보관을 간소화하세요.",
          des_6: "텍스트는 저장, 구조화, 재사용이 더 쉬워 기록, 문서화, AI 지식 베이스에 이상적입니다."
        },
        whyChoose: {
          title: "왜",
          titleHighlight: "우리의 MP4 텍스트 전사가 돋보이는가요",
          reason_1_title: "업계 최고 수준의 정확도",
          reason_1_des: "독립적으로 이용 가능한 가장 정확한 전사 도구 중 하나로 검증되었습니다.",
          reason_2_title: "빠른 처리 속도",
          reason_2_des: "원본 비디오 길이의 약 1/20로 전사 내용을 얻으세요.",
          reason_3_title: "화자 식별",
          reason_3_des: "화자 간을 명확히 구분하여 전사 내용을 읽고 따라가기 쉽게 만듭니다.",
          reason_4_title: "광범위한 언어 지원",
          reason_4_des: "100개 이상의 언어로 전사하고 249개 언어로 번역을 지원합니다.",
          reason_5_title: "간단하고 사용자 친화적",
          reason_5_des: "복잡한 인터페이스나 단계 없이. 몇 번의 클릭으로 작업을 완료하세요.",
          reason_6_title: "완전한 데이터 보안",
          reason_6_des: "저희는 데이터의 안전과 개인정보 보호를 핵심 약속 중 하나로 우선시합니다."
        },
        faq: {
          title: "MP4를 텍스트로 변환하는 것에",
          titleHighlight: "대한 질문",
          question_1: "MP4 파일을 텍스트로 전사하는 데 얼마나 걸리나요?",
          answer_1: "테스트에 따르면, 정상적인 조건에서 전사 프로세스는 비디오 길이의 약 1/20에서 1/10이 걸립니다. 예를 들어, 1시간 비디오는 약 3에서 6분이 걸립니다.",
          question_2: "업로드하는 MP4 파일의 크기에 제한이 있나요?",
          answer_2: "네. 최대 파일 크기는 5GB이며 비디오 길이는 10시간을 초과해서는 안 됩니다. 더 큰 파일은 처리하는 데 더 많은 시간이 필요할 수 있다는 점에 유의하세요.",
          question_3: "전사의 정확도는 어느 정도입니까?",
          answer_3: "전사 품질은 주로 비디오의 오디오 품질에 따라 달라진다는 점을 이해하는 것이 중요합니다. 그럼에도 불구하고 저희는 업계 최고 수준의 음성 인식 기술을 사용하여 MP4 전사에 최상의 결과를 보장합니다.",
          question_4: "MP4를 Word 문서로 전사할 수 있나요?",
          answer_4: "물론입니다. MP4 파일을 업로드하고 \"전사\"를 클릭한 후, 프로세스가 완료되면 \"내보내기\"를 선택하고 DOCX 형식을 선택하세요. Word 문서에서 완전한 전사 내용을 받게 됩니다.",
          question_5: "비디오 자막을 어떻게 얻을 수 있나요?",
          answer_5: "비디오를 업로드하고 전사하세요. 전사 후 \"내보내기\"를 클릭하고 SRT 또는 VTT 형식을 선택하여 자막을 다운로드하세요.",
          question_6: "이 MP4 전사 도구는 사용하기 안전한가요?",
          answer_6: "네. 저희 페이지는 광고 없으며, 처리를 위해 등록이 필요하지 않고 개인 정보를 요구하지 않습니다. 또한 바이러스를 방지하기 위한 강력한 기술적 조치를 사용합니다. 저희는 모든 사용자가 MP4 파일을 다운로드, 사용, 공유할 때 저작권 및 개인정보 보호 지침을 존중하도록 권장합니다."
        },
        explore: {
          title: "모든 것을 텍스트로 변환",
          des: "전사는 워크플로우를 간소화하고 실질적인 영향을 미치는 작업에 집중할 수 있게 해줍니다.",
          tool_1: "동영상을 텍스트로",
          tool_2: "MOV를 텍스트로",
          tool_3: "TikTok을 텍스트로",
          tool_4: "YouTube를 텍스트로",
          tool_5: "MP4를 SRT로",
          tool_11: "오디오를 텍스트로",
          tool_12: "음성을 텍스트로",
          tool_13: "MP3를 텍스트로",
      ...
      youtubeTranscription: {
        hero: {
          title: "YouTube 텍스트 온라인 변환",
          des_1: "YouTube 동영상이 즉시 텍스트로 변환 — 빠르고, 정확하며, 가입 불필요.",
          des_2: "6개의 내보내기 형식, 100개 이상의 언어, 249개의 번역 지원."
        },
        threeStep: {
          title: "정확한 결과를",
          titleHighlight: "얻는 방법",
          step_1_des: "YouTube 동영상 링크를 복사하세요.",
          step_2_des: "링크를 입력 상자에 붙여넣고 \"동영상 텍스트 얻기\"를 클릭하세요.",
          step_3_des: "변환이 완료될 때까지 기다린 후, 텍스트에 접근하여 편집, 번역 또는 내보내기하세요."
        },
        whatYouCan: {
          title: "YouTube 텍스트 변환 도구로",
          titleHighlight: "할 수 있는 일",
          list_title_1: "유연한 텍스트 콘텐츠",
          list_des_1: "좋아하는 YouTube 동영상을 읽기, 복사, 서치 가능한 텍스트로 변환하세요.",
          list_title_2: "빠른 검색과 편집",
          list_des_2: "동영상의 핵심 내용, 기억에 남는 인용, 중요한 세그먼트를 쉽게 찾고, 동영상을 참조하며 텍스트를 편집하세요.",
          list_title_3: "다양한 내보내기 형식",
          list_des_3: "TXT, PDF, DOCX, SRT, CSV, VTT 등 여러 형식으로 텍스트를 내보내어 자막, 문서 편집, 데이터 분석 등에 적합하게 하세요."
        },
        whyConvertYouTube: {
          title: "왜 YouTube 동영상을",
          titleHighlight: "텍스트로 변환해야 할까요",
          list_title_1: "쉬운 문서화, 저장 및 정리",
          list_des_1: "텍스트는 콘텐츠에 더 효과적으로 하이라이트, 참조, 비교하기 위해 사용됩니다.",
          list_title_2: "중요한 정보 찾기 및 검색",
          list_des_2: "동영상 타임라인을 이동할 필요 없이 핵심 내용을 신속하게 찾으세요.",
          list_title_3: "학습 효율 향상",
          list_des_3: "콘텐츠를 효과적으로 하이라이트, 참조, 비교하기 위해 텍스트를 사용하세요.",
          list_title_4: "콘텐츠 검색 및 추출",
          list_des_4: "텍스트는 검색 가능하고 복사 가능하여 인용 추출, 클립 참조 또는 스크립트 작성에 이상적입니다.",
          list_title_5: "언어 간 접근성",
          list_des_5: "모르는 언어의 콘텐츠를 쉽게 변환하고 여러 언어로 번역하세요.",
          list_title_6: "콘텐츠 재사용",
          list_des_6: "변환된 텍스트에서 기사, 자막, 소셜 미디어 카드, 동영상 스크립트 등을 생성하세요."
        },
        whyPeopleTrust: {
          title: "사람들이 우리",
          titleHighlight: "도구를 신뢰하는 이유",
          list_title_1: "무료 온라인 도구",
          list_des_1: "로그인 필요 없음. 소프트웨어, 플러그인, 확장 프로그램 설치 필요 없음.",
          list_title_2: "광고 제로, 방해 제로",
          list_des_2: "사용자의 필요를 충족시키도록 설계된 깨끗하고 단순한 인터페이스, 워크플로우를 중단하지 않음.",
          list_title_3: "번개 같은 변환 속도",
          list_des_3: "제한 없이 업계 최고 속도를 경험하세요.",
          list_title_4: "높은 정확도",
          list_des_4: "향상된 정밀도를 위해 최신 음성 인식 기술로 구동됩니다.",
          list_title_5: "방대한 언어 지원",
          list_des_5: "100개 이상의 언어로 콘텐츠를 변환하고 249개 언어로 번역하세요.",
          list_title_6: "저장 및 편집 기능",
          list_des_6: "실시간으로 텍스트를 편집하고 작업을 저장하여 나중에 사용하세요."
        },
        howToUse: {
          title: "사람들이 실제로 사용하는",
          titleHighlight: "YouTube 텍스트 변환 방법",
          list_title_1: "메모 작성자용",
          list_des_1: "YouTube 동영상을 보면서 메모를 작성하면 조급하고 정리가 안 되는 것처럼 느낄 수 있습니다. 변환을 이용하면 핵심 포인트와 주요 개념을 메모에 쉽게 복사하여 모든 것을 잡을 수 있습니다. ChatGPT와 같은 도구에 변환을 입력하여 명확한 요약 학습 노트 또는 개요를 생성할 수도 있습니다.",
          list_title_2: "콘텐츠 제작자용",
          list_des_2: "단순히 YouTube 링크를 붙여넣고 정확한 텍스트 버전을 얻으세요 — 제작자에게 훨씬 효율적인 작업 흐름입니다. 변환을 사용하여 블로그 게시물, 스크립트, 자막, 뉴스레터 또는 상세한 쇼 노트를 만드세요. 시간과 노력을 절약하고 콘텐츠 자체에 집중할 수 있게 해줍니다.",
          list_title_3: "전문가 및 분석가용",
          list_des_3: "법률, 의료, 컨설팅, 비즈니스 같은 분야에서 일하며 정밀한 정보 추출이 필요하다면, 변환은 작업을 더 쉽게 만듭니다. 동영상 전체를 다시 시청할 필요 없이 빠르게 특정 사실, 타임스탬프, 인용을 검색하세요. 전문가 강연, 프레젠테이션, 교육 동영상, 고객 인터뷰를 검토하는 데 이상적입니다.",
          list_title_4: "접근성 사용자용",
          list_des_4: "모두가 쉽게 비디오 콘텐츠를 보거나 들을 수 있는 것은 아닙니다. 변환은 청각 장애가 있거나 단순히 읽기를 선호하는 사용자에게 접근 가능하게 만듭니다. 249개 언어로 번역을 지원하여 언어 장벽을 허물고 글로벌 콘텐츠를 더 쉽게 이해하고 공유할 수 있게 합니다.",
          list_title_5: "지식 추출자용",
          list_des_5: "핵심 아이디어를 빨리 파악해야 하는 학생, 연구원, 제작자, 전문가를 위해, 변환은 값진 것입니다. 긴 동영상을 앉아 있을 필요 없이 즉시 찾아보고, 검색하고, 결정적인 정보를 식별하고, 효과적으로 핵심 포인트, 요약 또는 타임스탬프를 추출하도록 도와줍니다."
        },
        howToGet: {
          title: "YouTube 텍스트 변환으로",
          titleHighlight: "새로운 아이디어를 열다",
          subTitle: "YouTube 동영상을 쉽게 복사 가능하고, 실행 가능한 텍스트로 변환하고, Gemini나 ChatGPT 같은 AI 도구와 결합하여 다음을 할 수 있습니다:",
          list_des_1: "학습 노트나 요약 빠르게 생성",
          list_des_2: "핵심 포인트와 기억에 남는 인용이나 개념 추출",
          list_des_3: "퀴즈, Q&A 또는 학습 자료 생성",
          list_des_4: "블로그 게시물, 스크립트 또는 기사 초안",
          list_des_5: "인포그래픽, 밈 또는 소셜 미디어 콘텐츠 개발",
          list_des_6: "팬 Q&A, 퀴즈 또는 교육 게임 생산",
          list_des_7: "동영상에서 언급된 주제에 대해 더 깊이 파고들기",
          summary: "모든 것 번거로움 없이 — 복사, 붙여넣기, 시작."
        },
        faq: {
          title: "자주 묻는",
          titleHighlight: "질문",
          question_1: "YouTube 동영상 텍스트 변환에 길이 제한이 있나요?",
          answer_1: "아니요. 그러나 더 긴 동영상은 처리 시간이 더 필요합니다. 변환 작업을 그에 맞게 계획해 주세요.",
          question_2: "이것은 비공개 또나 목록에 없는 동영상으로 작동하나요?",
          answer_2: "공개적으로 사용 가능한 YouTube 동영상에서만 작동합니다. 비공개 또는 제한된 동영상은 변환될 수 없습니다.",
          question_3: "변환을 얻는 데 얼마나 걸리나요?",
          answer_3: "일반적으로 처리 시간은 동영상 길이의 1/10에서 1/20 사이입니다. 높은 정확도를 보장하면서 지속적으로 속도를 최적화하며 더 나은 사용자 경험을 위해 노력합니다.",
          question_4: "도구가 다른 말하는 사람을 구분할 수 있나요?",
          answer_4: "네. 최대 20명까지 말하는 사람을 감지하여 인터뷰, 팟캐스트, 토론 변환에 이상적입니다.",
          question_5: "텍스트 변환 도구의 정확도는 어느 정도입니까?",
          answer_5: "우리의 정확도는 96%를 초과합니다. 여러 억양이나 빠른 말 속도에서도 높은 정밀도를 유지하지만, 더 좋은 오디오 품질과 더 적은 배경 소음은 결과를 향상시킵니다.",
          question_6: "변환에는 어떤 기능이 포함되어 있나요?",
          answer_6: "변환에는 자동 말하는 사람 식별과 타임스탬프가 포함됩니다. 텍스트를 온라인으로 편집하거나 나중에 사용하기 위해 내보낼 수 있습니다.",
          question_7: "내 변환 기록을 저장할 수 있나요?",
          answer_7: "네. YouTube 링크를 처리한 후 변환을 저장하기 위해 계정을 등록하기만 하면 됩니다.",
          question_8: "내 데이터는 비공개로, 안전하게 유지되나요?",
          answer_8: "네. 이 동영상, 변환, 파일은 안전하게 처리되며 — AI 모델을 훈련하거나 제3자와 공유하는 데 사용되지 않습니다.",
          question_9: "변환 내용을 다른 AI 도구와 함께 사용할 수 있나요?",
          answer_9: "물론입니다. ChatGPT나 다른 AI 도구에 텍스트를 붙여넣어 요약, 노트, 퀴즈, 스크립트, 기사 등을 생성할 수 있습니다."
        }
      }
    },
    Upload: {
      ...
      tip7: "관리 및 편집을 위해",
      tip8: "모든 대본 파일",
      linkV1Placeholder: "여기에 YouTube URL을 붙여넣으세요.",
      linkV1Btn: "동영상 대본 가져오기"
    }
  },
  About: {
    Hero: {
      ...
      title: "소개",
      description:
        "우리의 미션은 가장 정확한 오디오 및 비디오 필사 서비스를 제공하는 것입니다. 업계 최고의 AI 기술을 활용하여 96% 이상의 필사 정확도를 달성합니다. 주요 언어의 경우 기술 최적화를 통해 99% 정확도까지 도달할 수 있습니다."
    },
    Stats: {
      title: "우리의",
      ...
      features: [
        {
          ...
          title: "비교 불가능한 정확도",
          description:
            "우리의 AI 모델은 지속적으로 개선되어 96% 이상의 필사 정확도를 제공하며, 고급 최적화를 통해 주요 언어는 99% 정확도까지 달성합니다."
        },
        {
          icon: "🌍",
          title: "글로벌 언어 지원",
          description:
            "100개 이상의 언어 음성 인식과 249개 이상의 언어 번역 기능을 지원하여 당신의 콘텐츠를 진정한 글로벌 콘텐츠로 만듭니다."
        },
        {
          icon: "⚡",
          title: "번개 같은 처리 속도",
          description:
            "몇 시간 분량의 오디오 및 비디오 콘텐츠를 몇 분 만에 처리합니다. 최적화된 AI 파이프라인이 품질 저하 없이 빠르게 필사 결과를 제공합니다."
        },
        {
          icon: "🔒",
          title: "기업급 보안",
          description:
            "당신의 데이터 보안은 우리의 최우선 과제입니다. 업계 표준 암호화를 사용하고 글로벌 개인정보 보호 규정을 준수하여 콘텐츠를 안전하고 기밀하게 유지합니다."
        }
      ]
    },
    Company: {
  ...
  Privacy: {
    ...
    policyAgreement:
      "본 개인정보 처리방침을 주의 깊게 읽고 이해하시기 바랍니다. 당사 서비스를 이용함으로써 귀하는 본 방침에 동의하는 것입니다. 본 방침에 따른 개인정보 사용에 동의하지 않을 경우 즉시 서비스 이용을 중지해야 합니다.",
    policyOverview:
      "본 방침에서는 다음을 명시합니다: 수집하는 데이터 및 이유; 데이터 처리 방식; 귀하의 데이터 권리. 당사는 귀하의 데이터를 판매하지 않습니다.",
    scopeTitle: "1. 개인정보 처리방침 범위",
    scopeDescription:
      "본 개인정보 처리방침은 당사가 서비스 이용자 정보를 수집 및 처리하는 경우에만 적용됩니다. 본 방침은 당사가 연결을 제공하거나 다른 사용자가 공유한 제3자 운영 서비스, 웹사이트 또는 소프트웨어에는 적용되지 않으며, 제3자의 콘텐츠, 데이터, 애플리케이션 또는 자료에도 적용되지 않습니다. 제3자 웹사이트 또는 소프트웨어에 정보를 제공하기 전에 해당 개인정보 처리방침을 확인할 것을 권장합니다.",
    ...
    identityDescription:
      "제품 가입 시 이름, 이메일 주소 등 신원 정보를 요청합니다. 이는 핵심 제품 기능 제공 및 제품 업데이트 등 필수 정보 전송을 위함입니다.",
    billingTitle: "2.2 결제 정보",
    billingDescription:
      "유료 제품 가입 시 결제 정보 및 청구 주소를 제공해야 합니다. 결제 정보는 당사 서버를 거치지 않고 결제 처리업체에 직접 전송됩니다.",
    productInteractionsTitle: "2.3 제품 상호작용",
    productInteractionsDescription:
      "귀하가 업로드하거나 수신하거나 제품 계정에서 유지하는 콘텐츠를 당사 서버에 저장합니다. 삭제하지 않는 한 계정이 활성 상태인 동안 이 콘텐츠를 보관할 수 있습니다.",
    websiteInteractionsTitle: "2.4 웹사이트 상호작용",
    websiteInteractionsDescription:
      "전환율 테스트 및 신제품 디자인 실험 등 분석 및 통계 목적으로 브라우징 활동 정보를 수집합니다. 여기에는 브라우저 및 운영체제 버전, IP 주소, 방문한 웹페이지 및 로딩 시간, 유입 경로 등이 포함됩니다. 계정이 있고 로그인한 경우, 이 웹 분석 데이터는 계정이 비활성화될 때까지 IP 주소 및 사용자 계정과 연결됩니다.",
    cookiesTitle: "2.5 쿠키",
    cookiesDescription1:
      "당사는 특정 기본 설정 저장, 애플리케이션 사용 편의 제공, A/B 테스트 수행 및 일부 분석 지원을 위해 지속적인 1자 쿠키와 일부 3자 쿠키를 사용합니다.",
    cookiesDescription2:
      "쿠키는 브라우저가 저장하는 텍스트 조각입니다. 로그인 정보 및 사이트 기본 설정 기억에 도움이 될 수 있습니다. 또한 브라우저 유형, 운영체제, 방문한 웹페이지, 방문 시간, 본 콘텐츠 및 기타 클릭스트림 데이터와 같은 정보를 수집할 수 있습니다. 브라우저 설정에서 쿠키 보존 설정을 조정하고 개별 쿠키를 허용 또는 차단할 수 있지만, 쿠키를 끄면 당사 앱이 작동하지 않으며 서비스의 다른 측면이 제대로 기능하지 않을 수 있습니다.",
    correspondenceTitle: "2.6 자발적 서신",
    correspondenceDescription:
      "질문이나 도움 요청을 위해 당사에 이메일을 보낼 경우, 향후 문의 시 참조할 수 있도록 이메일 주소를 포함한 해당 서신을 보관합니다.",
    accessTitle: "3. 정보 접근 또는 공유 시기",
    accessDescription1:
      "요청한 제품 또는 서비스 제공을 위해. 당사는 일부 제3자 하위처리자를 사용하여 애플리케이션 운영 및 서비스 제공을 지원합니다. 여기에는 클라우드 및 분석 제공업체가 포함됩니다.",
    accessDescription2:
      "남용 조사, 예방 또는 조치를 위해. 잠재적 남용 조사 시 고객 계정 접근은 최후의 수단입니다. 당사는 고객과 문제를 신고하는 사람들의 개인정보 보호와 안전을 보호하려 하며, 전 과정에서 이러한 책임을 균형 있게 수행하기 위해 최선을 다합니다. 제한된 목적으로 당사 제품을 사용하는 것이 발견될 경우, 필요한 조치를 취할 것이며 여기에는 적절한 경우 관련 당국에 통보하는 것도 포함됩니다.",
    ...
    preservationRequests:
      "데이터 보존 요청. 유사하게, 당사의 정책은 미국 연방 저장 통신법(18 U.S.C. Section 2703(f))에 의하거나 민사 사건에 대한 적절하게 발부된 미국 소환장에 의한 경우에만 데이터 보존 요청을 준수하는 것입니다. 당사는 법률에 의해 요구되거나 항소하지 않기로 선택한 법원 명령에 의하지 않는 한 보존된 데이터를 공유하지 않습니다. 또한, 필요한 보존 기간 만료 전에 적절한 영장, 법원 명령 또는 소환장을 받지 못할 경우, 당사는 보존 기간 종료 시 고객 데이터의 보존된 사본을 모두 파기할 것입니다.",
    taxAudits:
      "세무 당국으로부터 감사를 받을 경우, 당사는 결제 관련 정보를 공유해야 할 수 있습니다. 이 경우 청구 주소 및 세금 면제 정보 등 최소한의 정보만 공유할 것입니다.",
    ...
    locationDescription:
      "당사 제품 및 기타 웹 자산은 미국에서 운영됩니다. 유럽 연합, 영국 또는 미국 이외의 지역에 위치한 경우, 당사에 제공하는 모든 정보가 미국으로 전송 및 저장된다는 점을 유의하시기 바랍니다. 당사 웹사이트 또는 서비스를 이용하거나 개인정보를 제공함으로써 귀하는 이 전송에 동의하는 것입니다.",
    childrenTitle: "7. 아동 개인정보 보호",
    updatesTitle: "8. 개인정보 처리방침 업데이트",
    updatesDescription:
      "당사는 관련 규정을 준수하고 새로운 관행을 반영하기 위해 필요 시 본 방침을 업데이트할 수 있습니다. 방침에 중대한 변경을 할 때마다 본 페이지 상단의 날짜를 갱신할 것입니다.",
    contactTitle: "9. 문의하기",
    websiteUrl: "https://www.nevercap.ai/",
    at: "：",
    childrenDescription:
      "본 서비스는 어린이를 대상으로 하지 않으며, 13세 미만 어린이로부터 고의로 개인 정보를 수집하지 않습니다. 13세 미만인 경우, 서비스를 통해 어떠한 개인 정보도 제출하지 마십시오. 만약 어린이가 본 정책을 위반하여 저희에게 개인 정보를 제공했다고 생각되면, 아래에 명시된 {at} {email}로 문의해 주시기 바랍니다.",
    contactDescription:
      "개인정보 보호 정책에 관한 질문, 의견 또는 불만 사항이 있으시면 {at} {email}로 연락주시면 최대한 신속하게 처리하겠습니다.",
    policyDescriptionA:
      '본 정책은 {NeverCap}(이하 "NeverCap", "당사", "저희", "우리")이 귀하가 당사의 서비스, 웹사이트({url}) 및 소프트웨어(총칭하여 "서비스")를 이용할 때 귀하의 개인 정보를 수집, 사용 및 공개하는 방식에 대해 설명합니다.'
  },
  TermsOfUse: {
    title: "서비스",
    titleGradient: "약관",
    ...
    servicesDefinition:
      '"서비스"란 NeverCap이 제작 및 유지하는 웹 브라우저, 데스크톱 애플리케이션, 모바일 애플리케이션 등 모든 형태의 제품을 의미합니다.',
    termsUpdate:
      "향후 서비스 약관을 업데이트할 수 있습니다. 일반적으로 변경 사항은 관련 정책 링크를 통해 명확히 설명됩니다. 정책에 중대한 변경이 있을 경우 본 페이지 상단의 날짜를 갱신하고 계정 소유자에게 적절한 방법으로 알릴 것입니다.",
    acceptanceTitle: "1. 약관 동의",
    acceptanceDescription1:
      "서비스를 이용함으로써 본 약관에 동의하는 것이며, 이는 귀하와 NeverCap 사이의 구속력 있는 계약이 됩니다. 귀하는 본 약관을 수락할 법적 권한이 있으며 계약 체결 가능한 연령임을 확인합니다. NeverCap의 수락은 귀하가 본 약관의 모든 조건에 동의하는 것을 전제로 합니다.",
    eligibilityRequirement:
      "본 서비스는 18세 미만의 이용자를 대상으로 하지 않습니다. 서비스를 이용함으로써 귀하는 위 자격 요건을 충족함을 진술 및 보증합니다.",
    userResponsibility:
      '"귀하", "귀하의"란 귀하의 직원, 대리인, 비즈니스 대표자 및 귀하의 계정을 통해 서비스에 접근하는 모든 개인을 포함합니다. 귀하는 귀하의 계정으로 서비스에 접근하는 모든 사람이 본 약관을 인지하고 준수하도록 할 책임이 있습니다.',
    termsRevision:
      "NeverCap은 단독 재량으로 본 약관을 수시로 수정 및 업데이트할 권리를 가집니다. 모든 변경 사항은 게시 즉시 효력이 발생합니다. 수정된 약관 게시 후 서비스를 계속 이용함으로써 귀하는 변경 사항을 수락하고 동의하는 것입니다. 귀하는 본 페이지를 수시로 확인하여 변경 사항을 인지해야 하며, 이는 귀하에게 구속력이 있습니다.",
    ...
    servicesAccess:
      "저희는 귀하에게 서비스를 제공할 것입니다. 귀하는 서비스 이용에 필요한 모든 준비를 할 책임이 있습니다.",
    accountTermsTitle: "3. 계정 조건",
    accountSecurity:
      "귀하는 계정 보안 유지에 대한 책임이 있습니다. 회사는 귀하가 이 보안 의무를 준수하지 않아 발생하는 모든 손실 또는 손해에 대해 책임지지 않습니다.",
    lawfulUse: "서비스를 불법적, 비윤리적 또는 부도덕한 목적으로 사용해서는 안 됩니다.",
    contentResponsibility:
      "귀하의 계정 아래 게시된 모든 콘텐츠 및 발생한 활동에 대한 책임이 있습니다. 이는 (a) 귀하의 로그인 정보에 접근할 수 있는 자 또는 (b) 귀하의 계정 아래 자신의 로그인을 가진 자가 게시한 콘텐츠를 포함합니다.",
    humanRequirement:
      '귀하는 반드시 인간이어야 합니다. "봇" 또는 기타 자동화된 방법으로 등록된 계정은 허용되지 않습니다.',
    paymentTitle: "4. 결제, 환불 및 요금제 변경",
    freeTrial:
      "무료 체험을 제공하는 유료 서비스의 경우, 가입 시 체험 기간을 안내해 드립니다. 체험 기간 종료 후 서비스를 계속 이용하려면 사전 결제가 필요합니다. 결제하지 않을 경우 해당 서비스는 종료됩니다.",
    upgradePolicy:
      "무료 요금제에서 유료 요금제로 업그레이드하는 경우, 즉시 카드 결제가 이루어지며 결제 주기는 업그레이드 날짜부터 시작됩니다.",
    taxes:
      "모든 요금은 세금, 부과금 또는 관세를 포함하지 않습니다. 필요한 경우, 저희는 세무 당국을 대신하여 해당 세금을 징수하여 납부할 것입니다. 그렇지 않은 경우, 귀하는 모든 세금, 부과금 또는 관세를 납부할 책임이 있습니다.",
    refunds:
      "모든 구매는 환불이 불가능합니다. 귀하는 언제든지 계정에 로그인하여 유료 서비스를 취소할 수 있습니다. 유료 구독의 경우, 별도로 명시되지 않는 한 취소는 현재 유료 기간 종료 시점에 효력이 발생합니다.",
    cancellationTitle: "5. 해지 및 종료",
    cancellationPolicy:
      "유료 기간 종료 전 서비스를 해지하는 경우, 해지는 즉시 효력이 발생하며 재결제되지 않습니다. 마지막 결제 주기의 미사용 기간에 대해서는 자동으로 비례 환불되지 않습니다.",
    terminationRights:
      "저희는 언제든지 어떠한 이유로든 귀하의 계정을 정지 또는 종료하고 현재 또는 향후 서비스 이용을 거부할 권리를 가집니다. 정지는 계정 또는 계정 내 콘텐츠에 접근할 수 없음을 의미합니다. 종료는 계정 삭제 또는 접근 권한 상실 및 계정 내 모든 콘텐츠의 몰수와 포기를 초래합니다. 또한 저희는 언제든지 어떠한 이유로든 누구에게나 서비스 이용을 거부할 권리를 보유합니다.",
    abusePolicy:
      "회사 직원 또는 임원에 대한 언어적, 신체적, 서면적 또는 기타 학대(학대 또는 보복 위협 포함)는 즉시 계정 종료로 이어질 수 있습니다.",
    submissionsTitle: "6. 제출물",
    submissionsDescription:
      '귀하가 저희에게 제공한 사이트 관련 질문, 의견, 제안, 아이디어, 피드백 또는 기타 정보("제출물")는 비밀 유지되지 않으며 저희의 단독 소유물이 됨을 인정 및 동의합니다. 저희는 모든 지적 재산권을 포함한 독점적 권리를 가지며, 귀하에 대한 인정 또는 보상 없이 합법적 목적(상업적 또는 기타)으로 이러한 제출물을 무제한 사용 및 배포할 권리가 있습니다. 귀하는 모든 도덕적 권리를 포기하며, 제출물이 귀하의 창작물이거나 제출할 권리가 있음을 보증합니다. 귀하는 제출물에 대한 소유권 침해 또는 도용에 대해 저희에게 소송을 제기하지 않기로 동의합니다.',
    uptimeTitle: "7. 가동 시간 및 보안",
    serviceAvailability:
      '서비스 이용은 전적으로 귀하의 책임 하에 이루어집니다. 저희는 서비스를 "있는 그대로" 및 "이용 가능한 상태로" 제공합니다. 대부분의 서비스에 대해 서비스 수준 계약을 제공하지 않지만, 애플리케이션 가동 시간을 중요하게 생각합니다.',
    throttlingPolicy:
      "귀하의 활동이 다른 사용자에게 서비스의 안정성과 성능에 부정적 영향을 미치는 것으로 확인되는 드문 경우, 계정 접근을 일시적으로 제한할 권리를 보유합니다. 가장 중요한 경우를 제외하고는 조치 전에 귀하에게 연락하여 해결책을 모색할 것입니다.",
    dataSecurity:
      "백업, 중복화 및 암호화를 통해 데이터를 보호하고 보안을 유지하기 위해 다양한 조치를 취하고 있습니다. 공용 인터넷을 통한 데이터 전송 시 암호화를 적용합니다.",
    thirdPartyVendors:
      "서비스 운영에 필요한 하드웨어, 소프트웨어, 네트워킹, 저장장치 및 관련 기술을 제공하기 위해 제3자 공급업체 및 호스팅 파트너를 이용합니다.",
    siteManagementTitle: "8. 사이트 관리",
    siteManagementDescription:
      "저희는 다음의 권리를 보유하지만 의무는 아닙니다: (1) 사이트에서 본 서비스 약관 위반을 모니터링; (2) 법률 또는 본 서비스 약관을 위반하는 자에 대해 단독 재량으로 적절한 법적 조치(해당 사용자를 법 집행 기관에 신고하는 것 포함)를 취함; (3) 단독 재량으로 귀하의 기여물 또는 그 일부에 대한 접근 거부, 제한 또는 비활성화(기술적으로 가능한 범위 내); (4) 단독 재량으로 사이트에서 과도한 크기 또는 시스템에 부담을 주는 파일 및 콘텐츠 제거 또는 비활성화; (5) 저희의 권리와 재산을 보호하고 사이트의 원활한 운영을 위해 사이트를 관리.",
    copyrightTitle: "9. 저작권 및 콘텐츠 소유권",
    copyrightCompliance: "서비스에 게시된 모든 콘텐츠는 미국 저작권법을 준수해야 합니다.",
    ipRights:
      "귀하가 서비스에 제공한 자료에 대한 지적 재산권을 주장하지 않습니다. 업로드된 모든 자료는 귀하의 소유입니다.",
    contentModeration:
      "콘텐츠를 사전 검토하지는 않지만, 서비스를 통해 이용 가능한 콘텐츠를 거부 또는 제거할 권리(의무는 아님)를 보유합니다.",
    prohibitedExploitation:
      "회사의 서면 허가 없이 서비스의 일부, 서비스 이용 또는 서비스 접근을 복제, 복사, 판매, 재판매 또는 이용하지 않기로 동의합니다.",
    impersonationProhibition:
      "다른 웹사이트를 수정하여 서비스 또는 회사와 연관이 있는 것처럼 오인하게 해서는 안 됩니다.",
    dmcaPolicy:
      "저희는 타인의 지적 재산권을 존중합니다. 사이트에서 제공되는 자료가 귀하의 저작권을 침해한다고 생각되면 즉시 저희에게 연락하십시오. 귀하의 통지서 사본은 해당 자료를 게시 또는 저장한 자에게 전송됩니다. 관련 법률에 따라 통지서에 허위 진술을 할 경우 손해 배상 책임을 질 수 있음을 유의하십시오. 따라서 사이트에 게시되거나 링크된 자료가 귀하의 저작권을 침해하는지 확실하지 않은 경우, 먼저 변호사와 상담하는 것이 좋습니다.",
    prohibitedActivitiesTitle: "10. 금지 활동",
    generalProhibition:
      "당사가 사이트를 제공하는 목적 이외의 용도로 사이트에 접근하거나 사용할 수 없습니다. 당사가 특별히 승인하지 않는 한 사이트를 상업적 목적으로 사용할 수 없습니다.",
    userObligations: "사이트 사용자로서 다음 행위에 동의하지 않습니다:",
    dataScraping:
      "당사의 서면 허가 없이 체계적으로 데이터 또는 기타 콘텐츠를 검색하여 직접 또는 간접적으로 컬렉션, 컴파일레이션, 데이터베이스 또는 디렉토리를 생성하거나 편집하는 행위",
    fraud:
      "당사 및 다른 사용자를 속이거나 기만하는 행위, 특히 사용자 비밀번호와 같은 민감한 계정 정보를 알아내려는 시도",
    securityInterference:
      "사이트의 보안 관련 기능을 우회, 비활성화 또는 방해하는 행위. 이는 콘텐츠 사용 또는 복사를 방지/제한하는 기능이나 사이트 및/또는 해당 콘텐츠 사용에 대한 제한을 시행하는 기능을 포함합니다.",
    ...
    malware:
      "바이러스, 트로이 목마 또는 기타 자료를 업로드하거나 전송(시도 포함)하는 행위. 이는 대문자 과도한 사용 및 스팸(반복적인 텍스트 지속적 게시)을 포함하며, 사이트의 원활한 사용을 방해하거나 사이트의 사용, 기능, 운영 또는 유지 관리에 영향을 미치는 행위",
    automation:
      "시스템의 자동화된 사용에 종사하는 행위. 이는 스크립트를 사용하여 댓글 또는 메시지를 보내거나 데이터 마이닝, 로봇 또는 유사한 데이터 수집 및 추출 도구를 사용하는 것을 포함합니다.",
    copyrightRemoval: "콘텐츠에서 저작권 또는 기타 소유권 고지를 삭제하는 행위",
    impersonation: "다른 사용자 또는 사람을 사칭하거나 다른 사용자의 사용자 이름을 사용하는 시도",
    spyware:
      '수동적 또는 능동적 정보 수집 또는 전송 메커니즘으로 작용하는 자료를 업로드하거나 전송(시도 포함)하는 행위. 여기에는 명확한 그래픽 교환 형식("gifs"), 1×1 픽셀, 웹 버그, 쿠키 또는 기타 유사한 장치(일반적으로 "스파이웨어" 또는 "수동적 수집 메커니즘" 또는 "pcms"로 알려진 것)가 포함됩니다.',
    ...
    codeCopying:
      "사이트의 소프트웨어를 복사하거나 수정하는 행위. 여기에는 Flash, PHP, HTML, JavaScript 또는 기타 코드가 포함되지만 이에 국한되지 않습니다.",
    reverseEngineering:
      "적용 가능한 법률에서 허용하는 경우를 제외하고, 사이트의 일부를 구성하는 소프트웨어를 해독, 디컴파일, 디스어셈블 또는 리버스 엔지니어링하는 행위",
    ...
    unauthorizedUse:
      "사이트를 무단으로 사용하는 행위. 여기에는 전자적 또는 기타 수단으로 사용자 이름 및/또는 이메일 주소를 수집하여 원치 않는 이메일을 보내거나, 자동화된 수단 또는 허위 전제로 사용자 계정을 생성하는 행위가 포함됩니다.",
    competition:
      "당사와 경쟁하기 위한 노력의 일환으로 사이트를 사용하거나, 수익 창출 목적 또는 상업적 기업을 위해 사이트 및/또는 콘텐츠를 사용하는 행위",
    advertising: "사이트를 사용하여 상품 또는 서비스를 광고하거나 판매 제안을 하는 행위",
    profileTransfer: "프로필을 판매하거나 양도하는 행위",
    featuresTitle: "11. 기능 및 버그",
    featuresDescription:
      "당사는 자체 경험과 시간과 피드백을 공유한 고객의 경험을 바탕으로 서비스를 신중하게 설계합니다. 그러나 모든 사람을 만족시키는 서비스는 없습니다. 당사는 서비스가 귀하의 특정 요구 사항이나 기대를 충족할 것이라고 보장하지 않습니다.",
    bugsDescription:
      "당사는 모든 기능을 출시 전에 테스트합니다. 모든 소프트웨어와 마찬가지로 당사 서비스에도 일부 버그가 있을 수밖에 없습니다. 당사는 보고된 버그를 추적하고 처리하며, 특히 보안 또는 개인정보 보호와 관련된 버그를 우선적으로 해결합니다. 보고된 모든 버그가 수정되는 것은 아니며, 완전히 오류가 없는 서비스를 보장하지 않습니다.",
    correctionsTitle: "12. 수정",
    informationAccuracy:
      "사이트에는 오타, 부정확성 또는 누락이 포함된 정보가 있을 수 있습니다. 여기에는 설명, 가격, 가용성 및 기타 다양한 정보가 포함됩니다. 당사는 사전 통지 없이 오류, 부정확성 또는 누락을 수정하고 사이트의 정보를 변경 또는 업데이트할 권리를 보유합니다.",
    siteAvailability:
  ...
  Blog: {
    Hero: {
      ...
      description:
        "{NeverCap}의 튜토리얼, 전략 및 AI 도구를 사용하면 전문적인 필사 워크플로를 통해 무제한의 콘텐츠를 제작할 수 있습니다."
    },
    Featured: {
    ...
    ListSection: {
      ...
      categories: ["모든 게시물", "튜토리얼", "팟캐스팅", "콘텐츠 제작", "사업", "AI 팁"]
    },
    Detail: {
      Home: "집",
      Blog: "블로그",
